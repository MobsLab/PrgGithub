...
Fs      =   100;                    % sampling frequency  (for spectral analysis only)
...
fname = sprintf('/Users/karimbenchenane/Documents/MATLAB/PrgMATLAB/GCCA_toolbox/test_img/Noscall%d_%d.png', deb,fin);
