...
classdef BoardUI < handle
    ...
    methods
        function obj = BoardUI(board,sleep_stage,phase_space,gamma_distr,ratio_distr,...
                              chips_popup, channels_popup, fifolag, fifopercentagefull, num_channels)
        % Constructor
        %
        ...
        % num_channels       number of channels to display at the same time
            ...
            obj.Plot = BoardPlot(sleep_stage,phase_space,gamma_distr,ratio_distr,...
                                 num_channels,frequency(obj.Board.SamplingRate));
            obj.TheChannels=[1 2];
