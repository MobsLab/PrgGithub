classdef BoardPlot < handle
    ...
    methods
        ...
        function obj = BoardPlot(sleep_stage, phase_space,gamma_distr,ratio_distr,...
                                 num_channels, samplingfreq)
            obj.passed=0;
            obj.detec_seuil=100;
            ...
            %Def of Channels for Sleep Scoring and min and max of
            %Frequencies
...
%             % Create and set up the plot area for delta
% 
...
%             set(l, 'FontSize', 9);
        ...
        function refresh_display_now(obj)
        % Update the plot.
        %
