...
% plot : - Spectra during freezing for each mouse
%        - Average spectrum at the begining and the end of a freezing
%        episode
%        - Average spectrum during freezing divided in 5 periods
%        - Average spectrum during freezing for each CS+
%        - Average during freezing vs no freezing
% to be run : any  (path indicaed in the script)
...
%saveas(fig1, 'AllMiceSpectra.eps')
set(fig1, 'Position', [7         401        1920         477])
c=colorbar;
c.Label.String = 'time';
saveFigure(fig1,'AllMiceSpectra', '\\NASDELUXE2\DataMOBsRAID\ProjetAversion\ManipDec15BulbectomiePlethysmo\AnalyseRespi')
...
ylabel('Power')
set(gca,'XTick',[1:5],'XTickLabel',{'1/5','2/5','3/5','4/5','5/5'})
%saveas(fig3,'SpectraFreez5Periods.eps')
saveFigure(fig3,'SpectraFreez5Periods', '\\NASDELUXE2\DataMOBsRAID\ProjetAversion\ManipDec15BulbectomiePlethysmo\AnalyseRespi')
...
errorbar([1:12],nanmean(Tot11'),stdError(Tot11'),'k','linewidth',2)
 xlabel('CS num')
ylabel('Power')
%saveas(fig4,'SpectraFreezByCS.eps')
saveFigure(fig4,'SpectraFreezByCS', '\\NASDELUXE2\DataMOBsRAID\ProjetAversion\ManipDec15BulbectomiePlethysmo\AnalyseRespi')
...
colormap(jet)
saveFigure(fig5,'RespiDebFinEpFreez', '\\NASDELUXE2\DataMOBsRAID\ProjetAversion\ManipDec15BulbectomiePlethysmo\AnalyseRespi')
