%FEAR_compFR_matlab_imetronics
%Clara Nov 15 
%Comparison of the freezing measured by Matlab and by Imetronics:
% validation of the measure of the freezing by Imetronics.
...
%         csm=StimInfo(StimInfo(:,2)==5,1); % times of CS-
    ...
    bilan_M{1,2}(a,:)=FAll_M;
     ...
     a=a+1; %incr�ment du nombre de souris
     end
end
cd(res)
...
save bilan.mat MouseList_M -Append
