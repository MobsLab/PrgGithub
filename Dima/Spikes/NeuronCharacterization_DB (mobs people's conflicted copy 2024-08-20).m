...
fh = figure('units', 'normalized', 'outerposition', [0.1 0.2 0.8 0.7]);
subplot(121)
scatter(PREFR_SWS_IntAll,POSTFR_SWS_IntAll)
hold on
if xlim>=ylim
    plot([0:max(xlim)],[0:max(xlim)],'Color','k')
else
...
ylabel('Post-NREM')
subplot(122)
scatter(PREFR_REM_IntAll,POSTFR_REM_IntAll)
hold on
if xlim>=ylim
    plot([0:max(xlim)],[0:max(xlim)],'Color','k')
else
...
fh = figure('units', 'normalized', 'outerposition', [0.1 0.2 0.8 0.7]);
subplot(121)
scatter(PREFR_SWS_IntAll,PREFR_REM_IntAll)
hold on
if xlim>=ylim
    plot([0:max(xlim)],[0:max(xlim)],'Color','k')
else
...
ylabel('Pre-REM')
subplot(122)
scatter(POSTFR_SWS_IntAll,POSTFR_REM_IntAll)
hold on
if xlim>=ylim
    plot([0:max(xlim)],[0:max(xlim)],'Color','k')
else
...
saveas(fh, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/2_IntFR_Mean.fig');
saveFigure(fh, '2_IntFR_Mean', '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/');
close(fh)
...
fh = figure('units', 'normalized', 'outerposition', [0.1 0.2 0.8 0.7]);
% subplot(121)
scatter(PREFR_rip_PyrAll,POSTFR_rip_PyrAll)
hold on
if xlim>=ylim
    plot([0:max(xlim)],[0:max(xlim)],'Color','k')
else
...
saveas(fh, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/3_PyrFRRipples_Mean.fig');
saveFigure(fh, '3_PyrFRRipples_Mean', '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/');
close(fh)
...
fh = figure('units', 'normalized', 'outerposition', [0.1 0.2 0.8 0.7]);
% subplot(121)
scatter(PREFR_rip_IntAll,POSTFR_rip_IntAll)
hold on
if xlim>=ylim
    plot([0:max(xlim)],[0:max(xlim)],'Color','k')
else
...
saveas(fh, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/4_IntFRRipples_Mean.fig');
saveFigure(fh, '4_IntFRRipples_Mean', '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/');
close(fh)
...
fh = figure('units', 'normalized', 'outerposition', [0.1 0.2 0.8 0.7]);
subplot(121)
scatter(PartProbPre_rip_PyrAll,PartProbPost_rip_PyrAll)
hold on
...
ylabel('Post-Pyr')
subplot(122)
scatter(PartProbPre_rip_IntAll,PartProbPost_rip_IntAll)
hold on
if max(xlim)>=max(ylim)
    plot([0:max(xlim)],[0:max(xlim)],'Color','k')
else
...
saveas(fh, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/5_ProbRipples_Mean.fig');
saveFigure(fh, '5_ProbRipples_Mean', '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/');
close(fh)
...
subplot(151)
[A,sid] = sort(PREFR_SWS_PyrAll);
Pl = [A' PREFR_REM_PyrAll(sid)'];
imagesc(Pl)
...
clear A sid Pl
subplot(152)
[A,sid] = sort(POSTFR_SWS_PyrAll);
Pl = [A' POSTFR_REM_PyrAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:2,...
    'XTickLabel',{'NREM','REM'})
title('Pyr in Post')
...
subplot(154)
[A,sid] = sort(PREFR_SWS_IntAll);
Pl = [A' PREFR_REM_IntAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:2,...
    'XTickLabel',{'NREM','REM'})
title('Int in Pre')
clear A sid Pl
subplot(155)
[A,sid] = sort(POSTFR_SWS_IntAll);
Pl = [A' POSTFR_REM_IntAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:2,...
    'XTickLabel',{'NREM','REM'})
title('Int in Post')
...
saveas(fh, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/1_FRSleep_All.fig');
saveFigure(fh, '1_FRSleep_All', '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/');
close(fh)
...
saveas(fh, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/2_FRSleep_All.fig');
saveFigure(fh, '2_FRSleep_All', '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/');
close(fh)
...
subplot(151)
[A,sid] = sort(PREFR_rip_PyrAll);
Pl = [A' CONDFR_rip_PyrAll(sid)' POSTFR_rip_PyrAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:3,...
    'XTickLabel',{'Pre','Cond','Post'})
title('Pyr during ripples')
clear A sid Pl
subplot(152)
[A,sid] = sort(PREFR_norip_PyrAll);
Pl = [A' CONDFR_norip_PyrAll(sid)' POSTFR_norip_PyrAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:3,...
    'XTickLabel',{'Pre','Cond','Post'})
title('Pyr outside ripples')
clear A sid Pl

subplot(154)
[A,sid] = sort(PREFR_rip_IntAll);
Pl = [A' CONDFR_rip_IntAll(sid)' POSTFR_rip_IntAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:3,...
    'XTickLabel',{'Pre','Cond','Post'})
title('Int during ripples')
clear A sid Pl
subplot(155)
[A,sid] = sort(PREFR_norip_IntAll);
Pl = [A' CONDFR_rip_IntAll(sid)' POSTFR_norip_IntAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:3,...
    'XTickLabel',{'Pre','Cond','Post'})
title('Int outside ripples')
clear A sid Pl

saveas(fh, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/3_FRRipples_All.fig');
saveFigure(fh, '3_FRRipples_All', '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/');
close(fh)

%% Plot discharge probability ripples Pre/Post
fh = figure('units', 'normalized', 'outerposition', [0.1 0.2 0.4 0.9]);

subplot(121)
[A,sid] = sort(PartProbPre_rip_PyrAll);
Pl = [A' PartProbPost_rip_PyrAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:2,...
    'XTickLabel',{'Pre','Post'})
title('Pyr ripples probability')
clear A sid Pl
subplot(122)
[A,sid] = sort(PartProbPre_rip_IntAll);
Pl = [A' POSTFR_norip_IntAll(sid)'];
imagesc(Pl)
set(gca,'LineWidth',3,'FontWeight','bold','FontSize',16,'XTick',1:2,...
    'XTickLabel',{'Pre','Post'})
title('Int ripples probability')
clear A sid Pl

saveas(fh, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/3_ProbRipples_All.fig');
saveFigure(fh, '3_ProbRipples_All', '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Spikes/BasicCharacteristics_0819/Pyr_Int/');
close(fh)