...
mousenames={'534'};
    ...
    % Load the data
    cd /media/mobsrick/DataMOBs71/Mouse-538/Results/071417_Plain_elec/
    ...
    for man=1:length(Dir.path), 
        ...
        % Power for normalization is taken as a pre-stimulation 30 sec before stimulation on 1Hz
            ...
            for fq=1:nb_fq
                ...
                bbb=squeeze(LFPpower_Before(1,i,man,:,:,fq));% Power before the stimulation on the frequency requested
                ddd=squeeze(LFPpower(1,i,man,:,:,fq));% Power during the stimulation on the frequency requested
