...
%% Parameters
sav=1;
dir_out = '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/PAGTest/Pre_Cond_Post/';
fig_post = 'UMazeBehav';
...
for i = 1:1:ntest
    % PreTests
    a = load([indir Day '/' suf{1} '/' suf{1} num2str(i) '/behavResources.mat'],...
    ...
    % Cond
    b = load([indir Day '/' suf{2} '/' suf{2} num2str(i) '/behavResources.mat'],...
    'Occup', 'PosMat','Xtsd', 'Ytsd', 'Vtsd', 'mask', 'Zone', 'ZoneIndices', 'Ratio_IMAonREAL');
    Cond_Xtsd{i} = b.Xtsd;
    Cond_Ytsd{i} = b.Ytsd;
    Cond_Vtsd{i} = b.Vtsd;
    ...
    % PostTests
    c = load([indir Day '/' suf{3} '/' suf{3} num2str(i) '/behavResources.mat'],...
    'Occup', 'PosMat','Xtsd', 'Ytsd', 'Vtsd', 'mask', 'Zone', 'ZoneIndices', 'Ratio_IMAonREAL');
    Post_Xtsd{i} = c.Xtsd;
    Post_Ytsd{i} = c.Ytsd;
    Post_Vtsd{i} = c.Vtsd;
