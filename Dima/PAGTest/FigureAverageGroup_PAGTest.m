...
fig_post = 'GroupsComparison_112019'; % Name of the output file
...
fh = figure('units', 'normalized', 'outerposition', [0 0 1 0.65]);
% First experiment
annotation(fh,'textbox',[0.07 0.9 0.2 0.05],'String','First experiment','LineWidth',1,'HorizontalAlignment','center',...
    'FontSize', 16,'FontWeight','bold','FitBoxToText','off');
OccupancyBC_Axes = axes('position', [0.03 0.48 0.13 0.35]);
NumEntrBC_Axes = axes('position', [0.19 0.48 0.13 0.35]);
First_AxesBC = axes('position', [0.03 0.05 0.13 0.35]);
Speed_AxesBC = axes('position', [0.19 0.05 0.13 0.35]);
% Second experiment
annotation(fh,'textbox',[0.395 0.89 0.2 0.08],'String','Second experiment',...
    'LineWidth',1,'HorizontalAlignment','center',...
    'FontSize', 16,'FontWeight','bold','FitBoxToText','off');
OccupancyAP_Axes = axes('position', [0.365 0.48 0.13 0.35]);
NumEntrAP_Axes = axes('position', [0.525 0.48 0.13 0.35]);
...
% Occup
Pre_Occup_meanFirstMean = mean(Pre_Occup_mean(First,1));
Pre_Occup_meanFirstStd = std(Pre_Occup_mean(First,1));
Pre_Occup_meanSecondMean = mean(Pre_Occup_mean(Second,1));
Pre_Occup_meanSecondStd = std(Pre_Occup_mean(Second,1));
Post_Occup_meanFirstMean = mean(Post_Occup_mean(First,1));
Post_Occup_meanFirstStd = std(Post_Occup_mean(First,1));
Post_Occup_meanSecondMean = mean(Post_Occup_mean(Second,1));
Post_Occup_meanSecondStd = std(Post_Occup_mean(Second,1));

% First time
Pre_FirstTime_meanFirstMean = mean(Pre_Post_FirstTime_mean(First,1));
Pre_FirstTime_meanFirstStd = std(Pre_Post_FirstTime_mean(First,1));
Pre_FirstTime_meanSecondMean = mean(Pre_Post_FirstTime_mean(Second,1));
Pre_FirstTime_meanSecondStd = std(Pre_Post_FirstTime_mean(Second,1));
Post_FirstTime_meanFirstMean = mean(Pre_Post_FirstTime_mean(First,2));
Post_FirstTime_meanFirstStd = std(Pre_Post_FirstTime_mean(First,2));
Post_FirstTime_meanSecondMean = mean(Pre_Post_FirstTime_mean(Second,2));
Post_FirstTime_meanSecondStd = std(Pre_Post_FirstTime_mean(Second,2));

% Ent num
Pre_EntNum_meanFirstMean = mean(Pre_Post_entnum_mean(First,1));
Pre_EntNum_meanFirstStd = std(Pre_Post_entnum_mean(First,1));
Pre_EntNum_meanSecondMean = mean(Pre_Post_entnum_mean(Second,1));
Pre_EntNum_meanSecondStd = std(Pre_Post_entnum_mean(Second,1));
Post_EntNum_meanFirstMean = mean(Pre_Post_entnum_mean(First,2));
Post_EntNum_meanFirstStd = std(Pre_Post_entnum_mean(First,2));
Post_EntNum_meanSecondMean = mean(Pre_Post_entnum_mean(Second,2));
Post_EntNum_meanSecondStd = std(Pre_Post_entnum_mean(Second,2));

% Speed
Pre_V_meanFirstMean = mean(Pre_Post_VZmean_mean(First,1));
Pre_V_meanFirstStd = std(Pre_Post_VZmean_mean(First,1));
Pre_V_meanSecondMean = mean(Pre_Post_VZmean_mean(Second,1));
Pre_V_meanSecondStd = std(Pre_Post_VZmean_mean(Second,1));
Post_V_meanFirstMean = mean(Pre_Post_VZmean_mean(First,2));
Post_V_meanFirstStd = std(Pre_Post_VZmean_mean(First,2));
Post_V_meanSecondMean = mean(Pre_Post_VZmean_mean(Second,2));
Post_V_meanSecondStd = std(Pre_Post_VZmean_mean(Second,2));
...
%% Plot a figure with first vs second condiotining comparison

% ContextB&C
axes(OccupancyBC_Axes);
b = bar([Pre_Occup_meanFirstMean Post_Occup_meanFirstMean], 0.6, 'FaceColor', [0 0 0], 'LineWidth', 2);
b.FaceColor = 'flat';
b.CData(2,:) = [1 1 1];
hold on
errorbar([1:2],[Pre_Occup_meanFirstMean Post_Occup_meanFirstMean],[0 0],...
    [Pre_Occup_meanFirstStd Post_Occup_meanFirstStd], '.k', 'LineWidth',2);
...
axes(NumEntrBC_Axes);
b = bar([Pre_EntNum_meanFirstMean Post_EntNum_meanFirstMean], 0.6, 'FaceColor', [0 0 0], 'LineWidth', 2);
b.FaceColor = 'flat';
b.CData(2,:) = [1 1 1];
hold on
errorbar([1:2],[Pre_EntNum_meanFirstMean Post_EntNum_meanFirstMean],[0 0],...
    [Pre_EntNum_meanFirstStd Post_EntNum_meanFirstStd], '.k', 'LineWidth',2);
set(gca,'Xtick',[1:2],'XtickLabel',{'PreTest', 'PostTest'});
set(gca,'FontWeight',  'bold');
ylim([0 10]);
ylabel('#');
...
axes(First_AxesBC);
b = bar([Pre_FirstTime_meanFirstMean Post_FirstTime_meanFirstMean], 0.6, 'FaceColor', [0 0 0], 'LineWidth', 2);
b.FaceColor = 'flat';
b.CData(2,:) = [1 1 1];
hold on
errorbar([1:2],[Pre_FirstTime_meanFirstMean Post_FirstTime_meanFirstMean], [0 0],...
    [Pre_FirstTime_meanFirstStd Post_FirstTime_meanFirstStd], '.k', 'LineWidth',2);
set(gca,'Xtick',[1:2],'XtickLabel',{'PreTest', 'PostTest'});
set(gca, 'FontWeight',  'bold');
ylim([0 300]);
ylabel('Time (s)');
...
axes(Speed_AxesBC);
b = bar([Pre_V_meanFirstMean Post_V_meanFirstMean], 0.6, 'FaceColor', [0 0 0], 'LineWidth', 2);
b.FaceColor = 'flat';
b.CData(2,:) = [1 1 1];
hold on
errorbar([1:2],[Pre_V_meanFirstMean Post_V_meanFirstMean],[0 0],...
    [Pre_V_meanFirstStd Post_V_meanFirstStd], '.k', 'LineWidth',2);
set(gca,'Xtick',[1:2],'XtickLabel',{'PreTest', 'PostTest'});
set(gca, 'FontWeight',  'bold');
ylim([0 6]);
ylabel('Speed (cm/s)');
...
% Anterior&Posterior
axes(OccupancyAP_Axes);
b = bar([Pre_Occup_meanSecondMean Post_Occup_meanSecondMean], 0.6, 'FaceColor', [0 0 0], 'LineWidth', 2);
b.FaceColor = 'flat';
b.CData(2,:) = [1 1 1];
hold on
errorbar([1:2],[Pre_Occup_meanSecondMean Post_Occup_meanSecondMean],[0 0],...
    [Pre_Occup_meanSecondStd Post_Occup_meanSecondStd], '.k', 'LineWidth',2);
set(gca,'Xtick',[1:2],'XtickLabel',{'PreTest', 'PostTest'});
set(gca,'FontWeight',  'bold');
ylim([0 50]);
ylabel('%  Occupancy');
...
axes(NumEntrAP_Axes);
b = bar([Pre_EntNum_meanSecondMean Post_EntNum_meanSecondMean], 0.6, 'FaceColor', [0 0 0], 'LineWidth', 2);
b.FaceColor = 'flat';
b.CData(2,:) = [1 1 1];
hold on
errorbar([1:2],[Pre_EntNum_meanSecondMean Post_EntNum_meanSecondMean],[0 0],...
    [Pre_EntNum_meanSecondStd Post_EntNum_meanSecondStd], '.k', 'LineWidth',2);
set(gca,'Xtick',[1:2],'XtickLabel',{'PreTest', 'PostTest'});
set(gca,'FontWeight',  'bold');
ylim([0 10]);
ylabel('#');
...
axes(First_AxesAP);
b = bar([Pre_FirstTime_meanSecondMean Post_FirstTime_meanSecondMean], 0.6, 'FaceColor', [0 0 0], 'LineWidth', 2);
b.FaceColor = 'flat';
b.CData(2,:) = [1 1 1];
hold on
errorbar([1:2],[Pre_FirstTime_meanSecondMean Post_FirstTime_meanSecondMean],...
    [0 0],[Pre_FirstTime_meanSecondStd Post_FirstTime_meanSecondStd], '.k', 'LineWidth',2);
set(gca,'Xtick',[1:2],'XtickLabel',{'PreTest', 'PostTest'});
set(gca, 'FontWeight',  'bold');
ylim([0 300]);
ylabel('Time (s)');
...
axes(Speed_AxesAP);
b = bar([Pre_V_meanSecondMean Post_V_meanSecondMean], 0.6, 'FaceColor', [0 0 0], 'LineWidth', 2);
b.FaceColor = 'flat';
b.CData(2,:) = [1 1 1];
hold on
errorbar([1:2],[Pre_V_meanSecondMean Post_V_meanSecondMean],[0 0],...
    [Pre_V_meanSecondStd Post_V_meanSecondStd], '.k', 'LineWidth',2);
set(gca,'Xtick',[1:2],'XtickLabel',{'PreTest', 'PostTest'});
set(gca, 'FontWeight',  'bold');
ylim([0 6]);
ylabel('Speed (cm/s)');
