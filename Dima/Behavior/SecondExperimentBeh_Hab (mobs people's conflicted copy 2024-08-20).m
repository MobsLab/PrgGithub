...
for i=1:length(h1)
    ...
    hist(movmedian(Data(h1{i}.EKG.HBRate),5),20);
    set(gca, 'FontSize', 16, 'FontWeight',  'bold');
    xlim([11 14])
    if i==3
        ylim([0 2500])
    ...
    hist(movmedian(Data(h2{i}.EKG.HBRate),5),20);
    set(gca, 'FontSize', 16, 'FontWeight',  'bold');
    xlim([11 14])
    if i==3
        ylim([0 2500])
...
saveas(fh,['/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/PAGTest/FirstSecond/HR_DB.fig']);
    saveFigure(fh,'HR_DB',...
        '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/PAGTest/FirstSecond/');