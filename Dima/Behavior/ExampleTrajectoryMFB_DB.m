function ExampleTrajectoryMFB_DB(Dir, IsPCDriven, varargin)
%
...
%% Get data
a = load([Dir '/behavResources.mat'], 'behavResources', 'StimEpoch', 'SessionEpoch');
...
axes(PreTest_Axes)
[p_occ,h_occ, her_occ] = PlotErrorBarN_DB([Pre_Occup_Shock_mean*100 Pre_Occup_Safe_mean*100], 'barcolors', [0 0.8 0], 'barwidth', 0.6, 'newfig', 0, 'showpoints',0);
...
set(gca, 'LineWidth', 5,'Xtick',[1:2],'XTickLabel',{'Reward','Safe'});
...
axes(Cond_Axes)
[p_occ,h_occ, her_occ] = PlotErrorBarN_DB([Cond_Occup_Shock_mean*100 Cond_Occup_Safe_mean*100], 'barcolors', [0 0.8 0], 'barwidth', 0.6, 'newfig', 0, 'showpoints',0);
h_occ.FaceColor = 'flat';
h_occ.FaceAlpha = .45;
h_occ.CData(2,:) = [1 1 1];
set(gca, 'FontSize', 18, 'FontWeight',  'bold','FontName','Times New Roman');
...
axes(PostTest_Axes)
[p_occ,h_occ, her_occ] = PlotErrorBarN_DB([Post_Occup_Shock_mean*100 Post_Occup_Safe_mean*100], 'barcolors', [0 0.8 0], 'barwidth', 0.6, 'newfig', 0, 'showpoints',0);
h_occ.FaceColor = 'flat';
h_occ.FaceAlpha = .45;
h_occ.CData(2,:) = [1 1 1];
set(gca, 'FontSize', 18, 'FontWeight',  'bold','FontName','Times New Roman');
