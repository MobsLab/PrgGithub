...
try
    ...
    try
        ...
        evt={};
        evt{1,1}=['beginning of ERC-Mouse-' MouseNb '-' Date ];
        evt{1,2}=['end of ERC-Mouse-' MouseNb '-' Date ];
        load(['ERC-Mouse-' MouseNb '-' Date '.mat'],'PosMat')
