...
%     movefile([flnme '_' num2str(ExpeInfo.nmouse) '.dat'], [flnme '.dat']);
RefSubtraction_multi([flnme '.dat'], length(ExpeInfo.RecordElecs.channel), 1, num2str(ExpeInfo.nmouse), [1 2], 3, [0 3:8]);
    movefile([flnme '_' num2str(ExpeInfo.nmouse) '.dat'], [flnme '.dat']);
elseif ExpeInfo.nmouse == 785
    RefSubtraction_multi([flnme '.dat'], length(ExpeInfo.RecordElecs.channel), 1, num2str(ExpeInfo.nmouse), [0 1], 2, [2:7]);
    movefile([flnme '_' num2str(ExpeInfo.nmouse) '.dat'], [flnme '.dat']);
...
%     RefSubtraction_multi([flnme '.dat'], length(ExpeInfo.RecordElecs.channel), 1, num2str(ExpeInfo.nmouse), [0 1], 3, [2:7]);
%     movefile([flnme '_' num2str(ExpeInfo.nmouse) '.dat'], [flnme '.dat']);
elseif ExpeInfo.nmouse == 751
    RefSubtraction_multi_AverageChans([flnme '.dat'], length(ExpeInfo.RecordElecs.channel), 1, num2str(ExpeInfo.nmouse), [0:2], [0:2], [3:35]);
    movefile([flnme '_original_SpikeRef.dat'], [flnme '_SpikeRef' '.dat']);
elseif ExpeInfo.nmouse == 797
    try
        RefSubtraction_multi([flnme '.dat'], length(ExpeInfo.RecordElecs.channel), 1, num2str(ExpeInfo.nmouse), [0:7 10:31], 8, [8:9 32:35]);
        movefile([flnme '_' num2str(ExpeInfo.nmouse) '.dat'], [flnme '.dat']);
    catch
        RefSubtraction_multi([flnme num2str(i) '.dat'], length(ExpeInfo.RecordElecs.channel), 1, num2str(ExpeInfo.nmouse), [0:7 10:31], 8, [8:9 32:35]);
        movefile([flnme num2str(i) '_' num2str(ExpeInfo.nmouse) '.dat'], [flnme num2str(i) '.dat']);
    end
%     RefSubtraction_multi_AverageChans([flnme '.dat'], length(ExpeInfo.RecordElecs.channel)...
%         , 1, 'SpikeRef', [0:3 12:15 20:23 28:31], [0:3 12:15 20:23 28:31], [4:11 16:19 24:27 32:35]); % all channels - good ripples
%     movefile([flnme '_SpikeRef.dat'], [flnme '_SpikeRef' '.dat']);
elseif ExpeInfo.nmouse == 798
    RefSubtraction_multi([flnme '.dat'], length(ExpeInfo.RecordElecs.channel), 1, num2str(ExpeInfo.nmouse), [0:23 26:31], 25, [24:25 32:35]);
    movefile([flnme '_' num2str(ExpeInfo.nmouse) '.dat'], [flnme '.dat']);
end