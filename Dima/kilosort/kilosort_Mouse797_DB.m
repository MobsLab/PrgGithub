...
data_filename = 'M797_20181111_UMaze.dat'; % Filename of .dat with the data
folder_data = '/media/mobsrick/DataMOBS87/Mouse-797/11112018/_Concatenated/'; % Location of .dat folder

cd(folder_data);
folder_output = 'Spikes_Kilosort'; % Name of the output folder (will be creaed inside folder_data)
mkdir(folder_output);

[nb_groups, name_map] = channelmap_Mouse797(folder_data); % which channel map?
