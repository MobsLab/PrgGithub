...
function [nb_groups, name_map] = channelmap_Mouse828(folder,toSave)

Nchannels = 36; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_M828.mat'; % Name of the output channelmap file


groups{1} = [0 1 2 3]; % Channels in a group of electrodes (i.e. tetrodes, octrodes, etc.)
groups{2} = [20 21 22 23];
groups{3} = [24 25 26 27];
groups{4} = [28 29 30 31];
