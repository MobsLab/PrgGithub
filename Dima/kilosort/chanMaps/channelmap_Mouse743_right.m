...
function [nb_groups, name_map] = channelmap_Mouse743_right(folder,toSave)

Nchannels = 71; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_DB_right.mat'; % Name of the output channelmap file

groups{1} = [1 2 3]; % Channels in a group of electrodes (i.e. tetrodes, octrodes, etc.)
groups{2} = [4 5 6 7];
groups{3} = [8 9 10 11];
