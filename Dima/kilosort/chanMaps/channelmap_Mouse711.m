...
function [nb_groups, name_map] = channelmap_Mouse711(folder,toSave)

Nchannels = 36; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_M711.mat'; % Name of the output channelmap file

groups{3} = [16 17 18 19]; % Channels in a group of electrodes (i.e. tetrodes, octrodes, etc.)
