...
function [nb_groups, name_map] = channelmap_Mouse1199(folder,toSave)

Nchannels = 68; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_M1199.mat'; % Name of the output channelmap file


groups{1} = [44 43 42 56 55 47]; % Channels in a group of electrodes (i.e. tetrodes, octrodes, etc.)
groups{2} = [34 60 61 50];
groups{3} = [0 13 14 29 28 2];
groups{4} = [11 23 22 25];
