...
groups{1} = [59 45 46 47 55 56 42 43 44 52 ]; % Channels in a group of electrodes (i.e. tetrodes, octrodes, etc.)
groups{2} = [51 62 63 33 30 32];
groups{3} = [123 109 110 111 119 120 106];
groups{4} = [114 125 124 98 99];
groups{5} = [67 66 92 93 78 77 77 64 65 95];
groups{6} = [84 85 82 74 71 89 86 87];
% groups{7} = [28 29 30 31];
% groups{8} = [28 29 30 31];
