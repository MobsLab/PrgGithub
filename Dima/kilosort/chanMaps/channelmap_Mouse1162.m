...
function [nb_groups, name_map] = channelmap_Mouse1162(folder,toSave)

Nchannels = 64; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_M1162.mat'; % Name of the output channelmap file


groups{1} = [62 63 33 30 32]; % Channels in a group of electrodes (i.e. tetrodes, octrodes, etc.)
groups{2} = [12 3 2 28 29];
groups{3} = [9 6 20 21];
% groups{4} = [7 25 23 11];
