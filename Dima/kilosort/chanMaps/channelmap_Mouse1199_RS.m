...
function [nb_groups, name_map] = channelmap_Mouse1199_RS(folder,toSave)

Nchannels = 67; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_M1199_RS.mat'; % Name of the output channelmap file


groups{1} = [56 55 47 46 45]; % Channels in a group of electrodes (i.e. tetrodes, octrodes, etc.)
groups{2} = [60 61 50 38 37];
groups{3} = [14 29 28 2 3 12];
groups{4} = [11 23 22 25 7 10];
