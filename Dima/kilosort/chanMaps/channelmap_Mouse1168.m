...
function [nb_groups, name_map] = channelmap_Mouse1168(folder,toSave)

Nchannels = 64; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_M1168.mat'; % Name of the output channelmap file


groups{1} = [55 56 42 43 44 52]; % Channels in a group of electrodes (i.e. tetrodes, octrodes, etc.)
groups{2} = [60 34 35 48 51];
groups{3} = [0 1 31 49 15];
groups{4} = [7 25 23 11];
