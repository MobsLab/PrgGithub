...
function [nb_groups, name_map] = channelmap_Mouse994(folder,toSave)

Nchannels = 135; % Number of channels in the recording
fs = 20000; % sampling frequency
name_map = 'chanMap_M994.mat'; % Name of the output channelmap file
...
% groups{1} = [37 50 61 60 34 35 48 51 62 63];
% groups{2} = [1 31 15 49];
% groups{3} = [90 91 88 76 67];
% groups{4} = [83 80 81 73 70 84 85];
% groups{5} = [18 10 7 25 22 23 11];
% groups{6} = [123 109 110 111 119 120 106];
% groups{7} = [101 102 114 125 124 98 99 112];

% 24/01/2020
groups{1} = [59 45 46 47 55 56 42 43 44];
groups{2} = [35 48 51 62 63 33 30 32];
groups{3} = [1 31 15 49];
groups{4} = [20 21 18 10];
groups{5} = [25 22 23 11];
groups{6} = [123 109 110 111 119 120 106 107];
groups{7} = [101 102 114 125 124 98 99 112];
groups{8} = [76 67 66 92 93 78 77 64 65 95];
groups{9} = [70 84 85 82 74 71 89 86 87];
