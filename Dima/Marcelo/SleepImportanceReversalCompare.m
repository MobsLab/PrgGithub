...
for m=1:4
    ...
    TrajPreSleep{1} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreSleep{1} = cat(1,TrajPreSleep{1},AllignedCleanPosMatInit(:,[2,3]));
    end        
...
for m=1:4
    ...
    TrajPosSleep{1} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPosSleep{1} = cat(1,TrajPosSleep{1},AllignedCleanPosMatInit(:,[2,3]));
    end
end

load(['/media/vador/DataMOBS104/Marcelo/M863/20190223/Reversal/ERC-Mouse-863-23052019-Hab_00/cleanBehavResources'])

HabRev{1} =AllignedCleanPosMatInit(:,[2,3]);
...
for m=1:4
    ...
    TrajPreRev{1} = AllignedCleanPosMatInit(:,[2,3]); 
    else
    
    TrajPreRev{1} = cat(1,TrajPreRev{1},AllignedCleanPosMatInit(:,[2,3]));
    end
end
...
for m=1:4
    ...
    TrajPreSleep{2} = AllignedCleanPosMatInit(:,[2,3]); 
    else
    
    TrajPreSleep{2} = cat(1,TrajPreSleep{2},AllignedCleanPosMatInit(:,[2,3]));
    end
end
...
for m=1:4
    ...
    TrajPosSleep{2} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPosSleep{2} = cat(1,TrajPosSleep{2},AllignedCleanPosMatInit(:,[2,3]));    
    end
end

load(['/media/vador/DataMOBS104/Marcelo/M913/20190529/Reversal/ERC-Mouse-913-29052019-Hab_00/cleanBehavResources'])

HabRev{2} = AllignedCleanPosMatInit(:,[2,3]);
...
for m=1:4
    ...
    TrajPreRev{2} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreRev{2} = cat(1,TrajPreRev{2},AllignedCleanPosMatInit(:,[2,3]));
    end
end
...
for m=1:4
    ...
    TrajPreSleep{3} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreSleep{3} = cat(1,TrajPreSleep{3},AllignedCleanPosMatInit(:,[2,3]));
   end
end
...
for m=1:4
    ...
    TrajPosSleep{3} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPosSleep{3} = cat(1,TrajPosSleep{3},AllignedCleanPosMatInit(:,[2,3]));
    end
end

load(['/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Hab_00/cleanBehavResources'])

HabRev{3} =AllignedCleanPosMatInit(:,[2,3]);
...
for m=1:4
    ...
    TrajPreRev{3} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreRev{3} = cat(1,TrajPreRev{3},AllignedCleanPosMatInit(:,[2,3]));
    end
end
...
for m=1:4
    ...
    TrajPreSleep{4} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreSleep{4} = cat(1,TrajPreSleep{4},AllignedCleanPosMatInit(:,[2,3]));
    end
end
...
for m=1:4
    ...
    TrajPosSleep{4} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPosSleep{4} = cat(1,TrajPosSleep{4},AllignedCleanPosMatInit(:,[2,3]));
    end
end

load(['/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Hab_00/cleanBehavResources'])

HabRev{4} =AllignedCleanPosMatInit(:,[2,3]);
...
for m=1:4
    ...
    TrajPreRev{4} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreRev{4} = cat(1,TrajPreRev{4},AllignedCleanPosMatInit(:,[2,3]));
    end
end
...
for m=1:4
    ...
    TrajPreSleep{5} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreSleep{5} = cat(1,TrajPreSleep{5},AllignedCleanPosMatInit(:,[2,3]));
    end
end
...
for m=1:4
    ...
    TrajPosSleep{5} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPosSleep{5} = cat(1,TrajPosSleep{5},AllignedCleanPosMatInit(:,[2,3]));
    end
end

load(['/media/vador/DataMOBS104/Marcelo/M938/ReversalControl/ERC-Mouse-938-18062019-Hab_00/cleanBehavResources'])

HabRev{5} = AllignedCleanPosMatInit(:,[2,3]);
...
for m=1:4
    ...
    TrajPreRev{5} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreRev{5} = cat(1,TrajPreRev{5},AllignedCleanPosMatInit(:,[2,3]));
    end
end

%M932
for m=1:4
    load(['/media/vador/DataMOBS104/Marcelo/M932/SleepImportance/ERC-Mouse-932-04072019-TestPre_0',num2str(m-1),'/cleanBehavResources'])
    if m==1
    
    TrajPreSleep{6} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreSleep{6} = cat(1,TrajPreSleep{6},AllignedCleanPosMatInit(:,[2,3]));
    end
end

for m=1:4
    load(['/media/vador/DataMOBS104/Marcelo/M932/SleepImportance/ERC-Mouse-932-04072019-TestPost_0',num2str(m),'/cleanBehavResources'])
    if m==1
    
    TrajPosSleep{6} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPosSleep{6} = cat(1,TrajPosSleep{6},AllignedCleanPosMatInit(:,[2,3]));
    end
end

load(['/media/vador/DataMOBS104/Marcelo/M932/ReversalControl/ERC-Mouse-932-11072019-Hab_00/cleanBehavResources'])

HabRev{6} = AllignedCleanPosMatInit(:,[2,3]);

for m=1:4
    load(['/media/vador/DataMOBS104/Marcelo/M932/ReversalControl/ERC-Mouse-932-11072019-TestPre_0',num2str(m-1),'/cleanBehavResources'])
    if m==1

    TrajPreRev{6} = AllignedCleanPosMatInit(:,[2,3]);
    else
    
    TrajPreRev{6} = cat(1,TrajPreRev{6},AllignedCleanPosMatInit(:,[2,3]));
    end
end
...
figure
subplot(1,3,1)
[occH, x1, x2] = hist2(TrajPreSleepCat(:,1), TrajPreSleepCat(:,2), 240, 320);
        occHS(1:320,1:240) = SmoothDec(occH/15,[3,3]);
        x=[0 1];
        y=[0 1];
        imagesc(x,y,occHS)
...
subplot(1,3,2)
[occH, x1, x2] = hist2(TrajPosSleepCat(:,1), TrajPosSleepCat(:,2), 240, 320);
        occHS(1:320,1:240) = SmoothDec(occH/15,[3,3]);
        x=[0 1];
        y=[0 1];
        imagesc(x,y,occHS)
...
subplot(1,3,3)
[occH, x1, x2] = hist2(HabRevCat(:,1), HabRevCat(:,2), 240, 320);
        occHS(1:320,1:240) = SmoothDec(occH/15,[3,3]);
        x=[0 1];
        y=[0 1];
        imagesc(x,y,occHS)
