%% Get Data
clear all
MouseNumber = 863; %Enter the mouse number: 863, 913, 934 or 935
...
if MouseNumber == 934
    % Pre-tests
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPre_00/behavResources.mat')
OccupPre(:,1) = Occup;
TrajPre{1} = PosMat(:,[2,3]);
SpeedPre{1} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPre_01/behavResources.mat')
OccupPre(:,2) = Occup;
TrajPre{2} = PosMat(:,[2,3]);
SpeedPre{2} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPre_02/behavResources.mat')
OccupPre(:,3) = Occup;
TrajPre{3} = PosMat(:,[2,3]);
SpeedPre{3} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPre_03/behavResources.mat')
OccupPre(:,4) = Occup;
TrajPre{4} = PosMat(:,[2,3]);
SpeedPre{4} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
% Post-PAG
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPost_00/behavResources.mat')
OccupPosPAG(:,1)=Occup;
TrajPosPAG{1}=PosMat(:,[2,3]);
SpeedPosPAG{1} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPost_01/behavResources.mat')
OccupPosPAG(:,2)=Occup;
TrajPosPAG{2}=PosMat(:,[2,3]);
SpeedPosPAG{2} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPost_02/behavResources.mat')
OccupPosPAG(:,3)=Occup;
TrajPosPAG{3}=PosMat(:,[2,3]);
SpeedPosPAG{3} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPost_03/behavResources.mat')
OccupPosPAG(:,4)=Occup;
TrajPosPAG{4}=PosMat(:,[2,3]);
SpeedPosPAG{4} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
% Post MFB
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPost_04/behavResources.mat')
OccupPosMFB(:,1)=Occup;
TrajPosMFB{1}=PosMat(:,[2,3]);
SpeedPosMFB{1} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPost_05/behavResources.mat')
OccupPosMFB(:,2)=Occup;
TrajPosMFB{2}=PosMat(:,[2,3]);
SpeedPosMFB{2} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPost_06/behavResources.mat')
OccupPosMFB(:,3)=Occup;
TrajPosMFB{3}=PosMat(:,[2,3]);
SpeedPosMFB{3} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-TestPost_07/behavResources.mat')
OccupPosMFB(:,4)=Occup;
TrajPosMFB{4}=PosMat(:,[2,3]);
SpeedPosMFB{4} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Cond_00/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
OccupPAG(:,1)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallShock_00/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallSafe_00/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Cond_01/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
OccupPAG(:,4)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallShock_01/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallSafe_01/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Cond_02/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
OccupPAG(:,7)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallShock_02/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallSafe_02/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Cond_03/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
OccupMFB(:,1)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallShock_03/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallSafe_03/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Cond_04/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
OccupMFB(:,4)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallShock_04/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallSafe_04/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Cond_05/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
OccupMFB(:,7)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallShock_05/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-CondWallSafe_05/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
%Explorations
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Hab_00/behavResources.mat')
OccupExploPre=Occup;
TrajExploPre=PosMat(:,[2,3]);
aux=cell2mat(ZoneIndices(1));
if isempty(aux)
...
load('/media/vador/DataMOBS104/Marcelo/M934/20190612/Reversal/ERC-Mouse-934-12062019-Hab_03/behavResources.mat')
OccupExploPos=Occup;
TrajExploPos=PosMat(:,[2,3]);
aux=cell2mat(ZoneIndices(1));
if isempty(aux)
...
if MouseNumber == 935
    % Pre-tests
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPre_00/behavResources.mat')
OccupPre(:,1) = Occup;
TrajPre{1} = PosMat(:,[2,3]);
SpeedPre{1} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPre_01/behavResources.mat')
OccupPre(:,2) = Occup;
TrajPre{2} = PosMat(:,[2,3]);
SpeedPre{2} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPre_02/behavResources.mat')
OccupPre(:,3) = Occup;
TrajPre{3} = PosMat(:,[2,3]);
SpeedPre{3} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPre_03/behavResources.mat')
OccupPre(:,4) = Occup;
TrajPre{4} = PosMat(:,[2,3]);
SpeedPre{4} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
% Post-PAG
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPost_00/behavResources.mat')
OccupPosPAG(:,1)=Occup;
TrajPosPAG{1}=PosMat(:,[2,3]);
SpeedPosPAG{1} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPost_01/behavResources.mat')
OccupPosPAG(:,2)=Occup;
TrajPosPAG{2}=PosMat(:,[2,3]);
SpeedPosPAG{2} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPost_03/behavResources.mat')
OccupPosPAG(:,3)=Occup;
TrajPosPAG{3}=PosMat(:,[2,3]);
SpeedPosPAG{3} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPost_04/behavResources.mat')
OccupPosPAG(:,4)=Occup;
TrajPosPAG{4}=PosMat(:,[2,3]);
SpeedPosPAG{4} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
% Post MFB
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPost_02/behavResources.mat')
OccupPosMFB(:,1)=Occup;
TrajPosMFB{1}=PosMat(:,[2,3]);
SpeedPosMFB{1} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPost_05/behavResources.mat')
OccupPosMFB(:,2)=Occup;
TrajPosMFB{2}=PosMat(:,[2,3]);
SpeedPosMFB{2} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPost_06/behavResources.mat')
OccupPosMFB(:,3)=Occup;
TrajPosMFB{3}=PosMat(:,[2,3]);
SpeedPosMFB{3} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-TestPost_07/behavResources.mat')
OccupPosMFB(:,4)=Occup;
TrajPosMFB{4}=PosMat(:,[2,3]);
SpeedPosMFB{4} = [Data(Vtsd); 0];
aux=cell2mat(ZoneIndices(1));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Cond_00/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
OccupPAG(:,1)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallShock_00/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallSafe_00/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Cond_01/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
OccupPAG(:,4)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallShock_01/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallSafe_01/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Cond_02/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
OccupPAG(:,7)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallShock_02/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallSafe_02/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondPAG = NumCondPAG +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Cond_03/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
OccupMFB(:,1)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallShock_03/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallSafe_03/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Cond_04/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
OccupMFB(:,4)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallShock_04/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallSafe_04/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Cond_05/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
OccupMFB(:,7)=Occup;
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallShock_05/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-CondWallSafe_05/behavResources.mat')
Events=PosMat(:,4);
Events(isnan(Events)) = 0;
NumCondMFB = NumCondMFB +length(find(Events));
...
%Explorations
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Hab_00/behavResources.mat')
OccupExploPre=Occup;
TrajExploPre=PosMat(:,[2,3]);
aux=cell2mat(ZoneIndices(1));
if isempty(aux)
...
load('/media/vador/DataMOBS104/Marcelo/M935/20160613/ReversalControl/ERC-Mouse-935-13062019-Hab_03/behavResources.mat')
OccupExploPos=Occup;
TrajExploPos=PosMat(:,[2,3]);
aux=cell2mat(ZoneIndices(1));
if isempty(aux)
