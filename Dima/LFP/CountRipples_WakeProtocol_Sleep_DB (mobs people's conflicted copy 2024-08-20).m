...
subplot(121)
[p_sleep,h_sleep, her_sleep] = PlotErrorBarN_DB([PreREMperc' PostREMperc'], 'barcolors', [0 0 0], 'barwidth', 0.8, 'newfig', 0, 'showpoints',0);
ylim([0 10]);
...
subplot(122)
[p_rip,h_rip, her_rip] = PlotErrorBarN_DB([Pre_N_norm_all' Post_N_norm_all'], 'barcolors', [0 0 0], 'barwidth', 0.8, 'newfig', 0, 'showpoints',0);
% ylim([0 0.4]);
ylim([0 0.7]);
set(gca,'Xtick',[1:2],'XtickLabel',{});
set(gca, 'FontSize', 18, 'FontWeight',  'bold');
