...
nmice = [797 798 828 861 882 905 906 911 912 977 994 1117 1124 1161 1162 1168 1182 1186 1199];
...
f3 = figure('units', 'normalized', 'outerposition', [0 0 0.3 0.6])

[p_cond,h_cond, her_cond] = PlotErrorBarN_DB([Cond_Occup_Shock_mean*100 Cond_Occup_Safe_mean*100], 'barcolors', [0 0 0], 'barwidth', 0.6, 'newfig', 0, 'showpoints',0);
...
subplot(121)
[p_cond,h_cond, her_cond] = PlotErrorBarN_DB([Cond_N_norm_Shock' Cond_N_norm_AllExcSZFreeze'], 'barcolors', [0 0 0], 'barwidth', 0.8, 'newfig', 0, 'showpoints',0);
set(gca,'Xtick',[1:2],'XtickLabel',{'ShockZone', 'The Rest'});
...
subplot(121)
[p_cond,h_cond, her_cond] = PlotErrorBarN_DB([FreezingCondShockPercMean FreezingCondSafePercMean],...
...
%% Two freezings
f6 = figure('units', 'normalized', 'outerposition', [0 0 0.8 0.6])
...
subplot(122)
[p_Con,h, her] = PlotErrorBarN_DB([FreezingCondShockPercMean FreezingCondSafePercMean], 'barcolors', [0 0 0], 'barwidth', 0.8, 'newfig', 0, 'showpoints',0);
ylim([0 30]);
set(gca,'Xtick',[1:2],'XtickLabel',{'ShockZone', 'SafeZone'});
set(gca, 'FontSize', 18, 'FontWeight',  'bold');
set(gca, 'LineWidth', 3);
...
if sav
    saveas(f6, '/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Behavior/CondFreezing.fig');
    saveFigure(f6,'CondFreezing','/home/mobsrick/Dropbox/MOBS_workingON/Dima/Ongoing results/Behavior/');
end
