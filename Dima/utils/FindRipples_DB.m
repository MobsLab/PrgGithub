function [ripples,stdev] = FindRipples_DB (dHPC_rip,nonrip, thresh, varargin)
...
save ('Ripples', 'ripples', 'stdev', 'dHPC_rip', 'nonrip', 'thresh', 'dur', 'freq', 'rmvnoise');
...
saveas(gcf, [res '/Rippleraw.fig']);
saveFigure(gcf,'RippleRaw',res);
close(gcf);
