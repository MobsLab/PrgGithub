%FilteredAverageRipplePlot
%
% fid = PlotRipRaw(LFP, events, durations, cleaning, PlotFigure)
%
%
%%INPUT
% events : in seconds
...
function fid = FilteredAverageRipplePlot(LFP, events, durations, cleaning, PlotFigure)
...
%signals
LFP_filt = FilterLFP(LFP,[120 220],1048);
