...
%    interval           a matrix where the first column is the beginnings
%                       of interval and the second one is the ends of interval (in s)
...
%     'LeaveSelected'  if 1, gets only the intervals, if 0, gets everything
%     except those intervals (1 - default)
%    =========================================================================
...
for i = 1:2:length(varargin),
    ...
    switch(lower(varargin{i})),
        ...
        case 'leaveselected',
            leave = varargin{i+1};
            if ~isdscalar(leave),
                error('Incorrect value for property ''leaveselected'', (type ''help <a href="matlab:help RefSubtraction">RefSubtraction</a>'' for details).');
            end
        otherwise,
...
disp('Done!find the treated file in the current directory');
toc
end
