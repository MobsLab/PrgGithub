...
for i=1:20
    try
eval(['saveFigure(',num2str(i),',''FigureBilanWakeManualNew',num2str(i),''',''/media/DISK_1/Dropbox/Kteam/ProjetSommeil/Figures/BilaManipesSleepMarch2012/figuresposterED3C'')'])
    end
end
