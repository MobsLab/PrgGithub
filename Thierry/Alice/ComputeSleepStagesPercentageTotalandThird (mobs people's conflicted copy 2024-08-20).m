 function Res=ComputeSleepStagesPercentageTotalandThird(Wake,SWSEpoch,REMEpoch,plo)
...
Res(2,4)=durTSWS3/(durTWake3+durTSWS3+durTREM3)*100;
Res(2,5)=durTSWS1h/(durTWake1h+durTSWS1h+durTREM1h)*100;
Res(2,6)=durTSWS2h/(durTWake2h+durTSWS2h+durTREM2h)*100;
Res(2,7)=durTSWS3h/(durTWake3h+durTSWS3h+durTREM3h)*100;
...
Res(3,4)=durTREM3/(durTWake3+durTSWS3+durTREM3)*100;
Res(3,5)=durTREM1h/(durTWake1h+durTSWS1h+durTREM1h)*100;
Res(3,6)=durTREM2h/(durTWake2h+durTSWS2h+durTREM2h)*100;
Res(3,7)=durTREM3h/(durTWake3h+durTSWS3h+durTREM3h)*100;
