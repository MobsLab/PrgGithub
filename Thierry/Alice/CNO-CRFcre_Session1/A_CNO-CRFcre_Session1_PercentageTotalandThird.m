...
% Ce script permet de tracer 5 figures pour l'expérience CNO-CRFcre en
% appelant la fonction ComputeSleepStagesPercentageTotalandThird
% L'expérience CNO-CRFcre comprend 4 conditions : Baseline 2, CNO,
% Baseline 3 et Saline
% Et elle a été réalisée pour 2 souris : M929 et M930
...
%   vigilence selon les conditions (1 figure)
...
%   des trois tiers de l'expérience (1 figure)
...
Dir{2}=PathForExperiments_TG('CNO-CRFcre_Session1_CNO');
Dir{3}=PathForExperiments_TG('CNO-CRFcre_Session1_Baseline3');
Dir{4}=PathForExperiments_TG('CNO-CRFcre_Session1_Saline');
DirFigure='/media/nas5/Thierry_DATA/Figures/CNO-CRF-cre/Session1/';  % dossier où seront enregistrées les figures .fig
...
PlotErrorBarN_KJ({[ResWake(3,1),ResWake(4,1)] [ResWake(7,1),ResWake(8,1)]},'newfig',0);
hold on, plot([1.1,2.1],[ResWake(3,1),ResWake(7,1)],'b-o') %M929
hold on, plot([1.1,2.1],[ResWake(4,1),ResWake(8,1)],'r-o') %M930
...
%ylim([0,75]);
xticklabels({'CNO','Saline'})
PlotErrorBarN_KJ({[ResSWS(3,1),ResSWS(4,1)] [ResSWS(7,1),ResSWS(8,1)]},'newfig',0);
hold on, plot([1.1,2.1],[ResSWS(3,1),ResSWS(7,1)],'b-o') %M929
hold on, plot([1.1,2.1],[ResSWS(4,1),ResSWS(8,1)],'r-o') %M930
...
%ylim([0,75]);
xticklabels({'CNO','Saline'})
PlotErrorBarN_KJ({[ResREM(3,1),ResREM(4,1)] [ResREM(7,1),ResREM(8,1)]},'newfig',0);
hold on, plot([1.1,2.1],[ResREM(3,1),ResREM(7,1)],'b-o') %M929
hold on, plot([1.1,2.1],[ResREM(4,1),ResREM(8,1)],'r-o') %M930
...
xticks([1 2 3 4])
xticklabels({'Baseline 2','CNO','Baseline 3','Saline'})
