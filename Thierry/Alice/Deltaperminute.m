function Deltam=Deltaperminute(Deltas)
    ...
    Deltam(1)=indicem(1);                   % Pour chaque minute, on obtient en soustrayant l'indice précédent à l'indice actuel le nombre de delta par mintue : Deltam
    for i=2:nb_min
