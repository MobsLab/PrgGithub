%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% /home/mobschapeau/Dropbox/Kteam/PrgMatlab/Thierry/Alice/box_rat_72h/ParcoursComputeSleepStages_Overtime.m
...
%   conditions pour chacune des deux souris
...
DirFigure='/media/nas5/Thierry_DATA/Figures/Rat_box_72h/Figures/'
...
for i=1:length(Dir{1}.path)
    ...
    hold on, plot(Range(D_REM_200{2,i},'s'),Data(D_REM_200{2,i}),'r')   % Exposure
...
c=2;     % condition : 1=Baseline1   2=Exposure  3=Baseline2
m=2;     % souris : 1=M923   2=M926
