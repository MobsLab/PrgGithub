%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% /home/mobschapeau/Dropbox/Kteam/PrgMatlab/Thierry/Alice/Atropine/E_Atropine_OBspectrum.m

% Ce script permet de tracer 9 figures pour l'expérience Atropine en
...
for i=1:length(Dir) % baseline, atropine ou saline  i = pour chacune des condtions
...
for i=1:length(Dir{1}.path);    % pour chacune des souris 1=1035, 2=1036 et 3=1037
    ...
    plot(f_HB{3}{i},mean(10*(Data(Restrict(Spectrotsd_HB{3}{i},wake{3,i})))),'g','linewidth',2)                 % 3=Saline
    plot(f_HB{2}{i},mean(10*(Data(Restrict(Spectrotsd_HB{2}{i},wake{2,i})))),'r','linewidth',2)                 % 2=Atropine
    ...
    plot(f_HB{3}{i},mean(10*(Data(Restrict(Spectrotsd_HB{3}{i},SWS{3,i})))),'g','linewidth',2)
    ...
    plot(f_HB{3}{i},mean(10*(Data(Restrict(Spectrotsd_HB{3}{i},REM{3,i})))),'g','linewidth',2)
    ...
    plot(f_OB{3}{i},mean(10*(Data(Restrict(Spectrotsd_OB{3}{i},wake{3,i})))),'g','linewidth',2)
    ...
    plot(f_OB{3}{i},mean(10*(Data(Restrict(Spectrotsd_OB{3}{i},SWS{3,i})))),'g','linewidth',2)
    ...
    plot(f_OB{3}{i},mean(10*(Data(Restrict(Spectrotsd_OB{3}{i},REM{3,i})))),'g','linewidth',2)
...
axH{3}=[25,58];     % caxis pour la troisième souris 1037 à déterminer pour optimiser l'affichage
axH{4}=[25,55];     % caxis pour la troisième souris 1037 à déterminer pour optimiser l'affichage
...
for i=1:length(Dir{1}.path)
    data_OB_Wake_Baseline(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{1}{i},wake{1,i}))));
    data_OB_SWS_Baseline(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{1}{i},SWS{1,i}))));
    data_OB_REM_Baseline(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{1}{i},REM{1,i}))));
    data_OB_Wake_Saline(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{3}{i},wake{3,i}))));
    data_OB_SWS_Saline(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{3}{i},SWS{3,i}))));
    data_OB_REM_Saline(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{3}{i},REM{3,i}))));
    data_OB_Wake_Atropine(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{2}{i},wake{2,i}))));
    data_OB_SWS_Atropine(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{2}{i},SWS{2,i}))));
    data_OB_REM_Atropine(i,:)=mean(10*(Data(Restrict(Spectrotsd_OB{2}{i},REM{2,i}))));
end
% Calcul des moyennes
Spectrotsd_OB_Wake_Baseline_moy=mean(data_OB_Wake_Baseline);
Spectrotsd_OB_SWS_Baseline_moy=mean(data_OB_SWS_Baseline);
Spectrotsd_OB_REM_Baseline_moy=mean(data_OB_REM_Baseline);
...
Spectrotsd_OB_Wake_Atropine_moy=mean(data_OB_Wake_Atropine);
Spectrotsd_OB_SWS_Atropine_moy=mean(data_OB_SWS_Atropine);
Spectrotsd_OB_REM_Atropine_moy=mean(data_OB_REM_Atropine);

% Calcul des écarts types
Spectrotsd_OB_Wake_Baseline_std=CalculStdMoyMouse(data_OB_Wake_Baseline);
Spectrotsd_OB_SWS_Baseline_std=CalculStdMoyMouse(data_OB_SWS_Baseline);
Spectrotsd_OB_REM_Baseline_std=CalculStdMoyMouse(data_OB_REM_Baseline);
...
Spectrotsd_OB_Wake_Atropine_std=CalculStdMoyMouse(data_OB_Wake_Atropine);
Spectrotsd_OB_SWS_Atropine_std=CalculStdMoyMouse(data_OB_SWS_Atropine);
Spectrotsd_OB_REM_Atropine_std=CalculStdMoyMouse(data_OB_REM_Atropine);
...
errorbar(f_OB{3}{1},Spectrotsd_OB_Wake_Saline_moy,Spectrotsd_OB_Wake_Saline_std,'.','color',[0.2,0.6,0.2])
plot(f_OB{3}{1},Spectrotsd_OB_Wake_Saline_moy,'color',[0.2,0.6,0.2],'linewidth',2)
errorbar(f_OB{2}{1},Spectrotsd_OB_Wake_Atropine_moy,Spectrotsd_OB_Wake_Atropine_std,'r .')
plot(f_OB{2}{1},Spectrotsd_OB_Wake_Atropine_moy,'r','linewidth',2)
...
errorbar(f_OB{3}{1},Spectrotsd_OB_SWS_Saline_moy,Spectrotsd_OB_SWS_Saline_std,'.','color',[0.2,0.6,0.2])
plot(f_OB{3}{1},Spectrotsd_OB_SWS_Saline_moy,'color',[0.2,0.6,0.2],'linewidth',2)
errorbar(f_OB{2}{1},Spectrotsd_OB_SWS_Atropine_moy,Spectrotsd_OB_SWS_Atropine_std,'r .')
plot(f_OB{2}{1},Spectrotsd_OB_SWS_Atropine_moy,'r','linewidth',2)
legend('Saline ErrorBar','Saline','Atropine ErrorBar','Atropine')
xlabel('Frequency'), ylabel('Low OB')
...
errorbar(f_OB{3}{1},Spectrotsd_OB_REM_Saline_moy,Spectrotsd_OB_REM_Saline_std,'.','color',[0.2,0.6,0.2])
plot(f_OB{3}{1},Spectrotsd_OB_REM_Saline_moy,'color',[0.2,0.6,0.2],'linewidth',2)
errorbar(f_OB{2}{1},Spectrotsd_OB_REM_Atropine_moy,Spectrotsd_OB_REM_Atropine_std,'r .')
plot(f_OB{2}{1},Spectrotsd_OB_REM_Atropine_moy,'r','linewidth',2)
legend('Saline ErrorBar','Saline','Atropine ErrorBar','Atropine')
xlabel('Frequency'), ylabel('Low OB')
...
%% Analyses deltas avant et après atropine
