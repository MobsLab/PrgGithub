...
% 21.11.2017 SB
%
%  [Epoch,TotalNoiseEpoch,SubNoiseEpoch,Info]=FindNoiseEpoch_SleepScoring_Ap_noNoise(channel_hpc, foldername)
%
...
function [Epoch,TotalNoiseEpoch,SubNoiseEpoch,Info]=FindNoiseEpoch_SleepScoring_Ap(channel_hpc, varargin)
...
load(strcat(foldername, '/H_Low_Spectrum_Ap.mat'))
fH = Spectro{3};
tH = Spectro{2};
SpH = Spectro{1};
...
TotalNoiseEpoch = or(WeirdNoiseEpoch,ThresholdedNoiseEpoch);
