...
plot(fh,mean(10*(Data(Restrict(SpHBas1,WakeobBas1)))),'k','linewidth',2), title('Wake Gamma M926'), ylabel('Hpc')
...
plot(fh,mean(10*(Data(Restrict(SpHBas1,SWSobBas1)))),'k','linewidth',2), title('SWS Gamma M926'), ylabel('Hpc')
...
plot(fh,mean(10*(Data(Restrict(SpHBas1,REMobBas1)))),'k','linewidth',2), title('REM Gamma M926'), ylabel('Hpc')
...
plot(fb,mean(10*(Data(Restrict(SpBBas1,WakeobBas1)))),'k','linewidth',2), title('Wake Gamma M926'), ylabel('OB')
...
plot(fb,mean(10*(Data(Restrict(SpBBas1,SWSobBas1)))),'k','linewidth',2), title('SWS Gamma M926'), ylabel('OB')
...
plot(fb,mean(10*(Data(Restrict(SpBBas1,REMobBas1)))),'k','linewidth',2), title('REM Gamma M926'), ylabel('OB')
...
figure
subplot(2,3,1), hold on, 
plot(fh,mean(10*(Data(Restrict(SpHBas1,WakeAccBas1)))),'k','linewidth',2), title('Wake Bulb Acc M926'), ylabel('Hpc')
...
subplot(2,3,2), hold on, 
plot(fh,mean(10*(Data(Restrict(SpHBas1,SWSAccBas1)))),'k','linewidth',2), title('SWS Bulb Acc M926'), ylabel('Hpc')
...
subplot(2,3,3), hold on, 
plot(fh,mean(10*(Data(Restrict(SpHBas1,REMAccBas1)))),'k','linewidth',2), title('REM Bulb Acc M926'), ylabel('Hpc')
...
subplot(2,3,4), hold on, 
plot(fb,mean(10*(Data(Restrict(SpBBas1,WakeAccBas1)))),'k','linewidth',2), title('Wake Bulb Acc M926'), ylabel('OB')
...
subplot(2,3,5), hold on, 
plot(fb,mean(10*(Data(Restrict(SpBBas1,SWSAccBas1)))),'k','linewidth',2), title('SWS Bulb Acc M926'), ylabel('OB')
...
subplot(2,3,6), hold on, 
plot(fb,mean(10*(Data(Restrict(SpBBas1,REMAccBas1)))),'k','linewidth',2), title('REM Bulb Acc M926'), ylabel('OB')
