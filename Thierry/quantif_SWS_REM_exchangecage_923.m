...
cd /media/nas5/Thierry_DATA/Exchange Cages/923_926_927_928_Baseline2_02072019_190702_085527/M923_Baseline2
...
figure, plot(f,mean(Data(Restrict(Spectrotsd_Homecage1,REMEpoch))),'r')
hold on, plot(f,mean(Data(Restrict(Spectrotsd_Homecage1,SWSEpoch))),'b')
hold on, plot(f,mean(Data(Restrict(Spectrotsd_Homecage1,Wake))),'k')
