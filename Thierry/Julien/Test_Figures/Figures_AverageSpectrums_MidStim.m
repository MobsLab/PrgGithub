function Figures_AverageSpectrums_MidStim
clear all
pathname='Figures'
...
savefig(fullfile(pathname2,'VLPO_REM_MidStim'))
...
savefig(fullfile(pathname2,'VLPO_SWS_MidStim'))
...
savefig(fullfile(pathname2,'VLPO_Wake_MidStim'))
...
savefig(fullfile(pathname2,'Bulb_REM_MidStim'))
%%AverageSpectre Stim SWS 
...
savefig(fullfile(pathname2,'Bulb_SWS_MidStim'))
%%AverageSpectre Stim Wake
...
savefig(fullfile(pathname2,'Bulb_Wake_MidStim'))
...
savefig(fullfile(pathname2,'PFC_REM_MidStim'))
%%AverageSpectre Stim SWS 
...
savefig(fullfile(pathname2,'PFC_SWS_MidStim'))
%%AverageSpectre Stim Wake
...
savefig(fullfile(pathname2,'PFC_Wake_MidStim'))
...
title('HPC REM_MidStim')
savefig(fullfile(pathname2,'HPC_REM_MidStim'))
%%AverageSpectre Stim SWS 
...
savefig(fullfile(pathname2,'HPC_SWS_MidStim'))
%%AverageSpectre Stim Wake
...
savefig(fullfile(pathname2,'HPC_Wake_MidStim'))
