function [Ordered_REM] = Ordered_REM_BaselineSimulation()
...
%Simulation of the start time of all the stimulations 
...
Nb_Stim_REM_0_30 = 0;
Nb_Stim_REM_30etplus= 0;
Nb_Stim_REM_20 = 0;
Nb_Stim_REM_30 = 0;

[ Nb, States, Latence, Result] = LatenceTransitionBaselineSimulationJulien();

for k = 1:Nb_Stim_REM
    if Ordered_States(k,8) <= 30
        Nb_Stim_REM_0_30 = Nb_Stim_REM_0_30 +1;
        Ordered_REM_bis(Nb_Stim_REM_0_30,1) = Ordered_States(k,7);
        Ordered_REM_bis(Nb_Stim_REM_0_30,2) = Ordered_States(k,9);
        Ordered_REM_bis(Nb_Stim_REM_0_30,3) = Ordered_States(k,8);
        Ordered_REM_bis(Nb_Stim_REM_0_30,4) = Result(Ordered_States(k,7),4);
    elseif Ordered_States(k,8) <= 120
        Nb_Stim_REM_30etplus = Nb_Stim_REM_30 +1;
        Ordered_REM_bis(Nb_Stim_REM_30etplus,5) = Ordered_States(k,7);
        Ordered_REM_bis(Nb_Stim_REM_30etplus,6) = Ordered_States(k,9);
        Ordered_REM_bis(Nb_Stim_REM_30etplus,7) = Ordered_States(k,8);
        Ordered_REM_bis(Nb_Stim_REM_30etplus,8) = Result(Ordered_States(k,7),4);
    end
end

% Ordered_REM = Ordered_REM(1:max([Nb_Stim_REM_0, Nb_Stim_REM_10, Nb_Stim_REM_20, Nb_Stim_REM_30]),:);
Ordered_REM = NaN(max([Nb_Stim_REM_0_30, Nb_Stim_REM_30etplus, Nb_Stim_REM_20, Nb_Stim_REM_30etplus]),16);
for i = 1:max([Nb_Stim_REM_0_30, Nb_Stim_REM_30etplus, Nb_Stim_REM_20, Nb_Stim_REM_30etplus])
    for k = 1:16
