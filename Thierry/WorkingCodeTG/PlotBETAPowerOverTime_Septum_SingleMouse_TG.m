function [SpectroBrem,SpectroBsws,SpectroBwake,facREM,facSWS,facWake,valBetaREM,valBetaSWS,valBetaWake,freqB,temps] = PlotBETAPowerOverTime_SingleMouse_TG(plo)
...
%[Stim, StimREM, StimSWS, StimWake] = FindOptoStim_MC(WakeWiNoise, SWSEpochWiNoise, REMEpochWiNoise); % to find optogenetic stimulations
