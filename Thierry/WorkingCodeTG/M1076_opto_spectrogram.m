...
caxis([20 48])
set(gca,'FontSize',20)
savefig(fullfile(pathname2,'VLPO_REMwithNoise'))
...
caxis([20 48])
set(gca,'FontSize',20)
savefig(fullfile(pathname2,'VLPO_SWSwithNoise'))
...
h1 = openfig('VLPO_REMwithNoise','reuse');
colormap(jet)
caxis([20 48])
xlim([-80 +80])
...
h3 = openfig('VLPO_SWSwithNoise.fig','reuse');
colormap(jet)
caxis([20 48])
xlim([-80 +80])
ax3 = gca;
...
xlim([-30 +30])
ylim([0 +40])
savefig(fullfile('M1074_opto_REM_Wake_SWS.fig')) 