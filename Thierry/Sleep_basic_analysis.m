...
figure, 
subplot(3,1,1), imagesc(SpectroH{2},SpectroH{3},10*log10(SpectroH{1}')), axis xy
caxis([10 65])
colormap(jet)
subplot(3,1,2), imagesc(SpectroB{2},SpectroB{3},10*log10(SpectroB{1}')), axis xy
caxis([10 65])
subplot(3,1,3), imagesc(SpectroBH{2},SpectroBH{3},10*log10(SpectroBH{1}')), axis xy
caxis([10 65])
colormap(jet)
%% 
% *Nombre d'épisodes*
