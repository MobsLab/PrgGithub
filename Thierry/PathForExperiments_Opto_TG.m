function Dir=PathForExperiments_Opto_TG(experiment)
...
%%
if strcmp(experiment,'PFC_Baseline_20Hz')
...
%     load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse;
    ...
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse;
    %Mouse1109 Attention probleme pour eveil !!!
    a=a+1;Dir.path{a}{1}='/media/nas5/Thierry_DATA/M1109_processed/Opto_PFC_VLPO_1109_Baseline_200924_091530/';
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse
    Mouse1076 SHAM (pour un test, à enlever de ce dir après!!)
...
elseif strcmp(experiment,'PFC_Control_20Hz')
    ...
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse;
    %Mouse1111
    a=a+1;Dir.path{a}{1}='/media/nas5/Thierry_DATA/M1111_processed/Opto_PFC_VLPO_1111_OptoSleep20Hz_30s_201001_090048/';
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse;
    %Mouse1112
    a=a+1;Dir.path{a}{1}='/media/nas5/Thierry_DATA/M1112_processed/Opto_PFC_VLPO_1112_Opto20Hz_30s_200930_122249/';
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse;
    ...
    a=a+1;Dir.path{a}{1}='/media/nas5/Thierry_DATA/M1076_processed/20200716/';
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse;
    %Mouse1055 SHAM (pour un test, à enlever de ce dir après!!)
...
%    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse
    ...
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse
    %Mouse1109
    a=a+1;Dir.path{a}{1}='/media/nas5/Thierry_DATA/M1109_processed/Opto_PFC_VLPO_1109_OptoSleep20Hz_30s_Sleep_200925_092218/';
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse
    %Mouse1136
    a=a+1;Dir.path{a}{1}='/media/nas5/Thierry_DATA/M1136/OPTO_1136_opto20Hz30s_201210_090446/';
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse 
    %Mouse1137
    a=a+1;Dir.path{a}{1}='/media/nas5/Thierry_DATA/M1137/OPTO_1137_opto20Hz30s_201209_092118/';
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse     
...
elseif strcmp(experiment,'Septum_Stim_20Hz')
    ...
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse;
    %Mouse1052 20 mai 2020
    a=a+1;Dir.path{a}{1}='/media/nas5/Thierry_DATA/M1052_processed/M1052_OptoStimSleep20Hz60sInter2min_200520_101450/';
    load([Dir.path{a}{1},'ExpeInfo.mat']); Dir.ExpeInfo{a}=ExpeInfo,Dir.nMice{a}=ExpeInfo.nmouse;
