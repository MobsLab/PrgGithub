function compare_MedianSleepWakeVariables_control_vs_mutant_medianes()
    % Compare les médianes des variables de sommeil et d'éveil entre les groupes de souris contrôles et mutants.
    % Génère deux figures : l'une avec le test de Student, l'autre avec le test de Mann-Whitney.
    ...
    %% Générer deux figures : Student et Mann-Whitney
    test_types = {'ttest', 'ranksum'};
    for t = 1:2
        ...
        for k = 1:length(data_sets)
            ...
            % Calcul des médianes pour les barres
