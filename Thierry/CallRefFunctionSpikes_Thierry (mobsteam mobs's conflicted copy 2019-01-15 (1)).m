...
%         movefile('amplifier_M781_original.dat','amplifier_M781.dat') 
        ...
        RefVLPO1=17; % electrode used for subtraction
        AllChans(TetVLPO1+1)=[];
        RefSubtraction_multi('amplifier_M724.dat',32,1,'SpikeRef',TetVLPO1,RefVLPO1,AllChans);
        ...
        RefVLPO2=20;
        AllChans(TetVLPO2+1)=[];
        RefSubtraction_multi_AverageChans('amplifier_M724_SpikeRef.dat',32,1,'SpikeRef',TetVLPO2,RefVLPO2,AllChans);
