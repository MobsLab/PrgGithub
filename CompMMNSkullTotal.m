...
eval(['std',num2str(ki),'=std;'])

eval(['save stim',num2str(ki),' std MMN'])
...
plot(x1{ki},y1{ki},'color',[0 li/7 (7-li)/7],'linewidth',1)
plot(x2{ki},y2{ki},'color',[li/7 0 (7-li)/7],'linewidth',1)
title(LFPnames{ki})
yl=ylim;
