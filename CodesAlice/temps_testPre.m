...
Filename565={
    '/media/DataMOBS65/EmbReact_Eyeshock/Mouse565/20170726/ProjectEmbReact_M565_20170726_TestPre/TestPre1'
    '/media/DataMOBS65/EmbReact_Eyeshock/Mouse565/20170726/ProjectEmbReact_M565_20170726_TestPre/TestPre2'
    '/media/DataMOBS65/EmbReact_Eyeshock/Mouse565/20170726/ProjectEmbReact_M565_20170726_TestPre/TestPre3'
    '/media/DataMOBS65/EmbReact_Eyeshock/Mouse565/20170726/ProjectEmbReact_M565_20170726_TestPre/TestPre4'
    }
...
for souris=1:length(listefichiers)
    ...
    title(['TestPre : Mouse ',num2str(MouseNumber(souris))])
    saveas(fig.Number,['/home/vador/Dropbox/Mobs_member/AliceLallemand/Figures-Behaviour/TrajectoriesTestPreM',num2str(MouseNumber(souris)),'.png'])
...
set(gca,'XTick',[1:5],'XTickLabel',{'Shock','NoShock','Centre','CentreShock','CentreNoShock'})
title('Moyenne TestPre')
saveas(fig.Number,['/home/vador/Dropbox/Mobs_member/AliceLallemand/Figures-Behaviour/AverageOccupationTestPre.png'])
...
plot(tot','.-','linewidth',3)
set(gca,'XTick',[1:5],'XTickLabel',{'Shock','NoShock','Centre','CentreShock','CentreNoShock'})
title('Moyenne TestPre Fz')
saveas(fig.Number,['/home/vador/Dropbox/Mobs_member/AliceLallemand/Figures-Behaviour/AverageOccupationFzTestPre.png'])
close all