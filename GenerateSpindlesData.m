%GenerateSpindlesData

disp(pwd)

load StateEpoch SWSEpoch NoiseEpoch GndNoiseEpoch
...
try
    ...
    try
        [tDeltaT2,tDeltaP2]=FindDeltaWaves('PaCx',Epoch);
...
try
    ...
    try
[tDeltaT2,tDeltaP2]=FindDeltaWaves('PFCx',Epoch);
