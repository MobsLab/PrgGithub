...
clear all
close all
Mice=[862 864 866 870 878 863 865 867 871 879]; % /!\ Mice est ordonné, toutes les controles en premier, toutes les odeurs après. si on rajoute des souris il faut faire attention a ca, et a la separation dans la matrice a la fin
...
% load('behavResources.mat');
% load('TTLInfo.mat');
% FreezeEpoch=thresholdIntervals(Imdifftsd,20,'Direction','Below');
