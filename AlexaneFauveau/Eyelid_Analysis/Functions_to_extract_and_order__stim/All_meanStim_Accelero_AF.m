...
gamma=tsd(Range(tsdMovement),abs(Data(tsdMovement)-2.5));

%%

[m,s,tps]=mETAverage(Range(Restrict(stimt,Sleep)),Range(tsdMovement),Data(tsdMovement),bin1,bin2);
[mW,sW,tpsW]=mETAverage(Range(Restrict(stimt,Wake)),Range(tsdMovement),Data(tsdMovement),bin1,bin2);
