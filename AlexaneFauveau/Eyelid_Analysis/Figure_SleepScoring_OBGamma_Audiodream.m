% Figure_SleepScoring_OBGamma_Audiodream
% 21.11.2017 SB
% % Modif for SleepScoring_OBgamma_RemoveStimBeforeSmoothing_AF
%
...
function Figure_SleepScoring_OBGamma_Audiodream(foldername)
...
load([foldername 'SleepScoring_OBGamma_Audiodream'])
...
try    
    res=pwd;
    cd(foldername);
    saveas(SleepScoringFigureOB, 'SleepScoringOB_Audiodream.png', 'png');
    cd(res);
catch    
    res=pwd;
    cd(foldername);
    saveas(SleepScoringFigureOB.Number, 'SleepScoringOB_Audiodream.png', 'png');
    cd(res);
end
