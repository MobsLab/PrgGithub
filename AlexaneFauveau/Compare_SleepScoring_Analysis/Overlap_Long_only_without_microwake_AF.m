...
%     Sleep_LongOnly_OB = and(Sleep, Periode_sommeil_OB);
    ...
    Wake_modified_OB2 = dropShortIntervals(Wake_modified_OB,5*1e4);
    Wake_modified_OB = Wake_modified_OB - Wake_modified_OB2
    Sleep_LongOnly_OB = Periode_sommeil_OB - Wake_modified_OB;
    clear Sleep
    clear Wake
...
%     Sleep_LongOnly_accelero = and(Sleep, Periode_sommeil_accelero);
    ...
    Wake_modified_accelero2 = dropShortIntervals(Wake_modified_accelero,5*1e4);
    Wake_modified_accelero = Wake_modified_accelero - Wake_modified_accelero2
    Sleep_LongOnly_accelero = Periode_sommeil_accelero - Wake_modified_accelero;
...
%     Sleep_LongOnly_piezo = and(SleepEpoch_Piezo, Periode_sommeil_piezo);
    ...
    Wake_modified_piezo2 = dropShortIntervals(Wake_modified_piezo,5*1e4);
    Wake_modified_piezo = Wake_modified_piezo - Wake_modified_piezo2
    Sleep_LongOnly_piezo = Periode_sommeil_piezo - Wake_modified_piezo;
...
fig = figure;
suptitle('Overlap de la période de sommeil consolidé, éveil de moins de 5s only')
subplot(1,6,1)
