...
% Save the figure : 
cd(SaveFolderName);
% saveas(fig,'1562_8_CorrplotColor_OBPiezo.eps');
% saveas(fig,'1562_8_CorrplotColor_OBPiezo.jpg');
...
ylim([min(log10(Data(Actimetry_corr))) max(log10(Data(Actimetry_corr)))]);
    ...
    % Save the figure : 
cd(SaveFolderName);
% saveas(fig,'1562_8_CorrplotColor_OBPiezo_PeriodeSommeil.eps');
% saveas(fig,'1562_8_CorrplotColor_OBPiezo_PeriodeSommeil.jpg');
