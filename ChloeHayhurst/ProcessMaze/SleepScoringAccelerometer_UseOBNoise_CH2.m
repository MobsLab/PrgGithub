...
[ImmobilityEpoch, MovementEpoch, tsdMovement, Info_temp] = FindMovementAccelero_SleepScoring(Epoch, 'user_confirmation', user_confirmation,'mov_threshold','Info.mov_threshold');
Info=ConCatStruct(Info,Info_temp); clear Info_temp;
save('StateEpochSB','ImmobilityEpoch', 'MovementEpoch','-append')
...
[REMEpochAcc, SWSEpochAcc, WakeAcc] = ScoreEpochs_SleepScoring(TotalNoiseEpoch, Epoch, SleepEpochAcc, ThetaEpochAcc, minduration);
