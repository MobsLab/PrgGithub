...
% sizeMap = 50;
sizeMap2 = 9;
Type={'All','Blocked','Unblocked','Freeze','Freeze_Unblocked','Freeze_Blocked','Active_Unblocked','Active_Blocked','Ripples','Ripples_Blocked','Ripples_Unblocked','VHC','VHC_Blocked','VHC_Unblocked'};
