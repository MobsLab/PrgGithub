...
% .abf dans un dossier isolé (un seul fichier abf par dossier)
% se placer dans le dossier en question avec Matlab

TransformDataStep1('N');

% vérifier que la détection est ok et choisir une méthode (karim ou maud),
% sinon jouer sur les durées
% indiquer si on est sûr de la cellule
% vérifier que la correction de la baseline est ok, sinon, jouer sur les 2
% paramètres
