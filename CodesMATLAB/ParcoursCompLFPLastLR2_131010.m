...
try 
            ...
            % ------------------------------------------------------------------------
                                    try
                                            ...
                                            [C,CP,f,p,phi,S1,S2,f2]=CoherencyAstroFieldforLoopLR;
                                                close all
                                                disp('Coherency ok')
                                            ...
                                            [binS1,lS1]=PoolData(S1(f2<0.1),f2(f2<0.1),[0:0.01:0.1]);
                                            binS1T=[binS1T;binS1];
                                                
                                                
                                            [binS2,lS2]=PoolData(S2(f2<0.1),f2(f2<0.1),[0:0.01:0.1]);
                                            binS2T=[binS2T;binS2];
...
%                                         RlagZero=[RlagZero;[0 0]];
            ...
            save ResultsCompLFPGood cellnamesCross cellnamesCohr NomSuccess binS1T binS2T lS1 lS2 binCrossT binCrossT2 binCohrT binCohrT2 lCross lCross2 lCohr lCohr2 successCross successCohr RlagZero
