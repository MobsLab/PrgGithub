...
function [C,CP,f,p,phi,S1l,S2l,fl]=CoherencyAstroFieldforLoopLR
...
%   suite figure finale
            ...
            tempS1=(S1l(fl<0.1))/max(S1l(fl<0.1));
            tempS2=(S2l(fl<0.1))/max(S2l(fl<0.1));
            tempsmo=4;
            
            subplot(4,1,2)
            plot(fl(fl<0.1),smooth(tempS1,tempsmo),'r','linewidth',2)
            hold on, plot(fl(fl<0.1),smooth(tempS2,tempsmo),'b','linewidth',2)
