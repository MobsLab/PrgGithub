...
function [yf,f,spe,f2,S2,Serr2,Serr2a,Serr2b,S3,t3,f3,C,lag,lags]=PowerSpectrumLR011010(chF)
...
try
            ...
            comment='ok';
            valueLoc=200;
            save DataAdjust10 V V2 tps chF comment limInf limSup valueLoc
catch
           try
            V2=locdetrend(V,chF,[150,10]);
            comment='problem';
            valueLoc=150;
            save DataAdjust10 V V2 tps chF comment limInf limSup valueLoc
catch
            V2=locdetrend(V,chF,[50,10]);
            comment='problem';
            valueLoc=50;
            save DataAdjust10 V V2 tps chF comment limInf limSup valueLoc
           end
