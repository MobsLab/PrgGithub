...
save AnalysisCrossCorrPartFreqFinal
...
% -------------------------------------------------------------------------
% AJOUT LISA: suppression des outliers
% -------------------------------------------------------------------------
% (IndexGlobalh([1:13],[15:16],[18:end]);
% (IndexGlobalh([1:16],[18:end]);
% IndexGlobalh=IndexGlobalh([1:13],[15:16],[18:end]);

% binChTOK=binChT((IndexGlobalh([1:13],[15:16],[18:end])),:);
% [MeanBinCrosshOK,IndexGlobalhOK,Ppr0hOK,Tpr0hOK]=AnalysisBinCross(binChTOK,lCrossh);


% IndexGlobalhOK=IndexGlobalh([[1:13],[15:16],[18:20]]);

binChTOK=binChT(IndexGlobalh([[1:13],[15:16],[18:20]]),:);
[MeanBinCrosshOK,IndexGlobalhOK,Ppr0hOK,Tpr0hOK]=AnalysisBinCross(binChTOK,lCrossh);
cellnamesOK=cellnames(IndexGlobalh([[1:13],[15:16],[18:20]]));
Rreduc=RlisaT(IndexGlobalh([[1:13],[15:16],[18:20]]));
Preduc=PlisaT(IndexGlobalh([[1:13],[15:16],[18:20]]));
save dataCrossCorrOK MeanBinCrosshOK IndexGlobalhOK  Ppr0hOK Tpr0hOK cellnamesOK Rreduc Preduc

% [MeanBinCrossh,IndexGlobalh,Ppr0h,Tpr0h]=AnalysisBinCross(binChT((indexGlobalh([1:16],[18:end]),:),lCrosshOK);

% [MeanBinCrossh,IndexGlobalh,Ppr0h,Tpr0h]=AnalysisBinCross(binChT((indexGlobalh([1:13],[15:16],[18:end])),:),lCrosshOK);
% -------------------------------------------------------------------------
