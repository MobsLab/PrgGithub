...
%         try
            ...
            close all
            try
                eval(['load DataVM',nomL,' dEeg dEeg2 data tps spikes DebutUp FinUp VM'])
            catch
                eval(['load DataVM',nomL,' dEeg dEeg2 data tps DebutUp FinUp VM'])
            end
%             eval(['load DataPlotVM',nomL,' DebutUp FinUp'])
            ...
            eval(['load DataVMmaud',nomL,' DebutUp FinUp'])
...
close 
            ...
            eval(['save UpDown DebutUp FinUp UpStates'])
