function PlotErrorBar11(A,B,C,D,E,F,G,H,I,J,K,fig,points)
...
[Ri,Si,Ei]=MeanDifNan(I);
[Rj,Sj,Ej]=MeanDifNan(J);
[Rk,Sk,Ek]=MeanDifNan(K);
...
hold on, errorbar([Ra Rb Rc Rd Re Rf Rg Rh Ri Rj Rk],[Ea Eb Ec Ed Ee Ef Eg Eh Ei Ej Ek],'+','Color','k')
bar([Ra Rb Rc Rd Re Rf Rg Rh Ri Rj Rk],'k')
xlim([0.5 12.5])
