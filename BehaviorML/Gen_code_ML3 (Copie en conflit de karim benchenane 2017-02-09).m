...
%            FctCell=bla.FctCell;
    ...
    FctCell={'NosePokeOdor' 'NosePokeSequential' 'MultipleNosePoke'...
        'FreezingOnline' 'FearFreezingOnline' 'NosePokeSB' 'DoubleOnlineTrackingSavFrame' 'DoubleOnlineTracking' 'IntanPrep'  'FearFreezingOffline','FearFreezingOnline2','PainFreezingOnline','UMazeTracking'};
