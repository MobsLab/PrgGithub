function [numF,filename]=FearFreezingOnline(~,~)
...
%% track mouse
    function Track_Freeze(obj,event)
        ...
        save([name_folder,mark,'Behavior.mat'],'PosMat','frame_rate','FreezeEpoch','StimInfo','Movtsd','th_immob','imageRef','shape_ratio2','BW_threshold2','mask','smaller_object_size2');
        pause(0.5)
