...
%            FctCell=bla.FctCell;
    ...
    FctCell={'NosePokeOdor' 'NosePokeSequential' 'MultipleNosePoke'...
        'FreezingOnline' 'FearFreezingOnline' 'NosePokeTracking_Dima' 'DoubleOnlineTrackingSavFrame' 'DoubleOnlineTracking' 'IntanPrep'  'FearFreezingOffline','FearFreezingOnline2','PainFreezingOnline','UMazeTracking','SleepStimTracking','TrackThreeMiceOnline'};
...
try,            set(src,'Brightness',b_default);end
