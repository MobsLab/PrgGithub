...
slider_rapport = uicontrol(guireg_fig,'style','slider',...
    ...
    'callback', @rapport);
    set(slider_rapport,'Value',shape_ratio_2/typical_rapport);
...
%get threshold value
    ...
    function rapport(obj,event)
        ...
        disp(['     New shape_ratio=',num2str(shape_ratio_2)])
    end

    function enterManual(obj,event)
        defAns={num2str(BW_threshold2) num2str(smaller_object_size2) num2str(shape_ratio_2)};
        ...
        shape_ratio_2=str2num(answer{3});
