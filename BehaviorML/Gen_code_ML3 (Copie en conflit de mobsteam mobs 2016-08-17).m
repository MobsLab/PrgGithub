...
%            FctCell=bla.FctCell;
    ...
    FctCell={'NosePokeOdor' 'NosePokeSequentiasli' 'MultipleNosePoke'...
        'FreezingOnline' 'FearFreezingOnline' 'DoubleOnlineTrackingSavFrame' 'DoubleOnlineTracking' 'IntanPrep',...
        'FearFreezingOffline','FearFreezingOnline2','PainFreezingOnline','online_tracking_StimulationZone'};
    ...
    function init_device(obj,event)
        ...
        if var_init==0 % security : not used if the programm is launched correctly
            ...
            try,vid = videoinput('winvideo',1,'RGB24_320x240'); disp('using RGB');
                ...
                try,vid = videoinput('winvideo',1,'MJPG_320x240');disp('using MJPG');
                catch,vid = videoinput('dcam',1,'RGB24_320x240'); disp('using RGB');
                end
            end
            ...
            try
                ...
                save('InfoTrackingTemp.mat','b_default','c_default','e_default');
            end
