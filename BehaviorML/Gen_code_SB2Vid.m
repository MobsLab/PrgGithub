...
%% Choose your script
    function choose_tracking(obj,event)
        ...
        FctCell={'NosePokeOdor' 'NosePokeSequential' 'MultipleNosePoke'...
            'FreezingOnline' 'FearFreezingOnline' 'DoubleOnlineTracking' 'IntanPrep'  'FearFreezingOffline','FearFreezingOnline2','FearFreezingOnlineImetronic2Vid','FearFreezingOnlineImetronic2VidJL'};
