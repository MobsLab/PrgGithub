...
def run_linear_regression(data, dependent_var, independent_vars):
    """
    Run a linear regression model without cross-validation using statsmodels.
    ...
    Returns:
    model: The fitted linear regression model from statsmodels.
    """
    ...
    # Print out the R-squared and summary of the model
