...
compute_cross_correlation(maze_denoised_data, 'Mouse508', 'Heartrate', 'Heartrate', max_lag=20, time_step=0.2)
compute_cross_correlation(maze_denoised_data, 'Mouse508', 'BreathFreq', 'BreathFreq', max_lag=20, time_step=0.2)
compute_cross_correlation(maze_denoised_data, 'Mouse508', 'Heartrate', 'BreathFreq', max_lag=20, time_step=0.2)

compute_cross_correlation(all_denoised_data, 'Mouse508', 'Heartrate', 'BreathFreq', max_lag=20, time_step=0.2)

compute_cross_correlation(all_denoised_data, 'Mouse508', 'Heartrate', 'BreathFreq', max_lag=20, time_step=0.2, epoch='NREMStartStop')
compute_cross_correlation(all_denoised_data, 'Mouse508', 'Heartrate', 'BreathFreq', max_lag=20, time_step=0.2, epoch='WakeStartStop')
compute_cross_correlation(all_denoised_data, 'Mouse508', 'Heartrate', 'BreathFreq', max_lag=20, time_step=0.2, epoch='FzStartStop')
