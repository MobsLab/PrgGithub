...
#     Returns:
#     - dict: A dictionary containing results for all models and the random seed.
#     """
#     try:
#         # Preprocess data
#         maze_rebinned_normalized_data = zscore_columns(
...
#         # Split the data once
#         train_data, test_data = extract_random_bouts(model_all_df, bout_length=10, percent=10, random_state=random_seed)
...
#         # Return results, datasets, and the random seed
#         return {
#             "mouse_id": mouse_id,
#             "dependent_var": dependent_var,
#             "results": results,
