...
def fit_single_predictor_models(df, best_params):
    ...
    df_transformed = feature_transformer.fit_transform(df[required_raw_features])  # Apply transformation to full df
    ...
    for feature in transformed_features:
        try:
            ...
            # Perform cross-validation to get mean R²
            r2_scores = cross_val_score(pipeline, X_selected, y, cv=5, scoring="r2")
