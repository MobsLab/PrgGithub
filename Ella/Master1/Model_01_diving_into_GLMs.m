...
GLMArray_mouse = table( PositionArray', GlobalTimeArray', TimeSinceLastShockArray', TimepentFreezing', OB_FrequencyArray', 'VariableNames',varNames);
...
linear_mdl = fitglm(GLMArray_mouse,'linear','ResponseVar','OB_FrequencyArray','Distribution', 'gamma', 'link', 'reciprocal');
