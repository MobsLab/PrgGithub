...
[a,b,c] = mETAverage(sda*1E4,Range(LFP{10}),Data(LFP{5}),1,1000);
try
plot(c,a,'color','k','linewidth',2)
end
[a,b,c] = mETAverage(sda*1E4,Range(LFP{11}),Data(LFP{6}),1,1000);
try
plot(c,a,'color','b','linewidth',2)
end
[a,b,c] = mETAverage(sda*1E4,Range(LFP{13}),Data(LFP{8}),1,1000);
try
...
[a,b,c] = mETAverage(sda*1E4,Range(LFP{15}),Data(LFP{15}),1,1000);
try
plot(c,a,'color','r','linewidth',2)
end
[a,b,c] = mETAverage(sda*1E4,Range(LFP{13}),Data(LFP{13}),1,1000);
try
plot(c,a,'color','m','linewidth',2)
end
yl=ylim;
...
disp(' ')
disp(['std, n=',num2str(length(sda)),'; MMN, n=',num2str(length(MMN))])
disp(' ')
