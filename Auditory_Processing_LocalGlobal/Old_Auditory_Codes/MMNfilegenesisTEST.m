...
%% Import of the differents Stimulations Files
        newData1 = importdata('/media/KARIMBACKUP/DataMMN/Mouse55-63/File1-Bloc-AAAAA-BBBBA-BBBBB-AAAAB.txt');
...
for i = 1:length(vars)
        ...
        newData2 = importdata('/media/KARIMBACKUP/DataMMN/Mouse55-63/File2-Bloc-AAAAB-BBBBB-AAAAA-BBBBA.txt');
        File2=newData2; clear newData2;

        newData3 = importdata('/media/KARIMBACKUP/DataMMN/Mouse55-63/File3-Bloc-BBBBB-BBBBA-AAAAB-AAAAA.txt');
