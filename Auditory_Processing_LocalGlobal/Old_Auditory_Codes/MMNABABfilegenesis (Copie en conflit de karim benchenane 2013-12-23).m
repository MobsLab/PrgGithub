...
%% Import of the differents Stimulations Files
        newData1 = importdata('/media/DISK_1/Dropbox/GaetanPhD/Protocole LocalGlobal:MMN/Protocole ABABA/File1-Bloc-ABABA-BABAB-ABABB-BABAA.txt');
...
for a=1:(length(MegaBlockAAAAB)-1);
    ...
    elseif MegaBlockAAAAB(a,2)==1 & MegaBlockAAAAB(a,4)==3
        LocalStdGlobDvtA(i,1)=st((a+start-1377)+(startMegaBlockAAAABFile3-start),1);
        i=i+1;  
    end
end
LocalStdGlobDvtB=[];
