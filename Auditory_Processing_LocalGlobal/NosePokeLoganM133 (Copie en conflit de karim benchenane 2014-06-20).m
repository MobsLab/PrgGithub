directoryName='/media/DataMOBs10/DataMMN/AttentionalNosePoke/Mouse133';
cd(directoryName)
...
% ----------   20/05   -------
cd([directoryName,'/20140520/ICSS-Mouse-133-20052014'])
...
firstGen=firstGeneration(2:53);
firstGenbis=firstGeneration(54:130);
firstGenter=firstGeneration(131:length(GenToneEvent));
...
firstGenquar=firstGeneration(2:80);
firstGenquin=firstGeneration(81:137);
firstGensex=firstGeneration(138:length(GenToneEvent));
...
C=[PercGen10juin;PercGen10juinbis;PercGen10juinter;PercGen10juinquar;PercGen10juinquin;PercGen10juinsex];
