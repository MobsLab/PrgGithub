...
function [st]=MMNfilegenesis(protocole, start)

load behavResources
safe=0;

%% Import of the differents Stimulations Files
        newData1 = importdata('/media/DISK_1/Dropbox/GaetanPhD/Protocole LocalGlobal:MMN/Protocole AAAAB/File1-Bloc-AAAAA-BBBBA-BBBBB-AAAAB.txt');
...
for i = 1:length(vars)
        ...
        newData2 = importdata('/media/DISK_1/Dropbox/GaetanPhD/Protocole LocalGlobal:MMN/Protocole AAAAB/File2-Bloc-AAAAB-BBBBB-AAAAA-BBBBA.txt');
        File2=newData2; clear newData2;

        newData3 = importdata('/media/DISK_1/Dropbox/GaetanPhD/Protocole LocalGlobal:MMN/Protocole AAAAB/File3-Bloc-BBBBB-BBBBA-AAAAB-AAAAA.txt');
