...
disp('------------------------------------------------------------')
disp(' ')
[Epoch,TotalNoiseEpoch,SubNoiseEpoch,Info_temp] = FindNoiseEpoch_SleepScoring(channel_theta, 'foldername', foldername);
Info_OB = Info_temp;
...
if doob
    ...
    [REMEpoch,SWSEpoch,Wake,REMEpochWiNoise, SWSEpochWiNoise, WakeWiNoise] = ...
        ScoreEpochs_SleepScoring_tmp(TotalNoiseEpoch, Epoch, SleepOB, ThetaEpoch_OB, minduration,SmoothTheta,Info_OB);
...
if is_accelero
    ...
    disp('   2) Accelero')
    [REMEpoch,SWSEpoch,Wake,REMEpochWiNoise, SWSEpochWiNoise, WakeWiNoise] = ...
        ScoreEpochs_SleepScoring_tmp(TotalNoiseEpoch, Epoch, ImmobilityEpoch, ThetaEpoch_acc, minduration,SmoothTheta,Info_accelero);
    SleepWiNoise = or(REMEpochWiNoise,SWSEpochWiNoise);
    Sleep = or(REMEpoch,SWSEpoch);
    Info=Info_accelero;
