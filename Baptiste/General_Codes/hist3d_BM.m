function [no1,no2,xo1,xo2] = hist3d_BM(y1,y2,y3,x1,x2)
...
%    the results.
% 
% y3 is a variable associated with coordinate y1 and y2 (example : speed for coordinate y1=X, y2=Y)
...
for i=2:nbin1
   for j=2:nbin2
      ...
      nn2(i-1,j-1,:) = mean( y3(y1 < xx1(i) & y1 > xx1(i-1) & y2 < xx2(j) & y2 >  xx2(j-1)) );
