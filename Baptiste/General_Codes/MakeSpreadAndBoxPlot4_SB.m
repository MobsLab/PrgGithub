function [pval , stats_out] = MakeSpreadAndBoxPlot4_SB(A,Cols,X,Legends,varargin)

% modified by BM from MakeSpreadAndBoxPlot_SB, for just one value
...
%             set(handlesplot{1},'MarkerSize',10)
            ...
            set(handlesplot{1},'MarkerSize',8)
