function [map, mapNS, stats, px, py, FR, xB, yB, lEpoch , LinPos]=PlaceField_BM(tsa, XS, YS , linpos , varargin)
...
if flagstop
    ...
    [occH, LinPos , xB, yB] = hist3d_BM(Data(XS), Data(YS), Data(linpos) , sizeMap, sizeMap);
