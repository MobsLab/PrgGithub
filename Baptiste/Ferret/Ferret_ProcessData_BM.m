...
~/Dropbox/Kteam/PrgMatlab/OnlinePlaceDecoding/matlab/convertEvents2Mat -p /media/nas8/OB_ferret_AG_BM/Shropshire/freely-moving/20250103_LSP_saline/recording1/continuous
...
directory = '/media/nas8/OB_ferret_AG_BM/Shropshire/head-fixed';
sessions = {'20250103_TORCs_saline', '20250104_TORCs_saline', '20250105_TORCs_atropine', '20250108_TORCs_saline'};

directory = '/media/nas8/OB_ferret_AG_BM/Shropshire/freely-moving';
sessions = {'20250103_LSP_saline'};


directory = '/media/nas7/React_Passive_AG/OBG/Edel/head-fixed';
% sessions = {'20220419_m', '20220420_m', '20220420_n', '20220421_m', '20220421_n', '20220422_m', '20220422_n', '20220426_n', '20220427_n', '20220428_m', '20220520_n'};
sessions = {'20220419_m', '20220420_m', '20220420_n', '20220421_m', '20220421_n', '20220422_m', '20220422_n', '20220426_n', '20220427_n', '20220428_m'};

% Calculate various spectrograms. Just do it beforehands to save some time
Ferret_spectrograms_calculation(directory, sessions)

% If you are having issues with sampling rate, use this function (obligatory for Shropshire
Correct_Ferret_Processing(directory, sessions)

%                           ------------- Sleep scoring -------------
%{
    Here we classify wake and sleep based on OB gamma (40-60Hz) 
...
%%                           ------------- Behaviour (DLC) Analysis -------------

% AG_codes_unsaved

%%                           ------------- Session parameters -------------
% Select your sessions
Dir = PathForExperimentsOB();
