...
function [ThetaEpoch, SmoothTheta, ThetaRatioTSD, Info] = FindThetaEpoch_SleepScoring_Ferret_BM(SleepEpoch, Epoch, channel_HPC, minduration, varargin)
...
% ThetaEpoch = SleepEpoch-ThetaEpoch;             % what is the purpose of this ??
