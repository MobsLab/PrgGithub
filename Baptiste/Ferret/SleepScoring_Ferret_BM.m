function SleepScoring_Ferret_BM(varargin)
...
if doob
    ...
    disp('Gamma Epochs')
    if ~exist('StimEpoch')
    % Use this line for ferrets (OB gamma frequency = 40-60Hz)
    ...
    % Use this line for mice (OB gamma frequency = 50-70Hz)
%         [SleepOB,SmoothGamma,Info_temp,microWakeEpochOB,microSleepEpochOB]= ...
%             FindGammaEpoch_SleepScoring(Epoch, channel_bulb, minduration, 'foldername', foldername,...
%             'smoothwindow', smootime,'controlepoch',ControlEpoch,'frequency',[50 70]);
