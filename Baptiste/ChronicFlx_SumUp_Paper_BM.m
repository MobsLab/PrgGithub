...
load('/media/nas7/ProjetEmbReact/DataEmbReact/ThesisData/DATA_ChronicFlx_All.mat')



FreezingShock_prop.Cond{2}(7)=NaN;
FreezingShock_DurProp.Cond{2}(7)=NaN;
FreezingShock_Dur.Cond{2}(7)=NaN;
