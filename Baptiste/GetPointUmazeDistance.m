function [dis,dis1,dis2,U] = GetPointUmazeDistance(x,y,th,U)
...
try
    ...
    x6=1;y6=1;
    x7=0.35; y7=0.85;
    x8=0.65; y8=0.85; x8=0.7;
    U(:,1)=[x1,x2,x3,x4,x5,x6,x7,x8];
    U(:,2)=[y1,y2,y3,y4,y5,y6,y7,y8];
end

distance1 = GetPointLineDistance(x,y,x1,y1,x5,y5);
distance2 = GetPointLineDistance(x,y,x1,y1,x2,y2);
distance3 = GetPointLineDistance(x,y,x2,y2,x7,y7);
distance4 = GetPointLineDistance(x,y,x5,y5,x6,y6);
distance5 = GetPointLineDistance(x,y,x7,y7,x8,y8);
distance6 = GetPointLineDistance(x,y,x8,y8,x3,y3);
distance7 = GetPointLineDistance(x,y,x3,y3,x4,y4);
distance8 = GetPointLineDistance(x,y,x6,y6,x4,y4);
dis2=nanmin([distance1,distance2,distance3,distance4,distance5,distance6,distance7,distance8]');
dis1=nanmin([distance1,distance2,distance3,distance4,distance6,distance7,distance8]');
