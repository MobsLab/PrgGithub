...
load('/media/nas7/ProjetEmbReact/DataEmbReact/ThesisData/DATA_ChronicBus_All.mat')


ShockZone_Occupancy.TestPost{2}(1)=.2787;
MeanSpeed.Cond{2}(1)=NaN;
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%ù
%                            FIGURES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%ù

Cols2 = {[.3, .745, .93],[.85 .3 .75]};
X2 = 1:2;
Legends2 = {'Saline','Chronic Bus'};
...
yticklabels({'Chronic Bus','Saline'}), 
makepretty_BM2
xlim([-.3 .3])
...
text(-.29,1.5,'ns','HorizontalAlignment','Center','BackGroundColor','none','FontSize',15);
lim=.27;
plot([lim lim],[1 2],'-k','LineWidth',1.5,'Tag','sigstar_bar');
text(.29,1.5,'ns','HorizontalAlignment','Center','BackGroundColor','none','FontSize',15);
...
lim=-.3;
plot([lim lim],[1 2],'-k','LineWidth',1.5,'Tag','sigstar_bar');
text(-.35,1.5,'ns','HorizontalAlignment','Center','BackGroundColor','none','FontSize',15);
lim=.95;
plot([lim lim],[1 2],'-k','LineWidth',1.5,'Tag','sigstar_bar');
text(1,1.5,'ns','HorizontalAlignment','Center','BackGroundColor','none','FontSize',15);
...
%% Sleep
Prop.REM{1}{1}([1 2])=NaN
Prop.Wake{1}{1}([1 2])=NaN

Cols = {[.3, .745, .93],[.85 .3 .75]};
X = 1:2;
Legends = {'Saline','Chronic Bus'};
