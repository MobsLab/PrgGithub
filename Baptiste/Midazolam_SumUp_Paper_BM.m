...
load('/media/nas7/ProjetEmbReact/DataEmbReact/ThesisData/DATA_MDZ_All.mat')
...
Cols2 = {[.3, .745, .93],[.15 .85 .25]};
X2 = 1:2;
Legends2 = {'Saline','Midazolam'};
...
%% sleep
Cols = {[.3, .745, .93],[.15 .85 .25]};
X = 1:2;
Legends = {'Saline','Midazolam'};
