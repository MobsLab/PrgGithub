function FolderName=OrganizeFilesEmbReact_SecondDay_BM(MouseNum,Date,SaveFolderName,ExpeInfo)
...
ExperimentalConditions={'TestPost_PreDrug' 'UMazeCondExplo_PreDrug' 'UMazeCondBlockedShock_PreDrug' 'UMazeCondBlockedSafe_PreDrug' ...
    'Recover_From_Drug' 'UMazeCondExplo_PostDrug' 'UMazeCondBlockedShock_PostDrug' 'UMazeCondBlockedSafe_PostDrug',...
...
for e=1:length(ExperimentalConditions)
    ...
    if strcmp(ExperimentalConditions{e},'TestPost_PreDrug')
        for i=1:2
