function FolderName=OrganizeFilesEmbReactNewProtocol_VeryShort_BM(MouseNum,Date,SaveFolderName,ExpeInfo)
...
ExperimentalConditions={'TestPre_PreDrug' 'UMazeCondExplo_PostDrug' 'UMazeCondBlockedShock_PostDrug' 'TestPost_PostDrug' };
