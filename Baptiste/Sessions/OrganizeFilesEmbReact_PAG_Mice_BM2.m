function FolderName=OrganizeFilesEmbReact_PAG_Mice_BM2(MouseNum,Date,SaveFolderName,ExpeInfo)
...
ExperimentalConditions={'Habituation24HPre_PreDrug' 'Habituation_PreDrug' 'HabituationBlockedShock_PreDrug' 'HabituationBlockedSafe_PreDrug' 'SleepPre_PreDrug',...
    ...
    'SleepPost_PostDrug' 'TestPost_PostDrug'  'ExtinctionBlockedShock_PostDrug' 'ExtinctionBlockedSafe_PostDrug' 'Recall_PostDrug' 'Recover_From_Drug'};

IsSleep=zeros(18,1);
IsSleep(5)=1;IsSleep(13)=1;
