...
% Updated script for ferrets based on 21.11.2017 SB
% By AG, 22/10/2024
%
% [REMEpoch, SWSEpoch, Wake] = ScoreEpochs_SleepScoring_Ferret(TotalNoiseEpoch, Epoch, Sleep, ThetaEpoch, min_duration)
%
...
function [REMEpoch, SWSEpoch, Wake,REMEpochWiNoise, SWSEpochWiNoise, WakeWiNoise] = ...
    ScoreEpochs_SleepScoring_Ferret(TotalNoiseEpoch, Epoch, SleepEpoch, ThetaEpoch, minduration,SmoothTheta,Info)
