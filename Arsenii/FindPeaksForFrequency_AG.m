function AllPeaks=FindPeaksForFrequency_AG(LFP,Options,plo)
...
dat = Data(FilLFPP);
rmpath('C:\Users\Arsenii Goriachenkov\Dropbox\Kteam\PrgMatlab\chronux2\spectral_analysis\continuous\')
...
addpath('C:\Users\Arsenii Goriachenkov\Dropbox\Kteam\PrgMatlab\chronux2\spectral_analysis\continuous\')
...
if plo
    ...
    plot(Range(LFP,'s'),dat,'linewidth',3,'color',[0.3 1 0.3])
