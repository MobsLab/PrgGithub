function [lineOut, fillOut] = semshade(amatrix,alpha,acolor,F,smth)
...
asem = nanstd(amatrix,[],1)/sqrt(size(amatrix,1)); % to get sem shading
...
hold on;
lineOut = plot(F,amean,'Color',acolor,'linewidth',1.6); %% change color or linewidth to adjust mean line
