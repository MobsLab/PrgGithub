...
for k = 1:length(Dir.path)
    ...
    saveas(fig,[dropbox '/Mobs_member/SophieBagur/Figures/N1N2N3NeuronFiring/FigBilanMouse_dHPC',num2str(k),'.png'])
    saveas(fig,[dropbox '/Mobs_member/SophieBagur/Figures/N1N2N3NeuronFiring/FigBilanMouse_dHPC',num2str(k),'.fig'])
    close all
    end
end
