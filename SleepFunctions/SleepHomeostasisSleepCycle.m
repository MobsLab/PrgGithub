function [x_intervals, reg_delta1, reg_delta2]=SleepHomeostasisSleepCycle
...
x_intervals = (intervals_start + windowsize/2)/(3600E4)+rg(1)/3600/1E4;
...
plot(Data(NewtsdZT)/3600/1E4, rescale(Data(Restrict(SleepStagesC,NewtsdZT)),0,0.3),'color',[0.4 0.4 0.4])
plot(Data(Restrict(NewtsdZT,REMm))/3600/1E4,Data(Restrict(temp3,REMm)),'r.')
...
x_intervals(trghs)
x_intervals(trghs2)lo
density_delta1(trghs)
density_delta1(trghs2)
