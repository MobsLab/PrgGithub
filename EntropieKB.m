...
function [Q1,Q2,Z1,Z2,X1,X2,H1,P1,H2,P2,p_xy,p_xy2,M1,M2]=EntropieKB(M1,M2)
...
%         p_xy(:,:,1)=Rotate(M1(:,1:2),ang);
        ...
        p_xy(:,1)=rescale(p_xy(:,1)-p_xy(1,1),Xrange(1),Xrange(2));
        p_xy(:,2)=rescale(p_xy(:,2)-p_xy(1,2),Yrange(1),Yrange(2));
        
        
        p_xy2(:,:,1)=M2(:,1:2);
        
        p_xy2(:,1)=rescale(p_xy2(:,1)-p_xy2(1,1),Xrange(1),Xrange(2));
        p_xy2(:,2)=rescale(p_xy2(:,2)-p_xy2(1,2),Yrange(1),Yrange(2));
