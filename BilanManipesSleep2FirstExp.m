...
if renorm
    ...
    if renormAll
            ...
            Bsi=[Res1{1}(1:tr)/mean(Res1{1}(1:tr));Res2{1}(1:tr)/mean(Res2{1}(1:tr))];
            Asi=[Res1{2}(1:tr)/mean(Res1{1}(1:tr));Res2{2}(1:tr)/mean(Res2{1}(1:tr))];

            Bli=[Res1{3}(1:tr)/mean(Res1{3}(1:tr));Res2{3}(1:tr)/mean(Res2{3}(1:tr))];
            Ali=[Res1{4}(1:tr)/mean(Res1{3}(1:tr));Res2{4}(1:tr)/mean(Res2{3}(1:tr))];


            BsiM=[mean(Res1{1}(1:tr));mean(Res2{1}(1:tr))]/mean([mean(Res1{1}(1:tr));mean(Res2{1}(1:tr))]);
            AsiM=[mean(Res1{2}(1:tr));mean(Res2{2}(1:tr))]/mean([mean(Res1{1}(1:tr));mean(Res2{1}(1:tr))]);

            BliM=[mean(Res1{3}(1:tr));mean(Res2{3}(1:tr))]/mean([mean(Res1{3}(1:tr));mean(Res2{3}(1:tr))]);
            AliM=[mean(Res1{4}(1:tr));mean(Res2{4}(1:tr))]/mean([mean(Res1{3}(1:tr));mean(Res2{3}(1:tr))]);
            ...
            AsiM=[mean(Res1{2}(1:tr));mean(Res2{2}(1:tr))]/mean([mean(Res1{1});mean(Res2{1})]);

            BliM=[mean(Res1{3});mean(Res2{3})]/mean([mean(Res1{3});mean(Res2{3})]);
            AliM=[mean(Res1{4}(1:tr));mean(Res2{4}(1:tr))]/mean([mean(Res1{3});mean(Res2{3})]);
        ...
        if renormAll
                    Bsi=[Res1{1};Res2{1}];
                    Asi=[Res1{2}(1:tr);Res2{2}(1:tr)];

                    Bli=[Res1{3};Res2{3}];
                    Ali=[Res1{4}(1:tr);Res2{4}(1:tr)]; 

                    BsiM=[mean(Res1{1});mean(Res2{1})];
                    AsiM=[mean(Res1{2}(1:tr));mean(Res2{2}(1:tr))];

                    BliM=[mean(Res1{3});mean(Res2{3})];
                    AliM=[mean(Res1{4}(1:tr));mean(Res2{4}(1:tr))];

                     else


                    Bsi=[Res1{1}(1:tr);Res2{1}(1:tr)];
                    Asi=[Res1{2}(1:tr);Res2{2}(1:tr)];

                    Bli=[Res1{3}(1:tr);Res2{3}(1:tr)];
                    Ali=[Res1{4}(1:tr);Res2{4}(1:tr)];   

                    BsiM=[mean(Res1{1}(1:tr));mean(Res2{1}(1:tr))];
                    AsiM=[mean(Res1{2}(1:tr));mean(Res2{2}(1:tr))];

                    BliM=[mean(Res1{3}(1:tr));mean(Res2{3}(1:tr))];
                    AliM=[mean(Res1{4}(1:tr));mean(Res2{4}(1:tr))];
