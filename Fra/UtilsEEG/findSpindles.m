function [S, E, M] = findSpindles(EEG, DetectThresholdSTD, LimitThresholdSTD, varargin)
...
try
Filt_EEG = FilterLFP(EEG, [5 20], 1024);
catch
    Filt_EEG = FilterLFP(EEG, [5 20], 128);
    disp('128')
end
