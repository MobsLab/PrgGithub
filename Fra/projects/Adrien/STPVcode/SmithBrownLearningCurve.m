function [bLearning cLearning bLearningUp bLearningDw] = SmithBrownLearningCurve(mm,nfig,exampledata)
...
% exampledata = 1;       % flag for example data choice
...
%plot up the figures
 ...
 subplot(211);  
 plot(t, bmode(2:end),'r-','linewidth',3);
 hold on;
 ...
 subplot(212)
 plot(t,1 - pmatrix(2:end),'r','linewidth',3)
 ...
 bLearning = bmode(2:end);
 cLearning=(1-pmatrix(2:end))';
 
bLearningDw = b05(2:end);
bLearningUp = b95(2:end);
