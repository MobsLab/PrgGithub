...
A = registerResource(A, 'FiringMPreT', 'numeric', {1,1}, ...
    'firingM', 'binned firing rate during sleep1 Epoch');

A = registerResource(A, 'FiringMFirstHT', 'numeric', {1,1}, ...
    'firingM', 'binned firing rate during sleep1 Epoch');

A = registerResource(A, 'FiringMSecHT', 'numeric', {1,1}, ...
    'firingM', 'binned firing rate during sleep1 Epoch');

A = registerResource(A, 'FiringMPostO', 'numeric', {1,1}, ...
    'firingM', 'binned firing rate during sleep1 Epoch');
