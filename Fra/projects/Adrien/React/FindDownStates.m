...
eegPfc1 = Restrict(EEG1,sleep1Epoch);
eegPfc2 = Restrict(EEG1,sleep2Epoch);
...
eegSFilt = filtfilt(b,1,Data(eegHc1));
sigma = std(eegSFilt);
eegSFilt = tsd(Range(eegHc1),eegSFilt);
...
plot(Range(eeg1filt50r)/10000,Data(eeg1filt));
