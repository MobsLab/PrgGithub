...
A = registerResource(A, 'PfcHcStartTrialCohgram2', 'tsdArray', {1,1},...
    'pfcHcStartTrialCohgram', ...
    ['coherence gram  between prefrontal and hippocampal EEG', ...
    'thiggered on startTrial']);
A = registerResource(A, 'PfcHcStartTrialCohgramFreq2', 'numeric', {1,[]},...
    'pfcHcStartTrialCohgramFreq', ...
    ['coherence gram  between prefrontal and hippocampal EEG', ...
    'thiggered on startTrial, the frequencies']);
A = registerResource(A, 'PfcHcStartTrialCorrectCohgram2', 'tsdArray', {1,1},...
    'pfcHcStartTrialCohgram', ...
    ['coherence gram  between prefrontal and hippocampal EEG', ...
    'thiggered on startTrial']);
A = registerResource(A, 'PfcHcStartTrialCorrectCohgramFreq2', 'numeric', {1,[]},...
    'pfcHcStartTrialCohgramFreq', ...
    ['coherence gram  between prefrontal and hippocampal EEG', ...
    'thiggered on startTrial, the frequencies']);
A = registerResource(A, 'PfcHcStartTrialErrorCohgram2', 'tsdArray', {1,1},...
    'pfcHcStartTrialCohgram', ...
    ['coherence gram  between prefrontal and hippocampal EEG', ...
    'thiggered on startTrial']);
A = registerResource(A, 'PfcHcStartTrialErrorCohgramFreq2', 'numeric', {1,[]},...
    'pfcHcStartTrialCohgramFreq', ...
    ['coherence gram  between prefrontal and hippocampal EEG', ...
    'thiggered on startTrial, the frequencies ']);
...
try
    A = getResource(A, 'PfcHcStartTrialCohgram');
    A = getResource(A, 'PfcHcStartTrialCohgramFreq');
    A = getResource(A, 'PfcHcStartTrialCorrectCohgram');
    A = getResource(A, 'PfcHcStartTrialCorrectCohgramFreq');
    A = getResource(A, 'PfcHcStartTrialErrorCohgram');
    A = getResource(A, 'PfcHcStartTrialErrorCohgramFreq');
catch
display(lasterr);
...
[C,phi,S12,S1,S2,t,f]=cohgramc(dtPfc,deegHc,movingwin,params);
