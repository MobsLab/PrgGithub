...
A = registerResource(A, 'SpectrumTrials', 'cell', {7,1}, ...
   ...
   'seventh element is the frequencies']);
A = registerResource(A, 'SpectrumTrialsErr','cell', {7,1}, ...
    'spectrumTrialsErr', ...
   ['powerspectrum for the six EEG channels for the trials',...
   'seventh element is the frequencies']);
A = registerResource(A, 'SpectrumTrialsVar','cell', {7,1}, ...
    'spectrumTrialsVar', ...
   ['powerspectrum for the six EEG channels for the trials',...
   'seventh element is the frequencies']);
...
spectrumTrialsErr = cell(7,1);
spectrumTrialsVar = cell(7,1);
for neeg = 1:6
    ...
    [spectrumTrials{neeg},f,spectrumTrialsVar{neeg}, C, spectrumTrialsErr{neeg}]=...
        mtspectrumsegc(deeg1,2, params);
