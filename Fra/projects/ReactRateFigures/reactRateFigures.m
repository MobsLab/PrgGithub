function reactRateFigures()
  ...
  if isempty(FIGURE_DIR)
    FIGURE_DIR = '/home/fpbatta/Data/DIRAC/ReactRateFigures';
  end
  ...
  check_figure(@GlobalFRateHist, 1); % check global figures OK
  check_figure(@SleepACGFigure, 10);
