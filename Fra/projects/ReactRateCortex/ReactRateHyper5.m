function AO = ReactRateHyper5(A)
  ...
  A = getResource(A, 'PostSleep3_10min_Epoch');    
  PostSleep3 = PostSleep3{1};
...
% $$$   
  ...
  A = registerResource(A, 'FRateMaze2', 'numeric', dim_by_cell, ...
		       'frate_maze2', ...
		       ['firing rate in maze period'], 1);
...
% $$$   
  ...
  A = registerResource(A, 'FRateSleep2_2', 'numeric', dim_by_cell, ...
		       'frate_sleep2_2', ...
		       ['firing rate in sleep2_2 period'], 1);

  A = registerResource(A, 'FRateSleep3', 'numeric', dim_by_cell, ...
		       'frate_sleep3', ...
		       ['firing rate in sleep2 period'], 1);
  ...
  A = registerResource(A, 'FRateSPWSleep2_2', 'numeric', dim_by_cell, ...
		       'frate_spw_sleep2_2', ...
		       ['firing rate in sleep2_2 period',...
		   ' during sharp waves'], 1);

  A = registerResource(A, 'FRateSPWSleep3', 'numeric', dim_by_cell, ...
		       'frate_spw_sleep3', ...
		       ['firing rate in sleep3 period',...
		   ' during sharp waves'], 1);
  ...
  A = registerResource(A, 'FRateNoSPWSleep2_2', 'numeric', dim_by_cell, ...
		       'frate_no_spw_sleep2_2', ...
		       ['firing rate in sleep2_2 period',...
		   ' during inter sharp waves times'], 1);
  
  A = registerResource(A, 'FRateNoSPWSleep3', 'numeric', dim_by_cell, ...
		       'frate_no_spw_sleep3', ...
		       ['firing rate in sleep3 period',...
		   ' during inter sharp waves times'], 1);
  ...
  A = registerResource(A, 'FRatePreSleep1', 'numeric', dim_by_cell, ...
   ...
   A = registerResource(A, 'FRatePostSleep3', 'numeric', dim_by_cell, ...
			'frate_post_sleep3', ...
			['firing rate in post-sleep3 period'], 1);
   
   A = registerResource(A, 'FRateSPWPreSleep1', 'numeric', dim_by_cell, ...
			'frate_spw_pre_sleep1', ...
			['firing rate in pre-sleep1 period',...
		    ' during sharp waves'], 1);
   
   A = registerResource(A, 'FRateSPWPostSleep3', 'numeric', dim_by_cell, ...
			'frate_spw_post_sleep3', ...
			['firing rate in post-sleep3 period',...
		    ' during sharp waves'], 1);
   ...
   A = registerResource(A, 'FRateNoSPWPostSleep3', 'numeric', dim_by_cell, ...
			'frate_no_spw_post_sleep3', ...
			['firing rate in post-sleep3 period',...
		    ' during inter sharp waves times'], 1);
  ...
  A = registerResource(A, 'X_S3S2', 'numeric', dim_by_cell, ...
		       'X_S3S2', ...
		       ['log ration of firing rate during sleep3', ...
		    ' and 2'], 1);
  
  A = registerResource(A, 'X_M2S2', 'numeric', dim_by_cell, ...
		       'X_M2S2', ...
		       ['log ration of firing rate during maze2', ...
		    ' and sleep 2'], 1);
  
  A = registerResource(A, 'X_M2S3', 'numeric', dim_by_cell, ...
		       'X_M2S3', ...
		       ['log ration of firing rate during maze2', ...
		    ' and sleep 3'], 1);
...
% $$$ 		    ' while sleeping over while still'], 1);
  ...
  spw_s2_2= intersect(Sleep2_2, SPW_s2);
  no_spw_s2_2 = Sleep2 - spw_s2_2;

  SPW_s3 = spw_s3;
  spw_s3= intersect(Sleep3, SPW_s3);
  no_spw_s3 = Sleep3 - spw_s3;
  
  

  frate_maze = (mapArray(S, 'AO = rate(TSA, %1);', Maze));
  frate_maze2 = (mapArray(S, 'AO = rate(TSA, %1);', Maze2));
...
% $$$   frate_maze_reward = (mapArray(S, 'AO = rate(TSA, %1);', reward));
  ...
  frate_sleep2_2 = (mapArray(S, 'AO = rate(TSA, %1);', Sleep2_2));
  frate_sleep3 = (mapArray(S, 'AO = rate(TSA, %1);', Sleep3));
  ...
  frate_spw_sleep2_2 = (mapArray(S, 'AO = rate(TSA, %1);', spw_s2_2));    
  frate_no_spw_sleep2_2 = (mapArray(S, 'AO = rate(TSA, %1);', no_spw_s2_2));
  frate_spw_sleep3 = (mapArray(S, 'AO = rate(TSA, %1);', spw_s3));    
  frate_no_spw_sleep3 = (mapArray(S, 'AO = rate(TSA, %1);', no_spw_s3));

  
  spw_s1= intersect(PreSleep1, SPW_s1);
  no_spw_s1 = PreSleep1 - spw_s1;
   
  spw_s3= intersect(PostSleep3, SPW_s3);
  no_spw_s3 = PostSleep3 - spw_s3;

  
  frate_pre_sleep1 = (mapArray(S, 'AO = rate(TSA, %1);', PreSleep1));
  frate_post_sleep3 = (mapArray(S, 'AO = rate(TSA, %1);', PostSleep3));
  frate_spw_pre_sleep1 = (mapArray(S, 'AO = rate(TSA, %1);', spw_s1));
  frate_no_spw_pre_sleep1 = (mapArray(S, 'AO = rate(TSA, %1);', no_spw_s1));  
  frate_spw_post_sleep3 = (mapArray(S, 'AO = rate(TSA, %1);', spw_s3));    
  frate_no_spw_post_sleep3 = (mapArray(S, 'AO = rate(TSA, %1);', no_spw_s3));
...
% $$$ 			'TSO = realign(TSA, ''ZeroFirst'', 1);');
  ...
  X_M2S2 = log10((frate_maze2) ./ (frate_sleep2_2)); 
  X_M2S3 = log10((frate_maze2) ./ (frate_sleep3)); 
  X_S2S1 = log10((frate_sleep2) ./ (frate_sleep1));
  X_S3S2 = log10((frate_sleep3) ./ (frate_sleep2_2));
