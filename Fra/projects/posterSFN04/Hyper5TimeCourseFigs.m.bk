...
% $$$     pyr = find(pyr);
    ...
    [A, frate_postsleep2] = getResource(A, 'FRateSleep2_2', dsets);  
  ...
  if do_fig_split
    ...
    dsets = { List2Cell('/home/fpbatta/Data/Hyper5/dirs_BD1_empty.list'), ...
	      List2Cell('/home/fpbatta/Data/Hyper5/dirs_BD1_full.list') };
    sfx = { '_empty', '_full'};
    ...
    fig_spl.figureName = 'Hyper5TimeCourse';
