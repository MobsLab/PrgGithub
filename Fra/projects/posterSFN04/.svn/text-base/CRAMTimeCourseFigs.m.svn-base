function fig_st = CRAMTimeCourseFigs()
...
dsets = List2Cell('/home/fpbatta/Data/CRAM/dirs_CRAM.list');
  ...
  if do_fig_split
    ...
    dsets = { List2Cell('/home/fpbatta/Data/CRAM/dirs_BD1_empty.list'), ...
	      List2Cell('/home/fpbatta/Data/CRAM/dirs_BD1_full.list') };
    sfx = { '_empty', '_full'};
    ...
    fig_spl.figureName = 'CRAMTimeCourseEmptyFull';
