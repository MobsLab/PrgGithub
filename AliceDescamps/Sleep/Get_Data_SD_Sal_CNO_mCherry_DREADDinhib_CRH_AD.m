...
% Dir_ctrl = PathForExperiments_SleepPostSD_AD('SleepPostSD_inhibDREADD_CRH_VLPO_CNOInjection_10am');
...
% DirSocialDefeat_totSleepPost_mCherry_cno = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_inhibDREADD_CRH_VLPO_SalineInjection_10am');
% DirSocialDefeat_totSleepPost_mCherry_cno =PathForExperiments_SleepPostSD_AD('SleepPostSD_inhibDREADD_CRH_VLPO_CNOInjection_10am');
...
%%1
Dir_ctrl= PathForExperiments_DREADD_AD ('mCherry_CRH_VLPO_SalineInjection_10am');
% Dir_ctrl= PathForExperiments_DREADD_AD ('mCherry_CRH_VLPO_CNOInjection_10am');

%%2
DirSocialDefeat_classic = PathForExperiments_DREADD_AD('mCherry_CRH_VLPO_CNOInjection_10am');
% DirSocialDefeat_classic = PathForExperiments_DREADD_AD('mCherry_CRH_VLPO_CNOInjection_1mgkg_10am');

%%3
DirSocialDefeat_totSleepPost_mCherry_cno = PathForExperiments_DREADD_AD('mCherry_CRH_VLPO_CNOInjection_1mgkg_10am');

%%4
DirSocialDefeat_totSleepPost_dreadd_cno =PathForExperiments_DREADD_AD('mCherry_CRH_VLPO_CNOInjection_1mgkg_10am');
%% Comparison MC and AD
% 
% %%1
...
% Dir_ctrl = MergePathForExperiment(DirSocialDefeat_classic1,DirSocialDefeat_mCherry_saline);
% Dir_ctrl=RestrictPathForExperiment(Dir_ctrl,'nMice',[1148 1149 1150 1217 1218 1219 1415 1416 1437]);
% 
% %%2
% DirSocialDefeat_classic1 = PathForExperiments_SD_MC('SleepPostSD');
% DirSocialDefeat_mCherry_saline1 = PathForExperiments_SD_MC('SleepPostSD_mCherry_retroCre_PFC_VLPO_SalineInjection');
...
% DirSocialDefeat_classic=RestrictPathForExperiment(DirSocialDefeat_classic,'nMice',[1449 1450]);
% 
% %%3
...
% DirSocialDefeat_totSleepPost_mCherry_cno = RestrictPathForExperiment(DirSocialDefeat_totSleepPost_mCherry_cno,'nMice',[1433 1434 1435 1439 1440 1417 1418 1448]);
% 
% %%4
% DirSocialDefeat_totSleepPost_mCherry_cno1 = PathForExperiments_SD_MC('SleepPostSD_mCherry_retroCre_PFC_VLPO_CNOInjection');
% DirSocialDefeat_totSleepPost_BM_cno1 = PathForExperiments_SD_MC('SleepPostSD_noDREADD_BM_mice_CNOInjection');
% DirSocialDefeat_totSleepPost_dreadd_cno = MergePathForExperiment(DirSocialDefeat_totSleepPost_mCherry_cno1,DirSocialDefeat_totSleepPost_BM_cno1);
% DirSocialDefeat_totSleepPost_dreadd_cno = RestrictPathForExperiment(DirSocialDefeat_totSleepPost_dreadd_cno,'nMice',[1423 1424 1426]);

%% Comparison C57 and CRH after stress
% %%1
% DirSocialDefeat_classic1 = PathForExperiments_SD_MC('SleepPostSD');
% DirSocialDefeat_mCherry_saline1 = PathForExperiments_SD_MC('SleepPostSD_mCherry_retroCre_PFC_VLPO_SalineInjection');
% DirSocialDefeat_BM_saline1 = PathForExperiments_SD_MC('SleepPostSD_noDREADD_BM_mice_SalineInjection');
...
% DirSocialDefeat_totSleepPost_mCherry_cno1 = PathForExperiments_SD_MC('SleepPostSD_mCherry_retroCre_PFC_VLPO_CNOInjection');
% DirSocialDefeat_totSleepPost_BM_cno1 = PathForExperiments_SD_MC('SleepPostSD_noDREADD_BM_mice_CNOInjection');
% DirSocialDefeat_classic = MergePathForExperiment(DirSocialDefeat_totSleepPost_mCherry_cno1,DirSocialDefeat_totSleepPost_BM_cno1);
% 
% %%3
% DirSocialDefeat_totSleepPost_mCherry_cno = PathForExperiments_SleepPostSD_AD('SleepPostSD_mCherry_CRH_VLPO_SalineInjection_10am');
% 
% %%4
% DirSocialDefeat_totSleepPost_dreadd_cno =PathForExperiments_SleepPostSD_AD('SleepPostSD_mCherry_CRH_VLPO_CNOInjection_10am');
...
time_mid_end_first_period = 1.5*3600*1e4; %1.5         %1.5 first hours (insomnia) (MC param)
% time_mid_end_first_period = 2*3600*1e4; %2             %2 first hours (insomnia)
% time_mid_end_first_period = 2.5*3600*1e4; %2.5         %2.5 first hours (insomnia)
% time_mid_end_first_period = 3*3600*1e4; %3             %3 first hours (insomnia)
% time_mid_end_first_period = 3.5*3600*1e4; %3.5               %3.5 first hours (insomnia)

time_mid_begin_snd_period = 3.3*3600*1e4; %3.3             %2 last hours(late phase of the night) (MC param)
% time_mid_begin_snd_period = 6*3600*1e4; %6             %2 last hours(late phase of the night)
% time_mid_begin_snd_period = 5.5*3600*1e4; %6.5         %2 last hours(late phase of the night)
% time_mid_begin_snd_period = 6.5*3600*1e4; %6.5         %2 last hours(late phase of the night)
