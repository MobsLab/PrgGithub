...
% col_ctrl = [.7 .7 .7];
% col_SD = [1 .4 0];
% col_SD_mCherry_cno = [1 .2 0];
% col_SD_dreadd_cno = [0 .4 .4];

%CNO dose
col_ctrl = [.7 .7 .7];
col_SD = [0 .2 .6];
col_SD_mCherry_cno = [0 .6 .8];
col_SD_dreadd_cno = [0 .6 .8];

%comparison MC/AD
% col_ctrl = [1 .4 0];
% col_SD = [1 .2 0];
% col_SD_mCherry_cno = [0 .6 .4];
% col_SD_dreadd_cno = [0 .4 .4];
...
plot(nanmean(data_perc_WAKE_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_perc_WAKE_SD_dreadd_cno), stdError(data_perc_WAKE_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
...
plot(nanmean(data_num_WAKE_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_num_WAKE_SD_dreadd_cno), stdError(data_num_WAKE_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
...
plot(nanmean(data_dur_WAKE_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_dur_WAKE_SD_dreadd_cno), stdError(data_dur_WAKE_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
...
plot(nanmean(data_perc_SWS_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_perc_SWS_SD_dreadd_cno), stdError(data_perc_SWS_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
ylim([0 100])
makepretty
...
plot(nanmean(data_num_SWS_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_num_SWS_SD_dreadd_cno), stdError(data_num_SWS_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
...
plot(nanmean(data_dur_SWS_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_dur_SWS_SD_dreadd_cno), stdError(data_dur_SWS_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
...
plot(nanmean(data_perc_REM_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_perc_REM_SD_dreadd_cno), stdError(data_perc_REM_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
...
plot(nanmean(data_num_REM_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_num_REM_SD_dreadd_cno), stdError(data_num_REM_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
...
plot(nanmean(data_dur_REM_SD_dreadd_cno),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_SD_dreadd_cno,'color',col_SD_dreadd_cno)
errorbar(nanmean(data_dur_REM_SD_dreadd_cno), stdError(data_dur_REM_SD_dreadd_cno),'LineWidth',2,'color',col_SD_dreadd_cno)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
