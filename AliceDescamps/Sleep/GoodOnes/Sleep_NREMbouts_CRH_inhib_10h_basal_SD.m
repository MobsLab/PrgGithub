...
subplot(4,6,[13,14]) % NREM bouts number ovetime
...
plot(nanmean(data_num_SWS_SD,1),'linestyle','-','marker','^','markerfacecolor',col_3,'markersize',8,'color',col_3)
errorbar(nanmean(data_num_SWS_SD,1), stdError(data_num_SWS_SD),'linestyle','-','color',col_3)
plot(nanmean(data_num_SWS_SD_dreadd_cno),'linestyle','-','marker','o','markersize',8,'markerfacecolor',col_4,'color',col_4)
errorbar(nanmean(data_num_SWS_SD_dreadd_cno), stdError(data_num_SWS_SD_dreadd_cno),'color',col_4)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'10','12','14','16','18'})
makepretty
...
PlotErrorBarN_MC({...
    nanmean(data_num_SWS_1_3h_ctrl,2), nanmean(data_num_SWS_1_3h_SD_mCherry_cno,2), nanmean(data_num_SWS_1_3h_SD,2), nanmean(data_num_SWS_1_3h_SD_dreadd_cno,2),...
    nanmean(data_num_SWS_3_end_ctrl,2), nanmean(data_num_SWS_3_end_SD_mCherry_cno,2), nanmean(data_num_SWS_3_end_SD,2), nanmean(data_num_SWS_3_end_SD_dreadd_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4,6:9],'barcolors',{col_1,col_2,col_3,col_4,col_1,col_2,col_3,col_4});
xticks([2.5 7.5]); xticklabels({'10-13h','13-18h'}); xtickangle(0)
% title('NREM bouts number')
makepretty
...
% [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_num_SWS_1_3h_ctrl,2), nanmean(data_num_SWS_1_3h_SD_mCherry_cno,2));
[p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_num_SWS_1_3h_ctrl,2), nanmean(data_num_SWS_1_3h_SD_mCherry_cno,2));
...
[p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_num_SWS_1_3h_SD_mCherry_cno,2), nanmean(data_num_SWS_1_3h_SD,2));
...
%4-8h
% [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_num_SWS_3_end_ctrl,2), nanmean(data_num_SWS_3_end_SD_mCherry_cno,2));
[p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_num_SWS_3_end_ctrl,2), nanmean(data_num_SWS_3_end_SD_mCherry_cno,2));
...
[p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_num_SWS_3_end_SD_mCherry_cno,2), nanmean(data_num_SWS_3_end_SD,2));
...
plot(nanmean(data_dur_SWS_SD,1),'linestyle','-','marker','^','markerfacecolor',col_3,'markersize',8,'color',col_3)
errorbar(nanmean(data_dur_SWS_SD,1), stdError(data_dur_SWS_SD),'linestyle','-','color',col_3)
plot(nanmean(data_dur_SWS_SD_dreadd_cno),'linestyle','-','marker','o','markersize',8,'markerfacecolor',col_4,'color',col_4)
errorbar(nanmean(data_dur_SWS_SD_dreadd_cno), stdError(data_dur_SWS_SD_dreadd_cno),'color',col_4)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'10','12','14','16','18'})
makepretty
...
PlotErrorBarN_MC({...
    nanmean(data_dur_SWS_1_3h_ctrl,2), nanmean(data_dur_SWS_1_3h_SD_mCherry_cno,2), nanmean(data_dur_SWS_1_3h_SD,2), nanmean(data_dur_SWS_1_3h_SD_dreadd_cno,2),...
    nanmean(data_dur_SWS_3_end_ctrl,2), nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2), nanmean(data_dur_SWS_3_end_SD,2), nanmean(data_dur_SWS_3_end_SD_dreadd_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4,6:9],'barcolors',{col_1,col_2,col_3,col_4,col_1,col_2,col_3,col_4});
xticks([2.5 7.5]); xticklabels({'10-13h','13-18h'}); xtickangle(0)
% title('NREM mean duration (s)')
makepretty
...
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_dur_SWS_1_3h_ctrl,2), nanmean(data_dur_SWS_1_3h_SD_mCherry_cno,2));
...
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_dur_SWS_1_3h_SD_mCherry_cno,2), nanmean(data_dur_SWS_1_3h_SD,2));
...
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_dur_SWS_3_end_ctrl,2), nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2));
...
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2), nanmean(data_dur_SWS_3_end_SD,2));
...
PlotErrorBarN_MC({...
    ...
    nanmean(data_num_SWS_3_end_SD,2)./nanmean(data_dur_SWS_3_end_SD,2),...
    nanmean(data_num_SWS_3_end_SD_dreadd_cno,2)./nanmean(data_dur_SWS_3_end_SD_dreadd_cno,2)},...
...
[h,p_ctrl_vs_mCherry_cno] = ttest2(nanmean(data_num_SWS_3_end_ctrl,2)./nanmean(data_dur_SWS_3_end_ctrl,2), nanmean(data_num_SWS_3_end_SD_mCherry_cno,2)./nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_num_SWS_3_end_ctrl,2)./nanmean(data_dur_SWS_3_end_ctrl,2), nanmean(data_num_SWS_3_end_SD_mCherry_cno,2)./nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2));
[h,p_ctrl_vs_SD] = ttest2(nanmean(data_num_SWS_3_end_ctrl,2)./nanmean(data_dur_SWS_3_end_ctrl,2), nanmean(data_num_SWS_3_end_SD,2)./nanmean(data_dur_SWS_3_end_SD,2));
% [p_ctrl_vs_SD,h] = ranksum(nanmean(data_num_SWS_3_end_ctrl,2)./nanmean(data_dur_SWS_3_end_ctrl,2), nanmean(data_num_SWS_3_end_SD,2)./nanmean(data_dur_SWS_3_end_SD,2));
[h,p_ctrl_vs_dreadd_cno] = ttest2(nanmean(data_num_SWS_3_end_ctrl,2)./nanmean(data_dur_SWS_3_end_ctrl,2),nanmean(data_num_SWS_3_end_SD_dreadd_cno,2)./nanmean(data_dur_SWS_3_end_SD_dreadd_cno,2));
% [p_ctrl_vs_dreadd_cno,h] = ranksum(nanmean(data_num_SWS_3_end_ctrl,2)./nanmean(data_dur_SWS_3_end_ctrl,2),nanmean(data_num_SWS_3_end_SD_dreadd_cno,2)./nanmean(data_dur_SWS_3_end_SD_dreadd_cno,2));
[h,p_mCherry_cno_vs_SD] = ttest2(nanmean(data_num_SWS_3_end_SD_mCherry_cno,2)./nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2), nanmean(data_num_SWS_3_end_SD,2)./nanmean(data_dur_SWS_3_end_SD,2));
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_num_SWS_3_end_SD_mCherry_cno,2)./nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2), nanmean(data_num_SWS_3_end_SD,2)./nanmean(data_dur_SWS_3_end_SD,2));
[h,p_mCherry_cno_vs_dreadd_cno] = ttest2(nanmean(data_num_SWS_3_end_SD_mCherry_cno,2)./nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2),nanmean(data_num_SWS_3_end_SD_dreadd_cno,2)./nanmean(data_dur_SWS_3_end_SD_dreadd_cno,2));
% [p_mCherry_cno_vs_dreadd_cno,h] = ranksum(nanmean(data_num_SWS_3_end_SD_mCherry_cno,2)./nanmean(data_dur_SWS_3_end_SD_mCherry_cno,2),nanmean(data_num_SWS_3_end_SD_dreadd_cno,2)./nanmean(data_dur_SWS_3_end_SD_dreadd_cno,2));
[h,p_SD_vs_dreadd_cno] = ttest2(nanmean(data_num_SWS_3_end_SD,2)./nanmean(data_dur_SWS_3_end_SD,2), nanmean(data_num_SWS_3_end_SD_dreadd_cno,2)./nanmean(data_dur_SWS_3_end_SD_dreadd_cno,2));
% [p_SD_vs_dreadd_cno,h] = ranksum(nanmean(data_num_SWS_3_end_SD,2)./nanmean(data_dur_SWS_3_end_SD,2), nanmean(data_num_SWS_3_end_SD_dreadd_cno,2)./nanmean(data_dur_SWS_3_end_SD_dreadd_cno,2));
...
PlotErrorBarN_MC({...
    ...
    1-(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_SWS_WAKE_3_end_SD,2)),...
    1-(nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_dreadd_cno,2))},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4],'barcolors',{col_1,col_2,col_3,col_4});
ylim([.96 1])
xticks([1:5]); xticklabels({}); xtickangle(0)
...
[h,p_ctrl_vs_mCherry_cno] = ttest2(1-(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2)), 1-(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2)));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(1-(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2)), 1-(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2)));
[h,p_ctrl_vs_SD] = ttest2(1-(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2)), 1-(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_SWS_WAKE_3_end_SD,2)));
% [p_ctrl_vs_SD,h] = ranksum(1-(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2)), 1-(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_SWS_WAKE_3_end_SD,2)));
[h,p_ctrl_vs_dreadd_cno] = ttest2(1-(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2)),1-(nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_dreadd_cno,2)));
% [p_ctrl_vs_dreadd_cno,h] = ranksum(1-(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2)),1-(nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_dreadd_cno,2)));
[h,p_mCherry_cno_vs_SD] = ttest2(1-(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2)), 1-(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_SWS_WAKE_3_end_SD,2)));
% [p_mCherry_cno_vs_SD,h] = ranksum(1-(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2)), 1-(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_SWS_WAKE_3_end_SD,2)));
[h,p_mCherry_cno_vs_dreadd_cno] = ttest2(1-(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2)), 1-(nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_dreadd_cno,2)));
% [p_mCherry_cno_vs_dreadd_cno,h] = ranksum(1-(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2)), 1-(nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_dreadd_cno,2)));
[h,p_SD_vs_dreadd_cno] = ttest2(1-(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_SWS_WAKE_3_end_SD,2)), 1-(nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_dreadd_cno,2)));
% [p_SD_vs_dreadd_cno,h] = ranksum(1-(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_SWS_WAKE_3_end_SD,2)), 1-(nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_dreadd_cno,2)));
...
PlotErrorBarN_MC({...
    ...
    nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_WAKE_SWS_3_end_SD,2),...
    nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_dreadd_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4],'barcolors',{col_1,col_2,col_3,col_4});
xticks([1:5]); xticklabels({}); xtickangle(0)
...
[h,p_ctrl_vs_mCherry_cno] = ttest2(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2), nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2), nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2));
[h,p_ctrl_vs_SD] = ttest2(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2), nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_WAKE_SWS_3_end_SD,2));
% [p_ctrl_vs_SD,h] = ranksum(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2), nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_WAKE_SWS_3_end_SD,2));
[h,p_ctrl_vs_dreadd_cno] = ttest2(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2),nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_dreadd_cno,2));
% [p_ctrl_vs_dreadd_cno,h] = ranksum(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2),nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_dreadd_cno,2));
[h,p_mCherry_cno_vs_SD] = ttest2(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2), nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_WAKE_SWS_3_end_SD,2));
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2), nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_WAKE_SWS_3_end_SD,2));
[h,p_mCherry_cno_vs_dreadd_cno] = ttest2(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2), nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_dreadd_cno,2));
% [p_mCherry_cno_vs_dreadd_cno,h] = ranksum(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2), nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_dreadd_cno,2));
[h,p_SD_vs_dreadd_cno] = ttest2(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_WAKE_SWS_3_end_SD,2), nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_dreadd_cno,2));
% [p_SD_vs_dreadd_cno,h] = ranksum(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_WAKE_SWS_3_end_SD,2), nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_dreadd_cno,2));
