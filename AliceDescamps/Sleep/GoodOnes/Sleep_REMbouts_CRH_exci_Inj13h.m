...
Dir_1=PathForExperiments_DREADD_MC('inhibDREADD_CRH_VLPO_SalineInjection_1pm');
%%2
% Dir_2=PathForExperiments_DREADD_MC('exciDREADD_CRH_VLPO_CNOInjection_1pm');
Dir_2=PathForExperiments_DREADD_MC('inhibDREADD_CRH_VLPO_CNOInjection_1pm');
...
if isparam ==0
    [p_1,h_1, stats] = ranksum(data_perc_WAKE_ctrl(:,1), data_perc_WAKE_SD_mCherry_cno(:,1));
    [p_2,h_2, stats] = ranksum(data_perc_WAKE_ctrl(:,2), data_perc_WAKE_SD_mCherry_cno(:,2));
    [p_3,h_3, stats] = ranksum(data_perc_WAKE_ctrl(:,3), data_perc_WAKE_SD_mCherry_cno(:,3));
    [p_4,h_4, stats] = ranksum(data_perc_WAKE_ctrl(:,4), data_perc_WAKE_SD_mCherry_cno(:,4));
    [p_5,h_5, stats] = ranksum(data_perc_WAKE_ctrl(:,5), data_perc_WAKE_SD_mCherry_cno(:,5));
    [p_6,h_6, stats] = ranksum(data_perc_WAKE_ctrl(:,6), data_perc_WAKE_SD_mCherry_cno(:,6));
    [p_7,h_7, stats] = ranksum(data_perc_WAKE_ctrl(:,7), data_perc_WAKE_SD_mCherry_cno(:,7));
    [p_8,h_8, stats] = ranksum(data_perc_WAKE_ctrl(:,8), data_perc_WAKE_SD_mCherry_cno(:,8));
    [p_9,h_9, stats] = ranksum(data_perc_WAKE_ctrl(:,9), data_perc_WAKE_SD_mCherry_cno(:,9));
elseif isparam ==1
    [h_1,p_1] = ttest2(data_perc_WAKE_ctrl(:,1), data_perc_WAKE_SD_mCherry_cno(:,1));
    [h_2,p_2] = ttest2(data_perc_WAKE_ctrl(:,2), data_perc_WAKE_SD_mCherry_cno(:,2));
    [h_3,p_3] = ttest2(data_perc_WAKE_ctrl(:,3), data_perc_WAKE_SD_mCherry_cno(:,3));
    [h_4,p_4] = ttest2(data_perc_WAKE_ctrl(:,4), data_perc_WAKE_SD_mCherry_cno(:,4));
    [h_5,p_5] = ttest2(data_perc_WAKE_ctrl(:,5), data_perc_WAKE_SD_mCherry_cno(:,5));
    [h_6,p_6] = ttest2(data_perc_WAKE_ctrl(:,6), data_perc_WAKE_SD_mCherry_cno(:,6));
    [h_7,p_7] = ttest2(data_perc_WAKE_ctrl(:,7), data_perc_WAKE_SD_mCherry_cno(:,7));
    [h_8,p_8] = ttest2(data_perc_WAKE_ctrl(:,8), data_perc_WAKE_SD_mCherry_cno(:,8));
    [h_9,p_9] = ttest2(data_perc_WAKE_ctrl(:,9), data_perc_WAKE_SD_mCherry_cno(:,9));
else
end
if iscorr ==0
...
elseif iscorr ==1
    ...
    p_values = [p_1 p_2 p_3 p_4 p_5 p_6 p_7 p_8 p_9];
...
if isparam ==0
    [p_1,h_1, stats] = ranksum(data_perc_SWS_ctrl(:,1), data_perc_SWS_SD_mCherry_cno(:,1));
    [p_2,h_2, stats] = ranksum(data_perc_SWS_ctrl(:,2), data_perc_SWS_SD_mCherry_cno(:,2));
    [p_3,h_3, stats] = ranksum(data_perc_SWS_ctrl(:,3), data_perc_SWS_SD_mCherry_cno(:,3));
    [p_4,h_4, stats] = ranksum(data_perc_SWS_ctrl(:,4), data_perc_SWS_SD_mCherry_cno(:,4));
    [p_5,h_5, stats] = ranksum(data_perc_SWS_ctrl(:,5), data_perc_SWS_SD_mCherry_cno(:,5));
    [p_6,h_6, stats] = ranksum(data_perc_SWS_ctrl(:,6), data_perc_SWS_SD_mCherry_cno(:,6));
    [p_7,h_7, stats] = ranksum(data_perc_SWS_ctrl(:,7), data_perc_SWS_SD_mCherry_cno(:,7));
    [p_8,h_8, stats] = ranksum(data_perc_SWS_ctrl(:,8), data_perc_SWS_SD_mCherry_cno(:,8));
    [p_9,h_9, stats] = ranksum(data_perc_SWS_ctrl(:,9), data_perc_SWS_SD_mCherry_cno(:,9));
elseif isparam ==1
    [h_1,p_1] = ttest2(data_perc_SWS_ctrl(:,1), data_perc_SWS_SD_mCherry_cno(:,1));
    [h_2,p_2] = ttest2(data_perc_SWS_ctrl(:,2), data_perc_SWS_SD_mCherry_cno(:,2));
    [h_3,p_3] = ttest2(data_perc_SWS_ctrl(:,3), data_perc_SWS_SD_mCherry_cno(:,3));
    [h_4,p_4] = ttest2(data_perc_SWS_ctrl(:,4), data_perc_SWS_SD_mCherry_cno(:,4));
    [h_5,p_5] = ttest2(data_perc_SWS_ctrl(:,5), data_perc_SWS_SD_mCherry_cno(:,5));
    [h_6,p_6] = ttest2(data_perc_SWS_ctrl(:,6), data_perc_SWS_SD_mCherry_cno(:,6));
    [h_7,p_7] = ttest2(data_perc_SWS_ctrl(:,7), data_perc_SWS_SD_mCherry_cno(:,7));
    [h_8,p_8] = ttest2(data_perc_SWS_ctrl(:,8), data_perc_SWS_SD_mCherry_cno(:,8));
    [h_9,p_9] = ttest2(data_perc_SWS_ctrl(:,9), data_perc_SWS_SD_mCherry_cno(:,9));
else
end
if iscorr ==0
    %%comparaisons multiples non corrigées
...
if isparam ==0
    [p_1,h_1, stats] = ranksum(data_perc_REM_ctrl(:,1), data_perc_REM_SD_mCherry_cno(:,1));
    [p_2,h_2, stats] = ranksum(data_perc_REM_ctrl(:,2), data_perc_REM_SD_mCherry_cno(:,2));
    [p_3,h_3, stats] = ranksum(data_perc_REM_ctrl(:,3), data_perc_REM_SD_mCherry_cno(:,3));
    [p_4,h_4, stats] = ranksum(data_perc_REM_ctrl(:,4), data_perc_REM_SD_mCherry_cno(:,4));
    [p_5,h_5, stats] = ranksum(data_perc_REM_ctrl(:,5), data_perc_REM_SD_mCherry_cno(:,5));
    [p_6,h_6, stats] = ranksum(data_perc_REM_ctrl(:,6), data_perc_REM_SD_mCherry_cno(:,6));
    [p_7,h_7, stats] = ranksum(data_perc_REM_ctrl(:,7), data_perc_REM_SD_mCherry_cno(:,7));
    [p_8,h_8, stats] = ranksum(data_perc_REM_ctrl(:,8), data_perc_REM_SD_mCherry_cno(:,8));
    [p_9,h_9, stats] = ranksum(data_perc_REM_ctrl(:,9), data_perc_REM_SD_mCherry_cno(:,9));
elseif isparam ==1
    [h_1,p_1] = ttest2(data_perc_REM_ctrl(:,1), data_perc_REM_SD_mCherry_cno(:,1));
    [h_2,p_2] = ttest2(data_perc_REM_ctrl(:,2), data_perc_REM_SD_mCherry_cno(:,2));
    [h_3,p_3] = ttest2(data_perc_REM_ctrl(:,3), data_perc_REM_SD_mCherry_cno(:,3));
    [h_4,p_4] = ttest2(data_perc_REM_ctrl(:,4), data_perc_REM_SD_mCherry_cno(:,4));
    [h_5,p_5] = ttest2(data_perc_REM_ctrl(:,5), data_perc_REM_SD_mCherry_cno(:,5));
    [h_6,p_6] = ttest2(data_perc_REM_ctrl(:,6), data_perc_REM_SD_mCherry_cno(:,6));
    [h_7,p_7] = ttest2(data_perc_REM_ctrl(:,7), data_perc_REM_SD_mCherry_cno(:,7));
    [h_8,p_8] = ttest2(data_perc_REM_ctrl(:,8), data_perc_REM_SD_mCherry_cno(:,8));
    [h_9,p_9] = ttest2(data_perc_REM_ctrl(:,9), data_perc_REM_SD_mCherry_cno(:,9));
else
end
if iscorr ==0
    %%comparaisons multiples non corrigées
...
subplot(4,6,[13,14]) % REM bouts number overtime
plot(nanmean(data_num_REM_ctrl),'linestyle','-','marker','square','markersize',8,'markerfacecolor',col_1,'color',col_1), hold on
errorbar(nanmean(data_num_REM_ctrl), stdError(data_num_REM_ctrl),'color',col_1)
plot(nanmean(data_num_REM_SD_mCherry_cno),'linestyle','-','marker','^','markersize',8,'markerfacecolor',col_2,'color',col_2), hold on
errorbar(nanmean(data_num_REM_SD_mCherry_cno), stdError(data_num_REM_SD_mCherry_cno),'color',col_2)
xlim([0 9.5])
xticks([1 3 5 7 9]); xticklabels({'9','11','13','15','17'})
% makepretty
...
if isparam ==0
    [p_1,h_1, stats] = ranksum(data_num_REM_ctrl(:,1), data_num_REM_SD_mCherry_cno(:,1));
    [p_2,h_2, stats] = ranksum(data_num_REM_ctrl(:,2), data_num_REM_SD_mCherry_cno(:,2));
    [p_3,h_3, stats] = ranksum(data_num_REM_ctrl(:,3), data_num_REM_SD_mCherry_cno(:,3));
    [p_4,h_4, stats] = ranksum(data_num_REM_ctrl(:,4), data_num_REM_SD_mCherry_cno(:,4));
    [p_5,h_5, stats] = ranksum(data_num_REM_ctrl(:,5), data_num_REM_SD_mCherry_cno(:,5));
    [p_6,h_6, stats] = ranksum(data_num_REM_ctrl(:,6), data_num_REM_SD_mCherry_cno(:,6));
    [p_7,h_7, stats] = ranksum(data_num_REM_ctrl(:,7), data_num_REM_SD_mCherry_cno(:,7));
    [p_8,h_8, stats] = ranksum(data_num_REM_ctrl(:,8), data_num_REM_SD_mCherry_cno(:,8));
    [p_9,h_9, stats] = ranksum(data_num_REM_ctrl(:,9), data_num_REM_SD_mCherry_cno(:,9));
elseif isparam ==1
    [h_1,p_1] = ttest2(data_num_REM_ctrl(:,1), data_num_REM_SD_mCherry_cno(:,1));
    [h_2,p_2] = ttest2(data_num_REM_ctrl(:,2), data_num_REM_SD_mCherry_cno(:,2));
    [h_3,p_3] = ttest2(data_num_REM_ctrl(:,3), data_num_REM_SD_mCherry_cno(:,3));
    [h_4,p_4] = ttest2(data_num_REM_ctrl(:,4), data_num_REM_SD_mCherry_cno(:,4));
    [h_5,p_5] = ttest2(data_num_REM_ctrl(:,5), data_num_REM_SD_mCherry_cno(:,5));
    [h_6,p_6] = ttest2(data_num_REM_ctrl(:,6), data_num_REM_SD_mCherry_cno(:,6));
    [h_7,p_7] = ttest2(data_num_REM_ctrl(:,7), data_num_REM_SD_mCherry_cno(:,7));
    [h_8,p_8] = ttest2(data_num_REM_ctrl(:,8), data_num_REM_SD_mCherry_cno(:,8));
    [h_9,p_9] = ttest2(data_num_REM_ctrl(:,9), data_num_REM_SD_mCherry_cno(:,9));
else
end
if iscorr ==0
    %%comparaisons multiples non corrigées
...
PlotErrorBarN_MC({...
    nanmean(data_num_REM_1_3h_ctrl,2), nanmean(data_num_REM_1_3h_SD_mCherry_cno,2),...
    nanmean(data_num_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:2,4:5],'barcolors',{col_1,col_2,col_1,col_2});
xticks([1.5 4.5]); xticklabels({'9-13h','13-18h'}); xtickangle(0)
...
%Stat REM number
% [h,p_sal_vs_cno_REM_number_1_3h] = ttest(nanmean(data_num_REM_1_3h_ctrl,2), nanmean(data_num_REM_1_3h_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_REM_number_1_3h] = ttest2(nanmean(data_num_REM_1_3h_ctrl,2), nanmean(data_num_REM_1_3h_SD_mCherry_cno,2));
[p_sal_vs_cno_REM_number_1_3h,h] = signrank(nanmean(data_num_REM_1_3h_ctrl,2), nanmean(data_num_REM_1_3h_SD_mCherry_cno,2));
% [p_sal_vs_cno_REM_number_1_3h,h] = ranksum(nanmean(data_num_REM_1_3h_ctrl,2), nanmean(data_num_REM_1_3h_SD_mCherry_cno,2));

% [h,p_sal_vs_cno_REM_number_3_end] = ttest(nanmean(data_num_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_REM_number_3_end] = ttest2(nanmean(data_num_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2));
[p_sal_vs_cno_REM_number_3_end,h] = signrank(nanmean(data_num_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_REM_number_3_end,h] = ranksum(nanmean(data_num_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2));

if p_sal_vs_cno_REM_number_1_3h<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_REM_number_1_3h,0,'LineWigth',16,'StarSize',24); end
if p_sal_vs_cno_REM_number_3_end<0.05; sigstar_DB({[4 5]},p_sal_vs_cno_REM_number_3_end,0,'LineWigth',16,'StarSize',24);end


subplot(4,6,[15,16]) % REM bouts mean duraion overtime
plot(nanmean(data_dur_REM_ctrl),'linestyle','-','marker','square','markersize',8,'markerfacecolor',col_1,'color',col_1), hold on
errorbar(nanmean(data_dur_REM_ctrl), stdError(data_dur_REM_ctrl),'color',col_1)
plot(nanmean(data_dur_REM_SD_mCherry_cno),'linestyle','-','marker','^','markersize',8,'markerfacecolor',col_2,'color',col_2), hold on
errorbar(nanmean(data_dur_REM_SD_mCherry_cno), stdError(data_dur_REM_SD_mCherry_cno),'color',col_2)
xlim([0 9.5])
xticks([1 3 5 7 9]); xticklabels({'9','11','13','15','17'})
% makepretty
title('REM mean duration (s)')
xlabel('Time of the day (h)')

%%stats REM dur overtime
if isparam ==0
    [p_1,h_1, stats] = ranksum(data_dur_REM_ctrl(:,1), data_dur_REM_SD_mCherry_cno(:,1));
    [p_2,h_2, stats] = ranksum(data_dur_REM_ctrl(:,2), data_dur_REM_SD_mCherry_cno(:,2));
    [p_3,h_3, stats] = ranksum(data_dur_REM_ctrl(:,3), data_dur_REM_SD_mCherry_cno(:,3));
    [p_4,h_4, stats] = ranksum(data_dur_REM_ctrl(:,4), data_dur_REM_SD_mCherry_cno(:,4));
    [p_5,h_5, stats] = ranksum(data_dur_REM_ctrl(:,5), data_dur_REM_SD_mCherry_cno(:,5));
    [p_6,h_6, stats] = ranksum(data_dur_REM_ctrl(:,6), data_dur_REM_SD_mCherry_cno(:,6));
    [p_7,h_7, stats] = ranksum(data_dur_REM_ctrl(:,7), data_dur_REM_SD_mCherry_cno(:,7));
    [p_8,h_8, stats] = ranksum(data_dur_REM_ctrl(:,8), data_dur_REM_SD_mCherry_cno(:,8));
    [p_9,h_9, stats] = ranksum(data_dur_REM_ctrl(:,9), data_dur_REM_SD_mCherry_cno(:,9));
elseif isparam ==1
    [h_1,p_1] = ttest2(data_dur_REM_ctrl(:,1), data_dur_REM_SD_mCherry_cno(:,1));
    [h_2,p_2] = ttest2(data_dur_REM_ctrl(:,2), data_dur_REM_SD_mCherry_cno(:,2));
    [h_3,p_3] = ttest2(data_dur_REM_ctrl(:,3), data_dur_REM_SD_mCherry_cno(:,3));
    [h_4,p_4] = ttest2(data_dur_REM_ctrl(:,4), data_dur_REM_SD_mCherry_cno(:,4));
    [h_5,p_5] = ttest2(data_dur_REM_ctrl(:,5), data_dur_REM_SD_mCherry_cno(:,5));
    [h_6,p_6] = ttest2(data_dur_REM_ctrl(:,6), data_dur_REM_SD_mCherry_cno(:,6));
    [h_7,p_7] = ttest2(data_dur_REM_ctrl(:,7), data_dur_REM_SD_mCherry_cno(:,7));
    [h_8,p_8] = ttest2(data_dur_REM_ctrl(:,8), data_dur_REM_SD_mCherry_cno(:,8));
    [h_9,p_9] = ttest2(data_dur_REM_ctrl(:,9), data_dur_REM_SD_mCherry_cno(:,9));
else
end
if iscorr ==0
    %%comparaisons multiples non corrigées
...
subplot(4,6,[21,22]) % REM bouts mean duration quantif barplot
PlotErrorBarN_MC({...
    nanmean(data_dur_REM_1_3h_ctrl,2), nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2),...
    nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_dur_REM_3_end_SD_mCherry_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:2,4:5],'barcolors',{col_1,col_2,col_1,col_2});
xticks([1.5 4.5]); xticklabels({'9-13h','13-18h'}); xtickangle(0)
...
%Stat REM duration
[h,p_sal_vs_cno_REM_dur_1_3h] = ttest(nanmean(data_dur_REM_1_3h_ctrl,2), nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_REM_dur_1_3h] = ttest2(nanmean(data_dur_REM_1_3h_ctrl,2), nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2));
% [p_sal_vs_cno_REM_dur_1_3h,h] = signrank(nanmean(data_dur_REM_1_3h_ctrl,2), nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2));
% [p_sal_vs_cno_REM_dur_1_3h,h] = ranksum(nanmean(data_dur_REM_1_3h_ctrl,2), nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2));

[h,p_sal_vs_cno_REM_dur_3_end] = ttest(nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_REM_dur_3_end] = ttest2(nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_REM_dur_3_end,h] = signrank(nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_REM_dur_3_end,h] = ranksum(nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));

if p_sal_vs_cno_REM_dur_1_3h<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_REM_dur_1_3h,0,'LineWigth',16,'StarSize',24); end
if p_sal_vs_cno_REM_dur_3_end<0.05; sigstar_DB({[4 5]},p_sal_vs_cno_REM_dur_3_end,0,'LineWigth',16,'StarSize',24);end


subplot(4,6,[17]) % FI REM (5-8h)
PlotErrorBarN_MC({...
    nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2),...
    nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:2],'barcolors',{col_1,col_2});
title('REM fragmentation index')
...
%Stat REM FI
% [h,p_sal_vs_cno_REM_FI_3_end] = ttest(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_REM_FI_3_end] = ttest2(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
[p_sal_vs_cno_REM_FI_3_end,h] = signrank(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_REM_FI_3_end,h] = ranksum(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));

if p_sal_vs_cno_REM_FI_3_end<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_REM_FI_3_end,0,'LineWigth',16,'StarSize',24);end


subplot(4,6,[23]) %proba stay REM_4-8h
PlotErrorBarN_MC({...
    1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)),...
    1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2))},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:2],'barcolors',{col_1,col_2});
ylim([.96 1])
xlabel('Time of the day (h)')
title('REM stay probability')
xticks([1.5]); xticklabels({'13-18h'}); xtickangle(0)
% makepretty
set(gca,'xtick',[])

%Stat REM proba stay
% [h,p_sal_vs_cno_REM_proba_stay_3_end] = ttest(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)), 1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)));
% [h,p_sal_vs_cno_REM_proba_stay_3_end] = ttest2(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)),1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)));
[p_sal_vs_cno_REM_proba_stay_3_end,h] = signrank(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)), 1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)));
% [p_sal_vs_cno_REM_proba_stay_3_end,h] = ranksum(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)), 1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)));

if p_sal_vs_cno_REM_proba_stay_3_end<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_REM_proba_stay_3_end,0,'LineWigth',16,'StarSize',24);end


subplot(4,6,[24]) %proba initiate REM 4-8h
PlotErrorBarN_MC({...
    nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2),...
    nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:2],'barcolors',{col_1,col_2});
xticks([1.5]); xticklabels({'13-18h'}); xtickangle(0)
xlabel('Time of the day (h)')
title('REM init. probability')
% makepretty
set(gca,'xtick',[])

%Stat REM proba initiate
% [h,p_sal_vs_cno_REM_proba_init_3_end] = ttest(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2), nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_REM_proba_init_3_end] = ttest2(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2), nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2));
[p_sal_vs_cno_REM_proba_init_3_end,h] = signrank(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2), nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_REM_proba_init_3_end,h] = ranksum(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2), nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2));

if p_sal_vs_cno_REM_proba_init_3_end<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_REM_proba_init_3_end,0,'LineWigth',16,'StarSize',24);end
