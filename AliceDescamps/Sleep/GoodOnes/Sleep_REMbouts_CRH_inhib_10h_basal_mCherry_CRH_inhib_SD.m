...
% Dir_1 = MergePathForExperiment(Dir_inhib,Dir_mCherry);
% Dir_1 = PathForExperiments_SleepPostSD_AD('SleepPostSD_mCherry_CRH_VLPO_SalineInjection_10am');
...
% Dir_2 = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_inhibDREADD_CRH_VLPO_SalineInjection_10am');
...
% Dir_3 = PathForExperiments_DREADD_AD('inhibDREADD_CRH_VLPO_SalineInjection_10am');
% Dir_3 = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_inhibDREADD_CRH_VLPO_SalineInjection_10am');
% Dir_3 = PathForExperiments_DREADD_AD('inhibDREADD_CRH_VLPO_CNOInjection_10am');
...
% Dir_4 = PathForExperiments_DREADD_AD('inhibDREADD_CRH_VLPO_CNOInjection_10am');
% Dir_4 = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_inhibDREADD_CRH_VLPO_CNOInjection_10am');
...
% xlabel('Time of the day (h)')
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_perc_WAKE_1_3h_ctrl,2), nanmean(data_perc_WAKE_1_3h_SD_mCherry_cno,2));
...
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_perc_WAKE_3_end_ctrl,2), nanmean(data_perc_WAKE_3_end_SD_mCherry_cno,2));
...
% 
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_perc_SWS_1_3h_ctrl,2), nanmean(data_perc_SWS_1_3h_SD_mCherry_cno,2));
...
% if p_SD_vs_dreadd_cno<0.05; sigstar_DB({[3 4]},p_SD_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24);end
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_perc_SWS_3_end_ctrl,2), nanmean(data_perc_SWS_3_end_SD_mCherry_cno,2));
...
% xlabel('Time of the day (h)')
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_perc_REM_1_3h_ctrl,2), nanmean(data_perc_REM_1_3h_SD_mCherry_cno,2));
...
% if p_SD_vs_dreadd_cno<0.05; sigstar_DB({[3 4]},p_SD_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24);end
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_perc_REM_3_end_ctrl,2), nanmean(data_perc_REM_3_end_SD_mCherry_cno,2));
...
plot(nanmean(data_num_REM_SD,1),'linestyle','-','marker','^','markerfacecolor',col_3,'markersize',8,'color',col_3)
errorbar(nanmean(data_num_REM_SD,1), stdError(data_num_REM_SD),'linestyle','-','color',col_3)
plot(nanmean(data_num_REM_SD_dreadd_cno),'linestyle','-','marker','o','markersize',8,'markerfacecolor',col_4,'color',col_4)
errorbar(nanmean(data_num_REM_SD_dreadd_cno), stdError(data_num_REM_SD_dreadd_cno),'color',col_4)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'10','12','14','16','18'})
makepretty
...
% PlotErrorBarN_MC({...
%     nanmean(data_num_REM_1_3h_ctrl,2), nanmean(data_num_REM_1_3h_SD_mCherry_cno,2), nanmean(data_num_REM_1_3h_SD,2), nanmean(data_num_REM_1_3h_SD_dreadd_cno,2),...
%     nanmean(data_num_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2), nanmean(data_num_REM_3_end_SD,2), nanmean(data_num_REM_3_end_SD_dreadd_cno,2)},...
%     'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4,6:9],'barcolors',{col_1,col_2,col_3,col_4,col_1,col_2,col_3,col_4});
% xticks([2.5 7.5]); xticklabels({'10-13h','13-18h'}); xtickangle(0)
% % title('REM bouts number')
% makepretty
% xlabel('Time of the day (h)')
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_num_REM_1_3h_ctrl,2), nanmean(data_num_REM_1_3h_SD_mCherry_cno,2));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_num_REM_1_3h_ctrl,2), nanmean(data_num_REM_1_3h_SD_mCherry_cno,2));
...
% % [h,p_mCherry_cno_vs_SD] = ttest2(nanmean(data_num_REM_1_3h_SD_mCherry_cno,2), nanmean(data_num_REM_1_3h_SD,2));
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_num_REM_1_3h_SD_mCherry_cno,2), nanmean(data_num_REM_1_3h_SD,2));
...
% 
% %4-8h
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_num_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_num_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2));
...
% % [h,p_mCherry_cno_vs_SD] = ttest2(nanmean(data_num_REM_3_end_SD_mCherry_cno,2), nanmean(data_num_REM_3_end_SD,2));
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_num_REM_3_end_SD_mCherry_cno,2), nanmean(data_num_REM_3_end_SD,2));
...
plot(nanmean(data_dur_REM_SD,1),'linestyle','-','marker','^','markerfacecolor',col_3,'markersize',8,'color',col_3)
errorbar(nanmean(data_dur_REM_SD,1), stdError(data_dur_REM_SD),'linestyle','-','color',col_3)
plot(nanmean(data_dur_REM_SD_dreadd_cno),'linestyle','-','marker','o','markersize',8,'markerfacecolor',col_4,'color',col_4)
errorbar(nanmean(data_dur_REM_SD_dreadd_cno), stdError(data_dur_REM_SD_dreadd_cno),'color',col_4)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'10','12','14','16','18'})
makepretty
...
% PlotErrorBarN_MC({...
%     nanmean(data_dur_REM_1_3h_ctrl,2), nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2), nanmean(data_dur_REM_1_3h_SD,2), nanmean(data_dur_REM_1_3h_SD_dreadd_cno,2),...
%     nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_dur_REM_3_end_SD_mCherry_cno,2), nanmean(data_dur_REM_3_end_SD,2), nanmean(data_dur_REM_3_end_SD_dreadd_cno,2)},...
%     'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4,6:9],'barcolors',{col_1,col_2,col_3,col_4,col_1,col_2,col_3,col_4});
% xticks([2.5 7.5]); xticklabels({'10-13h','13-18h'}); xtickangle(0)
% % title('REM mean duration (s)')
% makepretty
% xlabel('Time of the day (h)')
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_dur_REM_1_3h_ctrl,2), nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_dur_REM_1_3h_ctrl,2), nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2));
...
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_dur_REM_1_3h_SD_mCherry_cno,2), nanmean(data_dur_REM_1_3h_SD,2));
...
% if p_SD_vs_dreadd_cno<0.05; sigstar_DB({[3 4]},p_SD_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24);end
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
...
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_dur_REM_3_end_SD_mCherry_cno,2), nanmean(data_dur_REM_3_end_SD,2));
...
% if p_mCherry_cno_vs_SD<0.05; sigstar_DB({[7 8]},p_mCherry_cno_vs_SD,0,'LineWigth',16,'StarSize',24);end
% if p_mCherry_cno_vs_dreadd_cno<0.05; sigstar_DB({[7 9]},p_mCherry_cno_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24);end
% % if p_mCherry_cno_vs_dreadd_cno<0.05; sigstar_DB({[7 9]},p_mCherry_cno_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24);else sigstar_DB({[8 9]},p_mCherry_cno_vs_dreadd_cno,0,'LineWigth',16,'StarSize',12);end
% if p_SD_vs_dreadd_cno<0.05; sigstar_DB({[8 9]},p_SD_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24);end
...
%     nanmean(data_num_REM_3_end_SD,2)./nanmean(data_dur_REM_3_end_SD,2),...
%     nanmean(data_num_REM_3_end_SD_dreadd_cno,2)./nanmean(data_dur_REM_3_end_SD_dreadd_cno,2)},...
...
% xlabel('Time of the day (h)')
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2));
% % [h,p_ctrl_vs_SD] = ttest2(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD,2)./nanmean(data_dur_REM_3_end_SD,2));
% [p_ctrl_vs_SD,h] = ranksum(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2), nanmean(data_num_REM_3_end_SD,2)./nanmean(data_dur_REM_3_end_SD,2));
% % [h,p_ctrl_vs_dreadd_cno] = ttest2(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2),nanmean(data_num_REM_3_end_SD_dreadd_cno,2)./nanmean(data_dur_REM_3_end_SD_dreadd_cno,2));
% [p_ctrl_vs_dreadd_cno,h] = ranksum(nanmean(data_num_REM_3_end_ctrl,2)./nanmean(data_dur_REM_3_end_ctrl,2),nanmean(data_num_REM_3_end_SD_dreadd_cno,2)./nanmean(data_dur_REM_3_end_SD_dreadd_cno,2));
% % [h,p_mCherry_cno_vs_SD] = ttest2(nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2), nanmean(data_num_REM_3_end_SD,2)./nanmean(data_dur_REM_3_end_SD,2));
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2), nanmean(data_num_REM_3_end_SD,2)./nanmean(data_dur_REM_3_end_SD,2));
% % [h,p_mCherry_cno_vs_dreadd_cno] = ttest2(nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2),nanmean(data_num_REM_3_end_SD_dreadd_cno,2)./nanmean(data_dur_REM_3_end_SD_dreadd_cno,2));
% [p_mCherry_cno_vs_dreadd_cno,h] = ranksum(nanmean(data_num_REM_3_end_SD_mCherry_cno,2)./nanmean(data_dur_REM_3_end_SD_mCherry_cno,2),nanmean(data_num_REM_3_end_SD_dreadd_cno,2)./nanmean(data_dur_REM_3_end_SD_dreadd_cno,2));
% % [h,p_SD_vs_dreadd_cno] = ttest2(nanmean(data_num_REM_3_end_SD,2)./nanmean(data_dur_REM_3_end_SD,2), nanmean(data_num_REM_3_end_SD_dreadd_cno,2)./nanmean(data_dur_REM_3_end_SD_dreadd_cno,2));
% [p_SD_vs_dreadd_cno,h] = ranksum(nanmean(data_num_REM_3_end_SD,2)./nanmean(data_dur_REM_3_end_SD,2), nanmean(data_num_REM_3_end_SD_dreadd_cno,2)./nanmean(data_dur_REM_3_end_SD_dreadd_cno,2));
% 
% if p_ctrl_vs_mCherry_cno<0.05; sigstar_DB({[1 2]},p_ctrl_vs_mCherry_cno,0,'LineWigth',16,'StarSize',24); end
% if p_ctrl_vs_SD<0.05; sigstar_DB({[1 3]},p_ctrl_vs_SD,0,'LineWigth',16,'StarSize',24);end
% if p_ctrl_vs_dreadd_cno<0.05; sigstar_DB({[1 4]},p_ctrl_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24); end
...
%     1-(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_REM_WAKE_3_end_SD,2)),...
%     1-(nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_REM_WAKE_3_end_SD_dreadd_cno,2))},...
%     'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4],'barcolors',{col_1,col_2,col_3,col_4});
% ylim([.96 1])
% xticks([1:5]); xticklabels({}); xtickangle(0)
...
% xlabel('Time of the day (h)')
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)), 1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)), 1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)));
% % [h,p_ctrl_vs_SD] = ttest2(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)), 1-(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_REM_WAKE_3_end_SD,2)));
% [p_ctrl_vs_SD,h] = ranksum(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)), 1-(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_REM_WAKE_3_end_SD,2)));
% % [h,p_ctrl_vs_dreadd_cno] = ttest2(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)),1-(nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_REM_WAKE_3_end_SD_dreadd_cno,2)));
% [p_ctrl_vs_dreadd_cno,h] = ranksum(1-(nanmean(data_REM_SWS_3_end_ctrl,2)+nanmean(data_REM_WAKE_3_end_ctrl,2)),1-(nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_REM_WAKE_3_end_SD_dreadd_cno,2)));
% % [h,p_mCherry_cno_vs_SD] = ttest2(1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)), 1-(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_REM_WAKE_3_end_SD,2)));
% [p_mCherry_cno_vs_SD,h] = ranksum(1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)), 1-(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_REM_WAKE_3_end_SD,2)));
% % [h,p_mCherry_cno_vs_dreadd_cno] = ttest2(1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)), 1-(nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_REM_WAKE_3_end_SD_dreadd_cno,2)));
% [p_mCherry_cno_vs_dreadd_cno,h] = ranksum(1-(nanmean(data_REM_SWS_3_end_SD_mCherry_cno,2)+nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)), 1-(nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_REM_WAKE_3_end_SD_dreadd_cno,2)));
% % [h,p_SD_vs_dreadd_cno] = ttest2(1-(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_REM_WAKE_3_end_SD,2)), 1-(nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_REM_WAKE_3_end_SD_dreadd_cno,2)));
% [p_SD_vs_dreadd_cno,h] = ranksum(1-(nanmean(data_REM_SWS_3_end_SD,2)+nanmean(data_REM_WAKE_3_end_SD,2)), 1-(nanmean(data_REM_SWS_3_end_SD_dreadd_cno,2)+nanmean(data_REM_WAKE_3_end_SD_dreadd_cno,2)));
% 
% if p_ctrl_vs_mCherry_cno<0.05; sigstar_DB({[1 2]},p_ctrl_vs_mCherry_cno,0,'LineWigth',16,'StarSize',24); end
% if p_ctrl_vs_SD<0.05; sigstar_DB({[1 3]},p_ctrl_vs_SD,0,'LineWigth',16,'StarSize',24);  end
% if p_ctrl_vs_dreadd_cno<0.05; sigstar_DB({[1 4]},p_ctrl_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24);end
...
%     nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_WAKE_REM_3_end_SD,2),...
%     nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_REM_3_end_SD_dreadd_cno,2)},...
%     'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4],'barcolors',{col_1,col_2,col_3,col_4});
% xticks([1:5]); xticklabels({}); xtickangle(0)
...
% xlabel('Time of the day (h)')
% 
% % [h,p_ctrl_vs_mCherry_cno] = ttest(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2), nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2));
% [p_ctrl_vs_mCherry_cno,h] = ranksum(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2), nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2));
% % [h,p_ctrl_vs_SD] = ttest2(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2), nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_WAKE_REM_3_end_SD,2));
% [p_ctrl_vs_SD,h] = ranksum(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2), nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_WAKE_REM_3_end_SD,2));
% % [h,p_ctrl_vs_dreadd_cno] = ttest2(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2),nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_REM_3_end_SD_dreadd_cno,2));
% [p_ctrl_vs_dreadd_cno,h] = ranksum(nanmean(data_SWS_REM_3_end_ctrl,2)+nanmean(data_WAKE_REM_3_end_ctrl,2),nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_REM_3_end_SD_dreadd_cno,2));
% % [h,p_mCherry_cno_vs_SD] = ttest2(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2), nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_WAKE_REM_3_end_SD,2));
% [p_mCherry_cno_vs_SD,h] = ranksum(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2), nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_WAKE_REM_3_end_SD,2));
% % [h,p_mCherry_cno_vs_dreadd_cno] = ttest2(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2), nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_REM_3_end_SD_dreadd_cno,2));
% [p_mCherry_cno_vs_dreadd_cno,h] = ranksum(nanmean(data_SWS_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2), nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_REM_3_end_SD_dreadd_cno,2));
% % [h,p_SD_vs_dreadd_cno] = ttest2(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_WAKE_REM_3_end_SD,2), nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_REM_3_end_SD_dreadd_cno,2));
% [p_SD_vs_dreadd_cno,h] = ranksum(nanmean(data_SWS_REM_3_end_SD,2)+nanmean(data_WAKE_REM_3_end_SD,2), nanmean(data_SWS_REM_3_end_SD_dreadd_cno,2)+nanmean(data_WAKE_REM_3_end_SD_dreadd_cno,2));
% 
% if p_ctrl_vs_mCherry_cno<0.05; sigstar_DB({[1 2]},p_ctrl_vs_mCherry_cno,0,'LineWigth',16,'StarSize',24); end
% if p_ctrl_vs_SD<0.05; sigstar_DB({[1 3]},p_ctrl_vs_SD,0,'LineWigth',16,'StarSize',24); end
% if p_ctrl_vs_dreadd_cno<0.05; sigstar_DB({[1 4]},p_ctrl_vs_dreadd_cno,0,'LineWigth',16,'StarSize',24);end
