...
% %%4
% Dir_4 = PathForExperiments_SleepPostSD_AD('SleepPostSD_mCherry_CRH_VLPO_CNOInjection_10am');
% %%5
...
% Dir_3 = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_mCherry_CRH_VLPO_SalineInjection_10am');
% %%4
% Dir_4 = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_inhibDREADD_CRH_VLPO_SalineInjection_10am');
% %%5
% Dir_5 = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_mCherry_CRH_VLPO_CNOInjection_10am');
...
% Dir_1= PathForExperiments_DREADD_AD ('mCherry_CRH_VLPO_SalineInjection_10am');
% %%2
% Dir_2 = PathForExperiments_DREADD_AD ('inhibDREADD_CRH_VLPO_SalineInjection_10am');
% %%3
% Dir_3 = PathForExperiments_SleepPostSD_AD('SleepPostSD_mCherry_CRH_VLPO_SalineInjection_10am');
% %%4
% Dir_4 = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_mCherry_CRH_VLPO_SalineInjection_10am');
% %%5
% Dir_5 = PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_inhibDREADD_CRH_VLPO_SalineInjection_10am');
%% input dir
% %1
% Dir_1 =PathForExperiments_DREADD_MC ('mCherry_retroCre_PFC_VLPO_SalineInjection_10am');
% %%2
% Dir_2 = PathForExperiments_DREADD_AD ('mCherry_CRH_VLPO_SalineInjection_10am');
% %%3
...
% Dir_3 = MergePathForExperiment(DirSocialDefeat_classic1,DirSocialDefeat_mCherry_saline);
% %%4
...
% time_mid_begin_snd_period = 5.5*3600*1e4;
...
for i=1:length(Dir_1.path)
    ...
    same_epoch_begin_1{i} = intervalSet(time_st,time_mid_begin_snd_period); %beginning of the session (period of insomnia)
    ...
    dur_totSleep1{i}=dur_moyenne_ep_totSleep;
    num_totSleep1{i}=num_moyen_ep_totSleep;
    perc_totSleep1{i}=perc_moyen_totSleep;
    ...
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_1{i}.Wake,same_epoch_interPeriod_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_interPeriod_1{i}),and(stages_1{i}.REMEpoch,same_epoch_interPeriod_1{i}),'sleep',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    ...
    %%Compute percentage, mean duration and number of bouts (average in the defined time window)
    [dur_moyenne_ep_WAKE, num_moyen_ep_WAKE, perc_moyen_WAKE, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_1{i}.Wake,same_epoch_end_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_end_1{i}),and(stages_1{i}.REMEpoch,same_epoch_end_1{i}),'wake',tempbin,time_mid_begin_snd_period,time_end);
    dur_WAKE_end_1{i}=dur_moyenne_ep_WAKE;
    num_WAKE_end_1{i}=num_moyen_ep_WAKE;
    perc_WAKE_end_1{i}=perc_moyen_WAKE;
    
    [dur_moyenne_ep_SWS, num_moyen_ep_SWS,perc_moyen_SWS, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_1{i}.Wake,same_epoch_end_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_end_1{i}),and(stages_1{i}.REMEpoch,same_epoch_end_1{i}),'sws',tempbin,time_mid_begin_snd_period,time_end);
    dur_SWS_end_1{i}=dur_moyenne_ep_SWS;
    num_SWS_end_1{i}=num_moyen_ep_SWS;
    perc_SWS_end_1{i}=perc_moyen_SWS;
    
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_1{i}.Wake,same_epoch_end_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_end_1{i}),and(stages_1{i}.REMEpoch,same_epoch_end_1{i}),'rem',tempbin,time_mid_begin_snd_period,time_end);
    dur_REM_end_1{i}=dur_moyenne_ep_REM;
    num_REM_end_1{i}=num_moyen_ep_REM;
    perc_REM_end_1{i}=perc_moyen_REM;
    
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_1{i}.Wake,same_epoch_end_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_end_1{i}),and(stages_1{i}.REMEpoch,same_epoch_end_1{i}),'sleep',tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_1{i}.Wake,same_epoch_end_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_end_1{i}),and(stages_1{i}.REMEpoch,same_epoch_end_1{i}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_1{i}.Wake,same_epoch_end_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_end_1{i}),and(short_REMEpoch_1_1{i},same_epoch_end_1{i}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_1{i}.Wake,same_epoch_end_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_end_1{i}),and(mid_REMEpoch_1{i},same_epoch_end_1{i}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_1{i}.Wake,same_epoch_end_1{i}),and(stages_1{i}.SWSEpoch,same_epoch_end_1{i}),and(long_REMEpoch_1{i},same_epoch_end_1{i}),tempbin,time_mid_begin_snd_period,time_end);
...
for i=1:length(dur_REM_1)
    ...
    data_dur_totSleep_1(i,:) = dur_totSleep1{i}; data_dur_totSleep_1(isnan(data_dur_totSleep_1)==1)=0;
    ...
    data_num_totSleep_1(i,:) = num_totSleep1{i}; data_num_totSleep_1(isnan(data_num_totSleep_1)==1)=0;
    ...
    data_perc_totSleep_1(i,:) = perc_totSleep1{i}; data_perc_totSleep_1(isnan(data_perc_totSleep_1)==1)=0;
...
for k=1:length(Dir_2.path)
    ...
    same_epoch_begin_2{k} = intervalSet(time_st,time_mid_begin_snd_period);
    ...
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_2{k}.Wake,same_epoch_interPeriod_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_interPeriod_2{k}),and(stages_2{k}.REMEpoch,same_epoch_interPeriod_2{k}),'rem',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    ...
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_2{k}.Wake,same_epoch_interPeriod_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_interPeriod_2{k}),and(stages_2{k}.REMEpoch,same_epoch_interPeriod_2{k}),'sleep',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    ...
    %%Compute percentage, mean duration and number of bouts
    [dur_moyenne_ep_WAKE, num_moyen_ep_WAKE, perc_moyen_WAKE, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_2{k}.Wake,same_epoch_end_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_end_2{k}),and(stages_2{k}.REMEpoch,same_epoch_end_2{k}),'wake',tempbin,time_mid_begin_snd_period,time_end);
    dur_WAKE_end_2{k}=dur_moyenne_ep_WAKE;
    num_WAKE_end_2{k}=num_moyen_ep_WAKE;
    perc_WAKE_end_2{k}=perc_moyen_WAKE;
    
    [dur_moyenne_ep_SWS, num_moyen_ep_SWS,perc_moyen_SWS, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_2{k}.Wake,same_epoch_end_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_end_2{k}),and(stages_2{k}.REMEpoch,same_epoch_end_2{k}),'sws',tempbin,time_mid_begin_snd_period,time_end);
    dur_SWS_end_2{k}=dur_moyenne_ep_SWS;
    num_SWS_end_2{k}=num_moyen_ep_SWS;
    perc_SWS_end_2{k}=perc_moyen_SWS;
    
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_2{k}.Wake,same_epoch_end_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_end_2{k}),and(stages_2{k}.REMEpoch,same_epoch_end_2{k}),'rem',tempbin,time_mid_begin_snd_period,time_end);
    dur_REM_end_2{k}=dur_moyenne_ep_REM;
    num_REM_end_2{k}=num_moyen_ep_REM;
    perc_REM_end_2{k}=perc_moyen_REM;
    
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_2{k}.Wake,same_epoch_end_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_end_2{k}),and(stages_2{k}.REMEpoch,same_epoch_end_2{k}),'sleep',tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_2{k}.Wake,same_epoch_end_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_end_2{k}),and(stages_2{k}.REMEpoch,same_epoch_end_2{k}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from short REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_2{k}.Wake,same_epoch_end_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_end_2{k}),and(short_REMEpoch_2_1{k},same_epoch_end_2{k}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from mid REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_2{k}.Wake,same_epoch_end_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_end_2{k}),and(mid_REMEpoch_2{k},same_epoch_end_2{k}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from long REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_2{k}.Wake,same_epoch_end_2{k}),and(stages_2{k}.SWSEpoch,same_epoch_end_2{k}),and(long_REMEpoch_2{k},same_epoch_end_2{k}),tempbin,time_mid_begin_snd_period,time_end);
...
for j=1:length(Dir_3.path)
    ...
    same_epoch_begin_3{j} = intervalSet(time_st,time_mid_begin_snd_period);
    same_epoch_end_3{j} = intervalSet(time_mid_begin_snd_period,time_end);
    same_epoch_interPeriod_3{j} = intervalSet(time_mid_end_first_period,time_mid_begin_snd_period);
    ...
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_3{j}.Wake,same_epoch_interPeriod_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_interPeriod_3{j}),and(stages_3{j}.REMEpoch,same_epoch_interPeriod_3{j}),'sleep',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    ...
    %%Compute percentage, mean duration and number of bouts
    [dur_moyenne_ep_WAKE, num_moyen_ep_WAKE, perc_moyen_WAKE, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_3{j}.Wake,same_epoch_end_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_end_3{j}),and(stages_3{j}.REMEpoch,same_epoch_end_3{j}),'wake',tempbin,time_mid_begin_snd_period,time_end);
    dur_WAKE_end_3{j}=dur_moyenne_ep_WAKE;
    num_WAKE_end_3{j}=num_moyen_ep_WAKE;
    perc_WAKE_end_3{j}=perc_moyen_WAKE;
    
    
    [dur_moyenne_ep_SWS, num_moyen_ep_SWS,perc_moyen_SWS, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_3{j}.Wake,same_epoch_end_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_end_3{j}),and(stages_3{j}.REMEpoch,same_epoch_end_3{j}),'sws',tempbin,time_mid_begin_snd_period,time_end);
    dur_SWS_end_3{j}=dur_moyenne_ep_SWS;
    num_SWS_end_3{j}=num_moyen_ep_SWS;
    perc_SWS_end_3{j}=perc_moyen_SWS;
    
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_3{j}.Wake,same_epoch_end_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_end_3{j}),and(stages_3{j}.REMEpoch,same_epoch_end_3{j}),'rem',tempbin,time_mid_begin_snd_period,time_end);
    dur_REM_end_3{j}=dur_moyenne_ep_REM;
    num_REM_end_3{j}=num_moyen_ep_REM;
    perc_REM_end_3{j}=perc_moyen_REM;
    
    
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_3{j}.Wake,same_epoch_end_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_end_3{j}),and(stages_3{j}.REMEpoch,same_epoch_end_3{j}),'sleep',tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_3{j}.Wake,same_epoch_end_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_end_3{j}),and(stages_3{j}.REMEpoch,same_epoch_end_3{j}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from short REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_3{j}.Wake,same_epoch_end_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_end_3{j}),and(short_REMEpoch_3_1{j},same_epoch_end_3{j}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from mid REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_3{j}.Wake,same_epoch_end_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_end_3{j}),and(mid_REMEpoch_3{j},same_epoch_end_3{j}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from long REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_3{j}.Wake,same_epoch_end_3{j}),and(stages_3{j}.SWSEpoch,same_epoch_end_3{j}),and(long_REMEpoch_3{j},same_epoch_end_3{j}),tempbin,time_mid_begin_snd_period,time_end);
...
for m=1:length(Dir_4.path)
    ...
    same_epoch_begin_4{m} = intervalSet(time_st,time_mid_begin_snd_period);
    same_epoch_end_4{m} = intervalSet(time_mid_begin_snd_period,time_end);
    same_epoch_interPeriod_4{m} = intervalSet(time_mid_end_first_period,time_mid_begin_snd_period);
    ...
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_4{m}.Wake,same_epoch_interPeriod_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_interPeriod_4{m}),and(stages_4{m}.REMEpoch,same_epoch_interPeriod_4{m}),'rem',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    ...
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_4{m}.Wake,same_epoch_interPeriod_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_interPeriod_4{m}),and(stages_4{m}.REMEpoch,same_epoch_interPeriod_4{m}),'sleep',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    ...
    %%3H POST 2 JUSQU'A LA FIN
    %%Compute percentage, mean duration and number of bouts
    [dur_moyenne_ep_WAKE, num_moyen_ep_WAKE, perc_moyen_WAKE, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_4{m}.Wake,same_epoch_end_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_end_4{m}),and(stages_4{m}.REMEpoch,same_epoch_end_4{m}),'wake',tempbin,time_mid_begin_snd_period,time_end);
    dur_WAKE_end_4{m}=dur_moyenne_ep_WAKE;
    num_WAKE_end_4{m}=num_moyen_ep_WAKE;
    perc_WAKE_end_4{m}=perc_moyen_WAKE;
    
    
    [dur_moyenne_ep_SWS, num_moyen_ep_SWS,perc_moyen_SWS, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_4{m}.Wake,same_epoch_end_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_end_4{m}),and(stages_4{m}.REMEpoch,same_epoch_end_4{m}),'sws',tempbin,time_mid_begin_snd_period,time_end);
    dur_SWS_end_4{m}=dur_moyenne_ep_SWS;
    num_SWS_end_4{m}=num_moyen_ep_SWS;
    perc_SWS_end_4{m}=perc_moyen_SWS;
    
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_4{m}.Wake,same_epoch_end_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_end_4{m}),and(stages_4{m}.REMEpoch,same_epoch_end_4{m}),'rem',tempbin,time_mid_begin_snd_period,time_end);
    dur_REM_end_4{m}=dur_moyenne_ep_REM;
    num_REM_end_4{m}=num_moyen_ep_REM;
    perc_REM_end_4{m}=perc_moyen_REM;
    
    
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_4{m}.Wake,same_epoch_end_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_end_4{m}),and(stages_4{m}.REMEpoch,same_epoch_end_4{m}),'sleep',tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_4{m}.Wake,same_epoch_end_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_end_4{m}),and(stages_4{m}.REMEpoch,same_epoch_end_4{m}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from short REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_4{m}.Wake,same_epoch_end_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_end_4{m}),and(short_REMEpoch_4_1{m},same_epoch_end_4{m}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from mid REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_4{m}.Wake,same_epoch_end_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_end_4{m}),and(mid_REMEpoch_4{m},same_epoch_end_4{m}),tempbin,time_mid_begin_snd_period,time_end);
    ...
    %%Compute transition probabilities from long REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_4{m}.Wake,same_epoch_end_4{m}),and(stages_4{m}.SWSEpoch,same_epoch_end_4{m}),and(long_REMEpoch_4{m},same_epoch_end_4{m}),tempbin,time_mid_begin_snd_period,time_end);
...
%% GET DATA - 5th group
for m=1:length(Dir_5.path)
    cd(Dir_5.path{m}{1});
    %%Load sleep scoring
    if exist('SleepScoring_Accelero.mat')
        stages_5{m} = load('SleepScoring_Accelero', 'REMEpoch', 'SWSEpoch', 'Wake','Sleep');
    elseif exist('SleepScoring_OBGamma.mat')
        stages_5{m} = load('SleepScoring_OBGamma', 'REMEpoch', 'SWSEpoch', 'Wake','Sleep');
    else
    end
    same_epoch_5{m} = intervalSet(0,time_end);
    same_epoch_begin_5{m} = intervalSet(time_st,time_mid_begin_snd_period);
    same_epoch_end_5{m} = intervalSet(time_mid_begin_snd_period,time_end);
    same_epoch_interPeriod_5{m} = intervalSet(time_mid_end_first_period,time_mid_begin_snd_period);
    
    
    %%ALL SESSION WITH TIMEBiNS 1H
    %%Compute percentage mean duration and number of bouts - overtime
    [dur_moyenne_ep_WAKE, num_moyen_ep_WAKE, perc_moyen_WAKE, rg]=Get_Mean_Dur_Num_Overtime_MC(and(stages_5{m}.Wake,same_epoch_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_5{m}),and(stages_5{m}.REMEpoch,same_epoch_5{m}),'wake',tempbin,time_st,time_end);
    dur_WAKE_5{m}=dur_moyenne_ep_WAKE;
    num_WAKE_5{m}=num_moyen_ep_WAKE;
    perc_WAKE_5{m}=perc_moyen_WAKE;
    
    [dur_moyenne_ep_SWS, num_moyen_ep_SWS,perc_moyen_SWS, rg]=Get_Mean_Dur_Num_Overtime_MC(and(stages_5{m}.Wake,same_epoch_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_5{m}),and(stages_5{m}.REMEpoch,same_epoch_5{m}),'sws',tempbin,time_st,time_end);
    dur_SWS_5{m}=dur_moyenne_ep_SWS;
    num_SWS_5{m}=num_moyen_ep_SWS;
    perc_SWS_5{m}=perc_moyen_SWS;
    
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_Overtime_MC(and(stages_5{m}.Wake,same_epoch_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_5{m}),and(stages_5{m}.REMEpoch,same_epoch_5{m}),'rem',tempbin,time_st,time_end);
    dur_REM_5{m}=dur_moyenne_ep_REM;
    num_REM_5{m}=num_moyen_ep_REM;
    perc_REM_5{m}=perc_moyen_REM;
    
    
    
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_Overtime_MC(and(stages_5{m}.Wake,same_epoch_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_5{m}),and(stages_5{m}.REMEpoch,same_epoch_5{m}),'sleep',tempbin,time_st,time_end);
    dur_totSleep_5{m}=dur_moyenne_ep_totSleep;
    num_totSleep_5{m}=num_moyen_ep_totSleep;
    perc_totSleep_5{m}=perc_moyen_totSleep;
    
    
    
    %%Compute transition probabilities - overtime
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_Overtime_MC_VF(and(stages_5{m}.Wake,same_epoch_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_5{m}),and(stages_5{m}.REMEpoch,same_epoch_5{m}),tempbin,time_end);
    all_trans_REM_REM_5{m} = trans_REM_to_REM;
    all_trans_REM_SWS_5{m} = trans_REM_to_SWS;
    all_trans_REM_WAKE_5{m} = trans_REM_to_WAKE;
    
    all_trans_SWS_REM_5{m} = trans_SWS_to_REM;
    all_trans_SWS_SWS_5{m} = trans_SWS_to_SWS;
    all_trans_SWS_WAKE_5{m} = trans_SWS_to_WAKE;
    
    all_trans_WAKE_REM_5{m} = trans_WAKE_to_REM;
    all_trans_WAKE_SWS_5{m} = trans_WAKE_to_SWS;
    all_trans_WAKE_WAKE_5{m} = trans_WAKE_to_WAKE;
    
    
    %%3 PREMI7RE HEUES APRES 2
    %%Compute percentage mean duration and number of bouts
    [dur_moyenne_ep_WAKE, num_moyen_ep_WAKE, perc_moyen_WAKE, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_begin_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_begin_5{m}),and(stages_5{m}.REMEpoch,same_epoch_begin_5{m}),'wake',tempbin,time_st,time_mid_end_first_period);
    dur_WAKE_begin_5{m}=dur_moyenne_ep_WAKE;
    num_WAKE_begin_5{m}=num_moyen_ep_WAKE;
    perc_WAKE_begin_5{m}=perc_moyen_WAKE;
    
    [dur_moyenne_ep_SWS, num_moyen_ep_SWS,perc_moyen_SWS, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_begin_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_begin_5{m}),and(stages_5{m}.REMEpoch,same_epoch_begin_5{m}),'sws',tempbin,time_st,time_mid_end_first_period);
    dur_SWS_begin_5{m}=dur_moyenne_ep_SWS;
    num_SWS_begin_5{m}=num_moyen_ep_SWS;
    perc_SWS_begin_5{m}=perc_moyen_SWS;
    
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_begin_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_begin_5{m}),and(stages_5{m}.REMEpoch,same_epoch_begin_5{m}),'rem',tempbin,time_st,time_mid_end_first_period);
    dur_REM_begin_5{m}=dur_moyenne_ep_REM;
    num_REM_begin_5{m}=num_moyen_ep_REM;
    perc_REM_begin_5{m}=perc_moyen_REM;
    
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_begin_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_begin_5{m}),and(stages_5{m}.REMEpoch,same_epoch_begin_5{m}),'sleep',tempbin,time_st,time_mid_end_first_period);
    dur_totSleep_begin_5{m}=dur_moyenne_ep_totSleep;
    num_totSleep_begin_5{m}=num_moyen_ep_totSleep;
    perc_totSleep_begin_5{m}=perc_moyen_totSleep;
    
    
    %%Compute transition probabilities
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_5{m}.Wake,same_epoch_begin_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_begin_5{m}),and(stages_5{m}.REMEpoch,same_epoch_begin_5{m}),tempbin,time_st,time_mid_end_first_period);
    all_trans_REM_REM_begin_5{m} = trans_REM_to_REM;
    all_trans_REM_SWS_begin_5{m} = trans_REM_to_SWS;
    all_trans_REM_WAKE_begin_5{m} = trans_REM_to_WAKE;
    
    all_trans_SWS_REM_begin_5{m} = trans_SWS_to_REM;
    all_trans_SWS_SWS_begin_5{m} = trans_SWS_to_SWS;
    all_trans_SWS_WAKE_begin_5{m} = trans_SWS_to_WAKE;
    
    all_trans_WAKE_REM_begin_5{m} = trans_WAKE_to_REM;
    all_trans_WAKE_SWS_begin_5{m} = trans_WAKE_to_SWS;
    all_trans_WAKE_WAKE_begin_5{m} = trans_WAKE_to_WAKE;
    
    [dur_moyenne_ep_WAKE, num_moyen_ep_WAKE, perc_moyen_WAKE, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_interPeriod_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_interPeriod_5{m}),and(stages_5{m}.REMEpoch,same_epoch_interPeriod_5{m}),'wake',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    dur_WAKE_interPeriod_5{m}=dur_moyenne_ep_WAKE;
    num_WAKE_interPeriod_5{m}=num_moyen_ep_WAKE;
    perc_WAKE_interPeriod_5{m}=perc_moyen_WAKE;
    
    [dur_moyenne_ep_SWS, num_moyen_ep_SWS,perc_moyen_SWS, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_interPeriod_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_interPeriod_5{m}),and(stages_5{m}.REMEpoch,same_epoch_interPeriod_5{m}),'sws',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    dur_SWS_interPeriod_5{m}=dur_moyenne_ep_SWS;
    num_SWS_interPeriod_5{m}=num_moyen_ep_SWS;
    perc_SWS_interPeriod_5{m}=perc_moyen_SWS;
    
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_interPeriod_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_interPeriod_5{m}),and(stages_5{m}.REMEpoch,same_epoch_interPeriod_5{m}),'rem',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    dur_REM_interPeriod_5{m}=dur_moyenne_ep_REM;
    num_REM_interPeriod_5{m}=num_moyen_ep_REM;
    perc_REM_interPeriod_5{m}=perc_moyen_REM;
    
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_interPeriod_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_interPeriod_5{m}),and(stages_5{m}.REMEpoch,same_epoch_interPeriod_5{m}),'sleep',tempbin,time_mid_end_first_period,time_mid_begin_snd_period);
    dur_totSleep_interPeriod_5{m}=dur_moyenne_ep_totSleep;
    num_totSleep_interPeriod_5{m}=num_moyen_ep_totSleep;
    perc_totSleep_interPeriod_5{m}=perc_moyen_totSleep;
    
    
    %%3H POST 2 JUSQU'A LA FIN
    %%Compute percentage, mean duration and number of bouts
    [dur_moyenne_ep_WAKE, num_moyen_ep_WAKE, perc_moyen_WAKE, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_end_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),and(stages_5{m}.REMEpoch,same_epoch_end_5{m}),'wake',tempbin,time_mid_begin_snd_period,time_end);
    dur_WAKE_end_5{m}=dur_moyenne_ep_WAKE;
    num_WAKE_end_5{m}=num_moyen_ep_WAKE;
    perc_WAKE_end_5{m}=perc_moyen_WAKE;
    
    
    [dur_moyenne_ep_SWS, num_moyen_ep_SWS,perc_moyen_SWS, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_end_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),and(stages_5{m}.REMEpoch,same_epoch_end_5{m}),'sws',tempbin,time_mid_begin_snd_period,time_end);
    dur_SWS_end_5{m}=dur_moyenne_ep_SWS;
    num_SWS_end_5{m}=num_moyen_ep_SWS;
    perc_SWS_end_5{m}=perc_moyen_SWS;
    
    [dur_moyenne_ep_REM, num_moyen_ep_REM,perc_moyen_REM, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_end_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),and(stages_5{m}.REMEpoch,same_epoch_end_5{m}),'rem',tempbin,time_mid_begin_snd_period,time_end);
    dur_REM_end_5{m}=dur_moyenne_ep_REM;
    num_REM_end_5{m}=num_moyen_ep_REM;
    perc_REM_end_5{m}=perc_moyen_REM;
    
    
    [dur_moyenne_ep_totSleep, num_moyen_ep_totSleep,perc_moyen_totSleep, rg]=Get_Mean_Dur_Num_OverTimeWindows_version_2_groups_MC(and(stages_5{m}.Wake,same_epoch_end_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),and(stages_5{m}.REMEpoch,same_epoch_end_5{m}),'sleep',tempbin,time_mid_begin_snd_period,time_end);
    dur_totSleep_end_5{m}=dur_moyenne_ep_totSleep;
    num_totSleep_end_5{m}=num_moyen_ep_totSleep;
    perc_totSleep_end_5{m}=perc_moyen_totSleep;
    
    %%Compute transition probabilities
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_5{m}.Wake,same_epoch_end_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),and(stages_5{m}.REMEpoch,same_epoch_end_5{m}),tempbin,time_mid_begin_snd_period,time_end);
    all_trans_REM_REM_end_5{m} = trans_REM_to_REM;
    all_trans_REM_SWS_end_5{m} = trans_REM_to_SWS;
    all_trans_REM_WAKE_end_5{m} = trans_REM_to_WAKE;
    
    all_trans_SWS_REM_end_5{m} = trans_SWS_to_REM;
    all_trans_SWS_SWS_end_5{m} = trans_SWS_to_SWS;
    all_trans_SWS_WAKE_end_5{m} = trans_SWS_to_WAKE;
    
    all_trans_WAKE_REM_end_5{m} = trans_WAKE_to_REM;
    all_trans_WAKE_SWS_end_5{m} = trans_WAKE_to_SWS;
    all_trans_WAKE_WAKE_end_5{m} = trans_WAKE_to_WAKE;
    
    
    %%Short versus long REM bouts
    [dur_WAKE_5_bis{m}, durT_WAKE_5(m)]=DurationEpoch(and(stages_5{m}.Wake,same_epoch_end_5{m}),'s');
    [dur_SWS_5_bis{m}, durT_SWS_5(m)]=DurationEpoch(and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),'s');
    
    [dur_REM_5_bis{m}, durT_REM_5(m)]=DurationEpoch(and(stages_5{m}.REMEpoch,same_epoch_end_5{m}),'s');
    
    idx_short_rem_5_1{m} = find(dur_REM_5_bis{m}<lim_short_rem_1); %short bouts < 10s
    short_REMEpoch_5_1{m} = subset(and(stages_5{m}.REMEpoch,same_epoch_end_5{m}), idx_short_rem_5_1{m});
    [dur_rem_short_5_1{m}, durT_rem_short_5(m)] = DurationEpoch(short_REMEpoch_5_1{m},'s');
    perc_rem_short_5_1(m) = durT_rem_short_5(m) / durT_REM_5(m) * 100;
    dur_moyenne_rem_short_5_1(m) = nanmean(dur_rem_short_5_1{m});
    num_moyen_rem_short_5_1(m) = length(dur_rem_short_5_1{m});
    
    idx_short_rem_5_2{m} = find(dur_REM_5_bis{m}<lim_short_rem_2); %short bouts < 15s
    short_REMEpoch_5_2{m} = subset(and(stages_5{m}.REMEpoch,same_epoch_end_5{m}), idx_short_rem_5_2{m});
    [dur_rem_short_5_2{m}, durT_rem_short_5(m)] = DurationEpoch(short_REMEpoch_5_2{m},'s');
    perc_rem_short_5_2(m) = durT_rem_short_5(m) / durT_REM_5(m) * 100;
    dur_moyenne_rem_short_5_2(m) = nanmean(dur_rem_short_5_2{m});
    num_moyen_rem_short_5_2(m) = length(dur_rem_short_5_2{m});
    
    idx_short_rem_5_3{m} = find(dur_REM_5_bis{m}<lim_short_rem_3);  %short bouts < 20s
    short_REMEpoch_5_3{m} = subset(and(stages_5{m}.REMEpoch,same_epoch_end_5{m}), idx_short_rem_5_3{m});
    [dur_rem_short_5_3{m}, durT_rem_short_5(m)] = DurationEpoch(short_REMEpoch_5_3{m},'s');
    perc_rem_short_5_3(m) = durT_rem_short_5(m) / durT_REM_5(m) * 100;
    dur_moyenne_rem_short_5_3(m) = nanmean(dur_rem_short_5_3{m});
    num_moyen_rem_short_5_3(m) = length(dur_rem_short_5_3{m});
    
    idx_long_rem_5{m} = find(dur_REM_5_bis{m}>lim_long_rem); %long bout
    long_REMEpoch_5{m} = subset(and(stages_5{m}.REMEpoch,same_epoch_end_5{m}), idx_long_rem_5{m});
    [dur_rem_long_5{m}, durT_rem_long_5(m)] = DurationEpoch(long_REMEpoch_5{m},'s');
    perc_rem_long_5(m) = durT_rem_long_5(m) / durT_REM_5(m) * 100;
    dur_moyenne_rem_long_5(m) = nanmean(dur_rem_long_5{m});
    num_moyen_rem_long_5(m) = length(dur_rem_long_5{m});
    
    idx_mid_rem_5{m} = find(dur_REM_5_bis{m}>lim_short_rem_1 & dur_REM_5_bis{m}<lim_long_rem); % middle bouts
    mid_REMEpoch_5{m} = subset(and(stages_5{m}.REMEpoch,same_epoch_end_5{m}), idx_mid_rem_5{m});
    [dur_rem_mid_5{m}, durT_rem_mid_5(m)] = DurationEpoch(mid_REMEpoch_5{m},'s');
    perc_rem_mid_5(m) = durT_rem_mid_5(m) / durT_REM_5(m) * 100;
    dur_moyenne_rem_mid_5(m) = nanmean(dur_rem_mid_5{m});
    num_moyen_rem_mid_5(m) = length(dur_rem_mid_5{m});
    
    
    %%Compute transition probabilities from short REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_5{m}.Wake,same_epoch_end_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),and(short_REMEpoch_5_1{m},same_epoch_end_5{m}),tempbin,time_mid_begin_snd_period,time_end);
    all_trans_REM_short_SWS_end_5{m} = trans_REM_to_SWS;
    all_trans_REM_short_WAKE_end_5{m} = trans_REM_to_WAKE;
    all_trans_REM_short_REM_end_5{m} = trans_REM_to_REM;
    
    %%Compute transition probabilities from mid REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_5{m}.Wake,same_epoch_end_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),and(mid_REMEpoch_5{m},same_epoch_end_5{m}),tempbin,time_mid_begin_snd_period,time_end);
    all_trans_REM_mid_SWS_end_5{m} = trans_REM_to_SWS;
    all_trans_REM_mid_WAKE_end_5{m} = trans_REM_to_WAKE;
    all_trans_REM_mid_REM_end_5{m} = trans_REM_to_REM;
    
    %%Compute transition probabilities from long REM
    [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=...
        Get_proba_timebins_OverTimeWindows_MC_version2_vf(and(stages_5{m}.Wake,same_epoch_end_5{m}),and(stages_5{m}.SWSEpoch,same_epoch_end_5{m}),and(long_REMEpoch_5{m},same_epoch_end_5{m}),tempbin,time_mid_begin_snd_period,time_end);
    all_trans_REM_long_SWS_end_5{m} = trans_REM_to_SWS;
    all_trans_REM_long_WAKE_end_5{m} = trans_REM_to_WAKE;
    all_trans_REM_long_REM_end_5{m} = trans_REM_to_REM;
...
%%percentage/duration/number
for m=1:length(dur_REM_5)
    %%ALL SESSION
    data_dur_REM_5(m,:) = dur_REM_5{m}; data_dur_REM_5(isnan(data_dur_REM_5)==1)=0;
    data_dur_SWS_5(m,:) = dur_SWS_5{m}; data_dur_SWS_5(isnan(data_dur_SWS_5)==1)=0;
    data_dur_WAKE_5(m,:) = dur_WAKE_5{m}; data_dur_WAKE_5(isnan(data_dur_WAKE_5)==1)=0;
    data_dur_totSleep_5(m,:) = dur_totSleep_5{m}; data_dur_totSleep_5(isnan(data_dur_totSleep_5)==1)=0;
    
    data_num_REM_5(m,:) = num_REM_5{m};data_num_REM_5(isnan(data_num_REM_5)==1)=0;
    data_num_SWS_5(m,:) = num_SWS_5{m}; data_num_SWS_5(isnan(data_num_SWS_5)==1)=0;
    data_num_WAKE_5(m,:) = num_WAKE_5{m}; data_num_WAKE_5(isnan(data_num_WAKE_5)==1)=0;
    data_num_totSleep_5(m,:) = num_totSleep_5{m}; data_num_totSleep_5(isnan(data_num_totSleep_5)==1)=0;
    
    data_perc_REM_5(m,:) = perc_REM_5{m}; data_perc_REM_5(isnan(data_perc_REM_5)==1)=0;
    data_perc_SWS_5(m,:) = perc_SWS_5{m}; data_perc_SWS_5(isnan(data_perc_SWS_5)==1)=0;
    data_perc_WAKE_5(m,:) = perc_WAKE_5{m}; data_perc_WAKE_5(isnan(data_perc_WAKE_5)==1)=0;
    data_perc_totSleep_5(m,:) = perc_totSleep_5{m}; data_perc_totSleep_5(isnan(data_perc_totSleep_5)==1)=0;
    
    %%3 PREMI7RES HEURES
    data_dur_REM_begin_5(m,:) = dur_REM_begin_5{m}; data_dur_REM_begin_5(isnan(data_dur_REM_begin_5)==1)=0;
    data_dur_SWS_begin_5(m,:) = dur_SWS_begin_5{m}; data_dur_SWS_begin_5(isnan(data_dur_SWS_begin_5)==1)=0;
    data_dur_WAKE_begin_5(m,:) = dur_WAKE_begin_5{m}; data_dur_WAKE_begin_5(isnan(data_dur_WAKE_begin_5)==1)=0;
    data_dur_totSleep_begin_5(m,:) = dur_totSleep_begin_5{m}; data_dur_totSleep_begin_5(isnan(data_dur_totSleep_begin_5)==1)=0;
    
    
    data_num_REM_begin_5(m,:) = num_REM_begin_5{m};data_num_REM_begin_5(isnan(data_num_REM_begin_5)==1)=0;
    data_num_SWS_begin_5(m,:) = num_SWS_begin_5{m}; data_num_SWS_begin_5(isnan(data_num_SWS_begin_5)==1)=0;
    data_num_WAKE_begin_5(m,:) = num_WAKE_begin_5{m}; data_num_WAKE_begin_5(isnan(data_num_WAKE_begin_5)==1)=0;
    data_num_totSleep_begin_5(m,:) = num_totSleep_begin_5{m}; data_num_totSleep_begin_5(isnan(data_num_totSleep_begin_5)==1)=0;
    
    data_perc_REM_begin_5(m,:) = perc_REM_begin_5{m}; data_perc_REM_begin_5(isnan(data_perc_REM_begin_5)==1)=0;
    data_perc_SWS_begin_5(m,:) = perc_SWS_begin_5{m}; data_perc_SWS_begin_5(isnan(data_perc_SWS_begin_5)==1)=0;
    data_perc_WAKE_begin_5(m,:) = perc_WAKE_begin_5{m}; data_perc_WAKE_begin_5(isnan(data_perc_WAKE_begin_5)==1)=0;
    data_perc_totSleep_begin_5(m,:) = perc_totSleep_begin_5{m}; data_perc_totSleep_begin_5(isnan(data_perc_totSleep_begin_5)==1)=0;
    
    data_dur_REM_interPeriod_5(m,:) = dur_REM_interPeriod_5{m}; data_dur_REM_interPeriod_5(isnan(data_dur_REM_interPeriod_5)==1)=0;
    data_dur_SWS_interPeriod_5(m,:) = dur_SWS_interPeriod_5{m}; data_dur_SWS_interPeriod_5(isnan(data_dur_SWS_interPeriod_5)==1)=0;
    data_dur_WAKE_interPeriod_5(m,:) = dur_WAKE_interPeriod_5{m}; data_dur_WAKE_interPeriod_5(isnan(data_dur_WAKE_interPeriod_5)==1)=0;
    data_dur_totSleep_interPeriod_5(m,:) = dur_totSleep_interPeriod_5{m}; data_dur_totSleep_interPeriod_5(isnan(data_dur_totSleep_interPeriod_5)==1)=0;
    
    
    data_num_REM_interPeriod_5(m,:) = num_REM_interPeriod_5{m};data_num_REM_interPeriod_5(isnan(data_num_REM_interPeriod_5)==1)=0;
    data_num_SWS_interPeriod_5(m,:) = num_SWS_interPeriod_5{m}; data_num_SWS_interPeriod_5(isnan(data_num_SWS_interPeriod_5)==1)=0;
    data_num_WAKE_interPeriod_5(m,:) = num_WAKE_interPeriod_5{m}; data_num_WAKE_interPeriod_5(isnan(data_num_WAKE_interPeriod_5)==1)=0;
    data_num_totSleep_interPeriod_5(m,:) = num_totSleep_interPeriod_5{m}; data_num_totSleep_interPeriod_5(isnan(data_num_totSleep_interPeriod_5)==1)=0;
    
    data_perc_REM_interPeriod_5(m,:) = perc_REM_interPeriod_5{m}; data_perc_REM_interPeriod_5(isnan(data_perc_REM_interPeriod_5)==1)=0;
    data_perc_SWS_interPeriod_5(m,:) = perc_SWS_interPeriod_5{m}; data_perc_SWS_interPeriod_5(isnan(data_perc_SWS_interPeriod_5)==1)=0;
    data_perc_WAKE_interPeriod_5(m,:) = perc_WAKE_interPeriod_5{m}; data_perc_WAKE_interPeriod_5(isnan(data_perc_WAKE_interPeriod_5)==1)=0;
    data_perc_totSleep_interPeriod_5(m,:) = perc_totSleep_interPeriod_5{m}; data_perc_totSleep_interPeriod_5(isnan(data_perc_totSleep_interPeriod_5)==1)=0;
    
    
    
    %%FIN DE LA SESSION
    data_dur_REM_end_5(m,:) = dur_REM_end_5{m}; data_dur_REM_end_5(isnan(data_dur_REM_end_5)==1)=0;
    data_dur_SWS_end_5(m,:) = dur_SWS_end_5{m}; data_dur_SWS_end_5(isnan(data_dur_SWS_end_5)==1)=0;
    data_dur_WAKE_end_5(m,:) = dur_WAKE_end_5{m}; data_dur_WAKE_end_5(isnan(data_dur_WAKE_end_5)==1)=0;
    data_dur_totSleep_end_5(m,:) = dur_totSleep_end_5{m}; data_dur_totSleep_end_5(isnan(data_dur_totSleep_end_5)==1)=0;
    
    
    data_num_REM_end_5(m,:) = num_REM_end_5{m};data_num_REM_end_5(isnan(data_num_REM_end_5)==1)=0;
    data_num_SWS_end_5(m,:) = num_SWS_end_5{m}; data_num_SWS_end_5(isnan(data_num_SWS_end_5)==1)=0;
    data_num_WAKE_end_5(m,:) = num_WAKE_end_5{m}; data_num_WAKE_end_5(isnan(data_num_WAKE_end_5)==1)=0;
    data_num_totSleep_end_5(m,:) = num_totSleep_end_5{m}; data_num_totSleep_end_5(isnan(data_num_totSleep_end_5)==1)=0;
    
    
    data_perc_REM_end_5(m,:) = perc_REM_end_5{m}; data_perc_REM_end_5(isnan(data_perc_REM_end_5)==1)=0;
    data_perc_SWS_end_5(m,:) = perc_SWS_end_5{m}; data_perc_SWS_end_5(isnan(data_perc_SWS_end_5)==1)=0;
    data_perc_WAKE_end_5(m,:) = perc_WAKE_end_5{m}; data_perc_WAKE_end_5(isnan(data_perc_WAKE_end_5)==1)=0;
    data_perc_totSleep_end_5(m,:) = perc_totSleep_end_5{m}; data_perc_totSleep_end_5(isnan(data_perc_totSleep_end_5)==1)=0;
    
end
%%probability
for m=1:length(all_trans_REM_REM_5)
% %     %%ALL SESSION
% %     data_REM_REM_5(m,:) = all_trans_REM_REM_5{m}; data_REM_REM_5(isnan(data_REM_REM_5)==1)=0;
% %     data_REM_SWS_5(m,:) = all_trans_REM_SWS_5{m}; data_REM_SWS_5(isnan(data_REM_SWS_5)==1)=0;
% %     data_REM_WAKE_5(m,:) = all_trans_REM_WAKE_5{m}; data_REM_WAKE_5(isnan(data_REM_WAKE_5)==1)=0;
% %
% %     data_SWS_SWS_5(m,:) = all_trans_SWS_SWS_5{m}; data_SWS_SWS_5(isnan(data_SWS_SWS_5)==1)=0;
% %     data_SWS_REM_5(m,:) = all_trans_SWS_REM_5{m}; data_SWS_REM_5(isnan(data_SWS_REM_5)==1)=0;
% %     data_SWS_WAKE_5(m,:) = all_trans_SWS_WAKE_5{m}; data_SWS_WAKE_5(isnan(data_SWS_WAKE_5)==1)=0;
% %
% %     data_WAKE_WAKE_5(m,:) = all_trans_WAKE_WAKE_5{m}; data_WAKE_WAKE_5(isnan(data_WAKE_WAKE_5)==1)=0;
% %     data_WAKE_REM_5(m,:) = all_trans_WAKE_REM_5{m}; data_WAKE_REM_5(isnan(data_WAKE_REM_5)==1)=0;
% %     data_WAKE_SWS_5(m,:) = all_trans_WAKE_SWS_5{m}; data_WAKE_SWS_5(isnan(data_WAKE_SWS_5)==1)=0;
% %
% %     %%3 PREMI7RES HEURES
% %         data_REM_REM_begin_5(m,:) = all_trans_REM_REM_begin_5{m}; data_REM_REM_begin_5(isnan(data_REM_REM_begin_5)==1)=0;
% %     data_REM_SWS_begin_5(m,:) = all_trans_REM_SWS_begin_5{m}; data_REM_SWS_begin_5(isnan(data_REM_SWS_begin_5)==1)=0;
% %     data_REM_WAKE_begin_5(m,:) = all_trans_REM_WAKE_begin_5{m}; data_REM_WAKE_begin_5(isnan(data_REM_WAKE_begin_5)==1)=0;
% %
% %     data_SWS_SWS_begin_5(m,:) = all_trans_SWS_SWS_begin_5{m}; data_SWS_SWS_begin_5(isnan(data_SWS_SWS_begin_5)==1)=0;
% %     data_SWS_REM_begin_5(m,:) = all_trans_SWS_REM_begin_5{m}; data_SWS_REM_begin_5(isnan(data_SWS_REM_begin_5)==1)=0;
% %     data_SWS_WAKE_begin_5(m,:) = all_trans_SWS_WAKE_begin_5{m}; data_SWS_WAKE_begin_5(isnan(data_SWS_WAKE_begin_5)==1)=0;
% %
% %     data_WAKE_WAKE_begin_5(m,:) = all_trans_WAKE_WAKE_begin_5{m}; data_WAKE_WAKE_begin_5(isnan(data_WAKE_WAKE_begin_5)==1)=0;
% %     data_WAKE_REM_begin_5(m,:) = all_trans_WAKE_REM_begin_5{m}; data_WAKE_REM_begin_5(isnan(data_WAKE_REM_begin_5)==1)=0;
% %     data_WAKE_SWS_begin_5(m,:) = all_trans_WAKE_SWS_begin_5{m}; data_WAKE_SWS_begin_5(isnan(data_WAKE_SWS_begin_5)==1)=0;
% %
% %     %%FIN DE LA SESSION
% %         data_REM_REM_end_5(m,:) = all_trans_REM_REM_end_5{m}; data_REM_REM_end_5(isnan(data_REM_REM_end_5)==1)=0;
% %     data_REM_SWS_end_5(m,:) = all_trans_REM_SWS_end_5{m}; data_REM_SWS_end_5(isnan(data_REM_SWS_end_5)==1)=0;
% %     data_REM_WAKE_end_5(m,:) = all_trans_REM_WAKE_end_5{m}; data_REM_WAKE_end_5(isnan(data_REM_WAKE_end_5)==1)=0;
% %
% %     data_SWS_SWS_end_5(m,:) = all_trans_SWS_SWS_end_5{m}; data_SWS_SWS_end_5(isnan(data_SWS_SWS_end_5)==1)=0;
% %     data_SWS_REM_end_5(m,:) = all_trans_SWS_REM_end_5{m}; data_SWS_REM_end_5(isnan(data_SWS_REM_end_5)==1)=0;
% %     data_SWS_WAKE_end_5(m,:) = all_trans_SWS_WAKE_end_5{m}; data_SWS_WAKE_end_5(isnan(data_SWS_WAKE_end_5)==1)=0;
% %
% %     data_WAKE_WAKE_end_5(m,:) = all_trans_WAKE_WAKE_end_5{m}; data_WAKE_WAKE_end_5(isnan(data_WAKE_WAKE_end_5)==1)=0;
% %     data_WAKE_REM_end_5(m,:) = all_trans_WAKE_REM_end_5{m}; data_WAKE_REM_end_5(isnan(data_WAKE_REM_end_5)==1)=0;
% %     data_WAKE_SWS_end_5(m,:) = all_trans_WAKE_SWS_end_5{m}; data_WAKE_SWS_end_5(isnan(data_WAKE_SWS_end_5)==1)=0;
data_REM_short_WAKE_end_5(m,:) = all_trans_REM_short_WAKE_end_5{m}; data_REM_short_WAKE_end_5(isnan(data_REM_short_WAKE_end_5)==1)=0;
data_REM_short_SWS_end_5(m,:) = all_trans_REM_short_SWS_end_5{m}; data_REM_short_SWS_end_5(isnan(data_REM_short_SWS_end_5)==1)=0;

data_REM_mid_WAKE_end_5(m,:) = all_trans_REM_mid_WAKE_end_5{m}; data_REM_mid_WAKE_end_5(isnan(data_REM_mid_WAKE_end_5)==1)=0;
data_REM_mid_SWS_end_5(m,:) = all_trans_REM_mid_SWS_end_5{m}; data_REM_mid_SWS_end_5(isnan(data_REM_mid_SWS_end_5)==1)=0;

data_REM_long_WAKE_end_5(m,:) = all_trans_REM_long_WAKE_end_5{m}; data_REM_long_WAKE_end_5(isnan(data_REM_long_WAKE_end_5)==1)=0;
data_REM_long_SWS_end_5(m,:) = all_trans_REM_long_SWS_end_5{m}; data_REM_long_SWS_end_5(isnan(data_REM_long_SWS_end_5)==1)=0;


data_REM_short_REM_end_5(m,:) = all_trans_REM_short_REM_end_5{m}; data_REM_short_REM_end_5(isnan(data_REM_short_REM_end_5)==1)=0;
data_REM_mid_REM_end_5(m,:) = all_trans_REM_mid_REM_end_5{m}; data_REM_mid_REM_end_5(isnan(data_REM_mid_REM_end_5)==1)=0;
data_REM_long_REM_end_5(m,:) = all_trans_REM_long_REM_end_5{m}; data_REM_long_REM_end_5(isnan(data_REM_long_REM_end_5)==1)=0;
