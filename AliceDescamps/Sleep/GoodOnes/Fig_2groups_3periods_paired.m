...
% legend = {'1','2'};
legend = {'Sal mCherry (n=4)','SD + CNO mCherry (n=4)'};
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_WAKE_begin_1,2), nanmean(data_perc_WAKE_begin_2,2)},...
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_SWS_begin_1,2), nanmean(data_perc_SWS_begin_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none') 
set(gca,'xticklabels',[])
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_REM_begin_1,2), nanmean(data_perc_REM_begin_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
set(gca,'xticklabels',[])
...
subplot(4,7,[8],'align') %WAKE percentage phase2
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_WAKE_interPeriod_1,2), nanmean(data_perc_WAKE_interPeriod_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
set(gca,'xticklabels',[])
ylabel('Wake percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_SWS_interPeriod_1,2), nanmean(data_perc_SWS_interPeriod_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
set(gca,'xticklabels',[])
ylabel('NREM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_SWS_interPeriod_1,2), nanmean(data_num_SWS_interPeriod_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
set(gca,'xticklabels',[])
ylabel('NREM bouts number')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_REM_interPeriod_1,2), nanmean(data_perc_REM_interPeriod_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
set(gca,'xticklabels',[])
ylabel('REM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_REM_interPeriod_1,2), nanmean(data_num_REM_interPeriod_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
set(gca,'xticklabels',[])
ylabel('REM bouts number')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_WAKE_end_1,2), nanmean(data_perc_WAKE_end_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
% set(gca,'xticklabels',[])
ylabel('Wake percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_SWS_end_1,2), nanmean(data_perc_SWS_end_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
% set(gca,'xticklabels',[])
ylabel('NREM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_REM_end_1,2), nanmean(data_perc_REM_end_2,2)},...
    {col_1,col_2},[1:2],legend,'paired',1,'showsigstar','none')   
% set(gca,'xticklabels',[])
ylabel('REM percentage')
% makepretty
