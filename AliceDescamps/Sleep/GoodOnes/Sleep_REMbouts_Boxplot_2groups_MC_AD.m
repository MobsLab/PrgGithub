...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_WAKE_begin_ctrl,2), nanmean(data_perc_WAKE_begin_SD,2)},...
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_SWS_begin_ctrl,2), nanmean(data_perc_SWS_begin_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_REM_begin_ctrl,2), nanmean(data_perc_REM_begin_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_REM_begin_ctrl,2), nanmean(data_num_REM_begin_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_dur_REM_begin_ctrl,2), nanmean(data_dur_REM_begin_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_WAKE_end_ctrl,2), nanmean(data_perc_WAKE_end_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('Wake percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_SWS_end_ctrl,2), nanmean(data_perc_SWS_end_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('NREM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_REM_end_ctrl,2), nanmean(data_perc_REM_end_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('REM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_num_REM_end_ctrl,2), nanmean(data_num_REM_end_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('REM bouts number')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_dur_REM_end_ctrl,2), nanmean(data_dur_REM_end_SD,2)},...
    {col_ctrl,col_SD},[1:2],{},'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('REM bouts duration (s)')
% makepretty
