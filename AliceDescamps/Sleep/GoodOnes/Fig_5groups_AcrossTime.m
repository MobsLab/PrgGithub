...
plot(nanmean(data_perc_WAKE_5),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_5,'color',col_5)
errorbar(nanmean(data_perc_WAKE_5), stdError(data_perc_WAKE_5),'LineWidth',2,'color',col_5)
xlim([0 8.5])
...
plot(nanmean(data_perc_SWS_5),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_5,'color',col_5)
errorbar(nanmean(data_perc_SWS_5), stdError(data_perc_SWS_5),'LineWidth',2,'color',col_5)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
ylim([0 100])
makepretty
...
plot(nanmean(data_perc_REM_5),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_5,'color',col_5)
errorbar(nanmean(data_perc_REM_5), stdError(data_perc_REM_5),'LineWidth',2,'color',col_5)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
