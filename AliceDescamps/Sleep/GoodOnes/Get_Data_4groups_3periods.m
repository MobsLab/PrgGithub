...
% DirSocialDefeat_classic = RestrictPathForExperiment(DirSocialDefeat_classic,'nMice',[1566 1580]);
...
% DirSocialDefeat_totSleepPost_mCherry_cno = PathForExperiments_SleepPostSD_AD('SleepPostSD_mCherry_CRH_VLPO_SalineInjection_10am');
% DirSocialDefeat_totSleepPost_mCherry_cno = RestrictPathForExperiment(DirSocialDefeat_totSleepPost_mCherry_cno,'nMice',[1581 1635]);
...
% DirSocialDefeat_totSleepPost_dreadd_cno =PathForExperiments_SleepPostSD_AD('SleepPostSD_SecondRun_inhibDREADD_CRH_VLPO_SalineInjection_10am');
% DirSocialDefeat_totSleepPost_dreadd_cno =PathForExperiments_SleepPostSD_AD('SleepPostSD_ThirdRun_Wisden_mCherry_CRH_VLPO_SalineInjection_10am');
...
% time_mid_end_first_period = 3.5*3600*1e4; %1.5         %2 first hours (insomnia)
% time_mid_end_first_period = 6.5*3600*1e4; %1.5         %2 first hours (insomnia)
time_mid_end_first_period = 8*3600*1e4; %1.5         %2 first hours (insomnia)
% time_mid_begin_snd_period = 8*3600*1e4;%3.3           %2 last hours(late phase of the night)
