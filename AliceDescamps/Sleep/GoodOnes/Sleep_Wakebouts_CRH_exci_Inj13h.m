...
subplot(4,6,[13,14]) % Wake bouts number overtime
...
PlotErrorBarN_MC({...
    nanmean(data_num_WAKE_1_3h_ctrl,2), nanmean(data_num_WAKE_1_3h_SD_mCherry_cno,2),...
    nanmean(data_num_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:2,4:5],'barcolors',{col_1,col_2,col_1,col_2});
xticks([1.5 4.5]); xticklabels({'9-13h','13-18h'}); xtickangle(0)
...
%Stat Wake number
% [h,p_sal_vs_cno_WAKE_number_1_3h] = ttest(nanmean(data_num_WAKE_1_3h_ctrl,2), nanmean(data_num_WAKE_1_3h_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_WAKE_number_1_3h] = ttest2(nanmean(data_num_WAKE_1_3h_ctrl,2), nanmean(data_num_WAKE_1_3h_SD_mCherry_cno,2));
[p_sal_vs_cno_WAKE_number_1_3h,h] = signrank(nanmean(data_num_WAKE_1_3h_ctrl,2), nanmean(data_num_WAKE_1_3h_SD_mCherry_cno,2));
% [p_sal_vs_cno_WAKE_number_1_3h,h] = ranksum(nanmean(data_num_WAKE_1_3h_ctrl,2), nanmean(data_num_WAKE_1_3h_SD_mCherry_cno,2));

% [h,p_sal_vs_cno_WAKE_number_3_end] = ttest(nanmean(data_num_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_WAKE_number_3_end] = ttest2(nanmean(data_num_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2));
[p_sal_vs_cno_WAKE_number_3_end,h] = signrank(nanmean(data_num_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_WAKE_number_3_end,h] = ranksum(nanmean(data_num_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2));

if p_sal_vs_cno_WAKE_number_1_3h<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_WAKE_number_1_3h,0,'LineWigth',16,'StarSize',24); end
if p_sal_vs_cno_WAKE_number_3_end<0.05; sigstar_DB({[4 5]},p_sal_vs_cno_WAKE_number_3_end,0,'LineWigth',16,'StarSize',24);end
...
PlotErrorBarN_MC({...
    nanmean(data_dur_WAKE_1_3h_ctrl,2), nanmean(data_dur_WAKE_1_3h_SD_mCherry_cno,2),...
    nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2)},...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:2,4:5],'barcolors',{col_1,col_2,col_1,col_2});
xticks([1.5 4.5]); xticklabels({'9-13h','13-18h'}); xtickangle(0)
...
%Stat Wake duration
% [h,p_sal_vs_cno_WAKE_dur_1_3h] = ttest(nanmean(data_dur_WAKE_1_3h_ctrl,2), nanmean(data_dur_WAKE_1_3h_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_WAKE_dur_1_3h] = ttest2(nanmean(data_dur_WAKE_1_3h_ctrl,2), nanmean(data_dur_WAKE_1_3h_SD_mCherry_cno,2));
[p_sal_vs_cno_WAKE_dur_1_3h,h] = signrank(nanmean(data_dur_WAKE_1_3h_ctrl,2), nanmean(data_dur_WAKE_1_3h_SD_mCherry_cno,2));
% [p_sal_vs_cno_WAKE_dur_1_3h,h] = ranksum(nanmean(data_dur_WAKE_1_3h_ctrl,2), nanmean(data_dur_WAKE_1_3h_SD_mCherry_cno,2));

% [h,p_sal_vs_cno_WAKE_dur_3_end] = ttest(nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_WAKE_dur_3_end] = ttest2(nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2));
[p_sal_vs_cno_WAKE_dur_3_end,h] = signrank(nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_WAKE_dur_3_end,h] = ranksum(nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2));

if p_sal_vs_cno_WAKE_dur_1_3h<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_WAKE_dur_1_3h,0,'LineWigth',16,'StarSize',24); end
if p_sal_vs_cno_WAKE_dur_3_end<0.05; sigstar_DB({[4 5]},p_sal_vs_cno_WAKE_dur_3_end,0,'LineWigth',16,'StarSize',24);end
...
%Stat Wake FI
% [h,p_sal_vs_cno_WAKE_FI_3_end] = ttest(nanmean(data_num_WAKE_3_end_ctrl,2)./nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2)./nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_WAKE_FI_3_end] = ttest2(nanmean(data_num_WAKE_3_end_ctrl,2)./nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2)./nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2));
[p_sal_vs_cno_WAKE_FI_3_end,h] = signrank(nanmean(data_num_WAKE_3_end_ctrl,2)./nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2)./nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_WAKE_FI_3_end,h] = ranksum(nanmean(data_num_WAKE_3_end_ctrl,2)./nanmean(data_dur_WAKE_3_end_ctrl,2), nanmean(data_num_WAKE_3_end_SD_mCherry_cno,2)./nanmean(data_dur_WAKE_3_end_SD_mCherry_cno,2));

if p_sal_vs_cno_WAKE_FI_3_end<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_WAKE_FI_3_end,0,'LineWigth',16,'StarSize',24);end


subplot(4,6,[23]) %proba stay Wake 4-8h
PlotErrorBarN_MC({...
...
%Stat Wake proba stay
[h,p_sal_vs_cno_WAKE_proba_stay_3_end] = ttest(1-(nanmean(data_WAKE_REM_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2)), 1-(nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2)));
% [h,p_sal_vs_cno_WAKE_proba_stay_3_end] = ttest2(1-(nanmean(data_WAKE_REM_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2)),1-(nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2)));
% [p_sal_vs_cno_WAKE_proba_stay_3_end,h] = signrank(1-(nanmean(data_WAKE_REM_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2)), 1-(nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2)));
% [p_sal_vs_cno_WAKE_proba_stay_3_end,h] = ranksum(1-(nanmean(data_WAKE_REM_3_end_ctrl,2)+nanmean(data_WAKE_SWS_3_end_ctrl,2)), 1-(nanmean(data_WAKE_REM_3_end_SD_mCherry_cno,2)+nanmean(data_WAKE_SWS_3_end_SD_mCherry_cno,2)));

if p_sal_vs_cno_WAKE_proba_stay_3_end<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_WAKE_proba_stay_3_end,0,'LineWigth',16,'StarSize',24);end
...
[h,p_sal_vs_cno_WAKE_proba_init_3_end] = ttest(nanmean(data_REM_WAKE_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2), nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2));
% [h,p_sal_vs_cno_WAKE_proba_init_3_end] = ttest2(nanmean(data_REM_WAKE_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2), nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_WAKE_proba_init_3_end,h] = signrank(nanmean(data_REM_WAKE_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2), nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2));
% [p_sal_vs_cno_WAKE_proba_init_3_end,h] = ranksum(nanmean(data_REM_WAKE_3_end_ctrl,2)+nanmean(data_SWS_WAKE_3_end_ctrl,2), nanmean(data_REM_WAKE_3_end_SD_mCherry_cno,2)+nanmean(data_SWS_WAKE_3_end_SD_mCherry_cno,2));

if p_sal_vs_cno_WAKE_proba_init_3_end<0.05; sigstar_DB({[1 2]},p_sal_vs_cno_WAKE_proba_init_3_end,0,'LineWigth',16,'StarSize',24);end
