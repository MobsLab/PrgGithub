...
if isparam ==0
    ...
    [p_9,h_9, stats] = ranksum(data_dur_WAKE_1(:,9), data_dur_WAKE_2(:,9));
elseif isparam ==1
    ...
    [h_9,p_9] = ttest2(data_dur_WAKE_1(:,9), data_dur_WAKE_2(:,9));
else
end
if iscorr ==0
...
if isparam ==0
    ...
    [p_9,h_9, stats] = ranksum(data_dur_SWS_1(:,9), data_dur_SWS_2(:,9));
elseif isparam ==1
    ...
    [h_9,p_9] = ttest2(data_dur_SWS_1(:,9), data_dur_SWS_2(:,9));
else
end
if iscorr ==0
    %%comparaisons multiples non corrigées
