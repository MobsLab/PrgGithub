...
subplot(4,6,[7,8]), hold on % SWS percentage overtime
...
subplot(4,6,[13,14]) %REM percentage overtime
...
if isparam==0 %%version ranksum (non param)
    %phase1
    data_perc_WAKE_begin = [data_perc_WAKE_begin_1, data_perc_WAKE_begin_2, data_perc_WAKE_begin_3]
    [p,anovatab,stats] = kruskalwallis(data_perc_WAKE_begin);
elseif isparam==1 %%version ttest
    %phase1
    data_perc_WAKE_begin = [data_perc_WAKE_begin_1, data_perc_WAKE_begin_2, data_perc_WAKE_begin_3]
    [p,anovatab,stats] = anova1(data_perc_WAKE_begin);
else
end
...
if isparam==0 %%version ranksum (non param)
    %phase2
    data_perc_WAKE_interPeriod = [data_perc_WAKE_interPeriod_1, data_perc_WAKE_interPeriod_2, data_perc_WAKE_interPeriod_3];
    [p,anovatab,stats] = kruskalwallis(data_perc_WAKE_interPeriod);
elseif isparam==1 %%version ttest
    %phase2
    data_perc_WAKE_interPeriod = [data_perc_WAKE_interPeriod_1, data_perc_WAKE_interPeriod_2, data_perc_WAKE_interPeriod_3];
    [p,anovatab,stats] = anova1(data_perc_WAKE_interPeriod);
else
end
% %%add corrections for multiple comparisons
% if iscorr==0
...
if isparam==0 %%version ranksum (non param)
    %phase3
    data_perc_WAKE_end = [data_perc_WAKE_end_1, data_perc_WAKE_end_2, data_perc_WAKE_end_3];
    [p,anovatab,stats] = kruskalwallis(data_perc_WAKE_end);
elseif isparam==1 %%version ttest
    %phase3
    data_perc_WAKE_end = [data_perc_WAKE_end_1, data_perc_WAKE_end_2, data_perc_WAKE_end_3];
    [p,anovatab,stats] = anova1(data_perc_WAKE_end);
else
end
% %%add corrections for multiple comparisons
% if iscorr==0
...
subplot(4,6,[10],'align') %NREM percentage phase1
MakeSpreadAndBoxPlot2_MC({...
...
if isparam==0 %%version ranksum (non param)
    %phase1
    data_perc_SWS_begin = [data_perc_SWS_begin_1, data_perc_SWS_begin_2, data_perc_SWS_begin_3];
    [p,anovatab,stats] = kruskalwallis(data_perc_SWS_begin);
elseif isparam==1 %%version ttest
    %phase1
    data_perc_SWS_begin = [data_perc_SWS_begin_1, data_perc_SWS_begin_2, data_perc_SWS_begin_3];
    [p,anovatab,stats] = anova1(data_perc_SWS_begin);
else
end
% %%add corrections for multiple comparisons
% if iscorr==0
...
if isparam==0 %%version ranksum (non param)
    %phase2
    data_perc_SWS_interPeriod = [data_perc_SWS_interPeriod_1, data_perc_SWS_interPeriod_2, data_perc_SWS_interPeriod_3];
    [p,anovatab,stats] = kruskalwallis(data_perc_SWS_interPeriod);
elseif isparam==1 %%version ttest
    %phase2
    data_perc_SWS_interPeriod = [data_perc_SWS_interPeriod_1, data_perc_SWS_interPeriod_2, data_perc_SWS_interPeriod_3];
    [p,anovatab,stats] = anova1(data_perc_SWS_interPeriod);
else
end
% %%add corrections for multiple comparisons
% if iscorr==0
...
subplot(4,6,[12],'align') %NREM percentage phase3
...
if isparam==0 %%version ranksum (non param)
    %phase3
    data_perc_SWS_end = [data_perc_SWS_end_1, data_perc_SWS_end_2, data_perc_SWS_end_3];
    [p,anovatab,stats] = kruskalwallis(data_perc_SWS_end);
elseif isparam==1 %%version ttest
    %phase3
    data_perc_SWS_end = [data_perc_SWS_end_1, data_perc_SWS_end_2, data_perc_SWS_end_3];
    [p,anovatab,stats] = anova1(data_perc_SWS_end);
else
end
% %%add corrections for multiple comparisons
% if iscorr==0
...
subplot(4,6,[16],'align') %REM percentage phase1
MakeSpreadAndBoxPlot2_MC({...
...
if isparam==0 %%version ranksum (non param)
    %phase1
    data_perc_REM_begin = [data_perc_REM_begin_1, data_perc_REM_begin_2, data_perc_REM_begin_3];
    [p,anovatab,stats] = kruskalwallis(data_perc_REM_begin);
elseif isparam==1 %%version ttest
    %phase1
    data_perc_REM_begin = [data_perc_REM_begin_1, data_perc_REM_begin_2, data_perc_REM_begin_3];
    [p,anovatab,stats] = anova1(data_perc_REM_begin);
else
end
% %%add corrections for multiple comparisons
% if iscorr==0
...
if isparam==0 %%version ranksum (non param)
    %phase2
    data_perc_REM_interPeriod = [data_perc_REM_interPeriod_1, data_perc_REM_interPeriod_2, data_perc_REM_interPeriod_3];
    [p,anovatab,stats] = kruskalwallis(data_perc_REM_interPeriod);
elseif isparam==1 %%version ttest
    %phase2
    data_perc_REM_interPeriod = [data_perc_REM_interPeriod_1, data_perc_REM_interPeriod_2, data_perc_REM_interPeriod_3];
    [p,anovatab,stats] = anova1(data_perc_REM_interPeriod);
else
end
% %%add corrections for multiple comparisons
% if iscorr==0
...
if isparam==0 %%version ranksum (non param)
    %phase3
    data_perc_REM_end = [data_perc_REM_end_1, data_perc_REM_end_2, data_perc_REM_end_3];
    [p,anovatab,stats] = kruskalwallis(data_perc_REM_end_1, data_perc_REM_end_2, data_perc_REM_end_3);
elseif isparam==1 %%version ttest
    %phase3
    data_perc_REM_end = [data_perc_REM_end_1, data_perc_REM_end_2, data_perc_REM_end_3];
    [p,anovatab,stats] = anova1(data_perc_REM_end);
else
end
% %%add corrections for multiple comparisons
% if iscorr==0
