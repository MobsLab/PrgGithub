...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_WAKE_begin_1,2), nanmean(data_num_WAKE_begin_2,2), nanmean(data_num_WAKE_begin_3,2)},...
...
subplot(4,6,[5],'align') %WAKE number phase2
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_2,2), nanmean(data_num_WAKE_interPeriod_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('Wake number')
% makepretty
...
subplot(4,6,[6],'align') %WAKE number phase3
MakeSpreadAndBoxPlot2_MC({nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_2,2), nanmean(data_num_WAKE_end_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('Wake number')
% makepretty
