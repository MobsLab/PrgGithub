...
legend = {'CNO mCherry (n=10)','SD1 + CNO mCherry (n=6)','SD2 + CNO mCherry (n=2)'};


figure('color',[1 1 1])
% suptitle ('xxxxxxxxxxxxx')
% suptitle ('Comparison between SD1 and SD2 saline')
suptitle ('Comparison between SD1 and SD2 CNO')
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_WAKE_begin_1,2), nanmean(data_perc_WAKE_begin_2,2), nanmean(data_perc_WAKE_begin_3,2)},...
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_SWS_begin_1,2), nanmean(data_perc_SWS_begin_2,2), nanmean(data_perc_SWS_begin_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_SWS_begin_1,2), nanmean(data_num_SWS_begin_2,2), nanmean(data_num_SWS_begin_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_REM_begin_1,2), nanmean(data_perc_REM_begin_2,2), nanmean(data_perc_REM_begin_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_REM_begin_1,2), nanmean(data_num_REM_begin_2,2), nanmean(data_num_REM_begin_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
...
subplot(4,7,[8],'align') %WAKE percentage phase2
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_WAKE_interPeriod_1,2), nanmean(data_perc_WAKE_interPeriod_2,2), nanmean(data_perc_WAKE_interPeriod_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('Wake percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_SWS_interPeriod_1,2), nanmean(data_perc_SWS_interPeriod_2,2), nanmean(data_perc_SWS_interPeriod_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('NREM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_SWS_interPeriod_1,2), nanmean(data_num_SWS_interPeriod_2,2), nanmean(data_num_SWS_interPeriod_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('NREM bouts number')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_perc_REM_interPeriod_1,2), nanmean(data_perc_REM_interPeriod_2,2), nanmean(data_perc_REM_interPeriod_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('REM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_REM_interPeriod_1,2), nanmean(data_num_REM_interPeriod_2,2), nanmean(data_num_REM_interPeriod_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('REM bouts number')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_WAKE_end_1,2), nanmean(data_perc_WAKE_end_2,2), nanmean(data_perc_WAKE_end_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
% set(gca,'xticklabels',[])
ylabel('Wake percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_SWS_end_1,2), nanmean(data_perc_SWS_end_2,2), nanmean(data_perc_SWS_end_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
% set(gca,'xticklabels',[])
ylabel('NREM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_num_SWS_end_1,2), nanmean(data_num_SWS_end_2,2), nanmean(data_num_SWS_end_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
% set(gca,'xticklabels',[])
ylabel('NREM bouts number')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_REM_end_1,2), nanmean(data_perc_REM_end_2,2), nanmean(data_perc_REM_end_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
% set(gca,'xticklabels',[])
ylabel('REM percentage')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_num_REM_end_1,2), nanmean(data_num_REM_end_2,2), nanmean(data_num_REM_end_3,2)},...
    {col_1,col_2,col_3},[1:3],legend,'paired',0,'showsigstar','none') 
% set(gca,'xticklabels',[])
ylabel('REM bouts number')
% makepretty
