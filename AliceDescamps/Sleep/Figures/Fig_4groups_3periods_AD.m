...
% legend = {'1','2','3','4'};
legend = {'Sal C57 (n=11)','Sal CRH (n=11)','SD + Sal C57 (n=13)','SD + Sal CRH (n=3)'};
% legend = {'Sal mCherry (n=11)','SD + Sal mCherry (n=3)','SD + CNO mCherry (n=6)','SD + CNO DREADD- (n=7)'};
% legend = {'Sal DREADD- (n=8)','SD + Sal mCherry (n=3)','SD + CNO mCherry (n=6)','SD + CNO DREADD- (n=7)'};
% legend = {'Sal mCherry (n=11)','SD1 + Sal mCherry (n=3)','SD2 + Sal mCherry (n=4)','SD2 + Sal DREADD- (n=4)'};
% legend = {'Sal DREADD- (n=8)','SD1 + Sal mCherry (n=3)','SD2 + Sal mCherry (n=4)','SD2 + Sal DREADD- (n=4)'};


figure('color',[1 1 1])
% suptitle ('xxxxxxxxxxxxx')
suptitle ('Effect of SD on both strain')
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_SWS_interPeriod_1,2), nanmean(data_num_SWS_interPeriod_2,2), nanmean(data_num_SWS_interPeriod_3,2), nanmean(data_num_SWS_interPeriod_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('NREM bouts number')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_dur_SWS_interPeriod_1,2), nanmean(data_dur_SWS_interPeriod_2,2), nanmean(data_dur_SWS_interPeriod_3,2), nanmean(data_dur_SWS_interPeriod_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('NREM bouts duration (s)')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_REM_interPeriod_1,2), nanmean(data_num_REM_interPeriod_2,2), nanmean(data_num_REM_interPeriod_3,2), nanmean(data_num_REM_interPeriod_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('REM bouts number')
% makepretty
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_dur_REM_interPeriod_1,2), nanmean(data_dur_REM_interPeriod_2,2), nanmean(data_dur_REM_interPeriod_3,2), nanmean(data_dur_REM_interPeriod_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
set(gca,'xticklabels',[])
ylabel('REM bouts duration (s)')
% makepretty
...
if isparam==0 %%version ranksum (non param)
    %phase2
    [p_1_vs_2_2, h_2] = ranksum(nanmean(data_perc_WAKE_end_1,2), nanmean(data_perc_WAKE_end_2,2));
    [p_1_vs_4_2, h_2] = ranksum(nanmean(data_perc_WAKE_end_1,2),nanmean(data_perc_WAKE_end_4,2));
    [p_2_vs_4_2, h_2] = ranksum(nanmean(data_perc_WAKE_end_2,2), nanmean(data_perc_WAKE_end_4,2));
    [p_1_vs_3_2, h_2] = ranksum(nanmean(data_perc_WAKE_end_1,2), nanmean(data_perc_WAKE_end_3,2));
    [p_2_vs_3_2, h_2] = ranksum(nanmean(data_perc_WAKE_end_2,2), nanmean(data_perc_WAKE_end_3,2));
    [p_3_vs_4_2, h_2] = ranksum(nanmean(data_perc_WAKE_end_3,2), nanmean(data_perc_WAKE_end_4,2));
elseif isparam==1 %%version ttest
    %phase2
    [h_2,p_1_vs_2_2] = ttest2(nanmean(data_perc_WAKE_end_1,2), nanmean(data_perc_WAKE_end_2,2));
    [h_2,p_1_vs_4_2] = ttest2(nanmean(data_perc_WAKE_end_1,2),nanmean(data_perc_WAKE_end_4,2));
    [h_2,p_2_vs_4_2] = ttest2(nanmean(data_perc_WAKE_end_2,2), nanmean(data_perc_WAKE_end_4,2));
    [h_2,p_1_vs_3_2] = ttest2(nanmean(data_perc_WAKE_end_1,2), nanmean(data_perc_WAKE_end_3,2));
    [h_2,p_2_vs_3_2] = ttest2(nanmean(data_perc_WAKE_end_2,2), nanmean(data_perc_WAKE_end_3,2));
    [h_2,p_3_vs_4_2] = ttest2(nanmean(data_perc_WAKE_end_3,2), nanmean(data_perc_WAKE_end_4,2));
else
end
%%add corrections for multiple comparisons
if iscorr==0
    %phase2
    if p_1_vs_2_2<0.05; sigstar_MC({[6 7]},p_1_vs_2_2,0,'LineWigth',16,'StarSize',24);end
    if p_1_vs_4_2<0.05; sigstar_MC({[6 9]},p_1_vs_4_2,0,'LineWigth',16,'StarSize',24);end
    if p_2_vs_4_2<0.05; sigstar_MC({[7 9]},p_2_vs_4_2,0,'LineWigth',16,'StarSize',24);end
    if p_1_vs_3_2<0.05; sigstar_MC({[6 8]},p_1_vs_3_2,0,'LineWigth',16,'StarSize',24);end
    if p_2_vs_3_2<0.05; sigstar_MC({[7 8]},p_2_vs_3_2,0,'LineWigth',16,'StarSize',24);end
    if p_3_vs_4_2<0.05; sigstar_MC({[8 9]},p_3_vs_4_2,0,'LineWigth',16,'StarSize',24);end
elseif iscorr==1
    p_values = [p_1_vs_2_2 p_1_vs_4_2 p_2_vs_4_2 p_1_vs_3_2 p_2_vs_3_2 p_3_vs_4_2];
    [h_2, crit_p_2, adj_ci_cvrg_2, adj_p] = fdr_bh(p_values);
    %phase2
    if adj_p(1)<0.05; sigstar_MC({[1 2]},adj_p(1),0,'LineWigth',16,'StarSize',24);end
    if adj_p(2)<0.05; sigstar_MC({[1 4]},adj_p(2),0,'LineWigth',16,'StarSize',24);end
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_perc_SWS_end_1,2), nanmean(data_perc_SWS_end_2,2), nanmean(data_perc_SWS_end_3,2), nanmean(data_perc_SWS_end_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
% set(gca,'xticklabels',[])
ylabel('NREM percentage')
% makepretty
...
if isparam==0 %%version ranksum (non param)
    %phase2
    [p_1_vs_2_2, h_2] = ranksum(nanmean(data_perc_SWS_end_1,2), nanmean(data_perc_SWS_end_2,2));
    [p_1_vs_4_2, h_2] = ranksum(nanmean(data_perc_SWS_end_1,2),nanmean(data_perc_SWS_end_4,2));
    [p_2_vs_4_2, h_2] = ranksum(nanmean(data_perc_SWS_end_2,2), nanmean(data_perc_SWS_end_4,2));
    [p_1_vs_3_2, h_2] = ranksum(nanmean(data_perc_SWS_end_1,2), nanmean(data_perc_SWS_end_3,2));
    [p_2_vs_3_2, h_2] = ranksum(nanmean(data_perc_SWS_end_2,2), nanmean(data_perc_SWS_end_3,2));
    [p_3_vs_4_2, h_2] = ranksum(nanmean(data_perc_SWS_end_3,2), nanmean(data_perc_SWS_end_4,2));
elseif isparam==1 %%version ttest
    %phase2
    [h_2,p_1_vs_2_2] = ttest2(nanmean(data_perc_SWS_end_1,2), nanmean(data_perc_SWS_end_2,2));
    [h_2,p_1_vs_4_2] = ttest2(nanmean(data_perc_SWS_end_1,2),nanmean(data_perc_SWS_end_4,2));
    [h_2,p_2_vs_4_2] = ttest2(nanmean(data_perc_SWS_end_2,2), nanmean(data_perc_SWS_end_4,2));
    [h_2,p_1_vs_3_2] = ttest2(nanmean(data_perc_SWS_end_1,2), nanmean(data_perc_SWS_end_3,2));
    [h_2,p_2_vs_3_2] = ttest2(nanmean(data_perc_SWS_end_2,2), nanmean(data_perc_SWS_end_3,2));
    [h_2,p_3_vs_4_2] = ttest2(nanmean(data_perc_SWS_end_3,2), nanmean(data_perc_SWS_end_4,2));
else
end
%%add corrections for multiple comparisons
if iscorr==0
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_num_SWS_end_1,2), nanmean(data_num_SWS_end_2,2), nanmean(data_num_SWS_end_3,2), nanmean(data_num_SWS_end_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
% set(gca,'xticklabels',[])
ylabel('NREM bouts number')
% makepretty
...
if isparam==0 %%version ranksum (non param)
    %phase2
    [p_1_vs_2_2, h_2] = ranksum(nanmean(data_num_SWS_end_1,2), nanmean(data_num_SWS_end_2,2));
    [p_1_vs_4_2, h_2] = ranksum(nanmean(data_num_SWS_end_1,2),nanmean(data_num_SWS_end_4,2));
    [p_2_vs_4_2, h_2] = ranksum(nanmean(data_num_SWS_end_2,2), nanmean(data_num_SWS_end_4,2));
    [p_1_vs_3_2, h_2] = ranksum(nanmean(data_num_SWS_end_1,2), nanmean(data_num_SWS_end_3,2));
    [p_2_vs_3_2, h_2] = ranksum(nanmean(data_num_SWS_end_2,2), nanmean(data_num_SWS_end_3,2));
    [p_3_vs_4_2, h_2] = ranksum(nanmean(data_num_SWS_end_3,2), nanmean(data_num_SWS_end_4,2));
elseif isparam==1 %%version ttest
    %phase2
    [h_2,p_1_vs_2_2] = ttest2(nanmean(data_num_SWS_end_1,2), nanmean(data_num_SWS_end_2,2));
    [h_2,p_1_vs_4_2] = ttest2(nanmean(data_num_SWS_end_1,2),nanmean(data_num_SWS_end_4,2));
    [h_2,p_2_vs_4_2] = ttest2(nanmean(data_num_SWS_end_2,2), nanmean(data_num_SWS_end_4,2));
    [h_2,p_1_vs_3_2] = ttest2(nanmean(data_num_SWS_end_1,2), nanmean(data_num_SWS_end_3,2));
    [h_2,p_2_vs_3_2] = ttest2(nanmean(data_num_SWS_end_2,2), nanmean(data_num_SWS_end_3,2));
    [h_2,p_3_vs_4_2] = ttest2(nanmean(data_num_SWS_end_3,2), nanmean(data_num_SWS_end_4,2));
else
end
%%add corrections for multiple comparisons
if iscorr==0
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_dur_SWS_end_1,2), nanmean(data_dur_SWS_end_2,2), nanmean(data_dur_SWS_end_3,2), nanmean(data_dur_SWS_end_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
% set(gca,'xticklabels',[])
ylabel('NREM bouts duration (s)')
% makepretty
...
if isparam==0 %%version ranksum (non param)
    %phase2
    [p_1_vs_2_2, h_2] = ranksum(nanmean(data_dur_SWS_end_1,2), nanmean(data_dur_SWS_end_2,2));
    [p_1_vs_4_2, h_2] = ranksum(nanmean(data_dur_SWS_end_1,2),nanmean(data_dur_SWS_end_4,2));
    [p_2_vs_4_2, h_2] = ranksum(nanmean(data_dur_SWS_end_2,2), nanmean(data_dur_SWS_end_4,2));
    [p_1_vs_3_2, h_2] = ranksum(nanmean(data_dur_SWS_end_1,2), nanmean(data_dur_SWS_end_3,2));
    [p_2_vs_3_2, h_2] = ranksum(nanmean(data_dur_SWS_end_2,2), nanmean(data_dur_SWS_end_3,2));
    [p_3_vs_4_2, h_2] = ranksum(nanmean(data_dur_SWS_end_3,2), nanmean(data_dur_SWS_end_4,2));
elseif isparam==1 %%version ttest
    %phase2
    [h_2,p_1_vs_2_2] = ttest2(nanmean(data_dur_SWS_end_1,2), nanmean(data_dur_SWS_end_2,2));
    [h_2,p_1_vs_4_2] = ttest2(nanmean(data_dur_SWS_end_1,2),nanmean(data_dur_SWS_end_4,2));
    [h_2,p_2_vs_4_2] = ttest2(nanmean(data_dur_SWS_end_2,2), nanmean(data_dur_SWS_end_4,2));
    [h_2,p_1_vs_3_2] = ttest2(nanmean(data_dur_SWS_end_1,2), nanmean(data_dur_SWS_end_3,2));
    [h_2,p_2_vs_3_2] = ttest2(nanmean(data_dur_SWS_end_2,2), nanmean(data_dur_SWS_end_3,2));
    [h_2,p_3_vs_4_2] = ttest2(nanmean(data_dur_SWS_end_3,2), nanmean(data_dur_SWS_end_4,2));
else
end
%%add corrections for multiple comparisons
if iscorr==0
...
if isparam==0 %%version ranksum (non param)
    %phase2
    [p_1_vs_2_2, h_2] = ranksum(nanmean(data_perc_REM_end_1,2), nanmean(data_perc_REM_end_2,2));
    [p_1_vs_4_2, h_2] = ranksum(nanmean(data_perc_REM_end_1,2),nanmean(data_perc_REM_end_4,2));
    [p_2_vs_4_2, h_2] = ranksum(nanmean(data_perc_REM_end_2,2), nanmean(data_perc_REM_end_4,2));
    [p_1_vs_3_2, h_2] = ranksum(nanmean(data_perc_REM_end_1,2), nanmean(data_perc_REM_end_3,2));
    [p_2_vs_3_2, h_2] = ranksum(nanmean(data_perc_REM_end_2,2), nanmean(data_perc_REM_end_3,2));
    [p_3_vs_4_2, h_2] = ranksum(nanmean(data_perc_REM_end_3,2), nanmean(data_perc_REM_end_4,2));
elseif isparam==1 %%version ttest
    %phase2
    [h_2,p_1_vs_2_2] = ttest2(nanmean(data_perc_REM_end_1,2), nanmean(data_perc_REM_end_2,2));
    [h_2,p_1_vs_4_2] = ttest2(nanmean(data_perc_REM_end_1,2),nanmean(data_perc_REM_end_4,2));
    [h_2,p_2_vs_4_2] = ttest2(nanmean(data_perc_REM_end_2,2), nanmean(data_perc_REM_end_4,2));
    [h_2,p_1_vs_3_2] = ttest2(nanmean(data_perc_REM_end_1,2), nanmean(data_perc_REM_end_3,2));
    [h_2,p_2_vs_3_2] = ttest2(nanmean(data_perc_REM_end_2,2), nanmean(data_perc_REM_end_3,2));
    [h_2,p_3_vs_4_2] = ttest2(nanmean(data_perc_REM_end_3,2), nanmean(data_perc_REM_end_4,2));
else
end
%%add corrections for multiple comparisons
if iscorr==0
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_num_REM_end_1,2), nanmean(data_num_REM_end_2,2), nanmean(data_num_REM_end_3,2), nanmean(data_num_REM_end_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
% set(gca,'xticklabels',[])
ylabel('REM bouts number')
% makepretty
...
if isparam==0 %%version ranksum (non param)
    %phase2
    [p_1_vs_2_2, h_2] = ranksum(nanmean(data_num_REM_end_1,2), nanmean(data_num_REM_end_2,2));
    [p_1_vs_4_2, h_2] = ranksum(nanmean(data_num_REM_end_1,2),nanmean(data_num_REM_end_4,2));
    [p_2_vs_4_2, h_2] = ranksum(nanmean(data_num_REM_end_2,2), nanmean(data_num_REM_end_4,2));
    [p_1_vs_3_2, h_2] = ranksum(nanmean(data_num_REM_end_1,2), nanmean(data_num_REM_end_3,2));
    [p_2_vs_3_2, h_2] = ranksum(nanmean(data_num_REM_end_2,2), nanmean(data_num_REM_end_3,2));
    [p_3_vs_4_2, h_2] = ranksum(nanmean(data_num_REM_end_3,2), nanmean(data_num_REM_end_4,2));
elseif isparam==1 %%version ttest
    %phase2
    [h_2,p_1_vs_2_2] = ttest2(nanmean(data_num_REM_end_1,2), nanmean(data_num_REM_end_2,2));
    [h_2,p_1_vs_4_2] = ttest2(nanmean(data_num_REM_end_1,2),nanmean(data_num_REM_end_4,2));
    [h_2,p_2_vs_4_2] = ttest2(nanmean(data_num_REM_end_2,2), nanmean(data_num_REM_end_4,2));
    [h_2,p_1_vs_3_2] = ttest2(nanmean(data_num_REM_end_1,2), nanmean(data_num_REM_end_3,2));
    [h_2,p_2_vs_3_2] = ttest2(nanmean(data_num_REM_end_2,2), nanmean(data_num_REM_end_3,2));
    [h_2,p_3_vs_4_2] = ttest2(nanmean(data_num_REM_end_3,2), nanmean(data_num_REM_end_4,2));
else
end
%%add corrections for multiple comparisons
if iscorr==0
...
MakeSpreadAndBoxPlot2_MC({nanmean(data_dur_REM_end_1,2), nanmean(data_dur_REM_end_2,2), nanmean(data_dur_REM_end_3,2), nanmean(data_dur_REM_end_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none')
% set(gca,'xticklabels',[])
ylabel('REM bouts duration (s)')
% makepretty
...
if isparam==0 %%version ranksum (non param)
    %phase2
    [p_1_vs_2_2, h_2] = ranksum(nanmean(data_dur_REM_end_1,2), nanmean(data_dur_REM_end_2,2));
    [p_1_vs_4_2, h_2] = ranksum(nanmean(data_dur_REM_end_1,2),nanmean(data_dur_REM_end_4,2));
    [p_2_vs_4_2, h_2] = ranksum(nanmean(data_dur_REM_end_2,2), nanmean(data_dur_REM_end_4,2));
    [p_1_vs_3_2, h_2] = ranksum(nanmean(data_dur_REM_end_1,2), nanmean(data_dur_REM_end_3,2));
    [p_2_vs_3_2, h_2] = ranksum(nanmean(data_dur_REM_end_2,2), nanmean(data_dur_REM_end_3,2));
    [p_3_vs_4_2, h_2] = ranksum(nanmean(data_dur_REM_end_3,2), nanmean(data_dur_REM_end_4,2));
elseif isparam==1 %%version ttest
    %phase2
    [h_2,p_1_vs_2_2] = ttest2(nanmean(data_dur_REM_end_1,2), nanmean(data_dur_REM_end_2,2));
    [h_2,p_1_vs_4_2] = ttest2(nanmean(data_dur_REM_end_1,2),nanmean(data_dur_REM_end_4,2));
    [h_2,p_2_vs_4_2] = ttest2(nanmean(data_dur_REM_end_2,2), nanmean(data_dur_REM_end_4,2));
    [h_2,p_1_vs_3_2] = ttest2(nanmean(data_dur_REM_end_1,2), nanmean(data_dur_REM_end_3,2));
    [h_2,p_2_vs_3_2] = ttest2(nanmean(data_dur_REM_end_2,2), nanmean(data_dur_REM_end_3,2));
    [h_2,p_3_vs_4_2] = ttest2(nanmean(data_dur_REM_end_3,2), nanmean(data_dur_REM_end_4,2));
else
end
%%add corrections for multiple comparisons
if iscorr==0
