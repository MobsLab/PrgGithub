...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_dur_WAKE_begin_1,2), nanmean(data_dur_WAKE_begin_2,2), nanmean(data_dur_WAKE_begin_3,2), nanmean(data_dur_WAKE_begin_4,2)},...
...
subplot(4,6,[5],'align') %WAKE duration phase2
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_dur_WAKE_interPeriod_1,2), nanmean(data_dur_WAKE_interPeriod_2,2), nanmean(data_dur_WAKE_interPeriod_3,2), nanmean(data_dur_WAKE_interPeriod_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('Wake duration')
% makepretty
...
elseif isparam==1 %%version ttest
    ...
    [h_1,p_1_vs_3_1] = ttest2(nanmean(data_dur_WAKE_interPeriod_1,2), nanmean(data_dur_WAKE_interPeriod_3,2));
...
subplot(4,6,[6],'align') %WAKE duration phase3
MakeSpreadAndBoxPlot2_MC({nanmean(data_dur_WAKE_end_1,2), nanmean(data_dur_WAKE_end_2,2), nanmean(data_dur_WAKE_end_3,2), nanmean(data_dur_WAKE_end_4,2)},...
    {col_1,col_2,col_3,col_4},[1:4],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('Wake duration')
% makepretty
