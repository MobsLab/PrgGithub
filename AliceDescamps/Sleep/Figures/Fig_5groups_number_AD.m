...
subplot(4,6,[5],'align') %WAKE number phase2
...
plot(nanmean(data_num_WAKE_4),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_4,'color',col_4)
errorbar(nanmean(data_num_WAKE_4), stdError(data_num_WAKE_4),'LineWidth',2,'color',col_4)
plot(nanmean(data_num_WAKE_5),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_5,'color',col_5)
errorbar(nanmean(data_num_WAKE_5), stdError(data_num_WAKE_5),'LineWidth',2,'color',col_5)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'})
ylabel('Wake number')
makepretty

% subplot(4,6,[6,7]), hold on % Total Sleep number overtime
% % plot(nanmean(data_num_totSleep_1),'linestyle','-','LineWidth',2,'marker','square','markersize',8,'markerfacecolor',col_1,'color',col_1), hold on
% % errorbar(nanmean(data_num_totSleep_1), stdError(data_num_totSleep_1),'LineWidth',2,'color',col_1)
% % plot(nanmean(data_num_totSleep_2),'linestyle','-','LineWidth',2,'marker','^','markerfacecolor',col_2,'markersize',8,'color',col_2)
% % errorbar(nanmean(data_num_totSleep_2), stdError(data_num_totSleep_2),'LineWidth',2,'color',col_2)
% plot(nanmean(data_num_totSleep_3),'linestyle','-','LineWidth',2,'marker','^','markersize',8,'markerfacecolor',col_3,'color',col_3), hold on
% errorbar(nanmean(data_num_totSleep_3), stdError(data_num_totSleep_3),'LineWidth',2,'color',col_3)
% plot(nanmean(data_num_totSleep_4),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_4,'color',col_4)
% errorbar(nanmean(data_num_totSleep_4), stdError(data_num_totSleep_4),'LineWidth',2,'color',col_4)
% plot(nanmean(data_num_totSleep_5),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_5,'color',col_5)
...
plot(nanmean(data_num_SWS_4),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_4,'color',col_4)
errorbar(nanmean(data_num_SWS_4), stdError(data_num_SWS_4),'LineWidth',2,'color',col_4)
plot(nanmean(data_num_SWS_5),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_5,'color',col_5)
errorbar(nanmean(data_num_SWS_5), stdError(data_num_SWS_5),'LineWidth',2,'color',col_5)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
ylabel('NREM number')
...
plot(nanmean(data_num_REM_4),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_4,'color',col_4)
errorbar(nanmean(data_num_REM_4), stdError(data_num_REM_4),'LineWidth',2,'color',col_4)
plot(nanmean(data_num_REM_5),'linestyle','-','LineWidth',2,'marker','o','markersize',8,'markerfacecolor',col_5,'color',col_5)
errorbar(nanmean(data_num_REM_5), stdError(data_num_REM_5),'LineWidth',2,'color',col_5)
xlim([0 8.5])
xticks([1 3 5 7 9]); xticklabels({'1','3','5','7','9'}) 
makepretty
ylabel('REM number')
...
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_WAKE_begin_1,2), nanmean(data_num_WAKE_begin_2,2), nanmean(data_num_WAKE_begin_3,2), nanmean(data_num_WAKE_begin_4,2), nanmean(data_num_WAKE_begin_5,2)},...
...
if isparam==0 %%version ranksum (non param)
    ...
    [p_1_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_begin_1,2), nanmean(data_num_WAKE_begin_4,2));
    [p_1_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_begin_1,2), nanmean(data_num_WAKE_begin_5,2));
    [p_2_vs_3_1, h_1] = ranksum(nanmean(data_num_WAKE_begin_2,2), nanmean(data_num_WAKE_begin_3,2));
    [p_2_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_begin_2,2), nanmean(data_num_WAKE_begin_4,2));
    [p_2_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_begin_2,2), nanmean(data_num_WAKE_begin_5,2));
    [p_3_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_begin_3,2), nanmean(data_num_WAKE_begin_4,2));
    [p_3_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_begin_3,2), nanmean(data_num_WAKE_begin_5,2));
    [p_4_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_begin_4,2), nanmean(data_num_WAKE_begin_5,2));
elseif isparam==1 %%version ttest
    %phase1
    [h_1,p_1_vs_2_1] = ttest2(nanmean(data_num_WAKE_begin_1,2), nanmean(data_num_WAKE_begin_2,2));
    [h_1,p_1_vs_3_1] = ttest2(nanmean(data_num_WAKE_begin_1,2), nanmean(data_num_WAKE_begin_3,2));
    [h_1,p_1_vs_4_1] = ttest2(nanmean(data_num_WAKE_begin_1,2), nanmean(data_num_WAKE_begin_4,2));
    [h_1,p_1_vs_5_1] = ttest2(nanmean(data_num_WAKE_begin_1,2), nanmean(data_num_WAKE_begin_5,2));
    [h_1,p_2_vs_3_1] = ttest2(nanmean(data_num_WAKE_begin_2,2), nanmean(data_num_WAKE_begin_3,2));
    [h_1,p_2_vs_4_1] = ttest2(nanmean(data_num_WAKE_begin_2,2), nanmean(data_num_WAKE_begin_4,2));
    [h_1,p_2_vs_5_1] = ttest2(nanmean(data_num_WAKE_begin_2,2), nanmean(data_num_WAKE_begin_5,2));
    [h_1,p_3_vs_4_1] = ttest2(nanmean(data_num_WAKE_begin_3,2), nanmean(data_num_WAKE_begin_4,2));
    [h_1,p_3_vs_5_1] = ttest2(nanmean(data_num_WAKE_begin_3,2), nanmean(data_num_WAKE_begin_5,2));
    [h_1,p_4_vs_5_1] = ttest2(nanmean(data_num_WAKE_begin_4,2), nanmean(data_num_WAKE_begin_5,2));
    else
end
...
subplot(4,6,[5],'align') %WAKE number phase2
MakeSpreadAndBoxPlot2_MC({...
    nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_2,2), nanmean(data_num_WAKE_interPeriod_3,2), nanmean(data_num_WAKE_interPeriod_4,2), nanmean(data_num_WAKE_interPeriod_5,2)},...
    {col_1,col_2,col_3,col_4,col_5},[1:5],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('Wake number')
% makepretty
...
if isparam==0 %%version ranksum (non param)
    %phase2
    [p_1_vs_2_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_2,2));
    [p_1_vs_3_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_3,2));
    [p_1_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_4,2));
    [p_1_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_5,2));
    [p_2_vs_3_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_2,2), nanmean(data_num_WAKE_interPeriod_3,2));
    [p_2_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_2,2), nanmean(data_num_WAKE_interPeriod_4,2));
    [p_2_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_2,2), nanmean(data_num_WAKE_interPeriod_5,2));
    [p_3_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_3,2), nanmean(data_num_WAKE_interPeriod_4,2));
    [p_3_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_3,2), nanmean(data_num_WAKE_interPeriod_5,2));
    [p_4_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_interPeriod_4,2), nanmean(data_num_WAKE_interPeriod_5,2));
elseif isparam==1 %%version ttest
    %phase2
    [h_1,p_1_vs_2_1] = ttest2(nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_2,2));
    [h_1,p_1_vs_3_] = ttest2(nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_3,2));
    [h_1,p_1_vs_4_1] = ttest2(nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_4,2));
    [h_1,p_1_vs_5_1] = ttest2(nanmean(data_num_WAKE_interPeriod_1,2), nanmean(data_num_WAKE_interPeriod_5,2));
    [h_1,p_2_vs_3_1] = ttest2(nanmean(data_num_WAKE_interPeriod_2,2), nanmean(data_num_WAKE_interPeriod_3,2));
    [h_1,p_2_vs_4_1] = ttest2(nanmean(data_num_WAKE_interPeriod_2,2), nanmean(data_num_WAKE_interPeriod_4,2));
    [h_1,p_2_vs_5_1] = ttest2(nanmean(data_num_WAKE_interPeriod_2,2), nanmean(data_num_WAKE_interPeriod_5,2));
    [h_1,p_3_vs_4_1] = ttest2(nanmean(data_num_WAKE_interPeriod_3,2), nanmean(data_num_WAKE_interPeriod_4,2));
    [h_1,p_3_vs_5_1] = ttest2(nanmean(data_num_WAKE_interPeriod_3,2), nanmean(data_num_WAKE_interPeriod_5,2));
    [h_1,p_4_vs_5_1] = ttest2(nanmean(data_num_WAKE_interPeriod_4,2), nanmean(data_num_WAKE_interPeriod_5,2));
    else
end
%%add corrections for multiple comparisons
if iscorr==0
...
subplot(4,6,[6],'align') %WAKE number phase3
MakeSpreadAndBoxPlot2_MC({nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_2,2), nanmean(data_num_WAKE_end_3,2), nanmean(data_num_WAKE_end_4,2), nanmean(data_num_WAKE_end_5,2)},...
    {col_1,col_2,col_3,col_4,col_5},[1:5],legend,'paired',0,'showsigstar','none') 
set(gca,'xticklabels',[])
ylabel('Wake number')
% makepretty
...
if isparam==0 %%version ranksum (non param)
    ...
    [p_1_vs_3_1, h_1] = ranksum(nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_3,2));
    [p_1_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_4,2));
    [p_1_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_5,2));
    [p_2_vs_3_1, h_1] = ranksum(nanmean(data_num_WAKE_end_2,2), nanmean(data_num_WAKE_end_3,2));
    [p_2_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_end_2,2), nanmean(data_num_WAKE_end_4,2));
    [p_2_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_end_2,2), nanmean(data_num_WAKE_end_5,2));
    [p_3_vs_4_1, h_1] = ranksum(nanmean(data_num_WAKE_end_3,2), nanmean(data_num_WAKE_end_4,2));
    [p_3_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_end_3,2), nanmean(data_num_WAKE_end_5,2));
    [p_4_vs_5_1, h_1] = ranksum(nanmean(data_num_WAKE_end_4,2), nanmean(data_num_WAKE_end_5,2));
elseif isparam==1 %%version ttest
    %phase3
    [h_1,p_1_vs_2_1] = ttest2(nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_2,2));
    [h_1,p_1_vs_3_1] = ttest2(nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_3,2));
    [h_1,p_1_vs_4_1] = ttest2(nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_4,2));
    [h_1,p_1_vs_5_1] = ttest2(nanmean(data_num_WAKE_end_1,2), nanmean(data_num_WAKE_end_5,2));
    [h_1,p_2_vs_3_1] = ttest2(nanmean(data_num_WAKE_end_2,2), nanmean(data_num_WAKE_end_3,2));
    [h_1,p_2_vs_4_1] = ttest2(nanmean(data_num_WAKE_end_2,2), nanmean(data_num_WAKE_end_4,2));
    [h_1,p_2_vs_5_1] = ttest2(nanmean(data_num_WAKE_end_2,2), nanmean(data_num_WAKE_end_5,2));
    [h_1,p_3_vs_4_1] = ttest2(nanmean(data_num_WAKE_end_3,2), nanmean(data_num_WAKE_end_4,2));
    [h_1,p_3_vs_5_1] = ttest2(nanmean(data_num_WAKE_end_3,2), nanmean(data_num_WAKE_end_5,2));
    [h_1,p_4_vs_5_1] = ttest2(nanmean(data_num_WAKE_end_4,2), nanmean(data_num_WAKE_end_5,2));
    else
end
%%add corrections for multiple comparisons
if iscorr==0
...
subplot(4,6,[11],'align') %NREM number phase2
MakeSpreadAndBoxPlot2_MC({...
...
subplot(4,6,[17],'align') %REM number phase2
MakeSpreadAndBoxPlot2_MC({...
