...
function Figure_SleepScoring_OBGamma_newgamma(foldername)
...
load([foldername 'SleepScoring_OBGamma_newgamma'])
...
%% Make the figure
% create figure
SleepScoringFigureOB_newgamma = figure;
set(SleepScoringFigureOB_newgamma,'color',[1 1 1],'Position',[1 1 1600 600])
...
try    
    res=pwd;
    cd(foldername);
    saveas(SleepScoringFigureOB_newgamma, 'SleepScoringOB_newgamma.png', 'png');
    cd(res);
catch    
    res=pwd;
    cd(foldername);
    saveas(SleepScoringFigureOB_newgamma.Number, 'SleepScoringOB_newgamma.png', 'png');
    cd(res);
end
