...
function [SleepEpoch,SmoothGamma,Info,microWakeEpoch,microSleepEpoch] = FindGammaEpoch_SleepScoring_newgamma(Epoch, channel_bulb, minduration, varargin)
...
if ~exist('Frequency','var')
    Frequency = [50 100];
    disp('Note, that chosen Gamma frequency is 50-100Hz')
end
