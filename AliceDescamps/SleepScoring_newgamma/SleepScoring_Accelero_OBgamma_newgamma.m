function SleepScoring_Accelero_OBgamma_newgamma(varargin)

%==========================================================================
% Details: Sleep Scoring Using Olfactory Bulb and Hippocampal LFP
%          This function creates SleepScoring_OBGamma_newgamma with sleep scoring 
...
%   Updated 2020-11 Dima - added SleepScoring_Accelero_newgamma_OBgamma('PlotFigure',1)
...
if ~recompute
    if exist('SleepScoring_OBGamma_newgamma.mat','file')==2 && exist('SleepScoring_Accelero_newgamma.mat','file')==2
...
diary('SleepScoring_history_newgamma.txt')
...
if doob
    save('SleepScoring_OBGamma_newgamma','Info')
end
save('SleepScoring_Accelero_newgamma','Info')
clear Info
...
if doob
    ...
    if ~exist('StimEpoch')
        [SleepOB,SmoothGamma,Info_temp,microWakeEpochOB,microSleepEpochOB]= ...
            FindGammaEpoch_SleepScoring_newgamma(Epoch, channel_bulb, minduration, 'foldername', foldername,...
...
if doob
    ...
    disp(' ')
    save('SleepScoring_OBGamma_newgamma','REMEpoch','SWSEpoch','Wake','REMEpochWiNoise', ...
...
if is_accelero
    ...
    disp(' ')
    save('SleepScoring_Accelero_newgamma','REMEpoch','SWSEpoch','Wake','REMEpochWiNoise', ...
        'SWSEpochWiNoise', 'WakeWiNoise','Sleep','SleepWiNoise', ...
...
if PlotFigure==1
    ...
    if exist('dowiob','var')
        if ~dowiob
            Figure_SleepScoring_OBGamma_newgamma(foldername)
        end
    else
        Figure_SleepScoring_OBGamma_newgamma(foldername)
    end
    ...
    if is_accelero
        ...
        Figure_SleepScoring_Accelero_newgamma(ratio_display_movement, foldername)
    end
