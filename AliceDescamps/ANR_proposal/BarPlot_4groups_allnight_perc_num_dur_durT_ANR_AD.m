...
PlotErrorBarN_MC({...
    ...
    'newfig',0,'paired',0,'showsigstar','none','x_data',[1:4],'barcolors',{col_ctrl,col_SD,col_mCherry_cno,col_dreadd_cno});
set(gca,'xticklabels',[])
...
elseif isparam==1 %%version ttest
    ...
    [~,p_ctrl_vs_mCherrry_cno_1] = ttest2(nanmean(data_dur_SWS_begin_ctrl,2), nanmean(data_dur_SWS_begin_SD_mCherry_cno,2));
