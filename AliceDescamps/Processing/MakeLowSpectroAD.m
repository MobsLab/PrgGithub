...
LowSpectrum_AD([cd filesep],channel,'PFCx_deep');

% load('ChannelsToAnalyse/PFCx_sup.mat')
% LowSpectrum_AD([cd filesep],channel,'PFCx_sup');
...
LowSpectrum_AD([cd filesep],channel,'dHPC_deep');

load('ChannelsToAnalyse/ThetaREM.mat')
LowSpectrum_AD([cd filesep],channel,'H');

%%Bulb_deep (à modifier si autres channels)
load('ChannelsToAnalyse/Bulb_deep.mat')
LowSpectrum_AD([cd filesep],channel,'Bulb_deep');
