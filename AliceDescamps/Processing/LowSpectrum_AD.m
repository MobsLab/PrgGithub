function LowSpectrum_AD(filename,ch,struc,whiten)
...
[params,movingwin,suffix]=SpectrumParametersSL_AD('low'); % low or high
...
Spectro={Sp,t,f};
save(strcat(filename,num2str(struc),'_Low_Spectrum.mat'),'Spectro','ch','-v7.3')
