function MiddleSpectrum_AD(filename,ch,struc,whiten)
% adapted from LowSpectrum_MC
...
% Below is a modification from July 2017, to harmonize codes in the lab, only change is that params.fpass=[0 20] become params.fpass=[0.1 20];
[params,movingwin,suffix]=SpectrumParametersSL_AD('middle'); % low or high
...
Spectro={Sp,t,f};
save(strcat(filename,num2str(struc),'_Middle_Spectrum.mat'),'Spectro','ch','-v7.3')
