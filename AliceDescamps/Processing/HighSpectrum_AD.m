function HighSpectrum_AD(filename,ch,struc,whiten)
...
[params,movingwin,suffix]=SpectrumParametersSL_AD('high'); % low or high
...
Spectro={Sp,t,f};
save(strcat(filename,num2str(struc),'_High_Spectrum.mat'),'Spectro','ch','-v7.3')
