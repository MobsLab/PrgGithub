...
for j=1:length(Dir1.path)
    ...
    stages_basal{j}.Wake = mergeCloseIntervals(stages_basal{j}.Wake,0.5*1e4);
    ...
    [dur_TOT_moyenne_ep, rg]=Get_Mean_Dur_TOTALE_Overtime_MC(and(stages_basal{j}.Wake,same_epoch_basal{j}),and(stages_basal{j}.SWSEpoch,same_epoch_basal{j}),and(stages_basal{j}.REMEpoch,same_epoch_basal{j}),'wake',tempbin,time_st,time_end);
...
for k=1:length(Dir2.path)
    ...
    stages_SD{k}.Wake = mergeCloseIntervals(stages_SD{k}.Wake,0.5*1e4);
    ...
    [dur_TOT_moyenne_ep, rg]=Get_Mean_Dur_TOTALE_Overtime_MC(and(stages_SD{k}.Wake,same_epoch_SD{k}),and(stages_SD{k}.SWSEpoch,same_epoch_SD{k}),and(stages_SD{k}.REMEpoch,same_epoch_SD{k}),'wake',tempbin,time_st,time_end);
...
for k=1:length(Dir3.path)
    ...
    [dur_TOT_moyenne_ep, rg]=Get_Mean_Dur_TOTALE_Overtime_MC(and(stages_SDsafe{k}.Wake,same_epoch_SDsafe{k}),and(stages_SDsafe{k}.SWSEpoch,same_epoch_SDsafe{k}),and(stages_SD{k}.REMEpoch,same_epoch_SDsafe{k}),'wake',tempbin,time_st,time_end);
...
PlotErrorBarN_KJ({...
    (nanmean(data_WAKE_REM_basal(:,4:8),2)+nanmean(data_WAKE_SWS_basal(:,4:8),2))*100,...
    (nanmean(data_WAKE_REM_SDsafe(:,4:8),2)+nanmean(data_WAKE_SWS_SDsafe(:,4:8),2))*100,...
    (nanmean(data_WAKE_REM_SD(:,4:8),2)+nanmean(data_WAKE_SWS_SD(:,4:8),2))*100},...
...
timebin=4:8;
[p_basal_SD,h]=ranksum((nanmean(data_WAKE_REM_basal(:,timebin),2)+nanmean(data_WAKE_SWS_basal(:,timebin),2)),(nanmean(data_WAKE_REM_SD(:,timebin),2)+nanmean(data_WAKE_SWS_SD(:,timebin),2)));
[p_SD_ctrlInhib,h]=ranksum((nanmean(data_WAKE_REM_SD(:,timebin),2)+nanmean(data_WAKE_SWS_SD(:,timebin),2)), (nanmean(data_WAKE_REM_SDsafe(:,timebin),2)+nanmean(data_WAKE_SWS_SDsafe(:,timebin),2)));
[p_basal_ctrlInhib,h]=ranksum((nanmean(data_WAKE_REM_basal(:,timebin),2)+nanmean(data_WAKE_SWS_basal(:,timebin),2)), (nanmean(data_WAKE_REM_SDsafe(:,timebin),2)+nanmean(data_WAKE_SWS_SDsafe(:,timebin),2)));
