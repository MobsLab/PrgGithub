...
for j=1:length(Dir1.path)
    ...
    [dur_TOT_moyenne_ep, rg]=Get_Mean_Dur_TOTALE_Overtime_MC(and(stages_basal{j}.Wake,same_epoch_basal{j}),and(stages_basal{j}.SWSEpoch,same_epoch_basal{j}),and(stages_basal{j}.REMEpoch,same_epoch_basal{j}),'sws',tempbin,time_st,time_end);
...
for k=1:length(Dir2.path)
    ...
    [dur_TOT_moyenne_ep, rg]=Get_Mean_Dur_TOTALE_Overtime_MC(and(stages_SD{k}.Wake,same_epoch_SD{k}),and(stages_SD{k}.SWSEpoch,same_epoch_SD{k}),and(stages_SD{k}.REMEpoch,same_epoch_SD{k}),'sws',tempbin,time_st,time_end);
...
for k=1:length(Dir3.path)
    ...
    [dur_TOT_moyenne_ep, rg]=Get_Mean_Dur_TOTALE_Overtime_MC(and(stages_SDsafe{k}.Wake,same_epoch_SDsafe{k}),and(stages_SDsafe{k}.SWSEpoch,same_epoch_SDsafe{k}),and(stages_SD{k}.REMEpoch,same_epoch_SDsafe{k}),'sws',tempbin,time_st,time_end);
...
plot(nanmean(data_num_SWS_basal),'linestyle','-','marker','o','markerfacecolor',col_basal,'color',col_basal), hold on
errorbar(nanmean(data_num_SWS_basal), stdError(data_num_SWS_basal),'color',col_basal)
...
plot(nanmean(data_num_SWS_SDsafe),'linestyle','-','marker','o','markerfacecolor',col_SDsafe,'color',col_SDsafe)
errorbar(nanmean(data_num_SWS_SDsafe), stdError(data_num_SWS_SDsafe),'color',col_SDsafe)
xlim([0 8])
makepretty
title('Sommeil lent')

subplot(4,6,[15,16]) % NREM bouts mean duraion overtime
plot(nanmean(data_dur_SWS_basal),'linestyle','-','marker','o','markerfacecolor',col_basal,'color',col_basal), hold on
errorbar(nanmean(data_dur_SWS_basal), stdError(data_dur_SWS_basal),'color',col_basal)
...
plot(nanmean(data_dur_SWS_SDsafe),'linestyle','-','marker','o','markerfacecolor',col_SDsafe,'color',col_SDsafe)
errorbar(nanmean(data_dur_SWS_SDsafe), stdError(data_dur_SWS_SDsafe),'color',col_SDsafe)
xlim([0 8])
makepretty
title('Sommeil lent')
...
PlotErrorBarN_KJ({...
    (nanmean(data_SWS_REM_basal(:,4:8),2)+nanmean(data_SWS_WAKE_basal(:,4:8),2))*100,...
    (nanmean(data_SWS_REM_SDsafe(:,4:8),2)+nanmean(data_SWS_WAKE_SDsafe(:,4:8),2))*100,...
    (nanmean(data_SWS_REM_SD(:,4:8),2)+nanmean(data_SWS_WAKE_SD(:,4:8),2))*100},...
...
timebin=4:8;
[p_basal_SD,h]=ranksum((nanmean(data_SWS_REM_basal(:,timebin),2)+nanmean(data_SWS_WAKE_basal(:,timebin),2)),(nanmean(data_SWS_REM_SD(:,timebin),2)+nanmean(data_SWS_WAKE_SD(:,timebin),2)));
[p_SD_ctrlInhib,h]=ranksum((nanmean(data_SWS_REM_SD(:,timebin),2)+nanmean(data_SWS_WAKE_SD(:,timebin),2)), (nanmean(data_SWS_REM_SDsafe(:,timebin),2)+nanmean(data_SWS_WAKE_SDsafe(:,timebin),2)));
[p_basal_ctrlInhib,h]=ranksum((nanmean(data_SWS_REM_basal(:,timebin),2)+nanmean(data_SWS_WAKE_basal(:,timebin),2)), (nanmean(data_SWS_REM_SDsafe(:,timebin),2)+nanmean(data_SWS_WAKE_SDsafe(:,timebin),2)));
