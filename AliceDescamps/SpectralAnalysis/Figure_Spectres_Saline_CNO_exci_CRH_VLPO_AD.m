...
figure,
ax(10)=subplot(3,6,1), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_BeforeInj_mean), SpectreSaline_Wake_BeforeInj_SEM,'k',1); hold on
...
ax(11)=subplot(3,6,7), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_AfterInj_all_mean), SpectreSaline_Wake_AfterInj_all_SEM,'k',1); hold on
...
ax(12)=subplot(3,6,13), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_AfterInj_3h_mean), SpectreSaline_Wake_AfterInj_3h_SEM,'k',1); hold on
...
ax(13)=subplot(3,6,2), shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_Wake_BeforeInj_mean), SpectreCNO_Wake_BeforeInj_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_SWS_BeforeInj_mean), SpectreCNO_SWS_BeforeInj_SEM,'b',1);
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_REM_BeforeInj_mean), SpectreCNO_REM_BeforeInj_SEM,'r',1);
title('pre CNO')
makepretty

ax(14)=subplot(3,6,8), shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_Wake_AfterInj_all_mean), SpectreCNO_Wake_AfterInj_all_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_SWS_AfterInj_all_mean), SpectreCNO_SWS_AfterInj_all_SEM,'b',1);
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_REM_AfterInj_all_mean), SpectreCNO_REM_AfterInj_all_SEM,'r',1);
title('post CNO')
makepretty

ax(15)=subplot(3,6,14), shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_Wake_AfterInj_3h_mean), SpectreCNO_Wake_AfterInj_3h_SEM,'k',1); hold on
...
ax(1)=subplot(3,6,4), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_BeforeInj_mean), SpectreSaline_Wake_BeforeInj_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_Wake_BeforeInj_mean), SpectreCNO_Wake_BeforeInj_SEM,'g',1);
ylabel('Power (a.u)')
title('WAKE pre')
makepretty
ax(2)=subplot(3,6,5), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_SWS_BeforeInj_mean), SpectreSaline_SWS_BeforeInj_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_SWS_BeforeInj_mean), SpectreCNO_SWS_BeforeInj_SEM,'g',1);
title('NREM pre')
makepretty
ax(3)=subplot(3,6,6), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_REM_BeforeInj_mean), SpectreSaline_REM_BeforeInj_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_REM_BeforeInj_mean), SpectreCNO_REM_BeforeInj_SEM,'g',1);
title('REM pre')
makepretty

ax(4)=subplot(3,6,10), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_AfterInj_all_mean), SpectreSaline_Wake_AfterInj_all_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_Wake_AfterInj_all_mean), SpectreCNO_Wake_AfterInj_all_SEM,'g',1);
title('WAKE post')
ylabel('Power (a.u)')
makepretty
ax(5)=subplot(3,6,11), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_SWS_AfterInj_all_mean), SpectreSaline_SWS_AfterInj_all_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_SWS_AfterInj_all_mean), SpectreCNO_SWS_AfterInj_all_SEM,'g',1);
title('NREM post')
makepretty
ax(6)=subplot(3,6,12), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_REM_AfterInj_all_mean), SpectreSaline_REM_AfterInj_all_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_REM_AfterInj_all_mean), SpectreCNO_REM_AfterInj_all_SEM,'g',1);
title('REM post')
makepretty

ax(7)=subplot(3,6,16), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_AfterInj_3h_mean), SpectreSaline_Wake_AfterInj_3h_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_Wake_AfterInj_3h_mean), SpectreCNO_Wake_AfterInj_3h_SEM,'g',1);
title('WAKE 3h post')
xlabel('Frequency(Hz)')
ylabel('Power (a.u)')
makepretty
ax(8)=subplot(3,6,17), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_SWS_AfterInj_3h_mean), SpectreSaline_SWS_AfterInj_3h_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_SWS_AfterInj_3h_mean), SpectreCNO_SWS_AfterInj_3h_SEM,'g',1);
xlabel('Frequency(Hz)')
title('NREM 3h post')
makepretty
ax(9)=subplot(3,6,18), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_REM_AfterInj_3h_mean), SpectreSaline_REM_AfterInj_3h_SEM,'k',1); hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_REM_AfterInj_3h_mean), SpectreCNO_REM_AfterInj_3h_SEM,'g',1);
xlabel('Frequency(Hz)')
title('REM 3h post')
makepretty
...
suptitle ('HPC low sal/CNO for CRH DREADD exci')

set(ax,'xlim',[0 15], 'ylim',[0 1e6])
% set(ax,'xlim',[20 100], 'ylim',[0 1e5])
%% Figure pre/post periods for Sal or CNO during Wake/NREM/REM
figure,
ax(16)=subplot(3,6,1),shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_BeforeInj_mean), SpectreSaline_Wake_BeforeInj_SEM,'k:',1);hold on
...
makepretty
%sws saline
ax(17)=subplot(3,6,2),shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_SWS_BeforeInj_mean), SpectreSaline_SWS_BeforeInj_SEM,'b:',1);hold on
%  shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_SWS_AfterInj_all_mean), SpectreSaline_SWS_AfterInj_all_SEM,'b',1);
 shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_SWS_AfterInj_3h_mean), SpectreSaline_SWS_AfterInj_3h_SEM,'b',1);
 title('NREM - saline')
makepretty
% rem saline
ax(18)=subplot(3,6,3), shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_REM_BeforeInj_mean), SpectreSaline_REM_BeforeInj_SEM,'r:',1);hold on
%  shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_REM_AfterInj_all_mean), SpectreSaline_REM_AfterInj_all_SEM,'r',1);
  shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_REM_AfterInj_3h_mean), SpectreSaline_REM_AfterInj_3h_SEM,'r',1);
  title('REM - saline')
makepretty
%wake cno
ax(19)=subplot(3,6,7),shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_Wake_BeforeInj_mean), SpectreCNO_Wake_BeforeInj_SEM,'k:',1);hold on
...
xlabel('Frequency (Hz)')
%sws cno
ax(20)=subplot(3,6,8),shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_SWS_BeforeInj_mean), SpectreCNO_SWS_BeforeInj_SEM,'b:',1);hold on
...
xlabel('Frequency (Hz)')
%rem cno
ax(21)=subplot(3,6,9),shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_REM_BeforeInj_mean), SpectreCNO_REM_BeforeInj_SEM,'r:',1);hold on
% shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_REM_AfterInj_all_mean), SpectreCNO_REM_AfterInj_all_SEM,'r',1);
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_REM_AfterInj_3h_mean), SpectreCNO_REM_AfterInj_3h_SEM,'r',1);
makepretty
title('REM - CNO')
...
suptitle ('HPC low sal/CNO for CRH DREADD inhib')
