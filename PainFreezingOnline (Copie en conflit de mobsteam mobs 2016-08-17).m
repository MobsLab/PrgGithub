    ...
    function Track_Freeze(obj,event)
        ...
        while enableTrack
            ...
            if StartChrono
                ...
                try set(PlotFreez,'XData',immob_val(max(1,num_fr_f-maxfrvis):end,2),'YData',immob_val(max(1,num_fr_f-maxfrvis):end,1)); end
                set(PlotJump,'XData',JumpMatrix,'YData',ones(1,length(JumpMatrix))*th_immob*1.3);
                set(PlotRear,'XData',RearMatrix,'YData',ones(1,length(RearMatrix))*th_immob*1.1);
                set(PlotLick,'XData',LickMatrix,'YData',ones(1,length(LickMatrix))*th_immob*1.2);
        ...
        hold on
        plot(JumpMatrix,max(Data(Movtsd))*1.2,'b*')
        plot(RearMatrix,max(Data(Movtsd))*1.2,'r*')
        plot(LickMatrix,max(Data(Movtsd))*1.2,'k*')
        title('Raw Data')
