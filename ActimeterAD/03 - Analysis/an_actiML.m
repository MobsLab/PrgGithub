...
MAT0=zeros(ceil(size(sleepWakeDuration,1)*block/24),24/block);
MAT1=MAT0; n0=0; n1=0;
for id =1:length(orderID)
    ...
    if id<=6,  n0=n0+1; MAT0=MAT0+Mat; else, n1=n1+1; MAT1=MAT1+Mat;end
end

% pool per group
figure('Color',[1 1 1],'Unit','normalized','Position',[0.03 0.6 0.2 0.3]),
subplot(2,1,1), imagesc(MAT0/n0);axis xy; caxis([20 80])
set(gca,'Xtick',a);set(gca,'XtickLabel',tik); title('Group WAKEcond');
subplot(2,1,2), imagesc(MAT1/n1);axis xy; caxis([20 80])
set(gca,'Xtick',a);set(gca,'XtickLabel',tik);title('Group SLEEPcond')
