classdef Activity_linux < handle
    ...
    properties
        ...
        dataDir = '/media/DataMOBsRAID/ProjetSLEEPActi/DataExpe';
    ...
    methods
        function obj = Activity_linux(numBatch,acqID, channelID)
