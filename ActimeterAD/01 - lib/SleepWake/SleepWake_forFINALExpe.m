...
% %%%%%%%%%%%%%                    
                    ...
                    if ~isempty(obj.hEvents)
                        ...
                        %add by Marie for FINALtest
                        if obj.activityBuffer(end, figureID) == obj.activityTriggered(figureID) 
                            obj.hEvents(obj.SWc.EVT_NOTHING, figureID, obj.activityBuffer(:, figureID));
                        end
                    end
