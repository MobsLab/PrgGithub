function MorphLinearizeMazeDB_MC(nMice, varargin)
%
...
%% Hyperparameters
% SessionNames = {'Hab', 'TestPre', 'TestPostPAG', 'TestPostMFB', 'CondPAG', 'CondMFB', 'CondWallShockPAG', 'CondWallSafePAG', 'CondWallShockMFB', 'CondWallSafeMFB'};
SessionNames = {'TestPre', 'TestPostPAG', 'TestPostMFB', 'CondPAG', 'CondMFB', 'Hab', 'CondWallShockPAG', 'CondWallSafePAG', 'CondWallShockMFB', 'CondWallSafeMFB'};
...
Dir = PathForExperimentsReversalBehav_MC(SessionNames{5});
