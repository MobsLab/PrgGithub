function [trans_REM_to_REM, trans_REM_to_SWS, trans_REM_to_WAKE, trans_SWS_to_REM, trans_SWS_to_SWS, trans_SWS_to_WAKE, trans_WAKE_to_REM, trans_WAKE_to_SWS, trans_WAKE_to_WAKE]=Get_proba_timebins_Overtime_MC_VF(Wake,SWSEpoch,REMEpoch,tempbin,time_end)
...
epoch8 = intervalSet(rg(8), tps(end));
...
trans_REM_to_REM = [P_R_R1 P_R_R2 P_R_R3 P_R_R4 P_R_R5 P_R_R6 P_R_R7 P_R_R8];
trans_REM_to_SWS = [P_R_S1 P_R_S2 P_R_S3 P_R_S4 P_R_S5 P_R_S6 P_R_S7 P_R_S8];
trans_REM_to_WAKE = [P_R_W1 P_R_W2 P_R_W3 P_R_W4 P_R_W5 P_R_W6 P_R_W7 P_R_W8];
trans_SWS_to_REM = [P_S_R1 P_S_R2 P_S_R3 P_S_R4 P_S_R5 P_S_R6 P_S_R7 P_S_R8];
trans_SWS_to_SWS = [P_S_S1 P_S_S2 P_S_S3 P_S_S4 P_S_S5 P_S_S6 P_S_S7 P_S_S8];
trans_SWS_to_WAKE = [P_S_W1 P_S_W2 P_S_W3 P_S_W4 P_S_W5 P_S_W6 P_S_W7 P_S_W8];
trans_WAKE_to_REM = [P_W_R1 P_W_R2 P_W_R3 P_W_R4 P_W_R5 P_W_R6 P_W_R7 P_W_R8];
trans_WAKE_to_SWS = [P_W_S1 P_W_S2 P_W_S3 P_W_S4 P_W_S5 P_W_S6 P_W_S7 P_W_S8];
trans_WAKE_to_WAKE = [P_W_W1 P_W_W2 P_W_W3 P_W_W4 P_W_W5 P_W_W6 P_W_W7 P_W_W8];
