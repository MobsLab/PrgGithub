function [dur_TOT_moyenne_ep, rg]=Get_Mean_Dur_TOTALE_Overtime_MC(Wake,SWSEpoch,REMEpoch,stage,tempbin,time_st,time_end)
...
if strcmp(lower(stage),'wake')
    ...
    dur_TOT_moyenne_ep = [nanmean(durT_wake_1), nanmean(durT_wake_2), nanmean(durT_wake_3), nanmean(durT_wake_4), nanmean(durT_wake_5), nanmean(durT_wake_6), nanmean(durT_wake_7), nanmean(durT_wake_8)];
...
elseif strcmp(lower(stage),'sws')
    ...
    dur_TOT_moyenne_ep = [nanmean(durT_sws_1), nanmean(durT_sws_2), nanmean(durT_sws_3), nanmean(durT_sws_4), nanmean(durT_sws_5), nanmean(durT_sws_6), nanmean(durT_sws_7), nanmean(durT_sws_8)];  
...
elseif strcmp(lower(stage),'rem')
    ...
    dur_TOT_moyenne_ep = [nanmean(durT_rem_1), nanmean(durT_rem_2), nanmean(durT_rem_3), nanmean(durT_rem_4), nanmean(durT_rem_5), nanmean(durT_rem_6), nanmean(durT_rem_7), nanmean(durT_rem_8)];
end
