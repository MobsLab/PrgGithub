...
%         datOBnew(:,k) = runmean(datOB(:,k),700);
%     end
%     % make tsd
%     sptsdOB(i) = tsd(SpectroB_high{i}{2}*1e4,datOBnew);
...
%     [MB_high_wake{i},SB_high_wake{i},tB_high_wake]=AverageSpectrogram(sptsdOB(i),SpectroB_high{i}{3},Restrict(ts(events{i}*1E4),wakeTime{i}),500,300);
%     [MB_high_REM{i},SB_high_REM{i},tB_high_REM]=AverageSpectrogram(sptsdOB(i),SpectroB_high{i}{3},Restrict(ts(events{i}*1E4),REMTime{i}),500,300);
%     
...
%% plot average spectro REM vs Wake for all structures

figure, subplot(5,2,1), imagesc(tP_REM/1E3,fP,avdata_MP_REM), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
% xlabel('Times (s)')
...
subplot(5,2,2), imagesc(tP_wake/1E3,fP,avdata_MP_wake), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
% xlabel('Times (s)')
...
subplot(5,2,3), imagesc(tB_high_REM/1E3,fOB_high,avdata_MB_high_REM), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
% xlabel('Times (s)')
...
subplot(5,2,4), imagesc(tB_high_wake/1E3,fOB_high,avdata_MB_high_wake), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
% xlabel('Times (s)')
...
subplot(5,2,5), imagesc(tB_low_REM/1E3,fOB_low,avdata_MB_low_REM), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
% xlabel('Times (s)')
...
subplot(5,2,6), imagesc(tB_low_wake/1E3,fOB_low,avdata_MB_low_wake), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
% xlabel('Times (s)')
...
subplot(5,2,7), imagesc(tV_REM/1E3,fV,avdata_MV_REM), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
% xlabel('Times (s)')
...
subplot(5,2,8), imagesc(tV_wake/1E3,fV,avdata_MV_wake), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
% xlabel('Times (s)')
...
subplot(5,2,9), imagesc(tH_REM/1E3,fH,avdata_MH_REM), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
xlabel('Times (s)')
...
subplot(5,2,10), imagesc(tH_wake/1E3,fH,avdata_MH_wake), axis xy
yl=ylim;
line([0 0],yl,'color','w')
ylabel('Frequency (Hz)')
xlabel('Times (s)')
...
suptitle('Average spectrograms (n = 3)')
