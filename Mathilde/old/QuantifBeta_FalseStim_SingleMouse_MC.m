function [MSws,MRem,MWake,BetaSWS,BetaREM,BetaWake,freqB,tps] = QuantifBeta_FalseStim_SingleMouse_MC(Wake,REMEpoch,SWSEpoch,plo)
...
[MSws,SSws,TPS]=AverageSpectrogram(sptsdB,freqB,(Restrict(SwsStim,SWSEpoch)),500,500,0);
[MRem,SRem,TPS]=AverageSpectrogram(sptsdB,freqB,(Restrict(RemStim,REMEpoch)),500,500,0);
[MWake,SWake,TPS]=AverageSpectrogram(sptsdB,freqB,(Restrict(WakeStim,Wake)),500,500,0);
