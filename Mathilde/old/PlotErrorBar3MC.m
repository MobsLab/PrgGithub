function PlotErrorBar3MC(A,A2,B,B2,C,C2,plo)
...
set (hb(1), 'facecolor',[1 1 1], 'linewidth', 2)
set (hb(2), 'facecolor',  [1 0 0], 'linewidth', 2)
...
plot(0.82,A,'.k','MarkerSize',25);
plot(0.82,A,'.w','MarkerSize',15);
plot(1.10,A2,'.k','MarkerSize',25);
plot(1.10,A2,'.w','MarkerSize',15);

plot(1.82,B,'.k','MarkerSize',25);
plot(1.82,B,'.w','MarkerSize',15);
plot(2.10,B2,'.k','MarkerSize',25);
plot(2.10,B2,'.w','MarkerSize',15);

plot(2.82,C,'.k','MarkerSize',25);
plot(2.82,C,'.w','MarkerSize',15);
plot(3.10,C2,'.k','MarkerSize',25);
plot(3.10,C2,'.w','MarkerSize',15);
