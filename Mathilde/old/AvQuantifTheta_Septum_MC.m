% Dir{1}=PathForExperiments_Opto_Septum('Sham_20Hz');
...
figure('color',[1 1 1]), subplot(3,4,[1,2]), imagesc(temps,freq, avdataSpREM),caxis([0 3.5]),axis xy, colormap(jet)
...
subplot(3,4,[5,6]), imagesc(temps,freq, avdataSpWake),caxis([0 3.5]),axis xy, colormap(jet)
line([0 0], ylim,'color','w','linestyle','-')
xlim([-30 +30])
xlabel('Time (s)')
ylabel('Frequency (Hz)')
