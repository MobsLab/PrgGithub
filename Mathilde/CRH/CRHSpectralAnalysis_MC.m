...
% set(ax,'xlim',[0 15], 'ylim',[0 1.5e6])
set(ax,'xlim',[20 100], 'ylim',[0 2.5e5])
...
figure
s(1)=subplot(241)
shadedErrorBar(frq_cno{1},  nanmean(SpectreSaline_WakeLowMov_Before_mean), SpectreSaline_WakeLowMov_Before_SEM,'k',1);hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_WakeLowMov_Before_mean), SpectreCNO_WakeLowMov_Before_SEM,'r',1);hold on
title('wake low movnt - pre')
makepretty

s(2)=subplot(242)
shadedErrorBar(frq_cno{1},  nanmean(SpectreSaline_WakeLowMov_After_mean), SpectreSaline_WakeLowMov_After_SEM,'k',1);hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_WakeLowMov_After_mean), SpectreCNO_WakeLowMov_After_SEM,'r',1);hold on
title('wake low movnt - post')
makepretty

s(3)=subplot(245)
shadedErrorBar(frq_cno{1},  nanmean(SpectreSaline_WakeHighMov_Before_mean), SpectreSaline_WakeHighMov_Before_SEM,'k',1);hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_WakeHighMov_Before_mean), SpectreCNO_WakeHighMov_Before_SEM,'r',1);hold on
title('wake low movnt - pre')
makepretty

s(4)=subplot(246)
shadedErrorBar(frq_cno{1},  nanmean(SpectreSaline_WakeHighMov_After_mean), SpectreSaline_WakeHighMov_After_SEM,'k',1);hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_WakeHighMov_After_mean), SpectreCNO_WakeHighMov_After_SEM,'r',1);hold on
title('wake low movnt - post')
makepretty


s(5)=subplot(243)
shadedErrorBar(frq_cno{1},  nanmean(SpectreSaline_WakeLowMov_Before_mean), SpectreSaline_WakeLowMov_Before_SEM,'c',1);hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreSaline_WakeHighMov_Before_mean), SpectreSaline_WakeHighMov_Before_SEM,'b',1);hold on
title('saline -pre')
makepretty

s(6)=subplot(244)
shadedErrorBar(frq_cno{1},  nanmean(SpectreSaline_WakeLowMov_After_mean), SpectreSaline_WakeLowMov_After_SEM,'c',1);hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreSaline_WakeHighMov_After_mean), SpectreSaline_WakeHighMov_After_SEM,'b',1);hold on
title('saline -post')
makepretty

s(7)=subplot(247)
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_WakeLowMov_Before_mean), SpectreCNO_WakeLowMov_Before_SEM,'c',1);hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_WakeHighMov_Before_mean), SpectreCNO_WakeHighMov_Before_SEM,'b',1);hold on
title('CNO -pre')
makepretty

s(8)=subplot(248)
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_WakeLowMov_After_mean), SpectreCNO_WakeLowMov_After_SEM,'c',1);hold on
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_WakeHighMov_After_mean), SpectreCNO_WakeHighMov_After_SEM,'b',1);hold on
title('CNO -post')
makepretty

% set(s,'xlim',[0 15], 'ylim',[0 6e5])
set(ax,'xlim',[20 100], 'ylim',[0 2.5e5])
...
%% panel wake high/low movement
 
figure
subplot(2,6,[1,2,7,8])
shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_BeforeInj_mean), SpectreSaline_Wake_BeforeInj_SEM,'k:',1);hold on
shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_Wake_AfterInj_all_mean), SpectreSaline_Wake_AfterInj_all_SEM,'k',1);
makepretty
xlim([20 100])
title('Wake')
...
subplot(2,6,3)
shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_WakeLowMov_Before_mean), SpectreSaline_WakeLowMov_Before_SEM,'k:',1);hold on
shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_WakeLowMov_After_mean), SpectreSaline_WakeLowMov_After_SEM,'k',1);
makepretty
xlim([20 100])
title('Wake Low mov')

subplot(2,6,9)
shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_WakeHighMov_Before_mean), SpectreSaline_WakeHighMov_Before_SEM,'k:',1);hold on
shadedErrorBar(frq_sal{1},  nanmean(SpectreSaline_WakeHighMov_After_mean), SpectreSaline_WakeHighMov_After_SEM,'k',1);
makepretty
xlim([20 100])
title('Wake High mov')
...
shadedErrorBar(frq_cno{1},  nanmean(SpectreCNO_Wake_BeforeInj_mean), SpectreCNO_Wake_BeforeInj_SEM,'k:',1);hold on
...
subplot(2,6,6)
shadedErrorBar(frq_sal{1},  nanmean(SpectreCNO_WakeLowMov_Before_mean), SpectreCNO_WakeLowMov_Before_SEM,'k:',1);hold on
shadedErrorBar(frq_sal{1},  nanmean(SpectreCNO_WakeLowMov_After_mean), SpectreCNO_WakeLowMov_After_SEM,'g',1);
makepretty
xlim([20 100])
title('Wake Low mov')

subplot(2,6,12)
shadedErrorBar(frq_sal{1},  nanmean(SpectreCNO_WakeHighMov_Before_mean), SpectreCNO_WakeHighMov_Before_SEM,'k:',1);hold on
shadedErrorBar(frq_sal{1},  nanmean(SpectreCNO_WakeHighMov_After_mean), SpectreCNO_WakeHighMov_After_SEM,'g',1);
makepretty
xlim([20 100])
title('Wake High mov')
