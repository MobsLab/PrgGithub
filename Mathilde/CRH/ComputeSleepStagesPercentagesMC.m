 function Res=ComputeSleepStagesPercentagesMC(Wake,SWSEpoch,REMEpoch,plo)
...
[durWake_pre,durTWake_pre]=DurationEpoch(and(Wake,epoch_preInj)); %first half / pre injection
...
[durWake_allPost,durTWake_allPost]=DurationEpoch(and(Wake,epoch_postInj));%second half / post injection
...
[durWake_3hPostInj,durTWake_3hPostInj]=DurationEpoch(and(Wake,epoch_3hPostInj));%restricted to 3 hours post injection
...
[durWake_first_3h,durTWake_first_3h]=DurationEpoch(and(Wake,epoch_first_3h_of_recording)); %first 3 hours of the recording
[durSWS_first_3h,durTSWS_first_3h]=DurationEpoch(and(SWSEpoch,epoch_first_3h_of_recording));
[durREM_first_3h,durTREM_first_3h]=DurationEpoch(and(REMEpoch,epoch_first_3h_of_recording));

% [durWake_3hPost_to_the_end,durTWake_3hPost_to_the_end]=DurationEpoch(and(Wake,epoch_3hPost_to_the_end)); %end of the first 3h hours up to the end
...
% [durWake_3hSleepy,durTWake_3hSleepy]=DurationEpoch(and(Wake,epoch_3hSleepy)); %3 hours following first sleep episode
...
% [durWake_3hSleepyEnd,durTWake_3hSleepyEnd]=DurationEpoch(and(Wake,epoch_3hSleepyEnd)); %end of 3 hours following first sleep up to the end
...
% Res(1,6)=durTWake_3hPost_to_the_end/(durTWake_3hPost_to_the_end+durTSWS_3hPost_to_the_end+durTREM_3hPost_to_the_end)*100;
% Res(1,7)=durTWake_3hSleepy/(durTWake_3hSleepy+durTSWS_3hSleepy+durTREM_3hSleepy)*100;
% Res(1,8)=durTWake_3hSleepyEnd/(durTWake_3hSleepyEnd+durTSWS_3hSleepyEnd+durTREM_3hSleepyEnd)*100;
...
% Res(2,6)=durTSWS_3hPost_to_the_end/(durTWake_3hPost_to_the_end+durTSWS_3hPost_to_the_end+durTREM_3hPost_to_the_end)*100;
% Res(2,7)=durTSWS_3hSleepy/(durTWake_3hSleepy+durTSWS_3hSleepy+durTREM_3hSleepy)*100;
% Res(2,8)=durTSWS_3hSleepyEnd/(durTWake_3hSleepyEnd+durTSWS_3hSleepyEnd+durTREM_3hSleepyEnd)*100;
...
% Res(3,6)=durTREM_3hPost_to_the_end/(durTWake_3hPost_to_the_end+durTSWS_3hPost_to_the_end+durTREM_3hPost_to_the_end)*100;
% Res(3,7)=durTREM_3hSleepy/(durTWake_3hSleepy+durTSWS_3hSleepy+durTREM_3hSleepy)*100;
% Res(3,8)=durTREM_3hSleepyEnd/(durTWake_3hSleepyEnd+durTSWS_3hSleepyEnd+durTREM_3hSleepyEnd)*100;
