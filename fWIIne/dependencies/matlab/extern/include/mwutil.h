/*
 * @(#)mwutil.h    generated by: makeheader 5.1.3  Thu Jan 11 14:46:30 2007
 *
...
#define BEGIN_SETJMP							    \
		{   MathWorks::System::MacroCleanup cbuf;                   \
		    try {
...
#define BEGIN_SEGV_SETJMP						    \
	{   MathWorks::System::SegvCleanup cbuf;			    \
            try {							    \
...
#define NATIVE_WINDOWS_TRY
#ifdef NATIVE_WINDOWS_TRY
#define         THROW_SEGV_LONGJMP(_X)					\
    __try { _X;								\
    } __except (MathWorks::System::Win32::filter__except( GetExceptionInformation(),false) ) { \
	ut_error(utGetErrorContext(), ERR_SIGNAL_INTERRUPT);		\
    }
...
#define ELSE_SEGV_SETJMP					    \
	} __except (MathWorks::System::Win32::filter__except( GetExceptionInformation(),true) ) { 
