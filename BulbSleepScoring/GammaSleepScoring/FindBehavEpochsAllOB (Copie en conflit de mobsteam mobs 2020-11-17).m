function FindBehavEpochsAllOB(TotalEpoch,mindur,mw_dur,sl_dur,ms_dur,wa_dur,filename)
...
load(strcat(filename,'StateEpochSB'),'NoiseEpoch','GndNoiseEpoch')
   ...
   load('SleepScoring_OBGamma.mat','SubNoiseEpoch')
...
save(strcat(filename,'StateEpochSBAllOB'),'REMEpoch','SWSEpoch','wakeper','Sleep','Wake','strWake','strSleep','MicroSleep','MicroWake','-v7.3','-append');
end