...
ylim([13 21])
line(xlim,[16.5 16.5],'linewidth',2,'color','k')
ylabel('reaction to stimulus')
set(gca,'FontSize',15,'LineWidth',1.5)
box off

subplot(3,3,[8,9])
[Y,X]=hist(log(AllGamma_OB),[-4:0.15:3]);
...
line(xlim,[16.5 16.5],'linestyle',':','linewidth',1,'color','k')
...
stairs(X,runmean(Y,2),'linewidth',3,'color','k')
xlim([-1 8])
line([4 4],ylim,'linewidth',2,'color','k')
xlabel('HB - transformed')
set(gca,'FontSize',15,'LineWidth',1.5)
box off

subplot(3,3,[2,3,5,6])
line([4 4],ylim,'linestyle',':','linewidth',1,'color','k')
line(xlim,[16.5 16.5],'linestyle',':','linewidth',1,'color','k')
