...
clear all
m=0;
m=m+1;Filename{m}='/media/DataMOBsRAIDN/ProjetSlSc/M258/20151112/';
m=m+1;Filename{m}='/media/DataMOBsRAID/ProjectEmbReact/Mouse439/20160820/ProjectEmbReact_M439_20160820_SleepPost/';
m=m+1;Filename{m}='/media/DataMOBsRAIDN/ProjetSlSc/M259/20151112/';
...
cd /media/DataMOBsRAIDN/ProjetSlSc/AnalysisResults/FreezingEMG
...
figure
errorbar(time,mean(SlWk),stdError(SlWk)','b');
hold on
errorbar(time,mean(FrNoFr),[stdError(FrNoFr);stdError(FrNoFr)]','b','alpha');
