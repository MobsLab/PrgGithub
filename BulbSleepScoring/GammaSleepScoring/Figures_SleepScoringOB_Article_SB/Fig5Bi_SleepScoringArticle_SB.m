...
m=m+1;
Filename{m,1}='/media/DataMOBSSlSc/SleepScoringMice/M258/20151113/';
...
for mm=1:size(Filename,1)
    ...
    for k=1:2
        ...
        [REMEpoch,SWSEpoch,Wake,REMEpoch1,SWSEpoch1,Wake1,smooth_ghi]=FindBehavEpochsDiffDays(mindur,mw_dur,sl_dur,ms_dur,wa_dur,(Filename{mm,WhichWay(k,2)}),gamma_thresh_temp,theta_thresh_temp,0,0);
...
save('/media/DataMOBSSlSc/SleepScoringMice/AnalysisResults/CompDiffDays.mat','StateComp','Kap')

%%%
load('/media/DataMOBsRAIDN/ProjetSlSc/AnalysisResults/CompDiffDays.mat')
figure
