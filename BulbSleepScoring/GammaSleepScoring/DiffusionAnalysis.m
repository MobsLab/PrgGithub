...
for dd=1:length(DiffDurTimes)
    ...
    for mm=14:15
        ...
        % subsample data to speed up calculations
...
%% Plots
    ...
    for mm=1:m
        ...
        subplot(233), plot(time,mean(GammDisp{3}/CoeffDG(6,mm))), hold on
        subplot(234), plot(time,mean(ThetDisp{1})/CoeffDT(1,mm)), hold on
        subplot(235), plot(time,mean(ThetDisp{2}/CoeffDT(2,mm))), hold on
        subplot(236), plot(time,mean(ThetDisp{3}/CoeffDT(6,mm))), hold on
