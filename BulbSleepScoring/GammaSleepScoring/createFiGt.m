...
% Auto-generated by MATLAB on 18-Mar-2014 17:02:56

% Set up figure to receive data sets and fits
f_ = clf;
figure(f_);
set(f_,'Units','Pixels','Position',[1291 270 688 490]);
...
if all(isfinite(xlim_))
    ...
    set(ax_, 'XLim',[15285.561218334030855, 503861.73583928344306]);
end
...
% data.
%    cv_ = { 23305.422726115677506, 46452.100146557364496, 15189.741076010081088};
%    cf_ = cfit(ft_,cv_{:});
