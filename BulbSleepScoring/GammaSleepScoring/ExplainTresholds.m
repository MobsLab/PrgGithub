close all
clear all
load('/media/DataMOBSSlSc/SleepScoringMice/M243/01042015/StateEpochSB.mat')
...
a=coeffvalues(cf2);
theta_thresh=((find((-output.residuals)'./Y>0.5)));
...
diff=(Y-a(1)*Y1)./Y;
bar(X(5:end),diff(5:end),'EdgeColor','k','FaceColor','k')
hold on
