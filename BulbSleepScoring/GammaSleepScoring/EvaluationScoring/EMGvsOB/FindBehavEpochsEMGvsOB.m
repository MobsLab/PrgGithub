function [REMEpoch,SWSEpoch,wakeper,REMEpoch1,SWSEpoch1,Wake1,smooth_ghi]=FindBehavEpochsEMGvsOB(mindur,mw_dur,sl_dur,ms_dur,wa_dur,filename,gamma_thresh_temp,theta_thresh_temp,fignum)
