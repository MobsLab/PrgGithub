...
save('OverlapStateByState_GADCre.mat','StateComp','Spec','Kap','fH','Dur_disagree_S_W','Dur_disagree_W_S')


%%%
% load('/media/DataMOBSSlSc/SleepScoringMice/AnalysisResults/CompEMGOBScoring.mat')
