function [REMEpoch,SWSEpoch,wakeper,REMEpoch1,SWSEpoch1,Wake1,smooth_ghi]=FindBehavEpochsDiffDays(mindur,mw_dur,sl_dur,ms_dur,wa_dur,filename,gamma_thresh_temp,theta_thresh_temp,fignum,plo)
cd(filename)
...
gamma_thresh_temp=gamma_thresh_temp+peak_gamma;
...
saveas(figurerecap,['CompareThresh' ,num2str(fignum),'.fig'])
saveas(figurerecap,['CompareThresh' ,num2str(fignum),'.png'])
end
close all
end