function SleepScoreFigureAllOB(filename,PlotEp,OBfrequency,name_to_use,smooth_Freq1Freq2)
...
[theText, rawN, x] =nhist(log(Data(Restrict(smooth_Freq1Freq2,sleepper))),'maxx',max(log(Data(Restrict(smooth_Freq1Freq2,sleepper)))),'noerror','xlabel','Beta power OB','ylabel',[]); axis xy
view(90,-90)
