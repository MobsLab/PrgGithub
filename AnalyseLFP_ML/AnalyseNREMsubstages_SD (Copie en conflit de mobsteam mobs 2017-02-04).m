...
try
    clear Epochs;
    temp=load([analyFolder,'/AnalyNREMsubstagesSD.mat'],'Epochs','DirE','Dir');
    temp.Epochs;
    chang=0;
    for a=1:length(DirE)
...
if DoAnalysis
    ...
    disp('saving in AnalyNREMsubstagesSD.mat')
    save([analyFolder,'/AnalyNREMsubstagesSD.mat'],'Dir','DirE','DirP','Stages',...
    ...
    disp('Loading existing AnalyNREMsubstagesSD.mat')
    load([analyFolder,'/AnalyNREMsubstagesSD.mat']);
end
...
if ~exist('durEp_LO','var')|| ~exist('durEp_SD','var')
    ...
    % saving 
    save([analyFolder,'/AnalyNREMsubstagesSD.mat'],'-append','durEp_LO','durEp_SD','MatDur','SD_dur',...
