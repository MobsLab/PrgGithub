...
function [SleepStages,Epochs,nameEpochs,fac]=PlotPolysomnoML(N1,N2,N3,SWS,REM,WAKE,numF,swaOB,legT)
...
if 1
    ...
    for ep=1:length(Epochs)
        id=ismember(rg,Range(Restrict(timeTsd,Epochs{ep})))==1;
...
if doOB
    ...
    id=ismember(rg,Range(Restrict(timeTsd,swaOB)))==1;
    OBtsd(id)=0.3;
    OBtsd=tsd(rg,OBtsd');
