...
%Dir{5,2}='/media/DataMOBsRAIDN/ProjetNREM/Mouse450/20161011';
Dir{5,3}='/media/DataMOBsRAIDN/ProjetNREM/Mouse450/20161012';

% ------------ 451 ------------ 
Dir{6,1}='/media/DataMOBsRAIDN/ProjetNREM/Mouse451/20161010';
%Dir{6,2}='/media/DataMOBsRAIDN/ProjetNREM/Mouse451/20161011';
%Dir{6,3}='/media/DataMOBsRAIDN/ProjetNREM/Mouse451/20161012';
...
try
    ...
    LNZT=0;
    for a=1:size(Dir,1), for i=1:3, nameMouse{a,i}='MouseNaN';end;end
    MATneuron=[]; DurEpZT=[];
