    ...
    try
        ...
        if doaccelero
            ...
            if dofreez % Julie 28.10.2016
                th_immob_Acc=3;% see EstablishAThresholdForFreezingFromAcceleration.m
                th_2merge_FreezAcc=0.5;thtps_immob_Acc=2;
                MovAccSmotsd=tsd(Range(MovAcctsd),SmoothDec(Data(MovAcctsd),3));
                ...
                save('behavResources','MovAccSmotsd','FreezeAccEpoch','th_immob_Acc','th_2merge_FreezAcc','thtps_immob_Acc','-append')
