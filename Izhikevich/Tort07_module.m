...
%% MODULE PARAMETERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Ne = 10;   Nfs = 20;  No = 20; N = Ne + Nfs + No;
...
tON = 10;        	% time at which the weights are turned on (ms)  par default 2000
...
for i=1:nsteps                        
    ...
    if time > tDopaON |time < tDopaOFF
        EC=100; Evr=-60; Evt=-40; Ek=0.95; % par default Ek=0.9; 
    else
        EC=100; Evr=-60; Evt=-40; Ek=0.55; % par default Ek=0.7;
    end
