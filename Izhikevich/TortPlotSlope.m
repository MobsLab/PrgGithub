function [spkformBb,spkformBa,spkformRb,spkformRa,spkformKb,spkformKa]=TortPlotSlope(Vlt,firings,tDopaON,tDopaOFF,Ne,Nfs,No,fig)
...
for i=1:N
hold on, plot([0.1:0.1:tDopaOFF],Vlt(i,:)+i*10,plotcoul{i})
end
