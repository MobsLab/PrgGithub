function [Times,Template,HeartRate,GoodEpoch]=DetectHeartBeats_EmbReact_SB(LFP,NoiseEpoch,Options,plo)
%
...
SnipDur = 5; %s
MinBeatSep = 0.06; % ms, so heart rate cannot be above 20Hz
...
HeartRate = tsd(Times(1:end-1),1./movmedian(diff(Times/1e4),4));
