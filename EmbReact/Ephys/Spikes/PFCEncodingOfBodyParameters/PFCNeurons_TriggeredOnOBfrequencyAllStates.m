...
if NoSleep
    ...
    save('PFCUnitFiringOnOBFrequencyAllSessBroadFreqNoSleep.mat','OBData','PSpk','RSpk','PSpk_btstrp','RSpk_btstrp','MeanSpk','Sp','SpHist')
else
    cd /media/DataMOBsRAIDN/ProjectEmbReact/Figures/SpikeAnalysis/PFC_Neurons_TwoTypesOfFreezing
    save('PFCUnitFiringOnOBFrequencyAllSessBroadFreq.mat','OBData','PSpk','RSpk','PSpk_btstrp','RSpk_btstrp','MeanSpk','Sp','SpHist')
end