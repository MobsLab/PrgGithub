...
for mm=1:length(MiceNumber)
    ...
    for k=1:length(FreqLims)-1
        ...
        [Y,X] = histc(log(Speeddata(Bins)),SpBins);
        SpHist{mm}(k,:) = Y;
...
if NoSleep
    ...
    save('PFCUnitFiringOnOBFrequencyAllSessSpeedCorrBroadFreqNoSleep.mat','OBData','PSpk','PvalAnovaInfo','RSpk','PSpk_btstrp','RSpk_btstrp','MeanSpk','Sp','SpHist','SpHist2','Sp2')
else
    cd /media/DataMOBsRAIDN/ProjectEmbReact/Figures/SpikeAnalysis/PFC_Neurons_TwoTypesOfFreezing
    save('PFCUnitFiringOnOBFrequencyAllSessSpeedCorrBroadFreq.mat','OBData','PSpk','RSpk','PSpk_btstrp','RSpk_btstrp','MeanSpk','Sp','SpHist','SpHist2','Sp2')
end
    save('PFCUnitFiringOnOBFrequencyAllSessSpeedCorrBroadFreqNoSleep.mat','PvalAnovaInfo','-append')
