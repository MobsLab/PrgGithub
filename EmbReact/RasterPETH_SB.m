function [fh,sq,sweeps, rasterAx, histAx,dArea] = RasterPETH_SB(S, center, TStart, TEnd,plo, varargin)


% S is tsd of Spike times
% center is ts of trigger times
% Tstart is (NEGATIVE) value to get time before trigger
% Tend is (POSITIVE) value to get time after trigger
