clear all
GroupNames = {'RipInhib','RipInhib_Ctrl'};
PosLimStep = 0.1;
...
load('Data_Physio_Freezing_RipInhib_Ctrl_ext_2sbins.mat')
...
for gg = 1:length(GroupNames)
    ...
    DataTypes = {'all','noHeart','noRespi','noGamma','noLowHpc','noHRVar','noRespiNoHR'};
    DataTypeDef = {[1:5,7:8],[1,4,5,7:8],[2:5,7:8],[1:3,7:8],[1:5],[1,2,4,5,7:8],[4,5,7:8]};
...
clear all
SessType = 'ext';
cd /media/nas7/ProjetEmbReact/DataEmbReact/Data_For_Decoding/old
load('Data_Physio_Freezing_RipInhib_ext_2sbins.mat')
% load('Data_Physio_Freezing_RipInhib_CondPost_2sbins.mat')
...
% load('Data_Physio_Freezing_FlxChr_Ctrl_ext_2sbins.mat')
load('Data_Physio_Freezing_RipInhib_Ctrl_ext_2sbins.mat')
% load('Data_Physio_Freezing_RipInhib_Ctrl_CondPost_2sbins.mat')
