function CalculateInstFreq_UMazeProject(folder,LFP,SaveName)
...
save(['InstFreqAndPhase_',SaveName,'.mat'],'LocalFreq','LocalPhase','AllPeaks','Options','Wavelet','-v7.3')
...
saveas(fig.Number,['InstantaneousFrequencyEstimate_',SaveName,'.png'])
close all
