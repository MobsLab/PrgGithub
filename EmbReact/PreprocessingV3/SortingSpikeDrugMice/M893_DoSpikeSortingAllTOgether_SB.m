...
CopyLocation = '/media/mobsmorty/2D373EF5372BA96B/Mouse893/SpikeSorting/'


% copy the ones for the UMaze day into folder
for g=1:length(FileNames)
    
    FileNames{g} = strrep(FileNames{g},'/media/nas4/ProjetEmbReact/','/media/mobsmorty/2D373EF5372BA96B/');
