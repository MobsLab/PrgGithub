function [LowFreqVals,HighFreqVals,Dkl,DklSurr,Prc99]=ComoduloPreFiltered(FilteredLow,FilteredHigh,LowFreqRg,HighFreqRg,LowFreqStep,HighFreqStep,BinNumbers,plo,NumSurrogates)
...
for ll=1:length(LowFreqVals)
    ...
    for hh=1:length(HighFreqVals)
        ...
        if HighFilterCenter>LowFilterCenter*2
            ...
            HilHigh=hilbert(Data(FilteredHigh{ll}{hh}));
            AmpLFP=abs(HilHigh);
