...
strsz=2;maxsrtsz=20;        se = strel('disk',strsz); se2 = strel('disk',strsz);
...
%% Track from Matlab generated frames
    ...
    function track(~,~)
        ...
        set(slider_srndsz,'Value',min(SrdZone/maxsrndsz,1));
...
%% Function called by the others
    ...
    function GetAllFolders(obj,event)
        ...
        save('FolderUMazeRetrackingEPM.mat','FolderNameAllUMaze')
