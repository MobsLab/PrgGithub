...
% 'Habituation' 'SleepPre' 'TestPre' 'UMazeCond' 'SleepPost' 'TestPost'
...
elseif strcmp(experiment,'Calibration_Eyeshock')
    ...
    StimDur={'2000','2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171226/ProjectEmbReact_M666_20171226_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172612/ProjectEmbReact_M667_20172612_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171226/ProjectEmbReact_M668_20171226_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171226/ProjectEmbReact_M669_20171226_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180207/ProjectEmbReact_M688_20180207_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180207/ProjectEmbReact_M689_20180207_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/22052018/ProjectEmbReact_M739_22052018_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/22052018/ProjectEmbReact_M740_22052018_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180606/ProjectEmbReact_M750_20180606_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180813/ProjectEmbReact_M775_20180813_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180822/ProjectEmbReact_M777_20180822_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180730/ProjectEmbReact_M778_20180730_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    StimDur={'2000','2000','2000','2000','2000','2000','2000'};
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180730/ProjectEmbReact_M779_20180730_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    for c=1:length(StimLevels)
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181023/ProjectEmbReact_M795_20181023_Calibration_',StimLevels{c},'V_',StimDur{c},'ms/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'WallCondShock_EyeShockTempProt')
    %Mouse560
...
elseif strcmp(experiment,'Habituation24HPre_EyeShock')
    ...
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse568/20170728/ProjectEmbReact_M568_20170728_Habituation24HPre/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
...
elseif strcmp(experiment,'SleepPost_EyeShock')
    ...
    % Mouse569
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse569/20170817/ProjectEmbReact_M569_20170817_SleepPost/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
...
elseif strcmp(experiment,'BaselineSleep')
    ...
    % Mouse436
    a=a+1;
    Dir.path{a}{1}='/media/DataMOBsRAID/ProjectEmbReact/Mouse436/20160810/Sleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAID/ProjectEmbReact/Mouse436/20160809/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    ...
    %Mouse688
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180207/ProjectEmbReact_M688_20180207_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    %Mouse689
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180207/ProjectEmbReact_M689_20180207_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    %Mouse739
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/18052018/ProjectEmbReact_M739_18052018_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    %Mouse740
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/18052018/ProjectEmbReact_M740_18052018_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    %Mouse750
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180702/ProjectEmbReact_M750_20180702_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    %Mouse775
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse775/20180725/ProjectEmbReact_M775_20180725_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse775/20180726/ProjectEmbReact_M775_20180726_BaselineSleep/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    Dir.path{a}{3}='/media/vador/DataMOBS89/Mouse775/20180727/ProjectEmbReact_M775_20180727_BaselineSleep/';
    load([Dir.path{a}{3},'ExpeInfo.mat']),Dir.ExpeInfo{a}{3}=ExpeInfo;
    
    %Mouse777
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse777/20180817/ProjectEmbReact_M777_20180817_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    %Mouse778
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse778/20180725/ProjectEmbReact_M778_20180725_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse778/20180726/ProjectEmbReact_M778_20180726_BaselineSleep/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    Dir.path{a}{3}='/media/vador/DataMOBS89/Mouse778/20180727/ProjectEmbReact_M778_20180727_BaselineSleep/';
    load([Dir.path{a}{3},'ExpeInfo.mat']),Dir.ExpeInfo{a}{3}=ExpeInfo;
    
    %Mouse779
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse779/20180725/ProjectEmbReact_M779_20180725_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse779/20180726/ProjectEmbReact_M779_20180726_BaselineSleep/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    Dir.path{a}{3}='/media/vador/DataMOBS89/Mouse779/20180727/ProjectEmbReact_M779_20180727_BaselineSleep/';
    load([Dir.path{a}{3},'ExpeInfo.mat']),Dir.ExpeInfo{a}{3}=ExpeInfo;
...
elseif strcmp(experiment,'Habituation24HPre_PreDrug')
    % Mouse688
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse689
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse739
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 740
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 750
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 775
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 777
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 778
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 779
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 795
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_Habituation24HPre_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_Habituation24HPre_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    
elseif strcmp(experiment,'Habituation_PreDrug')
    % Mouse688
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse689
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse739
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 740
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 750
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 775
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 777
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 778
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 779
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse 795
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_Habituation_PreDrug/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_Habituation_PreDrug/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    
elseif strcmp(experiment,'HabituationBlockedShock_PreDrug')
    % Mouse688
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse689
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse739
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse740
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse750
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse775
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse777
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse778
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse779
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse795
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_HabituationBlockedShock_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    
elseif strcmp(experiment,'HabituationBlockedSafe_PreDrug')
    % Mouse688
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse689
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse739
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse740
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse750
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse775
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse777
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse778
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse779
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse795
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_HabituationBlockedSafe_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    
elseif strcmp(experiment,'SleepPre_PreDrug')
    % Mouse688
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse689
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse 739
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse 740
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse 750
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse 775
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse 777
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse 778
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse 779
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse 795
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_SleepPre_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
...
elseif strcmp(experiment,'TestPre_PreDrug')
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_TestPre_PreDrug/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'UMazeCondExplo_PreDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_UMazeCondExplo_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'UMazeCondBlockedShock_PreDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_UMazeCondBlockedShock_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'UMazeCondBlockedSafe_PreDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_UMazeCondBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'SleepPost_PreDrug')
    % Mouse688
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse689
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse739
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse740
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse750
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse775
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse777
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse778
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse779
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse795
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_SleepPost_PreDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
...
elseif strcmp(experiment,'UMazeCondExplo_PostDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_UMazeCondExplo_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'UMazeCondBlockedShock_PostDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_UMazeCondBlockedShock_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'UMazeCondBlockedSafe_PostDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_UMazeCondBlockedSafe_PostDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'SleepPost_PostDrug')
    % Mouse688
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse689
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse739
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse740
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse750
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse775
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse777
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse778
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse779
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse795
    a=a+1;Dir.path{a}{1}='/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_SleepPost_PostDrug/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
...
elseif strcmp(experiment,'TestPost_PostDrug')
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_TestPost_PostDrug/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'ExtinctionBlockedShock_PostDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_ExtinctionBlockedShock_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'ExtinctionBlockedSafe_PostDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse689/20180213/ProjectEmbReact_M689_20180213_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse739/29052018/ProjectEmbReact_M739_29052018_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse740/25052018/ProjectEmbReact_M740_25052018_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse750/20180705/ProjectEmbReact_M750_20180705_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse775/20180815/ProjectEmbReact_M775_20180815_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse777/20180828/ProjectEmbReact_M777_20180828_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse778/20180807/ProjectEmbReact_M778_20180807_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS89/Mouse779/20180807/ProjectEmbReact_M779_20180807_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/vador/DataMOBS91/M795/20181030/ProjectEmbReact_M795_20181030_ExtinctionBlockedSafe_PostDrug/Ext',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'Habituation24HPre_PreDrug_TempProt')
    % Mouse666
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_Habituation24HPre/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_Habituation24HPre/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse667
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_Habituation24HPre/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_Habituation24HPre/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse668
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_Habituation24HPre/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_Habituation24HPre/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse669
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_Habituation24HPre/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_Habituation24HPre/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    
elseif strcmp(experiment,'Habituation_PreDrug_TempProt')
    % Mouse666
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_Habituation/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_Habituation/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse667
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_Habituation/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_Habituation/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse668
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_Habituation/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_Habituation/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
    % Mouse669
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_Habituation/Hab1/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_Habituation/Hab2/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    
elseif strcmp(experiment,'HabituationBlockedSafe_PreDrug_TempProt')
    % Mouse666
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_HabituationBlockedSafe/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse667
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_HabituationBlockedSafe/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse668
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_HabituationBlockedSafe/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse669
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_HabituationBlockedSafe/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    
elseif strcmp(experiment,'HabituationBlockedShock_PreDrug_TempProt')
    % Mouse666
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_HabituationBlockedShock/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse667
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_HabituationBlockedShock/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse668
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_HabituationBlockedShock/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse669
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_HabituationBlockedShock/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
...
elseif strcmp(experiment,'SleepPre_PreDrug_TempProt')
    ...
    % Mouse667
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_SleepPre/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
...
elseif strcmp(experiment,'TestPre_PreDrug_TempProt')
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_TestPre/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_TestPre/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_TestPre/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_TestPre/TestPre',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'UMazeCond_PreDrug_TempProt')
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_UMazeCondExplo/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_UMazeCondExplo/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_UMazeCondExplo/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_UMazeCondExplo/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'UMazeCondBlockedShock_PreDrug_TempProt')
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_UMazeCondBlockedShock/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_UMazeCondBlockedShock/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_UMazeCondBlockedShock/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_UMazeCondBlockedShock/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'UMazeCondBlockedSafe_PreDrug_TempProt')
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_UMazeCondBlockedSafe/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_UMazeCondBlockedSafe/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_UMazeCondBlockedSafe/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:3
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_UMazeCondBlockedSafe/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'SleepPost_PreDrug_TempProt')
    % Mouse666
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_SleepPost/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    ...
    % Mouse668
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_SleepPost/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse669
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_SleepPost/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
...
elseif strcmp(experiment,'TestPost_PreDrug_TempProt')
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_TestPost/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_TestPost/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_TestPost/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
    ...
    cc=1;
    for c=1:4
        Dir.path{a}{cc}=['/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_TestPost/TestPost',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'Extinction_PostDrug_TempProt')
    % Mouse666
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_Extinction/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse667
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_Extinction/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse668
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_Extinction/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse669
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_Extinction/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
elseif strcmp(experiment,'ExtinctionBlockedShock_PostDrug_TempProt')
    % Mouse666
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_ExtinctionBlockedShock/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse667
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_ExtinctionBlockedShock/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse668
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_ExtinctionBlockedShock/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse669
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_ExtinctionBlockedShock/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
elseif strcmp(experiment,'ExtinctionBlockedSafe_PostDrug_TempProt')
    % Mouse666
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse666/20171228/ProjectEmbReact_M666_20171228_ExtinctionBlockedSafe/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse667
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse667/20172912/ProjectEmbReact_M667_20172912_ExtinctionBlockedSafe/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse668
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse668/20171229/ProjectEmbReact_M668_20171229_ExtinctionBlockedSafe/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
    % Mouse669
    a=a+1;Dir.path{a}{1}='/media/DataMOBsRAIDN/ProjectEmbReact/Mouse669/20171228/ProjectEmbReact_M669_20171228_ExtinctionBlockedSafe/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    
elseif strcmp(experiment,'MidazolamDoseResponse_EPM')
    MouseNum = [801:824,830,831,833,836:848];
    for m = 1:length(MouseNum)
        a=a+1;Dir.path{a}{1}=['/media/vador/DataMOBS91/Midazolam/Mouse' num2str(MouseNum(m)) '/EPM/'];
        load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    end
...
elseif strcmp(experiment,'MidazolamDoseResponse_UMaze')
    MouseNum = [801:824,830,831,833,836:848];
    for m = 1:length(MouseNum)
        a=a+1;Dir.path{a}{1}=['/media/vador/DataMOBS91/Midazolam/Mouse' num2str(MouseNum(m)) '/UMazeExplo/'];
        load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    end
...
elseif strcmp(experiment,'MidazolamDoseResponse_Plethysmo')
    ...
    for m = 1:length(MouseNum)
        a=a+1;Dir.path{a}{1}=['/media/vador/DataMOBS91/Midazolam/Mouse' num2str(MouseNum(m)) '/Plethysmo/'];
        load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    end
