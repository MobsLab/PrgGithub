...
%     load([Dir.path{a}{3},'ExpeInfo.mat']),Dir.ExpeInfo{a}{3}=ExpeInfo;
    ...
    %Mouse779
    a=a+1;Dir.path{a}{1}='/media/nas4/ProjetEmbReact/Mouse779/20180725/ProjectEmbReact_M779_20180725_BaselineSleep/';
    load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    Dir.path{a}{2}='/media/nas4/ProjetEmbReact/Mouse779/20180726/ProjectEmbReact_M779_20180726_BaselineSleep/';
    load([Dir.path{a}{2},'ExpeInfo.mat']),Dir.ExpeInfo{a}{2}=ExpeInfo;
    Dir.path{a}{3}='/media/nas4/ProjetEmbReact/Mouse779/20180727/ProjectEmbReact_M779_20180727_BaselineSleep/';
    load([Dir.path{a}{3},'ExpeInfo.mat']),Dir.ExpeInfo{a}{3}=ExpeInfo;
...
elseif strcmp(experiment,'UMazeCondBlockedSafe_PreDrug')
    ...
    cc=1;
    for c=1:2
        Dir.path{a}{cc}=['/media/nas4/ProjetEmbReact/Mouse851/24012019/ProjectEmbReact_M851_24012019_HabituationBlockedSafe_PreDrug/Cond',num2str(c),'/'];
        load([Dir.path{a}{cc},'ExpeInfo.mat']),Dir.ExpeInfo{a}{cc}=ExpeInfo;
        cc=cc+1;
    end
...
elseif strcmp(experiment,'MidazolamDoseResponse_EPM')
    ...
    for m = 1:length(MouseNum)
        a=a+1;Dir.path{a}{1}=['/media/nas4/DataMOBS91/Midazolam/Mouse' num2str(MouseNum(m)) '/EPM/'];
        load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    end
...
elseif strcmp(experiment,'MidazolamDoseResponse_UMaze')
    MouseNum = [801:824,830,831,833,836:848];
    for m = 1:length(MouseNum)
        a=a+1;Dir.path{a}{1}=['/media/nas4/DataMOBS91/Midazolam/Mouse' num2str(MouseNum(m)) '/UMazeExplo/'];
        load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    end
...
elseif strcmp(experiment,'MidazolamDoseResponse_Plethysmo')
    ...
    for m = 1:length(MouseNum)
        a=a+1;Dir.path{a}{1}=['/media/nas4/DataMOBS91/Midazolam/Mouse' num2str(MouseNum(m)) '/Plethysmo/'];
        load([Dir.path{a}{1},'ExpeInfo.mat']),Dir.ExpeInfo{a}{1}=ExpeInfo;
    end
