function FolderName=OrganizeFilesEmbReactNewProtocolSB_FLXbis(MouseNum,Date,SaveFolderName,ChannelsToAnalyseLocation,InfoLFP,ExpeInfo,answer,answerdigin,XMLToCopy,XMLToCopySpike)
