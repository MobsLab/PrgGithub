...
%             HR.(MouseGroup{mg}){mm} = ConcatenateDataFromFolders_SB({'/media/DataMOBsRAIDN/ProjectEmbReact/Mouse688/20180209/ProjectEmbReact_M688_20180209_TestPost_PostDrug/TestPost1'},'heartrate');
...
%          save(['/media/nas4/ProjetEmbReact/DrugEffectFigures/DataFLXMDZ',num2str(sesstype),'_BlkEpoch_Corr.mat'],'Blk','-v7.3')
         save(['/media/nas4/ProjetEmbReact/DrugEffectFigures/DataFLXMDZ',num2str(sesstype),'_Pos_Corr.mat'],'Pos','-v7.3')
