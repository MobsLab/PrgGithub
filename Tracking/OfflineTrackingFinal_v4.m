            ...
            try
                ...
                try
                    ...
                    try
                        ...
                        pixratio=1./intvar.Ratio_IMAonREAL;
                    end
                    cd(PathName);
                catch
                    cd(PathName);
...
%% Function called by the others
    function GenMask
        ...
        subplot(1,2,1), imshow(ref),axis image
    ...
    function GenTracking
        ...
        subimage = (double(ref)-double(IM));
        subimage = uint8(double(subimage).*double(mask));
        % Convert the resulting grayscale image into a binary image.
        diff_im = (im2bw(subimage,BW_threshold)).*double(mask);
        imagesc(diff_im)
