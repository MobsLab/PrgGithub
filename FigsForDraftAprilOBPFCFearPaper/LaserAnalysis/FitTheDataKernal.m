function [x,fval,exitflag,output,lambda,grad,hessian]=FitTheDataKernal(TrialSet,FitFunction,ConstraintFunction)
...
TrialSet.In=TrialSet.In(:,1:InputInfo.subsample:end);
TrialSet.Out=TrialSet.Out(:,1:InputInfo.subsample:end);
time=[1./InputInfo.SampleRate:1./InputInfo.SampleRate:size(TrialSet.In,2)/InputInfo.SampleRate]; time=time(1:InputInfo.subsample:end);
