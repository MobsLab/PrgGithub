...
OnsetVal = nanmean(DatMatCl(:,37:62)');
OffsetVal = nanmean(DatMatCl(:,[63:88]+125)');
OnsetValrg = range(DatMatCl(:,37:62)');
...
OnsetVal_B = nanmean(DatMat_B(:,37:62)');
OffsetVal_B = nanmean(DatMat_B(:,[63:88]+125)');
OnsetValrg_B = range(DatMatCl_B(:,37:62)');
...
[pval med P] = circ_cmtest(PhaseNeur((UseForTresh)<-Thresh & PValNeur<0.05),PhaseNeur(UseForTresh>Thresh & PValNeur<0.05));

%% Onset vs offset for the three groups
figure
subplot(311)
[p1,~,s1] = PlotErrorBarN_KJ({OnsetVal((UseForTresh)<-Thresh);OffsetVal((UseForTresh)<-Thresh)},'paired',1,'showpoints',0,'newfig',0,'barcolors',{[251,176,64]/256,[127,63,152]/256})
ylim([-0.65 0.65])
...
makepretty
subplot(312)
[p2,~,s2] = PlotErrorBarN_KJ({OnsetVal(abs(UseForTresh)<Thresh);OffsetVal(abs(UseForTresh)<Thresh)},'paired',1,'showpoints',0,'newfig',0,'barcolors',{[251,176,64]/256,[127,63,152]/256})
ylim([-0.65 0.65])
set(gca,'XTick',[1,2],'XTickLabel',{'Onset','Offset'})
ylabel('FR (zscore)')
xlim([0.5 2.5])
makepretty
subplot(313)
[p3,~,s3] = PlotErrorBarN_KJ({OnsetVal((UseForTresh)>Thresh);OffsetVal((UseForTresh)>Thresh)},'paired',1,'showpoints',0,'newfig',0,'barcolors',{[251,176,64]/256,[127,63,152]/256})
ylim([-0.65 0.65])
set(gca,'XTick',[1,2],'XTickLabel',{'Onset','Offset'})
ylabel('FR (zscore)')
xlim([0.5 2.5])
...
figure
errorbar(1:40,runmean(nanmean(DatMatNormt(PValNeur<0.05,:)),1),stdError(runmean(DatMatNormt(PValNeur<0.05,:)',2)'),'LineWidth',2,'color','k')
hold on
errorbar(1:40,runmean(nanmean(DatMatNormt(PValNeur>0.05,:)),2),stdError(runmean(DatMatNormt(PValNeur>0.05,:)',2)'),'LineWidth',2,'color',[0.6 0.6 0.6])
...
[p_on,~,s_on] = PlotErrorBarN_KJ(A,'paired',0,'Newfig',0,'showpoints',0,'barcolors',{'k',[0.6 0.6 0.6],[0.8 0.2 0.2]})
...
[p_sust,~,s_sust] =PlotErrorBarN_KJ(A,'paired',0,'Newfig',0,'showpoints',0,'barcolors',{'k',[0.6 0.6 0.6],[0.8 0.2 0.2]})
% MakeSpreadAndBoxPlot_SB(A,{[0.4 0.4 0.4],[0.8 0.8 0.8],[0.8 0.2 0.2]},[1,3,5],{'CTRL-Mod','CTRL-NonMod','OBX'},0)
set(gca,'XTick',[1,2,3],'XTickLabel',{'CTRL-Mod','CTRL-NonMod','OBX'})
ylim([0 1.1])
xtickangle(45)
...
[p_off,~,s_off] =PlotErrorBarN_KJ(A,'paired',0,'Newfig',0,'showpoints',0,'barcolors',{'k',[0.6 0.6 0.6],[0.8 0.2 0.2]})
% MakeSpreadAndBoxPlot_SB(A,{[0.4 0.4 0.4],[0.8 0.8 0.8],[0.8 0.2 0.2]},[1,3,5],{'CTRL-Mod','CTRL-NonMod','OBX'},0)
ylim([0 1.1])
xtickangle(45)
set(gca,'XTick',[1,2,3],'XTickLabel',{'CTRL-Mod','CTRL-NonMod','OBX'})
