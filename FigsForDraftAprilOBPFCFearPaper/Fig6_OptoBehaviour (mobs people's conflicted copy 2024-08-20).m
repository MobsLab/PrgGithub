...
for k= 1 :3
    a=iosr.statistics.boxPlot(k,CHRMiceFz(:,k),'boxColor',[0.8 0.8 0.8],'lineColor',[0.8 0.8 0.8],'medianColor','k','boxWidth',0.5,'showOutliers',false);
...
for k= 1 :3
    a=iosr.statistics.boxPlot(k,GFPMiceFz (:,k),'boxColor',[0.95 0.95 0.95],'lineColor',[0.95 0.95 0.95],'medianColor','k','boxWidth',0.5,'showOutliers',false);
    a.handles.upperWhiskers.Visible='off';a.handles.upperWhiskerTips.Visible='off';
    a.handles.lowerWhiskers.Visible='off';a.handles.lowerWhiskerTips.Visible='off';
     a.handles.medianLines.LineWidth = 5;
