...
function [ok,x1,x2,x3,x4,x5,x6,x7,x8,x9] = samelength(x1,x2,x3,x4,x5,x6,x7,x8,x9)
  ...
  if (~isempty(x1)) isscalvect(1) = 0; if (isscalar(x1)|isvect(x1)) isscalvect(1) = 1; end; end;
  if (~isempty(x2)) isscalvect(2) = 0; if (isscalar(x2)|isvect(x2)) isscalvect(2) = 1; end; end;
  if (~isempty(x3)) isscalvect(3) = 0; if (isscalar(x3)|isvect(x3)) isscalvect(3) = 1; end; end;
  if (~isempty(x4)) isscalvect(4) = 0; if (isscalar(x4)|isvect(x4)) isscalvect(4) = 1; end; end;
  if (~isempty(x5)) isscalvect(5) = 0; if (isscalar(x5)|isvect(x5)) isscalvect(5) = 1; end; end;
  if (~isempty(x6)) isscalvect(6) = 0; if (isscalar(x6)|isvect(x6)) isscalvect(6) = 1; end; end;
  if (~isempty(x7)) isscalvect(7) = 0; if (isscalar(x7)|isvect(x7)) isscalvect(7) = 1; end; end;
  if (~isempty(x8)) isscalvect(8) = 0; if (isscalar(x8)|isvect(x8)) isscalvect(8) = 1; end; end;
  if (~isempty(x9)) isscalvect(9) = 0; if (isscalar(x9)|isvect(x9)) isscalvect(9) = 1; end; end;
  ...
  if (~isempty(x1)) isscalrowvect(1) = 0; if (isscalar(x1)|isvect(x1,1)) isscalrowvect(1) = 1; end; end;
  if (~isempty(x2)) isscalrowvect(2) = 0; if (isscalar(x2)|isvect(x2,1)) isscalrowvect(2) = 1; end; end;
  if (~isempty(x3)) isscalrowvect(3) = 0; if (isscalar(x3)|isvect(x3,1)) isscalrowvect(3) = 1; end; end;
  if (~isempty(x4)) isscalrowvect(4) = 0; if (isscalar(x4)|isvect(x4,1)) isscalrowvect(4) = 1; end; end;
  if (~isempty(x5)) isscalrowvect(5) = 0; if (isscalar(x5)|isvect(x5,1)) isscalrowvect(5) = 1; end; end;
  if (~isempty(x6)) isscalrowvect(6) = 0; if (isscalar(x6)|isvect(x6,1)) isscalrowvect(6) = 1; end; end;
  if (~isempty(x7)) isscalrowvect(7) = 0; if (isscalar(x7)|isvect(x7,1)) isscalrowvect(7) = 1; end; end;
  if (~isempty(x8)) isscalrowvect(8) = 0; if (isscalar(x8)|isvect(x8,1)) isscalrowvect(8) = 1; end; end;
  if (~isempty(x9)) isscalrowvect(9) = 0; if (isscalar(x9)|isvect(x9,1)) isscalrowvect(9) = 1; end; end;
  ...
  if (isscalvect)
    if (isvect(x1,1)) x1 = x1(:); isrowvect(1) = 1; end;
    if (isvect(x2,1)) x2 = x2(:); isrowvect(2) = 1; end;
    if (isvect(x3,1)) x3 = x3(:); isrowvect(3) = 1; end;
    if (isvect(x4,1)) x4 = x4(:); isrowvect(4) = 1; end;
    if (isvect(x5,1)) x5 = x5(:); isrowvect(5) = 1; end;
    if (isvect(x6,1)) x6 = x6(:); isrowvect(6) = 1; end;
    if (isvect(x7,1)) x7 = x7(:); isrowvect(7) = 1; end;
    if (isvect(x8,1)) x8 = x8(:); isrowvect(8) = 1; end;
    if (isvect(x9,1)) x9 = x9(:); isrowvect(9) = 1; end;
  end;
