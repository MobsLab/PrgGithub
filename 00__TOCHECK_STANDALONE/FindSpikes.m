function [S, E, M] = FindSpikes(Filt_EEG, DetectThreshold, varargin)
% [S, E, M] = findSpikes(Filt_EEG, DetectThreshold, varargin)
% 
% INPUTS: 
% Filt_EEG: EEG tsd filtered in the spikes (e.g. 100-300 Hz) range
% DetectThreshold: Threshold for detection of spikes 
%
% PARAMETERS:
% Q1: number of cycles to check to find boundaries
% CloseThreshold: Closeness threshold,if two ripple events are closer than
...
% parameters
Q1 = 3;
CloseThreshold = 0.5 * 10;
MinRippleDuration = 0.02 * 10;

LimitThreshold=DetectThreshold;
