...
% Event file(s) : channel 18
DATA.events18.time = [];
DATA.events18.description = {};
eventFiles18 = dir([path sepMark '*.e18.evt']);
...
% Event file(s) : channel 19
DATA.events19.time = [];
DATA.events19.description = {};
eventFiles19 = dir([path sepMark '*.e19.evt']);
...
% Event file(s) : channel 20
DATA.events20.time = [];
DATA.events20.description = {};
eventFiles20 = dir([path sepMark '*.e20.evt']);
...
disp(' ')
LocalGlobal=input('Was there a local global assignment to do during this session ? (yes=1/no=0) ')
disp(' ')
if LocalGlobal==1
    try
...
%------------------------------------    
try
    save behavResources -append Event17 Event18 Event19 Event20 Event21
catch
...
try
    ...
    save behavResources -append Event19
end
try
    save behavResources -append Event17 Event18 Event19 Event20 Event21
catch
    save behavResources -append Event18
end
