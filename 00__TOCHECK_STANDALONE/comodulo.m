...
% rgFreq=[Fdeb Ffin]; frequence de la bande modulante
...
fech=1/median(diff(Range(LFPi,'s'))); % sampling frequency
VTime=Range(LFPi,'s');% Time vector
Sgn=Data(LFPi)';% data vector
...
fechO=1/median(diff(Range(LFPo,'s'))); % sampling frequency
VTimeO=Range(LFPo,'s'); % Time vector
SgnO=Data(LFPo)'; % data vector
