...
if 0
rg=Range(LFP{1});
Epoch=intervalSet(0 ,620*1E4);
%Epoch=intervalSet(620*1E4, rg(end));
LFP=Restrict(LFP,Epoch);
end

[Dt1,Dp1,Sp1,Ri1]=IdentifyDeltaSpindlesRipples(LFP,15,12,3000,0);
[Dt2,Dp2,Sp2,Ri2]=IdentifyDeltaSpindlesRipples(LFP,5,7,3000,0);
[Dt3,Dp3,Sp3,Ri3]=IdentifyDeltaSpindlesRipples(LFP,1,[],3000,0);
...
badEpoch=mergeCloseIntervals(badEpoch,3E4);
badEpoch=dropShortIntervals(badEpoch,2E4);

badEpoch=intervalSet(Start(badEpoch)-4E4,End(badEpoch)+4E4);
...
DebutUp=Start(badEpoch,'s');
FinUp=End(badEpoch,'s');
