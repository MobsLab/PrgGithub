...
%     end
    ...
    for j=1:5
            for i=1:3
                try
            ClT{j}=[ClT{j};Cl{i,j}'];
            nbSpindlesL{j}=[nbSpindlesL{j},NBSpindlesL{i,j}];
                end
                try
                    ChT{j}=[ChT{j};Ch{i,j}']; 
                    nbSpindlesH{j}=[nbSpindlesH{j},NBSpindlesH{i,j}]; 
                end
            end
            
            try
                nbRipples{j}=[nbRipples{j},NBRipples{j}];
            end  
    end
    ...
    for j=1:5
            for i=1:3
    M1hrT{i,j}=[M1hrT{i,j},M1hr{i,j}(:,2)];
    M2hrT{i,j}=[M2hrT{i,j},M2hr{i,j}(:,2)];
    M3hrT{i,j}=[M3hrT{i,j},M3hr{i,j}(:,2)];
    M1sT{i,j}=[M1sT{i,j},M1s{i,j}(:,2)];
    M2sT{i,j}=[M2sT{i,j},M2s{i,j}(:,2)];
    M3sT{i,j}=[M3sT{i,j},M3s{i,j}(:,2)];
    M1lT{i,j}=[M1lT{i,j},M1l{i,j}(:,2)];
    M2lT{i,j}=[M2lT{i,j},M2l{i,j}(:,2)];
    M3lT{i,j}=[M3lT{i,j},M3l{i,j}(:,2)];
    M1prT{i,j}=[M1prT{i,j},M1pr{i,j}(:,2)];
    M2prT{i,j}=[M2prT{i,j},M2pr{i,j}(:,2)];
    M3prT{i,j}=[M3prT{i,j},M3pr{i,j}(:,2)];
            end
    end
...
% PlotMeanSTD(tps/1E3,ChT{1},5,'b',1)
% PlotMeanSTD(tps/1E3,ChT{2},5,'k',0)
% PlotMeanSTD(tps/1E3,ChT{3},5,'r',0)
% PlotMeanSTD(tps/1E3,ChT{4},5,'m',0)
% PlotMeanSTD(tps/1E3,ChT{5},5,'m',0)
% 
% PlotMeanSTD(tps/1E3,ClT{1},5,'b',1)
% PlotMeanSTD(tps/1E3,ClT{2},5,'k',0)
% PlotMeanSTD(tps/1E3,ClT{3},5,'r',0)
% PlotMeanSTD(tps/1E3,ClT{4},5,'m',0)
% PlotMeanSTD(tps/1E3,ClT{5},5,'m',0)


PlotMeanSTD(tps/1E3,zscore(ChT{1}')',5,'b',1)
PlotMeanSTD(tps/1E3,zscore(ChT{2}')',5,'k',0)
PlotMeanSTD(tps/1E3,zscore(ChT{3}')',5,'r',0)
PlotMeanSTD(tps/1E3,zscore(ChT{4}')',5,'m',0)
PlotMeanSTD(tps/1E3,zscore(ChT{5}')',5,'m',0)

PlotMeanSTD(tps/1E3,zscore(ClT{1}')',5,'b',1)
PlotMeanSTD(tps/1E3,zscore(ClT{2}')',5,'k',0)
PlotMeanSTD(tps/1E3,zscore(ClT{3}')',5,'r',0)
PlotMeanSTD(tps/1E3,zscore(ClT{4}')',5,'m',0)
PlotMeanSTD(tps/1E3,zscore(ClT{5}')',5,'m',0)


PlotErrorBar4(nbSpindlesL{1}',nbSpindlesL{2}',nbSpindlesL{3}',nbSpindlesL{4}')
PlotErrorBar4(nbSpindlesH{1}',nbSpindlesH{2}',nbSpindlesH{3}',nbSpindlesH{4}')
