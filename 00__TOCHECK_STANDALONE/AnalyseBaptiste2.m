...
pc2=V(:,2);pc3=V(:,3);
[BE,id2]=sort(pc2);[BE,id3]=sort(pc3);
...
figure, imagesc(r(id,id)), title('First PC')
try
set(gca,'YTick',1:length(Columns_Names),'YTickLabel',Columns_Names(id)), 
end
colorbar

figure, imagesc(r(id2,id2)), title('Second PC')
try
set(gca,'YTick',1:length(Columns_Names),'YTickLabel',Columns_Names(id2)), 
end
colorbar


figure, imagesc(r(id3,id3)), title('Third PC')
try
set(gca,'YTick',1:length(Columns_Names),'YTickLabel',Columns_Names(id3)), 
end
colorbar
...
%     v3=temp*V(:,3);
    ...
    line(xlim,[0 0],[0 0],'linewidth',1,'color','k')
    line([0 0],ylim,[0 0],'linewidth',1,'color','k')
    line([0 0],[0 0],zlim,'linewidth',1,'color','k')
    title(Mice_Group{i}) 
end
