function [Ppos,Pneg,Pboth]=fisherextest(a,b,c,d,plot_result)
...
%
% Change log:
% Mikut, Ralf November 11: 
%   * Optional switch off for result's visualization
%   * Smaller corrections for code optimization
