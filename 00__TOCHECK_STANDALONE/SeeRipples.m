...
function [ripples,ripples2]=SeeRipples(LFP,v,Epoch,v2,vnoise)
...
if vnoise==0
    ...
    FilRip=FilterLFP(Restrict(LFP{v},Epoch),[130 200],512);
    ...
    NoiseRip=FilterLFP(Restrict(LFP{vnoise},Epoch),[130 200],512);
...
if vnoise==0
    ...
    FilRip2=FilterLFP(Restrict(LFP{v2},Epoch),[130 200],512);
