...
ggggg
    ...
    load DataNoelliaCrossCorr1 % 
    elseif structu=='Par'& HighLow=='L';
    load DataNoelliaCrossCorr2 % struct='Par';, HighLow='L';
    elseif structu=='Pfc'& HighLow=='H';
    load DataNoelliaCrossCorr3 % struct='Pfc';, HighLow='H';
    elseif structu=='Par'& HighLow=='H';
    load DataNoelliaCrossCorr4 % struct='Par';, HighLow='H';
    elseif structu=='Aud'& HighLow=='L';
    load DataNoelliaCrossCorr5 % struct='Par';, HighLow='H';
    elseif structu=='Aud'& HighLow=='H';
    load DataNoelliaCrossCorr6 % struct='Par';, HighLow='H';
    end
    BilanCtrl;
catch
    ...
    try
     cd \\NASDELUXE\DataMOBs\ProjetLPS\Mouse056\20130409\BULB-Mouse-56-09042013
        ...
        cd /media/DataMOBs/ProjetLPS/Mouse056/20130409/BULB-Mouse-56-09042013
    end
   ...
   % cd \\NASDELUXE\DataMOBs\ProjetLPS\Mouse056\20130412\BULB-Mouse-56-12042013
    ...
    % [CPrePar{1,a},BPrePar{1,a},CPostPar{1,a},BPostPar{1,a}]=BilanCrossCorrSpindles(0,'Par','Hpc',HighLow);

    %LPS
    try
    cd \\NASDELUXE\DataMOBs\ProjetLPS\Mouse056\20130410\BULB-Mouse-56-10042013
    catch
        cd /media/DataMOBs/ProjetLPS/Mouse056/20130410/BULB-Mouse-56-10042013
    end
    ...
    % [CPrePar{2,a},BPrePar{2,a},CPostPar{2,a},BPostPar{2,a}]=BilanCrossCorrSpindles(0,'Par','Hpc',HighLow);
    ...
    try
     cd \\NASDELUXE\DataMOBs\ProjetLPS\Mouse063\20130424\BULB-Mouse-63-24042013
        ...
        cd /media/DataMOBs/ProjetLPS/Mouse063/20130424/BULB-Mouse-63-24042013
    end
    ...
    cd \\NASDELUXE\DataMOBs\ProjetLPS\Mouse063\20130425\BULB-Mouse-63-25042013
        ...
        cd /media/DataMOBs/ProjetLPS/Mouse063/20130425/BULB-Mouse-63-25042013
    end
    [M1RipPre{2,a},M2RipPre{2,a},M3RipPre{2,a},M1RipPost{2,a},M2RipPost{2,a},M3RipPost{2,a},M1SpiPre{2,a},M2SpiPre{2,a},M3SpiPre{2,a},M1SpiPost{2,a},M2SpiPost{2,a},M3SpiPost{2,a},M1PowPre{2,a},M2PowPre{2,a},M3PowPre{2,a},M1PowPost{2,a},M2PowPost{2,a},M3PowPost{2,a}]=RipPowerModulationSpi(structu,HighLow);
    title('LPS')
    [CPrePfc{2,a},BPrePfc{2,a},CPostPfc{2,a},BPostPfc{2,a},NPre{2,a},NPost{2,a},N2Pre{2,a},N2Post{2,a}]=BilanCrossCorrSpindles(0,structu,'Hpc',HighLow);
    ...
    try
     cd \\NASDELUXE\DataMOBs\ProjetLPS\Mouse055\20130402\BULB-Mouse-55-56-02042013
        ...
        cd /media/DataMOBs/ProjetLPS/Mouse055/20130402/BULB-Mouse-55-56-02042013
    end
     
     %cd \\NASDELUXE\DataMOBs\ProjetLPS\Mouse055\20130404\BULB-Mouse-55-04042013   
    [M1RipPre{1,a},M2RipPre{1,a},M3RipPre{1,a},M1RipPost{1,a},M2RipPost{1,a},M3RipPost{1,a},M1SpiPre{1,a},M2SpiPre{1,a},M3SpiPre{1,a},M1SpiPost{1,a},M2SpiPost{1,a},M3SpiPost{1,a},M1PowPre{1,a},M2PowPre{1,a},M3PowPre{1,a},M1PowPost{1,a},M2PowPost{1,a},M3PowPost{1,a}]=RipPowerModulationSpi(structu,HighLow,0.5);
    title('Veh')
     [CPrePfc{1,a},BPrePfc{1,a},CPostPfc{1,a},BPostPfc{1,a},NPre{1,a},NPost{1,a},N2Pre{1,a},N2Post{1,a}]=BilanCrossCorrSpindles(0,structu,'Hpc',HighLow,0.5);
    % [CPrePar{1,a},BPrePar{1,a},CPostPar{1,a},BPostPar{1,a}]=BilanCrossCorrSpindles(0,'Par','Hpc',HighLow);
    ...
    cd \\NASDELUXE\DataMOBs\ProjetLPS\Mouse055\20130403\BULB-Mouse-55-03042013
        ...
        cd /media/DataMOBs/ProjetLPS/Mouse055/20130403/BULB-Mouse-55-03042013
    end
    
    [M1RipPre{2,a},M2RipPre{2,a},M3RipPre{2,a},M1RipPost{2,a},M2RipPost{2,a},M3RipPost{2,a},M1SpiPre{2,a},M2SpiPre{2,a},M3SpiPre{2,a},M1SpiPost{2,a},M2SpiPost{2,a},M3SpiPost{2,a},M1PowPre{2,a},M2PowPre{2,a},M3PowPre{2,a},M1PowPost{2,a},M2PowPost{2,a},M3PowPost{2,a}]=RipPowerModulationSpi(structu,HighLow,0.5);
    title('LPS')
    [CPrePfc{2,a},BPrePfc{2,a},CPostPfc{2,a},BPostPfc{2,a},NPre{2,a},NPost{2,a},N2Pre{2,a},N2Post{2,a}]=BilanCrossCorrSpindles(0,structu,'Hpc',HighLow,0.5);
    % [CPrePar{2,a},BPrePar{2,a},CPostPar{2,a},BPostPar{2,a}]=BilanCrossCorrSpindles(0,'Par','Hpc',HighLow);
...
for i=1:3
 b=3;
    for a=listLFPGood{numStruct,numHighLow,i}
        try
idaft=find((BPrePfc{1,i}{a,b}>-2.5*1E3&BPrePfc{1,i}{a,b}<-1.5)|BPrePfc{1,i}{a,b}>1.5*1E3&BPrePfc{1,i}{a,b}<2.5);
...
p14=Pt(5);
p23=Pt(6);
title(['Modulation of Hpc Ripples Occurence by ',structu,' Spindles, p12 ',num2str(floor(p12*100)/100),', p34 ',num2str(floor(p34*100)/100),', p13 ',num2str(floor(p24*100)/100),', p24 ',num2str(floor(p13*100)/100),', p14 ',num2str(floor(p14*100)/100),', p23 ',num2str(floor(p23*100)/100)])
set(gca,'xtick',[1:4])
set(gca,'xticklabel',{'Veh Pre','Veh Post','LPS Pre','LPS Post'})
