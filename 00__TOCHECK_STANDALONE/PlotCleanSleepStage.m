function SleepStages=PlotCleanSleepStage(Wake,SWSEpoch,REMEpoch,plo,fac,varargin)

% SleepStages=PlotCleanSleepStage(Wake,SWSEpoch,REMEpoch,plo,fac,OptEpoch,OptYaxis)
...
% SleepStages=PlotCleanSleepStage(Wake,SWSEpoch,REMEpoch,0,[10 2]);
%
% figure('color',[1 1 1]), imagesc(Spectro{2},Spectro{3},10*log10(Spectro{1}')), axis xy  % (spectrum between 20 and 100 Hz)
% SleepStages=PlotCleanSleepStage(Wake,SWSEpoch,REMEpoch,0,[70 4]);
%
...
[Wake,TotalNoiseEpoch,Dur]=CleanWakeNoise(SleepStages,Wake);
[REMEpoch, Wake, idbad]=CleanREMEpoch(SleepStages,REMEpoch,Wake);
