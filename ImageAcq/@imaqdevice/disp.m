...
%    $Revision: 1.1.6.7 $  $Date: 2008/10/08 17:13:02 $
...
for nSrc=1:nSources,
    ...
    elseif nSrc~=nSources,
        ...
        srcStr = [srcStr AvailableSrcs{nSrc} sepStr]; %#ok<AGROW>
    else
        % ... and rgb6.
        srcStr = [srcStr 'and ', AvailableSrcs{nSrc} ' are available.']; %#ok<AGROW>
    end
end
