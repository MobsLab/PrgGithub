...
%   $Revision: 1.1.10.6 $  $Date: 2010/12/27 01:14:01 $
...
if (~isa(obj, 'imaqdevice') || (length(obj) ~= 1))
...
if (nargin == 1)
    ...
    imaqdeviceMethods = methods('imaqdevice');
...
methodNames(end+1:end+numToPad) = repmat({' '}, 1, numToPad);
