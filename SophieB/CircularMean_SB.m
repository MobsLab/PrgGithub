function [mu, Kappa, pval, Rmean, delta, sigma,confDw,confUp] = CircularMean_SB(theta,varargin)
% [theta, Kappa, pval, Rmean, delta] = CircularMean(t) ciricualr mean, dispersion
% and significance of a circular datasets
% 
% INPUTS:
% t: a set of angles (in degree) 
% OUTPUT:
...
delta = (1 - rho2) / (2 * Rmean^2)/360*2*pi;
