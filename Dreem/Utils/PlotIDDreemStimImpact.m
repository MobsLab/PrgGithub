...
% 23.03.2018 KJ
%
% infos = PlotIDDreemStimImpact(filereference)
%
% INFOS
...
%
% SEE 
%   DreemIDStimImpact PlotIDClinicalRecordVC
%
%


function infos = PlotIDDreemStimImpact(filereference)

%% Load Data
try
    datafile = fullfile(FolderStimImpactID,['IdFigureData_' num2str(filereference) '.mat']);
    load(datafile)
catch
...
textbox_str = {['Subject ' num2str(infos.subject)], [infos.date ' / ' infos.condition], [num2str(nb_events.tones) ' stimulations']}; 
