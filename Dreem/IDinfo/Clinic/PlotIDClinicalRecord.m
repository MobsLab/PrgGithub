...
%
% SEE 
%   GenerateIDClinicalRecord PlotIDClinicalRecordVC
%
%


function infos = PlotIDClinicalRecord(filereference)
...
textbox_str = {['Subject ' num2str(infos.subject) ' / night ' num2str(infos.night)], [infos.date ' / ' infos.condition], [num2str(infos.nb_tones) ' stimulations'], [num2str(infos.nb_hypnogram) '(+1) hypnograms']}; 
