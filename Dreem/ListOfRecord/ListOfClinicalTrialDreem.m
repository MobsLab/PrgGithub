function Dir=ListOfClinicalTrialDreem(experiment)
%
%
%   see ListOfClinicalTrialDreemAnalyse
%


%Select all nights
if strcmpi(experiment,'all')
    Dir1 = ListOfClinicalTrialDreemAnalyse('Habituation');
    Dir2 = ListOfClinicalTrialDreemAnalyse('Sham');
    Dir3 = ListOfClinicalTrialDreemAnalyse('Random');
    Dir4 = ListOfClinicalTrialDreemAnalyse('UpPhase');
    
    Dir1 = FusionListOfClinicalTrial(Dir1,Dir2);
    Dir2 = FusionListOfClinicalTrial(Dir3,Dir4);
    
    Dir = FusionListOfClinicalTrial(Dir1,Dir2);
    
elseif strcmpi(experiment,'study')
...
%Select one conditions
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% Habitutation condition
    a=0;
    if strcmpi(experiment,'Habituation')
        a=a+1; Dir.filereference{a} = 26647;
        Dir.date{a} = '19092016'; Dir.night{a} = 1; Dir.subject{a} = 2;  % 19/09/2016 -> Subject 2
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 26654;
        Dir.date{a} = '19092016'; Dir.night{a} = 1; Dir.subject{a} = 3;  % 19/09/2016 -> Subject 3
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 28445;
        Dir.date{a} = '19092016'; Dir.night{a} = 1; Dir.subject{a} = 4;  % 19/09/2016 -> Subject 4
        Dir.channel_sw{a} = [1 7];
        
        a=a+1; Dir.filereference{a} = 28454;
        Dir.date{a} = '19092016'; Dir.night{a} = 1; Dir.subject{a} = 5;  % 19/09/2016 -> Subject 5
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 26660;
        Dir.date{a} = '20092016'; Dir.night{a} = 1; Dir.subject{a} = 7;  % 20/09/2016 -> Subject 7
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 26665;
        Dir.date{a} = '20092016'; Dir.night{a} = 1; Dir.subject{a} = 8;  % 20/09/2016 -> Subject 8
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 26668;
        Dir.date{a} = '20092016'; Dir.night{a} = 1; Dir.subject{a} = 9;  % 20/09/2016 -> Subject 9
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 27036;
        Dir.date{a} = '20092016'; Dir.night{a} = 1; Dir.subject{a} = 10; % 20/09/2016 -> Subject 10
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 26882;
        Dir.date{a} = '21092016'; Dir.night{a} = 1; Dir.subject{a} = 11; % 21/09/2016 -> Subject 11
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 26825;
        Dir.date{a} = '20092016'; Dir.night{a} = 1; Dir.subject{a} = 12; % 20/09/2016 -> Subject 12
        Dir.channel_sw{a} = [7 10]; %1eventually
        
        a=a+1; Dir.filereference{a} = 28176;
        Dir.date{a} = '21092016'; Dir.night{a} = 1; Dir.subject{a} = 13; % 21/09/2016 -> Subject 13
        Dir.channel_sw{a} = [1 7 10];
        
        a=a+1; Dir.filereference{a} = 28468;
        Dir.date{a} = '21092016'; Dir.night{a} = 1; Dir.subject{a} = 14; % 21/09/2016 -> Subject 14
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 26855;
        Dir.date{a} = '21092016'; Dir.night{a} = 1; Dir.subject{a} = 16; % 21/09/2016 -> Subject 16
        Dir.channel_sw{a} = [1 7 10];
        
        a=a+1; Dir.filereference{a} = 27911;
        Dir.date{a} = '21092016'; Dir.night{a} = 1; Dir.subject{a} = 17; % 21/09/2016 -> Subject 17
        Dir.channel_sw{a} = [1 2 7 10];
        
%         %error ?
%         a=a+1; Dir.filereference{a} = ;
%         Dir.date{a} = '22092016'; Dir.night{a} = 1; Dir.subject{a} = 19;  % 22/09/2016 -> Subject 19
%         Dir.channel_sw{a} = [1 2 7 10];
%         
%         %error ?
%         a=a+1; Dir.filereference{a} = ;
%         Dir.date{a} = '22092016'; Dir.night{a} = 1; Dir.subject{a} = 20;  % 22/09/2016 -> Subject 20
%         Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 28181;
        Dir.date{a} = '22092016'; Dir.night{a} = 1; Dir.subject{a} = 21; % 22/09/2016 -> Subject 21
        Dir.channel_sw{a} = 1;
        
        a=a+1; Dir.filereference{a} = 27932;
        Dir.date{a} = '22092016'; Dir.night{a} = 1; Dir.subject{a} = 22; % 22/09/2016 -> Subject 22
        Dir.channel_sw{a} = [1 7];
        
        %TODO
        a=a+1; Dir.filereference{a} = 29269;
        Dir.date{a} = '22092016'; Dir.night{a} = 1; Dir.subject{a} = 23; % 22/09/2016 -> Subject 23
        Dir.channel_sw{a} = [1 2 7 10];
        
        a=a+1; Dir.filereference{a} = 45863;
        Dir.date{a} = '22092016'; Dir.night{a} = 1; Dir.subject{a} = 24; % 22/09/2016 -> Subject 24
        Dir.channel_sw{a} = [1 2 7 10];
    end
