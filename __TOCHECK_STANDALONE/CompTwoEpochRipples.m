...
if vnoise==0
    ...
    FilRip=FilterLFP(Restrict(LFP{v},Epoch),[130 250],96);
    ...
    [ripples,stdev,noise] = FindRipples(filtered,'thresholds',paramRip,'noise',filteredNoise,'durations',[30 30 100]);
...
if vnoise==0
    ...
    FilRip2=FilterLFP(Restrict(LFP{v},Epoch2),[130 250],96);
    rgFil2=Range(FilRip2,'s');
    filtered2=[rgFil2-rgFil2(1) Data(FilRip2)];
    [ripples2,stdev2,noise2] = FindRipples(filtered2,'thresholds',paramRip,'durations',[30 30 100]);
    ...
    rgFil2=Range(FilRip2,'s');
    filtered2=[rgFil2-rgFil2(1) Data(FilRip2)];
    [ripples2,stdev2,noise2] = FindRipples(filtered2,'thresholds',paramRip,'noise',filteredNoise,'durations',[30 30 100]);
...
% Pre-post comparison
figure('color',[1 1 1]);PlotDistribution2({data.peakAmplitude data2.peakAmplitude},{data.peakFrequency data2.peakFrequency});
...
figure('color',[1 1 1]);PlotDistribution2({data.duration data2.duration},{data.peakFrequency data2.peakFrequency});
