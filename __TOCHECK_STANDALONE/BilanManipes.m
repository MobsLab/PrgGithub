...
if renorm
    ...
    Bl=[Res1{3}/mean(Res1{3});Res2{3}/mean(Res2{3});Res3{3}/mean(Res3{3});Res4{3}/mean(Res4{3})];
    Al=[Res1{4}/mean(Res1{3});Res2{4}/mean(Res2{3});Res3{4}/mean(Res3{3});Res4{4}/mean(Res4{3})];
    ...
    if renormAll
            ...
            Bsi=[Res1{1}(1:tr)/mean(Res1{1}(1:tr));Res2{1}(1:tr)/mean(Res2{1}(1:tr));Res3{1}(1:tr)/mean(Res3{1}(1:tr));Res4{1}(1:tr)/mean(Res4{1}(1:tr))];
            Asi=[Res1{2}(1:tr)/mean(Res1{1}(1:tr));Res2{2}(1:tr)/mean(Res2{1}(1:tr));Res3{2}(1:tr)/mean(Res3{1}(1:tr));Res4{2}(1:tr)/mean(Res4{1}(1:tr))];

            Bli=[Res1{3}(1:tr)/mean(Res1{3}(1:tr));Res2{3}(1:tr)/mean(Res2{3}(1:tr));Res3{3}(1:tr)/mean(Res3{3}(1:tr));Res4{3}(1:tr)/mean(Res4{3}(1:tr))];
            Ali=[Res1{4}(1:tr)/mean(Res1{3}(1:tr));Res2{4}(1:tr)/mean(Res2{3}(1:tr));Res3{4}(1:tr)/mean(Res3{3}(1:tr));Res4{4}(1:tr)/mean(Res4{3}(1:tr))];


            BsiM=[mean(Res1{1}(1:tr));mean(Res2{1}(1:tr));mean(Res3{1}(1:tr));mean(Res4{1}(1:tr))]/mean([mean(Res1{1}(1:tr));mean(Res2{1}(1:tr));mean(Res3{1}(1:tr));mean(Res4{1}(1:tr))]);
            AsiM=[mean(Res1{2}(1:tr));mean(Res2{2}(1:tr));mean(Res3{2}(1:tr));mean(Res4{2}(1:tr))]/mean([mean(Res1{1}(1:tr));mean(Res2{1}(1:tr));mean(Res3{1}(1:tr));mean(Res4{1}(1:tr))]);

            BliM=[mean(Res1{3}(1:tr));mean(Res2{3}(1:tr));mean(Res3{3}(1:tr));mean(Res4{3}(1:tr))]/mean([mean(Res1{3}(1:tr));mean(Res2{3}(1:tr));mean(Res3{3}(1:tr));mean(Res4{3}(1:tr))]);
            AliM=[mean(Res1{4}(1:tr));mean(Res2{4}(1:tr));mean(Res3{4}(1:tr));mean(Res4{4}(1:tr))]/mean([mean(Res1{3}(1:tr));mean(Res2{3}(1:tr));mean(Res3{3}(1:tr));mean(Res4{3}(1:tr))]);

            
            else

            Bsi=[Res1{1}/mean(Res1{1});Res2{1}/mean(Res2{1});Res3{1}/mean(Res3{1});Res4{1}/mean(Res4{1})];
            Asi=[Res1{2}(1:tr)/mean(Res1{1});Res2{2}(1:tr)/mean(Res2{1});Res3{2}(1:tr)/mean(Res3{1});Res4{2}(1:tr)/mean(Res4{1})];

            Bli=[Res1{3}/mean(Res1{3});Res2{3}/mean(Res2{3});Res3{3}/mean(Res3{3});Res4{3}/mean(Res4{3})];
            Ali=[Res1{4}(1:tr)/mean(Res1{3});Res2{4}(1:tr)/mean(Res2{3});Res3{4}(1:tr)/mean(Res3{3});Res4{4}(1:tr)/mean(Res4{3})];   
            
            
            BsiM=[mean(Res1{1});mean(Res2{1});mean(Res3{1});mean(Res4{1})]/mean([mean(Res1{1});mean(Res2{1});mean(Res3{1});mean(Res4{1})]);
            AsiM=[mean(Res1{2}(1:tr));mean(Res2{2}(1:tr));mean(Res3{2}(1:tr));mean(Res4{2}(1:tr))]/mean([mean(Res1{1});mean(Res2{1});mean(Res3{1});mean(Res4{1})]);

            BliM=[mean(Res1{3});mean(Res2{3});mean(Res3{3});mean(Res4{3})]/mean([mean(Res1{3});mean(Res2{3});mean(Res3{3});mean(Res4{3})]);
            AliM=[mean(Res1{4}(1:tr));mean(Res2{4}(1:tr));mean(Res3{4}(1:tr));mean(Res4{4}(1:tr))]/mean([mean(Res1{3});mean(Res2{3});mean(Res3{3});mean(Res4{3})]);
        ...
        if renormAll
                    ...
                    Asi=[Res1{2}(1:tr);Res2{2}(1:tr);Res3{2}(1:tr);Res4{2}(1:tr)];

                    Bli=[Res1{3};Res2{3};Res3{3};Res4{3}];
                    Ali=[Res1{4}(1:tr);Res2{4}(1:tr);Res3{4}(1:tr);Res4{4}(1:tr)]; 

                    BsiM=[mean(Res1{1});mean(Res2{1});mean(Res3{1});mean(Res4{1})];
                    AsiM=[mean(Res1{2}(1:tr));mean(Res2{2}(1:tr));mean(Res3{2}(1:tr));mean(Res4{2}(1:tr))];

                    BliM=[mean(Res1{3});mean(Res2{3});mean(Res3{3});mean(Res4{3})];
                    AliM=[mean(Res1{4}(1:tr));mean(Res2{4}(1:tr));mean(Res3{4}(1:tr));mean(Res4{4}(1:tr))];

                     else


                    Bsi=[Res1{1}(1:tr);Res2{1}(1:tr);Res3{1}(1:tr);Res4{1}(1:tr)];
                    Asi=[Res1{2}(1:tr);Res2{2}(1:tr);Res3{2}(1:tr);Res4{2}(1:tr)];

                    Bli=[Res1{3}(1:tr);Res2{3}(1:tr);Res3{3}(1:tr);Res4{3}(1:tr)];
                    Ali=[Res1{4}(1:tr);Res2{4}(1:tr);Res3{4}(1:tr);Res4{4}(1:tr)];   

                    BsiM=[mean(Res1{1}(1:tr));mean(Res2{1}(1:tr));mean(Res3{1}(1:tr));mean(Res4{1}(1:tr))];
                    AsiM=[mean(Res1{2}(1:tr));mean(Res2{2}(1:tr));mean(Res3{2}(1:tr));mean(Res4{2}(1:tr))];

                    BliM=[mean(Res1{3}(1:tr));mean(Res2{3}(1:tr));mean(Res3{3}(1:tr));mean(Res4{3}(1:tr))];
                    AliM=[mean(Res1{4}(1:tr));mean(Res2{4}(1:tr));mean(Res3{4}(1:tr));mean(Res4{4}(1:tr))];
...
for i=1:20
    try
eval(['saveFigure(',num2str(i),',''FigureBilanSleepNew',num2str(i),''',''/media/DISK_1/Dropbox/Kteam/ProjetSommeil/Figures/BilaManipesSleepMarch2012/figuresposterED3C'')'])
    end
end
