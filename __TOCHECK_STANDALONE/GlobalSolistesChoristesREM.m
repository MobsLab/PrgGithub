% GlobalSolistesChoristesREM
try
     cd /media/DataMOBsRAID/ProjetBreathDeltaFeedback/
     load DataSolistesCoristesLimit2REM

catch
    
             [C,Cz,B,h,b,CSspkS,BSspkS,CEspkS,BEspkS,CSspkC,BSspkC,CEspkC,BEspkC,MiceNameSoliste,PathSoliste,NeuronIDSoliste,NombreNeuronsS,PathSolisteBis]=solistesCoristes('BASAL',2,1);    
             [C1,Cz1,B1,h1,b1,CSspkS1,BSspkS1,CEspkS1,BEspkS1,CSspkC1,BSspkC1,CEspkC1,BEspkC1,MiceNameSoliste1,PathSoliste1,NeuronIDSoliste1,NombreNeuronsS1,PathSolisteBis1]=solistesCoristes('RdmTone',2,1);
             [C2,Cz2,B2,h2,b2,CSspkS2,BSspkS2,CEspkS2,BEspkS2,CSspkC2,BSspkC2,CEspkC2,BEspkC2,MiceNameSoliste2,PathSoliste2,NeuronIDSoliste2,NombreNeuronsS2,PathSolisteBis2]=solistesCoristes('DeltaTone',2,1);
             cd /media/DataMOBsRAID/ProjetBreathDeltaFeedback/
             save DataSolistesCoristesLimit2Part1REM
            ...
            %     REMEpoch=REMEpoch-intervalSet(Start(Down),End(Down));
                ...
                FrS(i,1)=length(Range(Restrict(S{NeuronIDSoliste(i)},REMEpoch)))/sum(End(REMEpoch,'s')-Start(REMEpoch,'s'));
                FrS(i,2)=length(Range(Restrict(S{NeuronIDSoliste(i)},REMEpoch-DownExt)))/sum(End(REMEpoch-DownExt,'s')-Start(REMEpoch-DownExt,'s'));
                ...
                FrS(i,5)=length(Range(Restrict(S{NeuronIDSoliste(i)},REMEpoch-Epoch1-Epoch2)))/sum(End(REMEpoch-Epoch1-Epoch2,'s')-Start(REMEpoch-Epoch1-Epoch2,'s'));

                Q=BinTsd(S{NeuronIDSoliste(i)},10000);    
                data1=(Range(Restrict((Q),REMEpoch),'s'));
                data2=(Data(Restrict((Q),REMEpoch)));
            %     data1=(Range(Restrict((Q),REMEpoch-intervalSet(Start(Down),End(Down)),'s'));
            %     data2=(Data(Restrict((Q),REMEpoch-intervalSet(Start(Down),End(Down)))));      
                data1(find(data2==0))=[];
                data2(find(data2==0))=[];
                [rtemp,ptemp]=corrcoef(data1,data2);
                var=polyfit(data1,data2,1);
                FrSolistes{i}=tsd(Range(Restrict((Q),REMEpoch)),Data(Restrict((Q),REMEpoch)));
                slop(i,1)=var(1);
                slop(i,2)=var(2);
                slop(i,3)=rtemp(1,2);
                slop(i,4)=ptemp(1,2);
                ...
                for k=NumNeurons2
                    ...
                    Epoch1=intervalSet(Start(Down)-0.04E4,Start(Down));Epoch1=mergeCloseIntervals(Epoch1,1);
                    Epoch2=intervalSet(End(Down),End(Down)+0.04*1E4);Epoch2=mergeCloseIntervals(Epoch2,1);
                    FrC(ki,1)=length(Range(Restrict(S{k},REMEpoch)))/sum(End(REMEpoch,'s')-Start(REMEpoch,'s'));
                    FrC(ki,2)=length(Range(Restrict(S{(k)},REMEpoch-DownExt)))/sum(End(REMEpoch-DownExt,'s')-Start(REMEpoch-DownExt,'s'));
                    ...
                    FrC(ki,5)=length(Range(Restrict(S{(k)},REMEpoch-Epoch1-Epoch2)))/sum(End(REMEpoch-Epoch1-Epoch2,'s')-Start(REMEpoch-Epoch1-Epoch2,'s'));


                    Qs=BinTsd(S{k},10000);
                    data1=(Range(Restrict((Qs),REMEpoch),'s'));
                    data2=(Data(Restrict((Qs),REMEpoch)));
                %     data1=(Range(Restrict((Qs),REMEpoch-intervalSet(Start(Down),End(Down)),'s'));
                %     data2=(Data(Restrict((Qs),REMEpoch-intervalSet(Start(Down),End(Down)))));        
                    data1(find(data2==0))=[];
                    data2(find(data2==0))=[];
                    [rtemp,ptemp]=corrcoef(data1,data2);
                    var=polyfit(data1,data2,1);
                    ...
                    FrChoristes{ki}=tsd(Range(Restrict((Qs),REMEpoch)),Data(Restrict((Qs),REMEpoch)));
                    ki=ki+1;
                end
            end
            ...
            %     REMEpoch=REMEpoch-intervalSet(Start(Down),End(Down));    
                ...
                Epoch1=intervalSet(Start(Down)-0.04E4,Start(Down));Epoch1=mergeCloseIntervals(Epoch1,1);
                Epoch2=intervalSet(End(Down),End(Down)+0.04*1E4);Epoch2=mergeCloseIntervals(Epoch2,1);
                Fr1S(i,1)=length(Range(Restrict(S{NeuronIDSoliste1(i)},REMEpoch)))/sum(End(REMEpoch,'s')-Start(REMEpoch,'s'));
                Fr1S(i,2)=length(Range(Restrict(S{NeuronIDSoliste1(i)},REMEpoch-DownExt)))/sum(End(REMEpoch-DownExt,'s')-Start(REMEpoch-DownExt,'s'));
                ...
                Fr1S(i,5)=length(Range(Restrict(S{NeuronIDSoliste1(i)},REMEpoch-Epoch1-Epoch2)))/sum(End(REMEpoch-Epoch1-Epoch2,'s')-Start(REMEpoch-Epoch1-Epoch2,'s'));
            ...
            %     data2=(Data(Restrict((Q),REMEpoch-intervalSet(Start(Down),End(Down)))));     
                ...
                [rtemp,ptemp]=corrcoef(data1,data2);
                var=polyfit(data1,data2,1);
                FrSolistes1{i}=tsd(Range(Restrict((Q),REMEpoch)),Data(Restrict((Q),REMEpoch)));
                slopS1(i,1)=var(1);
                slopS1(i,2)=var(2);
                ...
                [CtoneC1(ki,:),B]=CrossCorr(TONEtime2_SWS, Range(S{k}),10,500);
                  ...
                  Epoch1=intervalSet(Start(Down)-0.04E4,Start(Down));Epoch1=mergeCloseIntervals(Epoch1,1);
                Epoch2=intervalSet(End(Down),End(Down)+0.04*1E4);Epoch2=mergeCloseIntervals(Epoch2,1);
                FrC1(ki,1)=length(Range(Restrict(S{(k)},REMEpoch)))/sum(End(REMEpoch,'s')-Start(REMEpoch,'s'));
                FrC1(ki,2)=length(Range(Restrict(S{(k)},REMEpoch-DownExt)))/sum(End(REMEpoch-DownExt,'s')-Start(REMEpoch-DownExt,'s'));
                ...
                FrC1(ki,5)=length(Range(Restrict(S{(k)},REMEpoch-Epoch1-Epoch2)))/sum(End(REMEpoch-Epoch1-Epoch2,'s')-Start(REMEpoch-Epoch1-Epoch2,'s'));
            ...
            %     data2=(Data(Restrict((Qs),REMEpoch-intervalSet(Start(Down),End(Down)))));        
                ...
                FrChoristes1{ki}=tsd(Range(Restrict((Qs),REMEpoch)),Data(Restrict((Qs),REMEpoch)));
                ki=ki+1;
                end    
            end
            ...
            %     REMEpoch=REMEpoch-intervalSet(Start(Down),End(Down));    
                ...
                Epoch1=intervalSet(Start(Down)-0.04E4,Start(Down));Epoch1=mergeCloseIntervals(Epoch1,1);
                Epoch2=intervalSet(End(Down),End(Down)+0.04*1E4);Epoch2=mergeCloseIntervals(Epoch2,1);
                Fr2S(i,1)=length(Range(Restrict(S{NeuronIDSoliste2(i)},REMEpoch)))/sum(End(REMEpoch,'s')-Start(REMEpoch,'s'));
                Fr2S(i,2)=length(Range(Restrict(S{NeuronIDSoliste2(i)},REMEpoch-DownExt)))/sum(End(REMEpoch-DownExt,'s')-Start(REMEpoch-DownExt,'s'));
                ...
                Fr2S(i,5)=length(Range(Restrict(S{NeuronIDSoliste2(i)},REMEpoch-Epoch1-Epoch2)))/sum(End(REMEpoch-Epoch1-Epoch2,'s')-Start(REMEpoch-Epoch1-Epoch2,'s'));
            ...
            %     data2=(Data(Restrict((Q),REMEpoch-intervalSet(Start(Down),End(Down)))));      
                ...
                [rtemp,ptemp]=corrcoef(data1,data2);
                var=polyfit(data1,data2,1);
                FrSolistes2{i}=tsd(Range(Restrict((Q),REMEpoch)),Data(Restrict((Q),REMEpoch)));
                ...
                [CtoneC2(ki,:),B]=CrossCorr(TONEtime2_SWS, Range(S{k}),10,500);
                  Epoch1=intervalSet(Start(Down)-0.04E4,Start(Down));Epoch1=mergeCloseIntervals(Epoch1,1);
                Epoch2=intervalSet(End(Down),End(Down)+0.04*1E4);Epoch2=mergeCloseIntervals(Epoch2,1);
                FrC2(ki,1)=length(Range(Restrict(S{(k)},REMEpoch)))/sum(End(REMEpoch,'s')-Start(REMEpoch,'s'));
                FrC2(ki,2)=length(Range(Restrict(S{(k)},REMEpoch-DownExt)))/sum(End(REMEpoch-DownExt,'s')-Start(REMEpoch-DownExt,'s'));
                ...
                FrC2(ki,5)=length(Range(Restrict(S{(k)},REMEpoch-Epoch1-Epoch2)))/sum(End(REMEpoch-Epoch1-Epoch2,'s')-Start(REMEpoch-Epoch1-Epoch2,'s'));
            ...
            %     data2=(Data(Restrict((Qs),REMEpoch-intervalSet(Start(Down),End(Down)))));    
                ...
                [rtemp,ptemp]=corrcoef(data1,data2);
                var=polyfit(data1,data2,1);
                FrChoristes2{ki}=tsd(Range(Restrict((Qs),REMEpoch)),Data(Restrict((Qs),REMEpoch)));
                sloptC2(ki,1)=var(1);
                sloptC2(ki,2)=var(2);
    ...
    cd /media/DataMOBsRAID/ProjetBreathDeltaFeedback/
    save DataSolistesCoristesLimit2REM
