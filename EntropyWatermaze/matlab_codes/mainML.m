...
%%-------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        hold on, plot(p_xy2(M2(:,3)==zon3,1),p_xy2(M2(:,3)==zon3,2),'c','linewidth',1)
