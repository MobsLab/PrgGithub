...
% Event file(s) : channel 00
DATA.events00.time = [];
DATA.events00.description = {};

eventFiles00 = dir([path sepMark '*.e00.evt']);
...
% Event file(s) : channel 01
DATA.events01.time = [];
DATA.events01.description = {};
eventFiles01 = dir([path sepMark '*.e01.evt']);
...
% Event file(s) : channel 02
DATA.events02.time = [];
DATA.events02.description = {};
eventFiles02 = dir([path sepMark '*.e02.evt']);
...
eventFiles03 = dir([path sepMark '*.e03.evt']);
...
% Event file(s) : channel 04
DATA.events04.time = [];
DATA.events04.description = {};
eventFiles04 = dir([path sepMark '*.e04.evt']);
...
eventFiles05 = dir([path sepMark '*.e05.evt']);
...
try
    clear Event00 Event01 Event02 Event03 Event04 Event05
end
try
