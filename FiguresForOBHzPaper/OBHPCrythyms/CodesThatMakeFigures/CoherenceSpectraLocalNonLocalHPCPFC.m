...
saveas(fig,[SaveFolder,'SpectraHPCLN.fig']); close all;
...
saveas(fig,[SaveFolder,'CohHPCPFCLN.fig']); close all;
...
saveas(fig,[SaveFolder,'CohHPCOBLN.fig']); close all;
...
saveas(fig,[SaveFolder,'SpectraOBLN.fig']); close all;
...
saveas(fig,[SaveFolder,'CohOBPFCLN.fig']); close all;
...
saveas(fig,[SaveFolder,'CohOBHPCLN.fig']); close all;
