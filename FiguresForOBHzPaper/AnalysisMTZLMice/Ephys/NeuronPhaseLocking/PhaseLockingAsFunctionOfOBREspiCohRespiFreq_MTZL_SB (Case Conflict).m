...
for d = 1:length(Dir.path)
    for dd = 1:length(Dir.path{d})
        ...
        if (exist('NeuronModulation/NeuronMod_Respi_ZeroCross_total_nonoise'))>0 & isempty(numNeurons)==0
            ...
            Results_AllMice{num}.mu_Coh = mu_Coh; clear mu_All
            
            Results_AllMice{num}.pval_Coh = pval_Coh; clear pval_All
            
            Results_AllMice{num}.Kappa_Coh = Kappa_Coh; clear Kappa_All
            num = num+1;
        end
    end
end
