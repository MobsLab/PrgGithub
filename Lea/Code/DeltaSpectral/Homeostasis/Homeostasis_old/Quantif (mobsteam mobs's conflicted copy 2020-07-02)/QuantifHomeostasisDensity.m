%% QUANTIFY HOMEOSTASIS on EVENT DENSITY (Local Maxima) during sleep
%
% 21/04/2020 LP
%
%
...
% for event density (delta waves, slow waves, down states)
% -> global fit and multiple fits in separate sleep episodes   
%
%
% SEE : ParcourQuantifHomeostasisDensity
