%% ParcourQuantif2FitHomeostasisDensity_ObPhasePlot
%
% 30/05/2020 LP
%
% Mean Plots for homeostasis on event density. 
...
%% CHOOSE SLOW WAVE PHASE PREFERENCE ('all', 'inphase', 'outphase') : 

phasepref = 'outphase' ; % can be 'all', 'inphase' (with OB), 'outphase' (out of OB phase) 
eval(['Homeo_res = Homeo_res_' phasepref ';'])
...
text(0.5,0.05,[phasepref ' slow waves'],'FontSize',18,'HorizontalALignment','center'), axis off

% Save plot :  
print(['2FitHomeostasisDensity_' phasepref '_MeanPlot_Supp1'], '-dpng', '-r300') ; 
print(['epsFigures/2FitHomeostasisDensity_' phasepref '_MeanPlot_Supp1'], '-depsc') ; 
...
% Save plot :  
print(['2FitHomeostasisDensity_' phasepref '_2FitMeanPlot_Supp1'], '-dpng', '-r300') ; 
print(['epsFigures/2FitHomeostasisDensity_' phasepref '_2FitMeanPlot_Supp1'], '-depsc') ; 
