function butif_toolbox(signal, samplingrate, varargin)%  name, reference, freqmin, freqmax, freqstep, downsample, offset_val, limit, maxi)
...
if (nargin < 4) | (isempty(varargin{2}))
    ...
    sig{1} = [varargin{2}(:),signal(:)];
    durationr = length(varargin{2})/samplingrate;
end
