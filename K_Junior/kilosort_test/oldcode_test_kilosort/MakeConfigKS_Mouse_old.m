...
function ops = MakeConfigKS_Mouse(filename, folder, tetrode, varargin)
...
ops.chanMap             = fullfile(folder, 'chanMaps', ['chanMap' num2str(tetrode) '.mat']); % make this file using createChannelMapFile.m		
...
dd                  = load('/home/mobsjunior/Dropbox/Kteam/PrgMatlab/KiloSort/configFiles/PCspikes2.mat'); % you might want to recompute this from your own data
