    ...
    function giv_inputs(obj,event)
        ...
        function savProtoc
            ...
            for mm = 1:4
                ...
                [x1,y1,BW,x2,y2]=roipoly(mat2gray(TrObjLocal.ref));
                maskint=uint8(BW);
...
%% track mouse
    function PerformTracking(obj,event)
        ...
        htrack2{mm} = imagesc(zeros(size((TrObjLocal.ref))));axis image; caxis([0 1]);hold on
        ...
        MouseTempTemp{mm}=[];
        OldIm{mm}=TrObjLocal.mask;
        OldZone{mm}=TrObjLocal.mask;
        end
        GotFrame = [];TempZone=[];
        ...
        while enableTrack
            ...
            if StartChrono
                ...
                if sum(isnan(Pos))==0
                    ...
                    switch TrObjLocal.camera_type
                        case 'IRCamera'
                            ...
                            MouseTempTemp{MouseNum}(num_fr,2)=max(max(TrObjLocal.mask.*MouseMask{MouseNum}));
                        case 'Webcam'
                ...
                % This was moved by SB on 02042019, used to de line 403,
                % GetFrame was therefore one frame too long
                num_fr=num_fr+1;
