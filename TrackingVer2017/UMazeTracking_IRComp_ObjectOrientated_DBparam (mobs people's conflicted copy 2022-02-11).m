...
%% Task parameters
global nametypes; nametypes={'Hab','TestPre', 'TestPreFakeStim', 'Cond','CondWallShock','CondWallSafe','TestPost','Ext','BlockedWall',...
    'EPM','SoundHab','SoundCnd','SoundTest',...
    'Calibration','CalibrationEyeshock','SleepSession','SleepStim' 'ManualStimulation','BlockedWallShock', 'ExploratoryStimulation'};
