        ...
        function TrObj=TrackingObject(textfig,camnum)
            ...
            switch TrObj.camera_type
                case 'Webcam'
                    ...
                    try,TrObj.vid = videoinput('winvideo',camnum,'RGB24_320x240');text(0,0.8,'Setting up webcam ...using RGB');
                    catch,TrObj.vid = videoinput('winvideo',camnum,'MJPG_320x240');text(0,0.8,'Setting up webcam ...using MJPG');end
