...
try
    load(['Spectro_ChR2DataSpectroFreezingChR2_' Treatment ]);MatInfo;
    disp(['Loading existing data from DataSpectroFreezingChR2_' Treatment '.mat']);
    [B,IX] = sort(Dir.group);
...
%                 end
    ...
    disp(['Saving data in local path, DataSpectroFreezingChR2_' Treatment ]);
    save (['DataSpectroFreezingChR2_' Treatment ], 'MatInfoON','MatSpFON','MatSpNoFON', 'MatInfoOFF','MatSpFOFF','MatSpNoFOFF','params','structlist','nameMice','nameGroups','Dir','f','th_immob','thtps_immob','Rogne','thtps_immob_for_rogne')
