...
manipname='LaserChR2-fear-July17';
...
% Dir = RestrictPathForExperiment(Dir,'nMice',[ 540 542 543]);
Dir = RestrictPathForExperiment(Dir,'nMice',[537]);
