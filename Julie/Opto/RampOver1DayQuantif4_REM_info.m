% RampOver1DayQuantif4_REM_Info.m
% 29.08.2017

% appelée par RampOver1DayQuantif4_REM.m
% 28.08.2017
...
try
    ...
    disp(['Loading existing data from DataRampOver1DayQuantif_no_selection_REM_info.mat']);
catch
...
%     load(['DataRampOver1DayQuantif_no_selec_HPC_PiCx.mat'], 'StimInfoAllMan');
    ...
    if sav
         save DataRampOver1DayQuantif_no_selection_REM_Info LFPpower_Info  f1  structlistname fq_list Dir LaserInt  nb_fq fq_list
    end
end
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% for the following steps, see RampOver1DayQuantif4_REM_Info
