%PSTH_behav_FreezAcctsd2_juil_oct_2.m
% 06.01.2016
...
manipname='LaserChR2-fear-Jul-Oct';


cd /media/DataMOBsRAIDN/ProjetAversion/DATA-Fear/
res=pwd;
Dir=PathForExperimentFEAR('Fear-electrophy-opto');
Dir = RestrictPathForExperiment(Dir,'nMice',[363 367 458 459 465 466 467 468]);
...
FolderPath='/media/DataMOBsRAIDN/ProjetAversion/DATA-Fear/367-363-458-459/';
