...
if strcmp(CSoption, '4firstCS not averaged')
    Ylegend={'CS-';'CS- laser';'CS-';'CS- laser';'CS+';'CS+ laser';'CS+';'CS+ laser'};
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    CS- no laser
% CS- no laser
SP{a}=subplot(n,p,a);imagesc(t0/1E3,[1:size(C2,2)],C0'),ylabel(Ylegend{b}); b=b+1; title(StepName{1}), 
...
% CS- with laser
SP{a}=subplot(n,p,a);imagesc(t1/1E3,[1:size(C2,2)],C1'),ylabel(Ylegend{b}); b=b+1;
hold on, line([0 0],[0.5 15.5],'color',[0.7 0.7 0.7]),line([30 30],[0.5 15.5],'color',[0.7 0.7 0.7])
set(gca, 'YTick',[1:length(MouseListC)],'YTickLabel', MouseListC)
a=a+1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    CS+  1 to 4
% CS+ no laser
SP{a}=subplot(n,p,a);imagesc(t2/1E3,[1:size(C2,2)],C2'),ylabel(Ylegend{b}); b=b+1;
...
% CS+ with laser
SP{a}=subplot(n,p,a);imagesc(t3/1E3,[1:size(C2,2)],C3'),ylabel(Ylegend{b}); b=b+1;
hold on, line([0 0],[0.5 15.5],'color',[0.7 0.7 0.7]),line([30 30],[0.5 15.5],'color',[0.7 0.7 0.7])
set(gca, 'YTick',[1:length(MouseListC)],'YTickLabel', MouseListC)
a=a+1;
...
% CS+ no laser
SP{a}=subplot(n,p,a);imagesc(t4/1E3,[1:size(C4,2)],C4'),ylabel(Ylegend{b}); b=b+1;
...
% CS+ with laser
SP{a}=subplot(n,p,a);imagesc(t5/1E3,[1:size(C2,2)],C5'),ylabel(Ylegend{b}); b=b+1; 
hold on, line([0 0],[0.5 15.5],'color',[0.7 0.7 0.7]),line([30 30],[0.5 15.5],'color',[0.7 0.7 0.7])
set(gca, 'YTick',[1:length(MouseListC)],'YTickLabel', MouseListC)
a=a+1;
...
% CS+ no laser
SP{a}=subplot(n,p,a);imagesc(t6/1E3,[1:size(C6,2)],C6'),ylabel(Ylegend{b}); b=b+1;
...
% CS+ with laser
SP{a}=subplot(n,p,a);imagesc(t7/1E3,[1:size(C7,2)],C7'),ylabel(Ylegend{b}); b=b+1; 
hold on, line([0 0],[0.5 15.5],'color',[0.7 0.7 0.7]),line([30 30],[0.5 15.5],'color',[0.7 0.7 0.7])
set(gca, 'YTick',[1:length(MouseListC)],'YTickLabel', MouseListC)
a=a+1;
