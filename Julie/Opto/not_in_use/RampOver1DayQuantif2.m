% RampOver1DayQuantif2.m
% 14.02.2017

% Dir.path={'/media/DataMOBS59/OptoSleepStim/Mouse459/20161124';
% '/media/DataMOBS59/OptoSleepStim/Mouse459/20161125';
% '/media/DataMOBS59/OptoSleepStim/Mouse458/20161119';
% '/media/DataMOBS59/OptoSleepStim/Mouse458/20161120';};

% Dir.path={
% '/media/DataMOBS59/OptoSleepStim/Mouse459/20161123';
% '/media/DataMOBS59/OptoSleepStim/Mouse458/20161117';
% '/media/DataMOBS59/OptoSleepStim/Mouse458/20161116';};
% Dir.name={'Mouse459';'Mouse458';'Mouse458';};

Dir.path={'/media/DataMOBS60/OptoSleepStim/Mouse465/20170126/Mouse465-OptoSleepstimramp_170126_082254';
'/media/DataMOBS60/OptoSleepStim/Mouse465/20170127/Mouse465-OptoSleepstimramp_170127_084632';};
Dir.name={'Mouse465';'Mouse465';};
...
% man=1;
% Dir.path{man}='/media/DataMOBS59/OptoSleepStim/Mouse458/20161117';
%cd (Dir.path{man})
load StimInfo
...
% %                 else
%                     LFPpower(1,i,man,evnt,1:length(f2))= mean(Data(Restrict(StsdH,subset(LaserInt36,evnt))));
% %                 end
%                 plot(f2,squeeze(LFPpower(1,i,man,evnt,:)),'r')
%             end
%             xlim([0 f2(end)]);
%             ylabel(structlistname{i});
%             
...
% %                 else
%                     LFPpower(1,i,man,evnt,1:length(f2))= mean(Data(Restrict(StsdH,subset(LaserInt62,evnt))));
% %                 end
%                 plot(f2,squeeze(LFPpower(1,i,man,evnt,:)),'r')
%             end
%             xlim([0 f2(end)]);
