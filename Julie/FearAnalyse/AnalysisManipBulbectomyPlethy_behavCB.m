function AnalysisManipBulbectomyPlethy_behavCB(datalocation,manipname,freezeTh,varargin)

% Clara Nov 15

% 2015.11.27 
% similar to AnalysisManipBulbectomyCB. Modif to deal with plethysmo manip.
% similar to AnalysisManipBulbectomy. Modif to deal with ManipNov15Bulbectomie

% analysis of the behavior only. For respi+behavior analysis see AnalysisPlethysmo.m
...
elseif strcmp(manipname,'ManipNov15Bulbectomie')
    StepName{3}='EXT envC';
    StepName{4}='EXT envB';
elseif strcmp(manipname,'ManipDec15BulbectomiePlethysmo') %elseif strcmp(manipname,'ManipDec15Bulbectomie')|
    StepName{3}='EXT pleth';
end
...
elseif strcmp(manipname,'ManipNov15Bulbectomie')
    shammice=[280:290]';
    bulbmice=[269:279]';
elseif strcmp(manipname,'ManipDec15Bulbectomie')
    shammice=[280:284]';
    bulbmice=[270:274]';
                ...
                if strcmp(manipname,'ManipNov15Bulbectomie')|(strcmp(manipname,'ManipDec15BulbectomiePlethysmo')& step~=1)
                   ...
                   if sum(strcmp(num2str(m),CSplu_bip_Gp))==1
                    ...
                    if strcmp(manipname,'ManipNov15Bulbectomie')
                        if step==1 % HAB env A=> 4 CS + and CS-
