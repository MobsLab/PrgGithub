function AnalysisManipBulbectomyCB_notexchanged(datalocation,manipname,freezeTh,varargin)

% 2015.02.25
% similar to AnalysisManipBulbectomyCB. Modif to exclude mice which may have been exchanged.
    ...
    for mousenb=1:length(group)
        ...
        for step=1:length(StepName)
            ...
            %try
                ...
                if strcmp(manipname,'ManipNov15Bulbectomie')|(strcmp(manipname,'ManipDec15BulbectomiePlethysmo')& step~=1)|strcmp(manipname,'ManipNov15Bulbectomie_notexch')
