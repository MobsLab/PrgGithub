function AnalysisManipBulbectomySoundBySoundMediansCB(datalocation,manipname,freezeTh,varargin)
...
StimCols(2,:)=[1 0.5 0]; % CS+ in orangeEndTime
    ...
    for mousenb=1:length(group)
        ...
        for step=1:4
            %try
                ...
                else %  'ManipDec14Bulbectomie' or 'ManipFeb15Bulbectomie'
...
%             end % of try catch
        ...
        cd([FolderPath manipname '/FreezingFullPeriod_median'])
    ...
    if gpfg
        ...
        plot(prctile(bilan_indiv{3},50), 'LineWidth',2), hold on;
        ...
        plot(prctile(bilan_indiv{4},75),'LineWidth',2), hold on;
    ...
    if gpfg
        ...
        plot(prctile(bilan_indiv{4},50),'LineWidth',2), hold on;
        plot(prctile(bilan_indiv{4},25)), hold on;
        legend('3rd quartile','median','1st quartile')
