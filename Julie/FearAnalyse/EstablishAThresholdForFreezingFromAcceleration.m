...
% conclusion : SMO=3 ; th_immob_Acc=0.3E8 ;  mergeCloseIntervals 0.5 sec ; dropShortIntervals 2sec  
% - smo 1 : surestime le freezing en negligeant des petites movements
% - smo 2 : intermedaires
% - smo 3 : Smoothing RETENU / recupère corretement les frezing (896 sec
% pour 873 en movt); pour les spectres, enlever la 1ere et la derniere sec
% des intervalles
% - smo 5 : ne récupère pas toutes les périodes de freezing détectées par
% le movement
% - smo 10 : intermediaire. ne pas prendre
% - smo 20 : utile pour regarder le freezing en excluant les periodes où
% elle sursaute avec les sons
