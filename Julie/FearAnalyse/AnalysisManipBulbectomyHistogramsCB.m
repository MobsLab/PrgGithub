function AnalysisManipBulbectomyHistograms(datalocation,manipname,freezeTh,varargin)

% 2015.12.09
% similar to AnalysisManipBulbectomyCB2. Modif to get histograms of freezing intervals
