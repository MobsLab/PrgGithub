...
%% Load data
load StateEpochSBAllOB SWSEpoch Wake
...
%temp=load('StateEpochSBAllOB.mat','REMEpoch');REM=temp.REMEpoch;
...
load('StateEpochSB','smooth_ghi','smooth_Theta')
load ('StateEpochSBAllOB')
try
