            ...
            for k=5:7
                if eval(['~isempty(Start(d_ON_per' num2str(k) '))'])
                    ...
                    if strcmp(freqband,'high')
                        ...
                        eval(['plot(f,10*log10(mean(Data(Restrict(Stsd,And(SWSEpoch,d_ON_per' num2str(k) '-d_ON_segt))))),''--'', ''Color'',''k'',''linewidth'',2)'])
                    elseif strcmp(freqband,'low')
                        eval(['plot(f,mean(Data(Restrict(Stsd,And(SWSEpoch,And(d_ON_segt,d_ON_per' num2str(k) '))))),''--'', ''Color'',colorplot(k,:),''linewidth'',2)'])
                        eval(['plot(f,mean(Data(Restrict(Stsd,And(SWSEpoch,d_ON_per' num2str(k) '-d_ON_segt)))),''--'', ''Color'',''k'',''linewidth'',2)'])
                    end
                    eval(['leg=tot_length(And(SWSEpoch,And(d_ON_segt,d_ON_per' num2str(k) ')))*1E-4;'])
            ...
            for k=5:7
                if eval(['~isempty(Start(d_ON_per' num2str(k) '))'])
                    ...
                    if strcmp(freqband,'high')
                        ...
                        eval(['plot(f,10*log10(mean(Data(Restrict(Stsd,And(REMEpoch,d_ON_per' num2str(k) '-d_ON_segt))))),''--'', ''Color'',''k'',''linewidth'',2)'])
                    elseif strcmp(freqband,'low')
                        eval(['plot(f,mean(Data(Restrict(Stsd,And(REMEpoch,And(d_ON_segt,d_ON_per' num2str(k) '))))),''--'', ''Color'',colorplot(k,:),''linewidth'',2)'])
                        eval(['plot(f,mean(Data(Restrict(Stsd,And(REMEpoch,d_ON_per' num2str(k) '-d_ON_segt)))),''--'', ''Color'',''k'',''linewidth'',2)'])
                    end
                    eval(['leg=tot_length(And(REMEpoch,And(d_ON_segt,d_ON_per' num2str(k) ')))*1E-4;'])
            ...
            for k=5:7
                if eval(['~isempty(Start(d_ON_per' num2str(k) '))'])
                    ...
                    if strcmp(freqband,'high')
                        ...
                        eval(['plot(f,10*log10(mean(Data(Restrict(Stsd,And(WakeEpoch,d_ON_per' num2str(k) '-d_ON_segt))))),''--'', ''Color'',''k'',''linewidth'',2)'])
                    elseif strcmp(freqband,'low')
                        eval(['plot(f,mean(Data(Restrict(Stsd,And(WakeEpoch,And(d_ON_segt,d_ON_per' num2str(k) '))))),''--'', ''Color'',colorplot(k,:),''linewidth'',2)'])
                        eval(['plot(f,mean(Data(Restrict(Stsd,And(WakeEpoch,d_ON_per' num2str(k) '-d_ON_segt)))),''--'', ''Color'',''k'',''linewidth'',2)'])
                    end
