...
%     % **************************************************
    ...
    dataDir      = ['/media/DISK_1/Dropbox/Kteam/PrgMatlab/MuTE_onlineVersion/' nameDataDir]; % Adjust according to your path -> just as example: dataDir = ['/home/alessandro/Scrivania/MuTE/' nameMainDir];
