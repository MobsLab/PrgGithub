function output1=MainBinueSelfEntropy(numchannels,dataDir,quantLevels,tempOrder)
...
%%  Defining the experiment parameters
    ...
    tic
    [output1,params1]               = parametersAndMethodsBinueSelfEntropy(listRealization,samplingRate,pointsToDiscard,channels,autoPairwiseTarDriv,...
                                      handPairwiseTarDriv,resultDir,dataDir,copyDir,numProcessors,...
                                      'binueSelf',idTargets,idDrivers,idOtherLagZero,modelOrder,multi_bivAnalysis,numQuantLevels,entropyFun,...
                                      preProcessingFun,firstTermCaseVect,secondTermCaseVect,numSurrogates,alphaPercentile,tauMin,...
                                      genCondTermFun,usePresent);
    close all
    toc
