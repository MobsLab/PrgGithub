function PFC_InteroceptiveTuningCurves_ByState_V3(Parameter, Period,BinNumber,TempBinsize,SaveFolder)
...
% get all the data
[VarOfInterest,spike_dat,Opts] = PFC_DataSpikesAndParameter_ByState(Parameter, Period,Opts);
