function [OutPutParam,OutPutSpikes,Opts]= HPC_DataSpikesAndParameter_ByState(Parameter, Period,Opts)
...
for mm = 1:length(MiceNumber)
    ...
    switch Parameter
        ...
        case 'speed'
            ...
            speed = MovAcctsd; clear MovAcctsd
...
%             Opts.ParamBinLims = [prctile(VarOfInterest,1):BinSize:prctile(VarOfInterest,99)];
        ...
        case 'position'
            ...
            LinearDist  = ReSampleDataInTime_ForPFCInterTuning(LinearDist,SubSample,TimeBins,Opts.TempBinsize);
            VarOfInterest = Data(Restrict(LinearDist,TotalEpoch));
    end
