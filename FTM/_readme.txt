...
If you find this toolbox useful and/or use it to produce a report or publication, PLEASE send me a note. That will help justify further development of the Toolbox. I'd also appreciate bug reports and suggestions for improvements. While I've made every attempt to write code that provides accurate and precise results, the functions in this toolbox are provided as is, with no guarantees.

Suggested citation:
Jones, D. L. 2014. The Fathom Toolbox for Matlab: multivariate ecological and oceanographic data analysis. College of Marine Science, University of South Florida, Tampa, Florida, USA. Available from: http://www.marine.usf.edu/user/djones/
