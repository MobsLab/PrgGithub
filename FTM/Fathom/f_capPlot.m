function [hdl,yCor,centroids] = f_capPlot(result,gLabels,sLabels,Y,yLabels,offset,fmt,wascores,ctr)
% - plot results from a CAP analysis
%
% USAGE: [hdl,yCor,centroids] = f_capPlot(result,gLabels,sLabels,Y,yLabels,offset,fmt,wascores,ctr);
%
