%%QuantifFakeDetectionDeltaDurationDownGp5Plot
% 28.09.2019 KJ
%
%   
%   
...
%   QuantifFakeDetectionDeltaDurationDownGp5
%   


% load
clear
load(fullfile(FolderDeltaDataKJ,'QuantifFakeDetectionDeltaDurationDownGp5.mat'))
...
[~,h(1)]=PlotErrorLineN_KJ(average_res.precision, 'x_data',x_plot,'newfig',0,'linecolor',color_clu6,'ShowSigstar','none','errorbars',1,'linespec','-.');
...
legend(h, 'Group 5', '2-layers');

%recall
subplot(1,3,2), hold on
[~,h(1)]=PlotErrorLineN_KJ(average_res.recall, 'x_data',x_plot,'newfig',0,'linecolor',color_clu6,'ShowSigstar','none','errorbars',1,'linespec','-.');
...
[~,h(1)]=PlotErrorLineN_KJ(average_res.fscore, 'x_data',x_plot,'newfig',0,'linecolor',color_clu6,'ShowSigstar','none','errorbars',1,'linespec','-.');
