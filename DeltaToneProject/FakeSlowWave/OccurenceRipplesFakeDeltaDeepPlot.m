...
% for m=1:length(animals)
%     plot(Cc.down1.X, cc_meanmouse.down1.y{m}, 'color', col_curve, 'linewidth',1);
% end
% plot(Cc.down1.X, Cc.down1.meanY, 'color',col_mean, 'linewidth',2),
% line([0 0], ylim,'Linewidth',1,'color',[0.5 0.5 0.5]), hold on
% xlabel('time from ripples (ms)'),
% ylabel('Occurence of down states'), 
% title('Down states'),
...
%     
%     %delta with down
%     subplot(2,4,1+c), hold on
%     for m=1:length(animals)
%         try
%             plot(Cclu.delta1.X{c}, cc_clumouse.delta1.y{m,c}, 'color', col_curve, 'linewidth',1);
%         end
%     end
%     plot(Cclu.delta1.X{c}, Cclu.delta1.meanY{c}, 'color',col_mean, 'linewidth',2),
%     line([0 0], ylim,'Linewidth',1,'color',[0.5 0.5 0.5]), hold on
%     xlabel('time from ripples (ms)'),
%     ylabel('Occurence of delta waves'), 
%     title(['Delta w down (cl ' num2str(clusters(c)) ')']),
%     
%     %fake delta
%     subplot(2,4,5+c), hold on
%     for m=1:length(animals)
%         try
%             plot(Cclu.other1.X{c}, cc_clumouse.other1.y{m,c}, 'color', col_curve, 'linewidth',1);
%         end
%     end
%     plot(Cclu.other1.X{c}, Cclu.other1.meanY{c}, 'color',col_mean, 'linewidth',2),
%     line([0 0], ylim,'Linewidth',1,'color',[0.5 0.5 0.5]), hold on
%     xlabel('time from ripples (ms)'),
%     ylabel('Occurence of delta waves'), 
%     title(['Fake delta (cl ' num2str(clusters(c)) ')']),
%     
% end
