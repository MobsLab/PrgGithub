...
for d=1:length(duration_range)
    ...
    [p6(d),h6(d)]= ranksum(multi_res.fscore(:,d),average_res.fscore{6}(:,d));
    [p1(d),h1(d)]= ranksum(multi_res.fscore(:,d),average_res.fscore{1}(:,d));
...
[~,h(1)] = PlotErrorLineN_KJ(average_res.precision{1}, 'x_data',x_plot,'newfig',0,'linecolor',colori{1},'ShowSigstar','none','errorbars',1,'linespec','-.');
[~,h(2)] = PlotErrorLineN_KJ(average_res.precision{6}, 'x_data',x_plot,'newfig',0,'linecolor',colori{6},'ShowSigstar','none','errorbars',1,'linespec','-.');
[~,h(3)]=PlotErrorLineN_KJ(multi_res.precision, 'x_data',x_plot,'newfig',0,'linecolor',color_diff,'ShowSigstar','none','errorbars',1,'linespec','-.');
set(gca,'xlim',[0 320], 'ylim',[0 100], 'xtick',0:50:300, 'fontsize', fontsize);
xlabel('Minimum down duration'), ylabel('% false positive')

%recall
subplot(1,3,2), hold on
[~,h(1)] = PlotErrorLineN_KJ(average_res.recall{1}, 'x_data',x_plot,'newfig',0,'linecolor',colori{1},'ShowSigstar','none','errorbars',1,'linespec','-.');
[~,h(2)] = PlotErrorLineN_KJ(average_res.recall{6}, 'x_data',x_plot,'newfig',0,'linecolor',colori{6},'ShowSigstar','none','errorbars',1,'linespec','-.');
[~,h(3)]=PlotErrorLineN_KJ(multi_res.recall, 'x_data',x_plot,'newfig',0,'linecolor',color_diff,'ShowSigstar','none','errorbars',1,'linespec','-.');
set(gca,'xlim',[0 320], 'ylim',[0 100], 'xtick',0:50:300, 'fontsize', fontsize);
xlabel('Minimum down duration'), ylabel('% missed down')

%fscore
subplot(1,3,3), hold on
[~,h(1)] = PlotErrorLineN_KJ(average_res.fscore{1}, 'x_data',x_plot,'newfig',0,'linecolor',colori{1},'ShowSigstar','none','errorbars',1,'linespec','-.');
[~,h(2)] = PlotErrorLineN_KJ(average_res.fscore{6}, 'x_data',x_plot,'newfig',0,'linecolor',colori{6},'ShowSigstar','none','errorbars',1,'linespec','-.');
[~,h(3)]=PlotErrorLineN_KJ(multi_res.fscore, 'x_data',x_plot,'newfig',0,'linecolor',color_diff,'ShowSigstar','none','errorbars',1,'linespec','-.');
set(gca,'xlim',[0 320], 'ylim',[0 100], 'xtick',0:50:300, 'fontsize', fontsize);
...
for d=1:length(duration_range)
    ...
    %with group 5
    if p6(d)<0.05
        text(x_plot(d), 80, '*', 'color',colori{6}, 'HorizontalAlignment','center','fontsize',20,'fontweight','bold')
    end
    
    
    %with Ecog
    if p1(d)<0.05
        text(x_plot(d), 72, '*', 'color',colori{1}, 'HorizontalAlignment','center','fontsize',20,'fontweight','bold')
    end
