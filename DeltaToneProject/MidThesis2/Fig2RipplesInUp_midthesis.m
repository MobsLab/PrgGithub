...
%
%   see 
%       Fig1TonesInUp_midthesis Fig2RipplesInDown_midthesis
%
%
...
title('Random time inside Up states')
...
ylim([0 0.035]), yticks(0:0.01:0.03),
...
% lgd = legend(h, 'ripples', 'random'); lgd.Location='northwest';
title('Occurence of ripples/random in Up state (normalized)'),
