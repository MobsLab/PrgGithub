...
% 21.02.2017 KJ
%
% Like AnalysesERPDownDeltaToneMousePlot, but just for Mouse244-490ms
%
...
for cond=1:length(conditions)
    for m=1:length(animals)
        ...
        %% PLOT - figure1 : Raster + Average LFP (many PFC depth)
        ...
        h_leg = legend('PFCx 1 deep', 'PFCx 2 deep', 'PFCx 3 deep', 'PFCx 4', 'PFCx 5 sup'); set(h_leg,'FontSize',15);
        ...
        %% PLOT - figure2 : Average LFP (many PFC depth)

        figure, hold on
        subplot(13,1,11:13); hold on
