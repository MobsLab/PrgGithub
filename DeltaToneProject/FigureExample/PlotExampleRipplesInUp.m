...
starttime = 128518256 - 0.5e4; endtime = starttime + 3e4;
...
Signal{end} = tsd(Range(Signal{end}), Data(Signal{end})/3);
%S
...
%params plot
gap = [0,0];
offset = [2800 1400 100 -1000 -4000];
