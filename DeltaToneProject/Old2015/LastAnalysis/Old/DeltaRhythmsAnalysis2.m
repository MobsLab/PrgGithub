...
if Plo==1
    ...
    l{1}='Basal';l{2}='delay: 140ms';l{3}='delay: 200ms';l{4}='delay: 300ms';
    ...
    figure('color',[1 1 1])
    hold on, subplot(2,1,1)
    hold on, h=bar([QtDelta_M243_basal',QtDelta_M243_Tone{1},QtDelta_M243_Tone{2},QtDelta_M243_Tone{3}]);
    hold on, legend(h,l)
    hold on, title(' Delta/sec - (Mouse 243)')
    set(gca,'xtick',[1:5],'xticklabel',gg)
    hold on, subplot(2,1,2)
    hold on, h=bar([QtDelta_M244_basal',QtDelta_M244_Tone{1},QtDelta_M244_Tone{2},QtDelta_M244_Tone{3}]);
    hold on, legend(h,l)
    ...
    figure('color',[1 1 1])
    hold on, subplot(2,1,1)
    hold on, h=bar([QtBurst_M243_basal',QtBurst_M243_Tone{1}',QtBurst_M243_Tone{2}',QtBurst_M243_Tone{3}']);
    hold on, legend(h,l)
    hold on, title(' Burst/sec - (Mouse 243)')
    set(gca,'xtick',[1:5],'xticklabel',gg)
    hold on, subplot(2,1,2)
    hold on, h=bar([QtBurst_M244_basal',QtBurst_M244_Tone{1}',QtBurst_M244_Tone{2}',QtBurst_M244_Tone{3}']);
    hold on, legend(h,l)
