...
if length(number)>1
    ...
    figure, [fh, rasterAx, histAx, matVal_MUA_TONEtime1] = ImagePETH(QMua, ts(TONEtime1_REM), -10000, +15000,'BinSize',500);
    hold on, title('PFCx MUA - time1')
    figure, [fh, rasterAx, histAx, matVal_MUA_TONEtime2] = ImagePETH(QMua, ts(TONEtime2_REM), -10000, +15000,'BinSize',500);
    hold on, title('PFCx MUA - time2')
    figure, [fh, rasterAx, histAx, matVal_MUA_DeltaDetect] = ImagePETH(QMua, ts(DeltaDetect_REM), -10000, +15000,'BinSize',500);
    hold on, title('PFCx MUA - DeltaDetect')
    
    save Spk_PFCx_Delta_REM matVal_MUA_TONEtime1 matVal_MUA_TONEtime2 matVal_MUA_DeltaDetect
end
%<><>
...
if length(number)>1
    ...
    figure, [fh, rasterAx, histAx, matVal_Spk_TONEtime1] = ImagePETH(Qspk, ts(TONEtime1_REM), -10000, +15000,'BinSize',500);
    hold on, title('PFCx spikes - time1')
    figure, [fh, rasterAx, histAx, matVal_Spk_TONEtime2] = ImagePETH(Qspk, ts(TONEtime2_REM), -10000, +15000,'BinSize',500);
    hold on, title('PFCx spikes - time2')
    figure, [fh, rasterAx, histAx, matVal_Spk_DeltaDetect] = ImagePETH(Qspk, ts(DeltaDetect_REM), -10000, +15000,'BinSize',500);
    hold on, title('PFCx spikes - DeltaDetect')
    
    save Spk_PFCx_Delta_REM -append matVal_Spk_TONEtime1 matVal_Spk_TONEtime2 matVal_Spk_DeltaDetect
end
%<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
...
if length(number)>1
    ...
    save Spk_NRT_Delta_REM matVal_MUA_TONEtime1 matVal_MUA_TONEtime2 matVal_MUA_DeltaDetect
end
%<><>
...
if length(number)>1
    ...
    save Spk_NRT_Delta_REM -append matVal_Spk_TONEtime1 matVal_Spk_TONEtime2 matVal_Spk_DeltaDetect
end
%<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
...
if length(number)>1
    ...
    save Spk_Bulb_Delta_REM matVal_MUA_TONEtime1 matVal_MUA_TONEtime2 matVal_MUA_DeltaDetect
end
%<><>
...
if length(number)>1
    ...
    save Spk_Bulb_Delta_REM -append matVal_Spk_TONEtime1 matVal_Spk_TONEtime2 matVal_Spk_DeltaDetect
end
%<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
...
if length(number)>1
    ...
    save Spk_dHPC_Delta_REM matVal_MUA_TONEtime1 matVal_MUA_TONEtime2 matVal_MUA_DeltaDetect
end
%<><>
...
if length(number)>1
    ...
    save Spk_dHPC_Delta_REM -append matVal_Spk_TONEtime1 matVal_Spk_TONEtime2 matVal_Spk_DeltaDetect
end
%<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
...
if length(number)>1
    ...
    save Spk_MoCx_Delta_REM matVal_MUA_TONEtime1 matVal_MUA_TONEtime2 matVal_MUA_DeltaDetect
end
%<><>
...
if length(number)>1
    ...
    save Spk_MoCx_Delta_REM -append matVal_Spk_TONEtime1 matVal_Spk_TONEtime2 matVal_Spk_DeltaDetect
end
%<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
