    ...
    for i=1:32
        ...
        if strcmp('PFCx', InfoLFP.structure(i))
            if InfoLFP.depth(i)==0
                ...
                hold on, plot(a(:,1),a(:,2)+PFCx*(decal*3),'b','linewidth',2)
                hold on, title('Prefrontal Cortex')
                PFCx=PFCx+1;
                hold on, xlim([-1 1])
            elseif InfoLFP.depth(i)>0
                hold on, subplot(7,1,1:2)
                hold on, plot(a(:,1),a(:,2)+PFCx*(decal*3),'r','linewidth',1)
                hold on, plot(b(:,1),b(:,2)+PFCx*(decal*3),'b','linewidth',1)
                hold on, title('Prefrontal Cortex')
                PFCx=PFCx+1;
                hold on, xlim([-1 1])
            end
        ...
        if strcmp('MoCx', InfoLFP.structure(i))
            if InfoLFP.depth(i)==0
                ...
                hold on, plot(b(:,1),b(:,2)+MoCx*(decal*3),'b','linewidth',2)
                hold on, title('Motor Cortex')
                MoCx=MoCx+1;
                hold on, xlim([-1 1])
            elseif InfoLFP.depth(i)>0
                hold on, subplot(7,1,3)
                hold on, plot(a(:,1),a(:,2)+MoCx*(decal*3),'r','linewidth',1)
                hold on, plot(b(:,1),b(:,2)+MoCx*(decal*3),'b','linewidth',1)
                hold on, title('Motor Cortex')
                MoCx=MoCx+1;
                hold on, xlim([-1 1])
            end
        ...
        if strcmp('PaCx', InfoLFP.structure(i))
            if InfoLFP.depth(i)==0
                ...
                hold on, plot(b(:,1),b(:,2)+PaCx*(decal*3),'b','linewidth',2)
                hold on, title('Parietal Cortex')
                PaCx=PaCx+1;
                hold on, xlim([-1 1])
            elseif InfoLFP.depth(i)>0
                hold on, subplot(7,1,4)
                hold on, plot(a(:,1),a(:,2)+PaCx*(decal*3),'r','linewidth',1)
                hold on, plot(b(:,1),b(:,2)+PaCx*(decal*3),'b','linewidth',1)
                hold on, title('Parietal Cortex')
                PaCx=PaCx+1;
                hold on, xlim([-1 1])
            end
        ...
        if strcmp('dHPC', InfoLFP.structure(i))
                ...
                hold on, plot(a(:,1),a(:,2)+dHPC*(decal*3),'r','linewidth',1)
                hold on, plot(b(:,1),b(:,2)+dHPC*(decal*3),'b','linewidth',1)
        ...
        if strcmp('Bulb', InfoLFP.structure(i))
            if InfoLFP.depth(i)==0
                ...
                hold on, plot(b(:,1),b(:,2)+Bulb*(decal*3),'b','linewidth',2)
                hold on, title('Bulb')
                Bulb=Bulb+1;
                hold on, xlim([-1 1])
            elseif InfoLFP.depth(i)>0
                hold on, subplot(7,1,7)
                hold on, plot(a(:,1),a(:,2)+Bulb*(decal*3),'r','linewidth',1)
                hold on, plot(b(:,1),b(:,2)+Bulb*(decal*3),'b','linewidth',1)
                hold on, title('Bulb')
                Bulb=Bulb+1;
                hold on, xlim([-1 1])
            end
        ...
        if strcmp('NRT', InfoLFP.structure(i))
                ...
                hold on, plot(a(:,1),a(:,2)+NRT*(decal*3),'r','linewidth',1)
                hold on, plot(b(:,1),b(:,2)+NRT*(decal*3),'b','linewidth',1)
                hold on, title('NRT')
                NRT=NRT+1;
                hold on, xlim([-1 1])
        end
