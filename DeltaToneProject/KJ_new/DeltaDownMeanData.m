...
% Plot of several Figures
% - Delta occurences across the night
% - Down states occurences across night
% - LFP signal sync on the begining or end of down states
...
Mdf=PlotRipRaw(LFPdeep,start_down(nb_down-sample_size:nb_down)/1E4,1000); close
Msf=PlotRipRaw(LFPsup,start_down(nb_down-sample_size:nb_down)/1E4,1000); close 
...
plot(Ms(:,1),Ms(:,2)-Ms(:,err),'r','linewidth',1), hold on 
title('deep(k) vs sup(r) : sleep begining')
...
plot(Mdf(:,1),Mdf(:,2)-Mdf(:,err),'m','linewidth',1), hold on 
title('deep layer : sleep begining(b) vs end(m)')
...
Mdf=PlotRipRaw(LFPdeep,end_down(nb_down-sample_size:nb_down)/1E4,1000); close
Msf=PlotRipRaw(LFPsup,end_down(nb_down-sample_size:nb_down)/1E4,1000); close 
err=4; %column ind of the std error
...
Mdf=PlotRipRaw(LFPdeep,tmp_deltas(nb_delta-sample_size:nb_delta)/1E4,1000); close
Msf=PlotRipRaw(LFPsup,tmp_deltas(nb_delta-sample_size:nb_delta)/1E4,1000); close 
err=4; %column ind of the std error
...
Mmf=PlotRipRaw(MUA,tmp_deltas(nb_delta-sample_size:nb_delta)/1E4,1000); close
err=4; %column ind of the std error
