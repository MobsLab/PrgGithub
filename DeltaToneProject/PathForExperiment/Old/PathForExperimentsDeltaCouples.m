function Dir=PathForExperimentsDeltaCouples(experiment)
...
if strcmpi(experiment,'BASAL')
    ...
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice328-330/20160329/Mouse330/Breath-Mouse-330-29032016'; % Mouse 330 - Day 1
...
if strcmpi(experiment,'RdmTone')
    ...
    Dir.delay{a}=0.14;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160215/Mouse294/Breath-Mouse-294-15022016'; % 15-02-2016 > random tone effect  - Mouse 294 (delay 140ms!! of M293 detection)
    Dir.delay{a}=0.14;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160216/Mouse293/Breath-Mouse-293-16022016'; % 16-02-2016 > random tone effect  - Mouse 293 (delay 140ms!! of M294 detection)
    Dir.delay{a}=0.14;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160217/Mouse294/Breath-Mouse-294-17022016'; % 17-02-2016 > random tone effect  - Mouse 294 (delay 320ms!! of M293 detection)
    Dir.delay{a}=0.32;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160223/Mouse293/Breath-Mouse-293-23022016'; % 23-02-2016 > random tone effect  - Mouse 293 (delay 320ms!! of M294 detection)
    Dir.delay{a}=0.32;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160224/Mouse294/Breath-Mouse-294-24022016'; % 24-02-2016 > random tone effect  - Mouse 294 (delay 490ms!! of M293 detection)
    Dir.delay{a}=0.49;
    ...
    Dir.delay{a}=0.49;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice328-330/20160614/Mouse328/Breath-Mouse-328-14062016'; % 14-05-2016 > random tone effect  - Mouse 328 (delay 480ms!! of M330 detection)
    Dir.delay{a}=0.49;
...
if strcmpi(experiment,'DeltaT140')
    ...
    Dir.delay{a}=0.14;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160215/Mouse293/Breath-Mouse-293-15022016';  % 15-02-2016 > delay 140ms - Mouse 293
    Dir.delay{a}=0.14;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160216/Mouse294/Breath-Mouse-294-16022016';  % 16-02-2016 > delay 140ms - Mouse 294
    Dir.delay{a}=0.14;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice328-330/20160421/Mouse328/Breath-Mouse-328-21042016';      % 21-04-2016 > delay 140ms - Mouse 328
    Dir.delay{a}=0.14;
...
if strcmpi(experiment,'DeltaT320') 
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160217/Mouse293/Breath-Mouse-293-17022016';  % 17-02-2016 > delay 320ms - Mouse 293
    Dir.delay{a}=0.32;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice293-294-296/20160223/Mouse294/Breath-Mouse-294-23022016';  % 23-02-2016 > delay 320ms - Mouse 294
    Dir.delay{a}=0.32;
...
if strcmpi(experiment,'DeltaT490')   
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice328-330/20160523/Mouse328/Breath-Mouse-328-23052016'; % 17-05-2016 > delay 490ms - Mouse 328
    Dir.delay{a}=0.49;
    a=a+1; Dir.path{a}='/media/DataMOBsRAID/ProjetBreathDeltaFeedback/Mice328-330/20160614/Mouse330/Breath-Mouse-330-14062016'; % 18-05-2016 > delay 490ms - Mouse 330
    Dir.delay{a}=0.49;
end
