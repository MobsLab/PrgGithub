...
xp = X(:,1);
yp = X(:,2);
cond{1} = yp>(0.8*xp+400);
cond{2} = yp<=(0.8*xp+400) & yp>(0.8*xp-400);
cond{3} = yp<=(0.8*xp-400) & yp>(0.8*xp-1100);
cond{4} = yp<=(0.8*xp-1100) & yp>(0.8*xp-1700);
cond{5} = yp<=(0.8*xp-1700);

% cond{1} = xp<=-300;
% cond{2} = xp>-300 & xp<=300;
% cond{3} = xp>300 & xp<=600;
% cond{4} = xp>600 & xp<=1100;
% cond{5} = xp>1100 & xp<=1550;
% cond{6} = xp>1550;
