...
text(mean(Xbar),0.025, '*', 'HorizontalAlignment','center','fontsize',35)
...
text(mean(Xbar(1:2)),-0.205, '*', 'HorizontalAlignment','center','fontsize',35)
text(Xbar(2),0.10, '*', 'HorizontalAlignment','center','fontsize',35)
text(Xbar(3),0.11, 'n.s', 'HorizontalAlignment','center','fontsize',25)
text(Xbar(4),0.11, 'n.s', 'HorizontalAlignment','center','fontsize',25)

set(gca,'xlim',XL, 'ylim', [-0.22 0.13], 'ytick', -0.2:0.1:0.1)
...
text(mean(Xbar),37.5, '*', 'HorizontalAlignment','center','fontsize',35)
set(gca,'xlim',XL,'xtick',Xbar,'XtickLabel',{'first 2h','last 2h'}, 'ylim', [0 39], 'ytick',0:10:40,'Fontsize',fontsize),
xtickangle(20),
