%%ParcoursHomeostasieLocalDeltaOccupancyPlot2
% 06.09.2019 KJ
%
% Infos
...
%
% see
%    ParcoursHomeostasieLocalDeltaOccupancy ParcoursHomeostasieFakeLocalDeltaPlot2
%    ParcoursHomeostasieFakeLocalDelta 
%
...
for p=13%:length(homeo_res.path)
    ...
    for tt=1:homeo_res.nb.tetrodes{p}
        ...
        limSplit = 14;
        idx1 =  homeo_res.down.global.x_intervals{p}<limSplit;
        idx2 =  homeo_res.down.global.x_intervals{p}>limSplit; 

        %global down states
        subplot(2,3,1), hold on
        hold on, plot(homeo_res.down.global.x_intervals{p}, homeo_res.down.global.y_density{p},'b')
        hold on, plot(homeo_res.down.global.x_intervals{p}, homeo_res.down.global.reg0{p},'r.')
        hold on, plot(homeo_res.down.global.x_intervals{p}(idx1), homeo_res.down.global.reg1{p}(idx1),'k.')
        hold on, plot(homeo_res.down.global.x_intervals{p}(idx2), homeo_res.down.global.reg2{p}(idx2),'k.')
        ...
        hold on, plot(homeo_res.down.local.x_intervals{p,tt}, homeo_res.down.local.reg0{p,tt},'r.')
        hold on, plot(homeo_res.down.local.x_intervals{p,tt}(idx1), homeo_res.down.local.reg1{p,tt}(idx1),'k.')
        hold on, plot(homeo_res.down.local.x_intervals{p,tt}(idx2), homeo_res.down.local.reg2{p,tt}(idx2),'k.')
        ...
        hold on, plot(homeo_res.delta.global.x_intervals{p,tt}, homeo_res.delta.global.reg0{p,tt},'r.')
        hold on, plot(homeo_res.delta.global.x_intervals{p,tt}(idx1), homeo_res.delta.global.reg1{p,tt}(idx1),'k.')
        hold on, plot(homeo_res.delta.global.x_intervals{p,tt}(idx2), homeo_res.delta.global.reg2{p,tt}(idx2),'k.')
        ...
        hold on, plot(homeo_res.delta.local.x_intervals{p,tt}, homeo_res.delta.local.reg0{p,tt},'r.')
        hold on, plot(homeo_res.delta.local.x_intervals{p,tt}(idx1), homeo_res.delta.local.reg1{p,tt}(idx1),'k.')
        hold on, plot(homeo_res.delta.local.x_intervals{p,tt}(idx2), homeo_res.delta.local.reg2{p,tt}(idx2),'k.')
        ...
        hold on, plot(homeo_res.delta.fake.x_intervals{p,tt}, homeo_res.delta.fake.reg0{p,tt},'r.')
        hold on, plot(homeo_res.delta.fake.x_intervals{p,tt}(idx1), homeo_res.delta.fake.reg1{p,tt}(idx1),'k.')
        hold on, plot(homeo_res.delta.fake.x_intervals{p,tt}(idx2), homeo_res.delta.fake.reg2{p,tt}(idx2),'k.')
