...
%
% see
%   QuantifHomeostasieLocalDeltaOccupancyPlot ParcoursHomeostasieLocalDeltaDensity
%   ParcoursHomeostasieLocalDeltaOccupancyPlo  ParcoursHomeostasieLocalDeltaOccupancyPlot2
...
for p=1:length(Dir.path)
    ...
    %save
    homeo_res.nb.down{p} = length(st_down);
    ...
    for tt=1:nb_tetrodes
        ...
        %all local down
        [~, ~, Hstat] = DensityOccupation_KJ(AllDown_local{tt}, 'homeostat',4, 'windowsize',windowsize_density,'endtime', night_duration,'newtsdzt',NewtsdZT,'epoch',NREM);
        ...
        %local down
        [~, ~, Hstat] = DensityOccupation_KJ(LocalDown{tt}, 'homeostat',4, 'windowsize',windowsize_density,'endtime', night_duration,'newtsdzt',NewtsdZT,'epoch',NREM);
        ...
        %global delta
        [~, ~, Hstat] = DensityOccupation_KJ(GlobalDelta{tt}, 'homeostat',4, 'windowsize',windowsize_density,'endtime', night_duration,'newtsdzt',NewtsdZT,'epoch',NREM);
        ...
        %other delta
        [~, ~, Hstat] = DensityOccupation_KJ(OtherDelta{tt}, 'homeostat',4, 'windowsize',windowsize_density,'endtime', night_duration,'newtsdzt',NewtsdZT,'epoch',NREM);
        homeo_res.delta.other.x_intervals{p,tt} = Hstat.x_intervals;
        homeo_res.delta.other.y_density{p,tt}   = Hstat.y_density;
        homeo_res.delta.other.x_peaks{p,tt}  = Hstat.x_peaks;
        homeo_res.delta.other.y_peaks{p,tt}  = Hstat.y_peaks;
        homeo_res.delta.other.p0{p,tt}   = Hstat.p0;
        homeo_res.delta.other.reg0{p,tt} = Hstat.reg0;
        homeo_res.delta.other.p1{p,tt}   = Hstat.p1;
        homeo_res.delta.other.reg1{p,tt} = Hstat.reg1;
        homeo_res.delta.other.p2{p,tt}   = Hstat.p2;
        homeo_res.delta.other.reg2{p,tt} = Hstat.reg2;
        homeo_res.delta.other.exp_a{p,tt} = Hstat.exp_a; 
        homeo_res.delta.other.exp_b{p,tt} = Hstat.exp_b;
        %correlation
        homeo_res.delta.other.pv0{p,tt}  = Hstat.pv0;
        homeo_res.delta.other.R2_0{p,tt} = Hstat.R2_0;
        homeo_res.delta.other.pv1{p,tt}  = Hstat.pv1;
        homeo_res.delta.other.R2_1{p,tt} = Hstat.R2_1;
        homeo_res.delta.other.pv2{p,tt}  = Hstat.pv2;
        homeo_res.delta.other.R2_2{p,tt} = Hstat.R2_2;
        homeo_res.delta.other.exp_R2{p,tt} = Hstat.exp_R2; 
        
        %local delta
        [~, ~, Hstat] = DensityOccupation_KJ(LocalDelta{tt}, 'homeostat',4, 'windowsize',windowsize_density,'endtime', night_duration,'newtsdzt',NewtsdZT,'epoch',NREM);
        ...
        %fake delta
        [~, ~, Hstat] = DensityOccupation_KJ(FakeDelta{tt}, 'homeostat',4, 'windowsize',windowsize_density,'endtime', night_duration,'newtsdzt',NewtsdZT,'epoch',NREM);
        ...
        homeo_res.nb.localdown{p}(tt) = length(st_localdown{tt});
    ...
    [~, ~, Hstat] = DensityOccupation_KJ(UnionAllDown, 'homeostat',4, 'windowsize',windowsize_density,'endtime', night_duration,'newtsdzt',NewtsdZT,'epoch',NREM);
...
save ParcoursHomeostasieLocalDeltaOccupancy.mat homeo_res
