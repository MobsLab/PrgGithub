...
%average and x% DistribDelayToneShamDeltaPlot
% 11.07.2019 KJ
%
% quantification of the delay between a tone/sham and the next delta, 
% for different substages
...
color_rdm = [0 0 1];
color_bci = [0 0.5 0];% DistribDelayToneShamDeltaPlot
% 11.07.2019 KJ
%
% quantification of the delay between a tone/sham and the next delta, 
% for different substages
...
figure, hold on
h(1) = plot(sham.plot.x, sham.plot.y, 'color',color_sham, 'LineWidth',4); hold on,
h(2) = plot(random.plot.x, random.plot.y, 'color',color_rdm, 'LineWidth',4); hold on,
h(3) = plot(deltas.plot.x, deltas.plot.y, 'color',color_bci, 'LineWidth',4); hold on,
...
xlabel('time from tones or sham(ms)'), ylabel('Occurence probability of delta waves')
