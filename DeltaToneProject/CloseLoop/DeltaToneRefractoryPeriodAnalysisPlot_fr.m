% DeltaToneRefractoryPeriodAnalysisPlot_fr
% 11.07.2019 KJ
%
...
legend(h,' Stim boucle fermée',' Stim aléatoire', ' Sham')
set(gca,'XTick',0:100:900,'Xlim',[20 820],'YTick',0:20:80,'YLim',[0 60],'FontName','Times','fontsize',30), hold on,
ylabel({'% de stim (ou sham)' 'suivi par une onde delta'}), xlabel('delai depuis la précédente onde delta (ms)')
