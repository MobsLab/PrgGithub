...
[~,h(3)]=PlotErrorLineN_KJ(percentage_tones.bci,'x_data',xdata_bci,'newfig',0,'linecolor',color_deltatone,'ShowSigstar','none','errorbars',1,'linespec','-.');

legend(h,'Random tone', 'Random Sham','Close-loop')
