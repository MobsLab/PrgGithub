%%RipplesOutDeltaN2N3Raster
% 18.09.2018 KJ
%
%
% see
%   FigRipplesOutDeltaN2N3 RipplesOutDeltaN2N3Effect RipplesInDeltaN2N3Raster
...
for p=1:length(Dir.path)
    ...
    %ripples
    ripraster_res.n2.rasters.ripples{p}  = RasterMatrixKJ(PFCdeep, RipplesUpN2, t_start, t_end);
    ripraster_res.n3.rasters.ripples{p}  = RasterMatrixKJ(PFCdeep, RipplesUpN3, t_start, t_end);
    ripraster_res.nrem.rasters.ripples{p}  = RasterMatrixKJ(PFCdeep, RipplesUpNREM, t_start, t_end);
    
    %sham
    ripraster_res.n2.rasters.sham{p}   = RasterMatrixKJ(PFCdeep, ShamUpN2, t_start, t_end);
    ripraster_res.n3.rasters.sham{p}   = RasterMatrixKJ(PFCdeep, ShamUpN3, t_start, t_end);
    ripraster_res.nrem.rasters.sham{p} = RasterMatrixKJ(PFCdeep, ShamUpNREM, t_start, t_end);
...
save RipplesOutDeltaN2N3Raster.mat -v7.3 ripraster_res t_start t_end
