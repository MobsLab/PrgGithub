...
%
%   see 
%       FigRipplesInDeltaN2N3 FigRIPPLESOutDeltaN2N3
%
%
...
load(fullfile(FolderDeltaDataKJ,'RipplesOutDeltaN2N3Effect.mat'))

load(fullfile(FolderDeltaDataKJ,'RipplesOutDeltaN2N3Raster.mat'))
...
caxis([-2000 3000]),
title('Ripples outside Delta waves - N2')
...
axis xy, hold on
line([0 0], ylim,'linewidth',2,'color','w'), hold on
set(gca,'YLim', [0 size(MatLFP.n2.sham,1)], 'ytick',0:5e4:15e4, 'XLim',[-400 400],'Fontsize',fontsize);
xlabel('time relative to random (ms)'), ylabel('#random'),
caxis([-2000 3000]),
title('Random outside Delta waves - N2')
...
title('occurence of start/end of up states- N2'),
...
title({'Occurence of ripples/random', 'in Up states (normalized) - N2'}),
...
title('Ripples outside Delta waves - N3')
...
caxis([-2000 3000]),
xlabel('time relative to random (ms)'), ylabel('#random'),
title('Random outside Delta waves - N3')
...
line([0 0],get(gca,'ylim'),'color',[0.7 0.7 0.7])
xlabel('time from ripples (ms)'),
title('occurence of start/end of up states- N3'),
...
set(gca, 'ytick',0:0.02:0.08, 'Fontsize',fontsize),
% lgd = legend(h, 'ripples', 'random'); lgd.Location='northwest';
title({'Occurence of ripples/random', 'in Up states (normalized) - N3'}),
...
caxis([-2000 3000]),
xlabel('time relative to ripples (ms)'), ylabel('#ripples'),
title('Ripples outside Delta waves - NREM')
...
xlabel('time relative to random (ms)'), ylabel('#random'),
title('Random outside Delta waves - NREM')
...
line([0 0],get(gca,'ylim'),'color',[0.7 0.7 0.7])
xlabel('time from ripples (ms)'),
title('occurence of start/end of up states- NREM'),
...
set(gca, 'ytick',0:0.02:0.08, 'Fontsize',fontsize),
% lgd = legend(h, 'ripples', 'random'); lgd.Location='northwest';
title({'Occurence of ripples/random', 'in Up states (normalized) - NREM'}),
...
PlotErrorBarN_KJ({proba.nrem.ripples proba.nrem.sham}, 'newfig',0, 'barcolors',{'b','r'}, 'paired',paired, 'optiontest',optiontest, 'showPoints',1,'ShowSigstar','sig');
set(gca,'ylim',[0 0.33], 'xtick',1:2,'XtickLabel',{'ripples','random'},'Fontsize',fontsize),
