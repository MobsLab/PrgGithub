...
load(fullfile(FolderDeltaDataKJ,'TonesOutDeltaN2N3Effect.mat'))
load(fullfile(FolderDeltaDataKJ,'ShamOutDeltaN2N3Effect.mat'))

load(fullfile(FolderDeltaDataKJ,'TonesOutDeltaN2N3Raster.mat'))
load(fullfile(FolderDeltaDataKJ,'ShamOutDeltaN2N3Raster.mat'))
...
title('Tones outside delta waves - N2')
...
title('Sham outside delta waves - N2')
...
set(gca,'ylim',[-1500 1500], 'XLim',[-400 400],'Fontsize',fontsize);
...
for c=1:5
    plot(x_met, y_mua_sham.n2{c}, 'color', colori_cluster{c});
end
set(gca,'ylim',[-1500 1500], 'XLim',[-400 400],'Fontsize',fontsize);
line([0 0],get(gca,'ylim'),'linewidth',2,'color',[0.7 0.7 0.7]);
...
title('probability of transition Up>Delta'),
...
set(gca,'ylim', [0 0.04], 'ytick',0:0.01:0.04, 'Fontsize',fontsize), 
...
% lgd = legend(h, 'tones', 'sham'); lgd.Location='northwest';
title({'Occurence of tones/sham' , 'in up (normalized) - N2'}),
...
xlabel('time relative to sham (ms)'), ylabel('#sham'),
title('Sham outside delta waves - N3')
...
subtightplot(4,4,6,gap), hold on
for c=1:5
    plot(x_met, y_mua_sham.n3{c}, 'color', colori_cluster{c});
end
set(gca,'ylim',[-1500 1500], 'XLim',[-400 400],'Fontsize',fontsize);
line([0 0],get(gca,'ylim'),'linewidth',2,'color',[0.7 0.7 0.7]);
xlabel('time from sham (s)'),
...
set(gca,'ylim', [0 0.06], 'ytick',0:0.02:0.06, 'Fontsize',fontsize), 
line([0 0],get(gca,'ylim'),'color',[0.7 0.7 0.7])
xlabel('time from tones (ms)'),
...
set(gca, 'ytick',0:0.02:0.08, 'Fontsize',fontsize),
% lgd = legend(h, 'tones', 'sham'); lgd.Location='northwest';
title({'Occurence of tones/sham', 'in Up (normalized) - N3'}),
...
xlabel('time relative to tones (s)'), ylabel('#tones'),
title('Tones outside delta waves - NREM')
...
xlabel('time relative to sham (ms)'), ylabel('#sham'),
title('Sham outside delta waves - NREM')
...
subtightplot(4,4,6,gap), hold on
for c=1:5
    plot(x_met, y_mua_sham.nrem{c}, 'color', colori_cluster{c});
end
set(gca,'ylim',[-1500 1500], 'XLim',[-400 400],'Fontsize',fontsize);
line([0 0],get(gca,'ylim'),'linewidth',2,'color',[0.7 0.7 0.7]);
xlabel('time from sham (s)'),
...
set(gca, 'ytick',0:0.02:0.08, 'Fontsize',fontsize),
% lgd = legend(h, 'tones', 'sham'); lgd.Location='northwest';
title({'Occurence of tones/sham', 'in Up (normalized) - NREM'}),
...
PlotErrorBarN_KJ({proba.nrem.tones proba.nrem.sham}, 'newfig',0, 'barcolors',{'b','r'}, 'paired',paired, 'optiontest',optiontest, 'showPoints',1,'ShowSigstar','sig');
set(gca,'ylim',[0 0.8],'ytick',0:0.2:1,'xtick',1:2,'XtickLabel',{'tones','sham'},'Fontsize',fontsize),
title('Tones in NREM')
