%%FiguresTonesInDownPerRecordRegular
% 06.04.2018 KJ
%
%
%
%
% see
%   FiguresTonesInDownPerRecordRegularPlot FiguresTonesInDownPerRecord
%
...
for p=1:length(Dir.path)
    ...
    idn = effect_peak>4|effect_mean>1.5;
    ...
    %MUA & Down
    MUA = GetMuaNeurons_KJ(regular_neurons, 'binsize',binsize_mua); %2mS
...
save FiguresTonesInDownPerRecordRegular.mat figure_res sham_distrib binsize_met nbBins_met binsize_mua minDuration intwindow nb_sham
