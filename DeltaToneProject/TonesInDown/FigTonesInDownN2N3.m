...
%
%   see 
%       Fig1TonesInDown_midthesis FigTonesInUpN2N3
...
%sham
for p=1:length(shamras_res.path)
...
title('Tones inside down states - N2')
...
title('Sham inside down states - N2')
...
% lgd = legend(h, 'tones', 'sham'); lgd.Location='northwest';
title({'Occurence of tones/sham' , 'in Down state (normalized) - N2'}),
...
xlabel('time relative to tones (s)'), ylabel('#tones'),
title('Tones inside down states - N3')
...
xlabel('time relative to sham (ms)'), ylabel('#sham'),
title('Sham inside down states - N3')
...
set(gca, 'ytick',0:0.02:0.08, 'Fontsize',fontsize),
% lgd = legend(h, 'tones', 'sham'); lgd.Location='northwest';
title({'Occurence of tones/sham', 'in Down state (normalized) - N3'}),
...
xlabel('time relative to tones (s)'), ylabel('#tones'),
title('Tones inside down states - NREM')
...
xlabel('time relative to sham (ms)'), ylabel('#sham'),
title('Sham inside down states - NREM')
...
set(gca, 'ytick',0:0.02:0.08, 'Fontsize',fontsize),
% lgd = legend(h, 'tones', 'sham'); lgd.Location='northwest';
title({'Occurence of tones/sham', 'in Down state (normalized) - NREM'}),
