...
%
%   see 
%       FigRipplesInUpN2N3 FigTonesInDownN2N3
%
%
...
for p=1:length(ripples_res.path)
    ...
    d_norm.nrem.ripples     = [d_norm.nrem.ripples ; nrem.d_norm.ripples{p}];
    ...
    d_norm.nrem.sham      = [d_norm.nrem.sham ; nrem.d_norm.sham{p}];
...
line([0 0], ylim,'linewidth',2,'color','w'), hold on
line([40 40], ylim,'linewidth',1,'color',[0.7 0.7 0.7]), hold on
set(gca,'YLim', [0 size(MatMUA.n2.sham,1)], 'ytick',0:1e4:15e4, 'XLim',[-400 400],'Fontsize',fontsize);
...
line([0 0], ylim,'linewidth',2,'color','w'), hold on
line([40 40], ylim,'linewidth',1,'color',[0.7 0.7 0.7]), hold on
set(gca,'YLim', [0 size(MatMUA.n3.sham,1)], 'ytick',0:1e4:15e4, 'XLim',[-400 400],'Fontsize',fontsize);
xlabel('time relative to random (ms)'), ylabel('#random'),
...
line([0 0], ylim,'linewidth',2,'color','w'), hold on
line([40 40], ylim,'linewidth',1,'color',[0.7 0.7 0.7]), hold on
set(gca,'YLim', [0 size(MatMUA.nrem.sham,1)], 'ytick',0:1e4:15e4, 'XLim',[-400 400],'Fontsize',fontsize);
xlabel('time relative to random (ms)'), ylabel('#random'),
...
PlotErrorBarN_KJ({proba.nrem.ripples proba.nrem.sham}, 'newfig',0, 'barcolors',{'b','r'}, 'paired',paired, 'optiontest',optiontest, 'showPoints',1,'ShowSigstar','sig');
set(gca,'ylim',[0 0.9], 'xtick',1:2,'XtickLabel',{'ripples','random'},'Fontsize',fontsize),
