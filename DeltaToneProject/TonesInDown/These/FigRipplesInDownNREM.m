...
axis xy, hold on
line([0 0], ylim,'linewidth',2,'color','w'), hold on
set(gca,'YLim', [0 size(MatMUA.nrem.sham,1)], 'ytick',0:5e4:20e4, 'XLim',[-400 400],'Fontsize',fontsize);
...
ylabel('Averaged MUA'), title('Ripples inside Down states'),
...
ylabel({'Down>Up ', 'transition probability'}),
...
xlabel('normalized time'), ylabel('probability occurence inside Down'),
