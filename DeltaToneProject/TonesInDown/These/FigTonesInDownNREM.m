...
%
%   see 
%       FigTonesInDownN2N3 FigTonesInUpNREM
%
...
xlabel('time relative to tones (ms)'), ylabel('#tones'),
title('Tones')
...
line(Xbar, [1 1], 'color', 'k', 'linewidth', 1.5),
text(mean(Xbar),1.1, '*', 'HorizontalAlignment','center','fontsize',20)
set(gca,'ytick',0:0.2:1, 'ylim',[0 1.2],'Fontsize',fontsize),
...
set(gca,'ylim', [0 0.19], 'ytick',0:0.05:0.19, 'Fontsize',fontsize),
...
set(gca, 'ytick',0:0.02:0.08, 'ylim', [0.01 0.1], 'Fontsize',fontsize),
lgd = legend(h, 'tones', 'sham'); lgd.Location='northwest';
