%%QuantifRipplesInDownEffectN2N3 
% 18.09.2018 KJ
%
...
%
%   see 
%       FigRipplesInDownN2N3 FigTonesInDownN2N3 QuantifRipplesInUpEffectN2N3
%
%
...
line(Xbar, [0.66 0.66], 'color', 'k', 'linewidth', 1.5),
text(mean(Xbar),0.68, '**', 'HorizontalAlignment','center','fontsize',20)
set(gca,'ylim',YL,'ytick',0:0.2:1,'Fontsize',fontsize),
set(gca,'xtick',Xbar,'XtickLabel',{'SPW-r','sham'},'xlim', XL),
title('NREM'), ylabel({'Down>Up', 'transition probability'}),


%N2
subtightplot(2,4,3,gap), hold on
notBoxPlot(proba.n2.ripples,Xbar(1), 'patchColors', colors_rip),
notBoxPlot(proba.n2.sham,Xbar(2), 'patchColors', colors_rdm),
for l=1:length(proba.n2.ripples)
    line(Xbar, [proba.n2.ripples(l) proba.n2.sham(l)], 'color', [0.7 0.7 0.7]),
end
line(Xbar, [0.67 0.67], 'color', 'k', 'linewidth', 1.5),
text(mean(Xbar),0.69, '**', 'HorizontalAlignment','center','fontsize',20)
set(gca,'ylim',YL,'ytick',0:0.2:1,'Fontsize',fontsize),
...
notBoxPlot(proba.n3.sham,Xbar(2), 'patchColors', colors_rdm),
for l=1:length(proba.n3.ripples)
    line(Xbar, [proba.n3.ripples(l) proba.n3.sham(l)], 'color', [0.7 0.7 0.7]),
end
line(Xbar, [0.64 0.64], 'color', 'k', 'linewidth', 1.5),
text(mean(Xbar),0.66, '**', 'HorizontalAlignment','center','fontsize',20)
set(gca,'ylim',YL,'ytick',0:0.2:1,'Fontsize',fontsize),
set(gca,'xtick',Xbar,'XtickLabel',{'SPW-r','random'},'xlim', XL),
