...
%
%   see 
%       FigRipplesInDownN2N3 FigRipplesInDownNREM
%
%
...
axis xy, hold on
line([0 0], ylim,'linewidth',2,'color','w'), hold on
set(gca,'YLim', [0 size(MatMUA.nrem.sham,1)], 'ytick',0:2e4:12e4, 'XLim',[-400 400],'Fontsize',fontsize);
...
xlabel('time from ripples or sham (ms)'),
ylabel('Averaged MUA'), title('Ripples inside Up states'),
...
line(Xbar, [0.16 0.16], 'color', 'k', 'linewidth', 1.5),
text(mean(Xbar),0.17, '**', 'HorizontalAlignment','center','fontsize',20)
set(gca,'ylim',[0 0.19],'ytick',0:0.2:1,'Fontsize',fontsize),
...
set(gca,'ylim', [0 0.028], 'ytick',0:0.02:0.1, 'Fontsize',fontsize), 
...
Hrip = shadedErrorBar(x_norm.nrem.ripples, Smooth(d_norm.nrem.ripples, smoothing), Smooth(std_norm.nrem.ripples, smoothing),{},0.4);
Hsham  = shadedErrorBar(x_norm.nrem.sham, Smooth(d_norm.nrem.sham, smoothing), Smooth(std_norm.nrem.sham, smoothing),{},0.4);
Hrip.patch.FaceColor = color_rip;
Hsham.patch.FaceColor  = color_rdm;
...
set(gca, 'xtick',0:0.5:1 , 'ytick',0:0.02:0.08, 'ylim', [0.02 0.07], 'Fontsize',fontsize),
lgd = legend(h, 'ripples', 'random'); lgd.Location='northwest';
