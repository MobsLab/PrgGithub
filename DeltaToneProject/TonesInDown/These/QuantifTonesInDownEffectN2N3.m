...
%
%   see 
%       FigTonesInDownN2N3 QuantifTonesInUpEffectN2N3
% 
...
line(Xbar, [1.05 1.05], 'color', 'k', 'linewidth', 1.5),
text(mean(Xbar),1.07, '*', 'HorizontalAlignment','center','fontsize',20)
