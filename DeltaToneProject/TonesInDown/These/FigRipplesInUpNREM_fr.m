...
% xlabel('temps (ms)'), ylabel('#ripples'),
% title('Ripples')
% caxis([0 3]),
% 
% 
...
% axis xy, hold on
% line([0 0], ylim,'linewidth',2,'color','w'), hold on
% set(gca,'YLim', [0 size(MatMUA.nrem.sham,1)], 'ytick',0:2e4:12e4, 'XLim',[-400 400],'Fontsize',14);
% xlabel('temps (ms)'), ylabel('#random'),
% title('Random')
% caxis([0 3]),
...
set(gca,'xlim',[-400 400],'ylim', [0 0.028], 'ytick',0:0.02:0.1, 'Fontsize',fontsize), 
...
set(gca,'ylim',[0 0.19],'ytick',0:0.05:1,'Fontsize',fontsize),
