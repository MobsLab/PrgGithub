%%FiguresRipplesInDownPerRecord_old
% 30.05.2018 KJ
%
%
%
...
for p=1:length(Dir.path)
    ...
    figure_res.nb_shamin{p} = length(RipplesOut);
...
if sham_distrib
    save FiguresRipplesInDownPerRecord_2.mat figure_res sham_distrib binsize_met nbBins_met binsize_mua minDuration intwindow nb_sham
else
    save FiguresRipplesInDownPerRecord.mat figure_res sham_distrib binsize_met nbBins_met binsize_mua minDuration intwindow nb_sham
end
