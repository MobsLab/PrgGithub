...
%
% see
%   ScriptTonesOnDeltaWavesEffect TonesAndLfpOnTransitionsPlot
%
...
for p=1:length(Dir.path)
    ...
    for ch=1:length(tones_res.channels{p})
        tones_res.clusters{p}(ch) = clusters(channels==tones_res.channels{p}(ch));
    end
