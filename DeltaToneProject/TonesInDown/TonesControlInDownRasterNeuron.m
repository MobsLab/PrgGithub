%%TonesControlInDownRasterNeuron
% 11.05.2018 KJ
%
%
% see
...
for p=1:length(Dir.path)
    ...
    %tones in
    tonesin_tmp = Range(Restrict(ToneEvent, down_PFCx));
...
if sham_distrib
    save TonesControlInDownRasterNeuron_2.mat -v7.3 sham_res t_start t_end binsize_mua neuron_pop minDuration sham_distrib nb_sham
else
    save TonesControlInDownRasterNeuron.mat -v7.3 sham_res t_start t_end binsize_mua neuron_pop minDuration sham_distrib nb_sham
end
