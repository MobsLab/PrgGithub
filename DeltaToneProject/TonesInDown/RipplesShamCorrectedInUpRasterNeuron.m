%%RipplesShamCorrectedInUpRasterNeuron
% 14.06.2018 KJ
%
%
% see
...
for p=1:length(Dir.path)
    ...
    ShamIn = Restrict(ShamEvent, CleanUpEpoch(up_PFCx-aftDown));
...
save RipplesShamCorrectedInUpRasterNeuron.mat -v7.3 sham_res t_start t_end binsize_mua maxDuration
