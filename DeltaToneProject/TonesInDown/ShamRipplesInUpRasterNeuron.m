%%ShamRipplesInUpRasterNeuron
% 18.05.2018 KJ
%
%
% see
%   ShamInUpRasterNeuron RipplesInUpRasterNeuron
%
...
for p=1:length(Dir.path)
    ...
    %% Delay between ripples and up start

    %ripples in
    ripplesin_tmp = Range(Restrict(RipplesEvent, up_PFCx));
...
if sham_distrib
    save ShamRipplesInUpRasterNeuron_2.mat -v7.3 sham_res t_start t_end binsize_mua neuron_pop maxDuration sham_distrib nb_sham
else
    save ShamRipplesInUpRasterNeuron.mat -v7.3 sham_res t_start t_end binsize_mua neuron_pop maxDuration sham_distrib nb_sham
end
