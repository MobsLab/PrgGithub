...
for i=1:length(tone_start)
    ...
    total_down_before = sum(down_start < tone_start(i));
    total_duration_down = sum(down_duration(down_start < tone_start(i)));
    data_tone(i,:) = [tone_start(i); total_down_before; total_duration_down; befdown_delay; befdown_durs]';
end
