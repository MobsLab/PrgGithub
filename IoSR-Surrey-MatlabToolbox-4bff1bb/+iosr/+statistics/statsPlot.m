...
%       - iosr.statistics.functionalPlot
    ...
    methods (Access = protected)
        ...
        function calculateStats(obj)
            ...
            % calculate stats
            obj.statistics.median = iosr.statistics.quantile2(obj.y,.5,[],obj.method,obj.weights); % median
            ...
            for n = 1:prod(obj.outDims)
                ...
                subidxAll{1} = ':';
                [~,obj.statistics.N(subidx{:})] = iosr.statistics.quantile2(obj.y(subidxAll{:}),0.25,[],obj.method,obj.weights(subidxAll{:}));
                ...
                obj.statistics.Q1(subidx{:}) = iosr.statistics.quantile2(obj.y(subidxAll{:}),0.25,[],obj.method,obj.weights(subidxAll{:}));
                obj.statistics.Q3(subidx{:}) = iosr.statistics.quantile2(obj.y(subidxAll{:}),0.75,[],obj.method,obj.weights(subidxAll{:}));
                ...
                if isnumeric(obj.limit)
                    upper_limit = iosr.statistics.quantile2(obj.y(subidxAll{:}),max(obj.limit)/100,[],obj.method,obj.weights(subidxAll{:}));
                    lower_limit = iosr.statistics.quantile2(obj.y(subidxAll{:}),min(obj.limit)/100,[],obj.method,obj.weights(subidxAll{:}));
                else
