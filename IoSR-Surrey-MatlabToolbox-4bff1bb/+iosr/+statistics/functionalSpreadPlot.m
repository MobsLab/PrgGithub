...
% 
%   See also IOSR.STATISTICS.BOXPLOT, IOSR.STATISTICS.quantile2,
        ...
        function calculateStats(obj)
            ...
            for n = 1:prod(obj.outDims)
                ...
                if isnumeric(obj.innerMode)
                    ...
                    obj.statistics.inner_u(subidx{:}) = iosr.statistics.quantile2(obj.y(subidxAll{:}), ...
                        max(obj.innerMode)/100, [], obj.method, obj.weights(subidxAll{:}));
                    obj.statistics.inner_l(subidx{:}) = iosr.statistics.quantile2(obj.y(subidxAll{:}), ...
                ...
                if isnumeric(obj.outerMode)
                    ...
                    obj.statistics.outer_u(subidx{:}) = iosr.statistics.quantile2(obj.y(subidxAll{:}), ...
                        max(obj.outerMode)/100, [], obj.method, obj.weights(subidxAll{:}));
                    obj.statistics.outer_l(subidx{:}) = iosr.statistics.quantile2(obj.y(subidxAll{:}), ...
                ...
                if ~isempty(obj.addPrctiles)
                    obj.statistics.addPrctiles(subidxAll{:}) = ...
                        iosr.statistics.quantile2(obj.y(subidxAll{:}),obj.addPrctiles(:)./100,[],obj.method,obj.weights(subidxAll{:}));
                end
