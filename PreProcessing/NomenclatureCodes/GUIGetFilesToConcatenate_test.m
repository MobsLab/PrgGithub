function varargout = GUIGetFilesToConcatenate_test(varargin)
...
if exist(ExpeInfo.PreProcessingInfo.NumFilesToConcatenate)
...
% Marks whether folders already entered should be re-used for
% pre-processing
% function OldFolders(hObject, eventdata)
